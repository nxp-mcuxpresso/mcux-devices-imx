...
#if !defined(MIMX8MD7_CM4_COMMON_H_)
#define MIMX8MD7_CM4_COMMON_H_                   /**< Symbol preventing repeated inclusion */
...
#include "system_MIMX8MD7_cm4.h"       /* Device specific configuration file */
