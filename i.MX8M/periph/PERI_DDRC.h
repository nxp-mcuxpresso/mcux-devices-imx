 ...
 *    DDRC is configured for 4 ranks): 0x1 - select rank 0 only select rank 1 only select ranks 0
 *    and 2 select ranks 1 and 3 select ranks 0, 1, 2 and 3
 */
...
#define DDRC_CRCPARCTL0_dfi_alert_err_int_en_MASK (0x1U)
#define DDRC_CRCPARCTL0_dfi_alert_err_int_en_SHIFT (0U)
/*! dfi_alert_err_int_en - Interrupt enable bit for DFI alert error. If this bit is set, any
 *    parity/CRC error detected on the dfi_alert_n input will result in an interrupt being set on
 *    CRCPARSTAT.dfi_alert_err_int.
 */
#define DDRC_CRCPARCTL0_dfi_alert_err_int_en(x)  (((uint32_t)(((uint32_t)(x)) << DDRC_CRCPARCTL0_dfi_alert_err_int_en_SHIFT)) & DDRC_CRCPARCTL0_dfi_alert_err_int_en_MASK)

#define DDRC_CRCPARCTL0_dfi_alert_err_int_clr_MASK (0x2U)
#define DDRC_CRCPARCTL0_dfi_alert_err_int_clr_SHIFT (1U)
/*! dfi_alert_err_int_clr - Interrupt clear bit for DFI alert error. If this bit is set, the alert
 *    error interrupt on CRCPARSTAT.dfi_alert_err_int will be cleared. When the clear operation is
 *    complete, the DDRC automatically clears this bit.
 */
#define DDRC_CRCPARCTL0_dfi_alert_err_int_clr(x) (((uint32_t)(((uint32_t)(x)) << DDRC_CRCPARCTL0_dfi_alert_err_int_clr_SHIFT)) & DDRC_CRCPARCTL0_dfi_alert_err_int_clr_MASK)

#define DDRC_CRCPARCTL0_dfi_alert_err_cnt_clr_MASK (0x4U)
#define DDRC_CRCPARCTL0_dfi_alert_err_cnt_clr_SHIFT (2U)
/*! dfi_alert_err_cnt_clr - DFI alert error count clear. Clear bit for DFI alert error counter.
 *    Asserting this bit will clear the DFI alert error counter, CRCPARSTAT.dfi_alert_err_cnt. When the
 *    clear operation is complete, the DDRC automatically clears this bit.
 */
#define DDRC_CRCPARCTL0_dfi_alert_err_cnt_clr(x) (((uint32_t)(((uint32_t)(x)) << DDRC_CRCPARCTL0_dfi_alert_err_cnt_clr_SHIFT)) & DDRC_CRCPARCTL0_dfi_alert_err_cnt_clr_MASK)
/*! @} */

/*! @name CRCPARCTL1 - CRC Parity Control Register1 */
/*! @{ */

#define DDRC_CRCPARCTL1_parity_enable_MASK       (0x1U)
#define DDRC_CRCPARCTL1_parity_enable_SHIFT      (0U)
/*! parity_enable - C/A Parity enable register. If RCD's parity error detection or SDRAM's parity
 *    detection is enabled, this register should be 1.
 ...
 */
#define DDRC_CRCPARCTL1_parity_enable(x)         (((uint32_t)(((uint32_t)(x)) << DDRC_CRCPARCTL1_parity_enable_SHIFT)) & DDRC_CRCPARCTL1_parity_enable_MASK)

#define DDRC_CRCPARCTL1_crc_enable_MASK          (0x10U)
#define DDRC_CRCPARCTL1_crc_enable_SHIFT         (4U)
 ...
 */
#define DDRC_CRCPARCTL1_crc_enable(x)            (((uint32_t)(((uint32_t)(x)) << DDRC_CRCPARCTL1_crc_enable_SHIFT)) & DDRC_CRCPARCTL1_crc_enable_MASK)

#define DDRC_CRCPARCTL1_crc_inc_dm_MASK          (0x80U)
#define DDRC_CRCPARCTL1_crc_inc_dm_SHIFT         (7U)
 ...
 */
#define DDRC_CRCPARCTL1_crc_inc_dm(x)            (((uint32_t)(((uint32_t)(x)) << DDRC_CRCPARCTL1_crc_inc_dm_SHIFT)) & DDRC_CRCPARCTL1_crc_inc_dm_MASK)

#define DDRC_CRCPARCTL1_caparity_disable_before_sr_MASK (0x1000U)
#define DDRC_CRCPARCTL1_caparity_disable_before_sr_SHIFT (12U)
/*! caparity_disable_before_sr - If DDR4-SDRAM's CA parity is enabled by INIT6.mr5[2:0]!=0 and this
 *    register is set to 1, CA parity is automatically disabled before Self-Refresh entry and
 *    enabled after Self-Refresh exit by issuing MR5. - 1: CA parity is disabled before Self-Refresh entry
 *    - 0: CA parity is not disabled before Self-Refresh entry If Geardown is used by
 *    MSTR.geardown_mode=1, this register must be set to 1. If this register set to 0, DRAMTMG5.t_ckesr and
 *    DRAMTMG5.t_cksre must be increased by PL(Parity latency)
 *  0b0..CA parity is not disabled before Self-Refresh entry
 *  0b1..CA parity is disabled before Self-Refresh entry
 */
#define DDRC_CRCPARCTL1_caparity_disable_before_sr(x) (((uint32_t)(((uint32_t)(x)) << DDRC_CRCPARCTL1_caparity_disable_before_sr_SHIFT)) & DDRC_CRCPARCTL1_caparity_disable_before_sr_MASK)
/*! @} */

/*! @name CRCPARSTAT - CRC Parity Status Register */
/*! @{ */

#define DDRC_CRCPARSTAT_dfi_alert_err_cnt_MASK   (0xFFFFU)
#define DDRC_CRCPARSTAT_dfi_alert_err_cnt_SHIFT  (0U)
/*! dfi_alert_err_cnt - DFI alert error count. If a parity/CRC error is detected on dfi_alert_n,
 *    this counter be incremented. This is independent of the setting of
 *    CRCPARCTL0.dfi_alert_err_int_en. It will saturate at 0xFFFF, and can be cleared by asserting
 *    CRCPARCTL0.dfi_alert_err_cnt_clr.
 */
#define DDRC_CRCPARSTAT_dfi_alert_err_cnt(x)     (((uint32_t)(((uint32_t)(x)) << DDRC_CRCPARSTAT_dfi_alert_err_cnt_SHIFT)) & DDRC_CRCPARSTAT_dfi_alert_err_cnt_MASK)

#define DDRC_CRCPARSTAT_dfi_alert_err_int_MASK   (0x10000U)
#define DDRC_CRCPARSTAT_dfi_alert_err_int_SHIFT  (16U)
/*! dfi_alert_err_int - DFI alert error interrupt. If a parity/CRC error is detected on dfi_alert_n,
 *    and the interrupt is enabled by CRCPARCTL0.dfi_alert_err_int_en, this interrupt bit will be
 *    set. It will remain set until cleared by CRCPARCTL0.dfi_alert_err_int_clr
 */
#define DDRC_CRCPARSTAT_dfi_alert_err_int(x)     (((uint32_t)(((uint32_t)(x)) << DDRC_CRCPARSTAT_dfi_alert_err_int_SHIFT)) & DDRC_CRCPARSTAT_dfi_alert_err_int_MASK)
/*! @} */
 ...
 *  0b1..(non-DDR4) Send all commands to even and odd ranks separately. (DDR4) Send MRS commands to each ranks separately.
 */
