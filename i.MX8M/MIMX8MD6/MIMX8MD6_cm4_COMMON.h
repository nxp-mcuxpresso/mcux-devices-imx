...
#if !defined(MIMX8MD6_CM4_COMMON_H_)
#define MIMX8MD6_CM4_COMMON_H_                   /**< Symbol preventing repeated inclusion */
...
#include "system_MIMX8MD6_cm4.h"       /* Device specific configuration file */
