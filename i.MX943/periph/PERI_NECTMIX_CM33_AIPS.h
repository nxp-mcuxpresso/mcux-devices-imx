...
#if !defined(PERI_NECTMIX_CM33_AIPS_H_)
#define PERI_NECTMIX_CM33_AIPS_H_                /**< Symbol preventing repeated inclusion */
...
#endif  /* PERI_NECTMIX_CM33_AIPS_H_ */
