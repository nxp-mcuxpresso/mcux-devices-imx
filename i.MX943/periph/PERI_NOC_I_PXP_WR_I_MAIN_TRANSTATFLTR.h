...
/*!
 * @file PERI_NOC_I_PXP_wr_I_main_TranStatFltr.h
 * @version 2.0
 * @date 2024-10-29
...
#if !defined(PERI_NOC_I_PXP_WR_I_MAIN_TRANSTATFLTR_H_)
#define PERI_NOC_I_PXP_WR_I_MAIN_TRANSTATFLTR_H_ /**< Symbol preventing repeated inclusion */
...
#endif  /* PERI_NOC_I_PXP_WR_I_MAIN_TRANSTATFLTR_H_ */
