...
/*!
 * @file PERI_NOC_Probe_PXP_wr_main_TrStProf.h
 * @version 2.0
 * @date 2024-10-29
...
#if !defined(PERI_NOC_PROBE_PXP_WR_MAIN_TRSTPROF_H_)
#define PERI_NOC_PROBE_PXP_WR_MAIN_TRSTPROF_H_   /**< Symbol preventing repeated inclusion */
...
#endif  /* PERI_NOC_PROBE_PXP_WR_MAIN_TRSTPROF_H_ */
