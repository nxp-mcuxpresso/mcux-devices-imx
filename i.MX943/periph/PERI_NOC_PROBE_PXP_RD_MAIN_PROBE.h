...
/*!
 * @file PERI_NOC_Probe_PXP_rd_main_Probe.h
 * @version 2.0
 * @date 2024-10-29
...
#if !defined(PERI_NOC_PROBE_PXP_RD_MAIN_PROBE_H_)
#define PERI_NOC_PROBE_PXP_RD_MAIN_PROBE_H_      /**< Symbol preventing repeated inclusion */
...
#endif  /* PERI_NOC_PROBE_PXP_RD_MAIN_PROBE_H_ */
