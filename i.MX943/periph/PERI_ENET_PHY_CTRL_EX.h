...
#if !defined(PERI_ENET_PHY_CTRL_EX_H_)
#define PERI_ENET_PHY_CTRL_EX_H_                 /**< Symbol preventing repeated inclusion */
...
#endif  /* PERI_ENET_PHY_CTRL_EX_H_ */
