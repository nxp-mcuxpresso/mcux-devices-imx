...
#endif MIMX94398_cm33_core0_SERIES
...
/* GPT - Peripheral instance base addresses */
  ...
  /** Peripheral GPT3 base pointer */
  #define GPT3_NS                                  ((GPT_Type *)GPT3_BASE_NS)
  ...
  /** Peripheral GPT4 base pointer */
  #define GPT4_NS                                  ((GPT_Type *)GPT4_BASE_NS)
  /** Array initializer of GPT peripheral base addresses */
  #define GPT_BASE_ADDRS                           { 0u, GPT1_BASE, GPT2_BASE, GPT3_BASE, GPT4_BASE }
  /** Array initializer of GPT peripheral base pointers */
  #define GPT_BASE_PTRS                            { (GPT_Type *)0u, GPT1, GPT2, GPT3, GPT4 }
  /** Array initializer of GPT peripheral base addresses */
  #define GPT_BASE_ADDRS_NS                        { 0u, GPT1_BASE_NS, GPT2_BASE_NS, GPT3_BASE_NS, GPT4_BASE_NS }
  /** Array initializer of GPT peripheral base pointers */
  #define GPT_BASE_PTRS_NS                         { (GPT_Type *)0u, GPT1_NS, GPT2_NS, GPT3_NS, GPT4_NS }
#else
  /** Peripheral GPT1 base address */
