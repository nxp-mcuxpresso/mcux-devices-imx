...
const uint8_t g_clockRootMux[CLOCK_NUM_ROOT][CLOCK_NUM_ROOT_MUX_SEL] =
{
    ...
    [CLOCK_ROOT_IGF][0] = CLOCK_SRC_OSC24M,
    [CLOCK_ROOT_IGF][1] = CLOCK_SRC_SYSPLL1_PFD0_DIV2,
    [CLOCK_ROOT_IGF][2] = CLOCK_SRC_SYSPLL1_PFD1_DIV2,
    [CLOCK_ROOT_IGF][3] = CLOCK_SRC_FRO,
