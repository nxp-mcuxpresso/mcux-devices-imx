...
/*! WRR_WEIGHT_VC_1 - WRR Weight for VC1. Note: The access attributes of this field are as follows: - Dbi: R */
...
/*! WRR_WEIGHT_VC_2 - WRR Weight for VC2. Note: The access attributes of this field are as follows: - Dbi: R */
...
/*! WRR_WEIGHT_VC_3 - WRR Weight for VC3. Note: The access attributes of this field are as follows: - Dbi: R */
...
/*! WRR_WEIGHT_VC_4 - WRR Weight for VC4. Note: The access attributes of this field are as follows: - Dbi: R */
...
/*! WRR_WEIGHT_VC_5 - WRR Weight for VC5. Note: The access attributes of this field are as follows: - Dbi: R */
...
/*! WRR_WEIGHT_VC_6 - WRR Weight for VC6. Note: The access attributes of this field are as follows: - Dbi: R */
...
/*! WRR_WEIGHT_VC_7 - WRR Weight for VC7. Note: The access attributes of this field are as follows: - Dbi: R */
 ...
 *    slv_rresp or slv_bresp. The recommended setting is SLVERR. CRS is always mapped to OKAY. - [0] --
 *    0: UR (unsupported request) -> DECERR -- 1: UR (unsupported request) -> SLVERR - [1] -- 0: CRS
 *    (configuration retry status) -> DECERR -- 1: CRS (configuration retry status) -> SLVERR - [2]
 *    -- 0: CA (completer abort) -> DECERR -- 1: CA (completer abort) -> SLVERR - [3]: Reserved -
 *    [4]: Reserved - [5]: -- 0: Completion Timeout -> DECERR -- 1: Completion Timeout -> SLVERR The
 *    AXI bridge internally drops (processes internally but not passed to your application) a
 *    completion that has been marked by the Rx filter as UC or MLF, and does not pass its status directly
 *    down to the slave interface. It waits for a timeout and then signals "Completion Timeout" to
 *    the slave interface. The controller sets the AXI slave read databus to 0xFFFF for all error
 *    responses. Note: This register field is sticky.
 */
 ...
 *    0: lower = Peripheral; upper = Memory - 1: lower = Memory type; upper = Peripheral Note: This
 *    register field is sticky.
 */
...
/*! CFG_MEMTYPE_BOUNDARY_LOW_ADDR - Boundary Lower Address For Memory Type. Bits [31:0] of
 *    dword-aligned address of the boundary for Memory type. The two lower address LSBs are "00". Addresses
 *    up to but not including this value are in the lower address space region; addresses equal or
 *    greater than this value are in the upper address space region. Note: This register field is
 *    sticky.
 */
...
/*! CFG_MEMTYPE_BOUNDARY_HIGH_ADDR - Boundary Upper Address For Memory Type. Bits [63:32] of the
 *    64-bit dword-aligned address of the boundary for Memory type. Note: This register field is sticky.
 */
...
/*! CFG_MSTR_ARCACHE_MODE - Master Read CACHE Signal Behavior. Defines how the individual bits in
 *    mstr_arcache are controlled: - 0: set automatically by the AXI master - 1: set by the value of
 *    the corresponding bit of the CFG_MSTR_ARCACHE_VALUE field Note: This register field is sticky.
 */
...
/*! CFG_MSTR_AWCACHE_MODE - Master Write CACHE Signal Behavior. Defines how the individual bits in
 *    mstr_awcache are controlled: - 0: set automatically by the AXI master - 1: set by the value of
 *    the corresponding bit of the CFG_MSTR_AWCACHE_VALUE field Note: for message requests the value
 *    of mstr_awcache is always "0000" regardless of the value of this bit Note: This register
 *    field is sticky.
 */
...
/*! CFG_MSTR_ARCACHE_VALUE - Master Read CACHE Signal Value. Value of the individual bits in
 *    mstr_arcache when CFG_MSTR_ARCACHE_MODE is '1'. Note: This register field is sticky.
 */
...
/*! CFG_MSTR_AWCACHE_VALUE - Master Write CACHE Signal Value. Value of the individual bits in
 *    mstr_awcache when CFG_MSTR_AWCACHE_MODE is '1'. Note: not applicable to message requests; for
 *    message requests the value of mstr_awcache is always "0000" Note: This register field is sticky.
 */
