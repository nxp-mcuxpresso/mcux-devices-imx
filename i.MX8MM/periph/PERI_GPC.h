...
typedef struct {
  ...
  __IO uint32_t IMR_M4[GPC_IMR_M4_COUNT];          /**< IRQ masking register 1 of M4..IRQ masking register 4 of M4, array offset: 0x50, array step: 0x4 */
  ...
  __I  uint32_t ISR_M4[GPC_ISR_M4_COUNT];          /**< IRQ status register 1 of M4..IRQ status register 4 of M4, array offset: 0x80, array step: 0x4 */
  ...
  __I  uint32_t M4_MIX_PGC_PUP_STATUS[GPC_M4_MIX_PGC_PUP_STATUS_COUNT]; /**< M4 MIX PGC software up trigger status register, array offset: 0x140, array step: 0x4 */
  ...
  __I  uint32_t M4_PU_PGC_PUP_STATUS[GPC_M4_PU_PGC_PUP_STATUS_COUNT]; /**< M4 PU PGC software up trigger status register, array offset: 0x158, array step: 0x4 */
  ...
  __I  uint32_t M4_MIX_PGC_PDN_STATUS[GPC_M4_MIX_PGC_PDN_STATUS_COUNT]; /**< M4 MIX PGC software power down trigger status register, array offset: 0x180, array step: 0x4 */
  ...
  __I  uint32_t M4_PU_PGC_PDN_STATUS[GPC_M4_PU_PGC_PDN_STATUS_COUNT]; /**< M4 PU PGC software down trigger status, array offset: 0x198, array step: 0x4 */
  ...
  __IO uint32_t SLT_CFG_PU[GPC_SLT_CFG_PU_COUNT];  /**< Slot configure register for PUs, array offset: 0x200, array step: 0x4 */
} GPC_Type;
