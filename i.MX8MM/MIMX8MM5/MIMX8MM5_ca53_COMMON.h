...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for MIMX8MM5_ca53
**
...
/*!
 * @file MIMX8MM5_ca53_COMMON.h
 * @version 5.0
 * @date 2024-10-29
 * @brief CMSIS Peripheral Access Layer for MIMX8MM5_ca53
 *
 * CMSIS Peripheral Access Layer for MIMX8MM5_ca53
 */

#if !defined(MIMX8MM5_CA53_COMMON_H_)
#define MIMX8MM5_CA53_COMMON_H_                  /**< Symbol preventing repeated inclusion */
...
typedef enum IRQn {
  ...
  SPDIF1_IRQn                  = 38,               /**< SPDIF1 Interrupt */
  ...
  VPU_H1_IRQn                  = 62,               /**< VPU H1 Decoder interrupt */
  ...
  USB2_IRQn                    = 73,               /**< USB1 Interrupt */
  Reserved74_IRQn              = 74,               /**< Reserved interrupt */
  Reserved75_IRQn              = 75,               /**< Reserved interrupt */
  PDM_HWVAD_EVENT_IRQn         = 76,               /**< Digital Microphone interface voice activity detector event interrupt */
  PDM_HWVAD_ERROR_IRQn         = 77,               /**< Digital Microphone interface voice activity detector error interrupt */
  ...
  TEMPMON_LOW_IRQn             = 81,               /**< TempSensor (Temperature low alarm). */
  ...
  Reserved106_IRQn             = 106,              /**< Reserved interrupt */
  Reserved107_IRQn             = 107,              /**< Reserved interrupt */
  Reserved108_IRQn             = 108,              /**< Reserved interrupt */
  Reserved109_IRQn             = 109,              /**< Reserved interrupt */
  ...
  MU_M4_IRQn                   = 129,              /**< Interrupt to M4 */
  DDR_PerformanceMonitor_IRQn  = 130,              /**< ddr Interrupt for performance monitor */
  DDR_IRQn                     = 131,              /**< ddr Interrupt */
  Reserved132_IRQn             = 132,              /**< Reserved interrupt */
  ...
  QSPI_IRQn                    = 139,              /**< QSPI Interrupt */
  TZASC_IRQn                   = 140,              /**< TZASC (PL380) interrupt */
  PDM_EVENT_IRQn               = 141,              /**< Digital Microphone interface interrupt */
  PDM_ERROR_IRQn               = 142,              /**< Digital Microphone interface error interrupt */
  Reserved143_IRQn             = 143,              /**< Reserved interrupt */
  ...
  Reserved149_IRQn             = 149,              /**< Reserved interrupt */
  ...
  ENET1_1588_Timer_IRQn        = 153,              /**< MAC 0 1588 Timer Interrupt - synchronous */
  PCIE_CTRL1_IRQ0_IRQn         = 154,              /**< Coming from GLUE logic, of set / reset FF, driven by PCIE signals. */
  PCIE_CTRL1_IRQ1_IRQn         = 155,              /**< Coming from GLUE logic, of set / reset FF, driven by PCIE signals. */
  PCIE_CTRL1_IRQ2_IRQn         = 156,              /**< Coming from GLUE logic, of set / reset FF, driven by PCIE signals. */
  PCIE_CTRL1_IRQ3_IRQn         = 157,              /**< Coming from GLUE logic, of set / reset FF, driven by PCIE signals. */
  Reserved158_IRQn             = 158,              /**< Reserved interrupt */
  PCIE_CTRL1_IRQn              = 159               /**< Channels [63:32] interrupts requests */
} IRQn_Type;
...
#define GIC_DISTRIBUTOR_BASE           0x38800000 /**< GIC distributor base address */
#define GIC_REDISTRIBUTOR_BASE         0x38880000 /**< GIC CPU redistributor base address */

#include "core_ca53.h"                 /* Core Peripheral Access Layer */
#include "system_MIMX8MM5_ca53.h"      /* Device specific configuration file */
...
#ifndef MIMX8MM5_ca53_SERIES
#define MIMX8MM5_ca53_SERIES
#endif
/* CPU specific feature definitions */
#include "MIMX8MM5_ca53_features.h"
...
#define SDMAARM_IRQS                             { NotAvail_IRQn, NotAvail_IRQn, SDMA2_IRQn, NotAvail_IRQn }
