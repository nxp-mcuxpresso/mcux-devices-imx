...
#if !defined(MIMX8MM6_cm4_H_)  /* Check if memory map has not been already included */
#define MIMX8MM6_cm4_H_
...
#endif  /* #if !defined(MIMX8MM6_cm4_H_) */
