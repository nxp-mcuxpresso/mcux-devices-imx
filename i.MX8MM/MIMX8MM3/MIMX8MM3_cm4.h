 ...
 * @version 5.0
 * @date 2024-10-29
 * @brief CMSIS Peripheral Access Layer for MIMX8MM3_cm4
 *
 * CMSIS Peripheral Access Layer for MIMX8MM3_cm4
 */

#if !defined(MIMX8MM3_cm4_H_)  /* Check if memory map has not been already included */
#define MIMX8MM3_cm4_H_
...
#endif  /* #if !defined(MIMX8MM3_cm4_H_) */
