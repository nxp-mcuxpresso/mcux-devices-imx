...
#if !defined(MIMX8MM3_ca53_H_)  /* Check if memory map has not been already included */
#define MIMX8MM3_ca53_H_
...
#endif  /* #if !defined(MIMX8MM3_ca53_H_) */
