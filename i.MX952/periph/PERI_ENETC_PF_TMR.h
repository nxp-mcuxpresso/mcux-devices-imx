...
/*! ECADJ - Enhanced Timer Adjustment
 *  0b0..Not supported
 *  0b1..Supported
 */
...
/*! IEEE_8021AS_REV - IEEE 802.1AS Support
 *  0b0..Not supported
 *  0b1..Supported
 */
 ...
 *  0b0..One MSI-X vector supported
 *  0b1..Two MSI-X vectors supported
 */
...
/* The count of ENETC_PF_TMR_TMR_CAPR */
#define ENETC_PF_TMR_TMR_CAPR_COUNT              (1U)
...
/*! TMR_FRT_L - Timer Free-Running Time Low */
...
/* The count of ENETC_PF_TMR_TMR_FRT_L */
#define ENETC_PF_TMR_TMR_FRT_L_COUNT             (1U)
...
/*! TMR_FRT_H - Timer Free-Running Time High */
...
/* The count of ENETC_PF_TMR_TMR_FRT_H */
#define ENETC_PF_TMR_TMR_FRT_H_COUNT             (1U)
...
/* The count of ENETC_PF_TMR_TMR_SRT_L */
#define ENETC_PF_TMR_TMR_SRT_L_COUNT             (1U)
...
/* The count of ENETC_PF_TMR_TMR_SRT_H */
#define ENETC_PF_TMR_TMR_SRT_H_COUNT             (1U)
...
/* The count of ENETC_PF_TMR_TMR_DEF_CNT_L */
#define ENETC_PF_TMR_TMR_DEF_CNT_L_COUNT         (1U)
...
/* The count of ENETC_PF_TMR_TMR_DEF_CNT_H */
#define ENETC_PF_TMR_TMR_DEF_CNT_H_COUNT         (1U)
 ...
 *  0b00..External high precision timer reference clock (TMR_1588_CLK)
 *  0b01..NETC system clock
 *  0b10, 0b11..
 */
...
#define ENETC_PF_TMR_TMR_CTRL_TMSR_MASK          (0x20U)
#define ENETC_PF_TMR_TMR_CTRL_TMSR_SHIFT         (5U)
/*! TMSR - Timer Soft Reset
 *  0b0..Normal operation
 *  0b1..Reset
 */
#define ENETC_PF_TMR_TMR_CTRL_TMSR(x)            (((uint32_t)(((uint32_t)(x)) << ENETC_PF_TMR_TMR_CTRL_TMSR_SHIFT)) & ENETC_PF_TMR_TMR_CTRL_TMSR_MASK)
...
/*! COMP_MODE - Compensation Mode
 *  0b0..Atomic updates disabled
 *  0b1..Atomic updates enabled
 */
...
/*! PP2L - FIPER2 Pulse Loopback Mode Enable
 *  0b0..Trigger 2 input is based upon normal external trigger input
 *  0b1..FIPER2 pulse is looped back into trigger 2 input
 */
...
/*! PP1L - FIPER1 Pulse Loopback Mode Enable
 *  0b0..Trigger 1 input is based upon normal external trigger input
 *  0b1..FIPER1 pulse is looped back into trigger 1 input
 */
 ...
 *  0b0..FIPER is enabled through timer enable
 *  0b1..FIPER is enabled through timer enable and alarm getting set
 */
 ...
 *  0b0..Shadow register not disabled
 *  0b1..Shadow register disabled
 */
...
/*! ALM2P - Alarm 2 Output Polarity
 *  0b0..Active high output
 *  0b1..Active low output
 */
...
/* The count of ENETC_PF_TMR_TMR_CTRL */
#define ENETC_PF_TMR_TMR_CTRL_COUNT              (1U)
...
/*! ETS1_THREN - External Trigger 1 Timestamp FIFO Threshold Level Hit
 *  0b0..No effect
 *  0b0..No event
 *  0b1..Clears event
 *  0b1..Event occurred
...
/*! ETS2_THREN - External Trigger 2 Timestamp FIFO Threshold Level Hit
 *  0b0..No effect
 *  0b0..No event
 *  0b1..Clears event
 *  0b1..Event occurred
...
/*! ETS1EN - External Trigger 1 Sample Event
 *  0b0..No effect
 *  0b0..No event
 *  0b1..Clears event
 *  0b1..Event occurred
...
/*! ETS2EN - External Trigger 2 Sample Event
 *  0b0..No effect
 *  0b0..No event
 *  0b1..Clears event
 *  0b1..Event occurred
...
/*! ETS1_OVEN - External Trigger 1 Timestamp FIFO Overflow Event
 *  0b0..No effect
 *  0b0..No event
 *  0b1..Clears event
 *  0b1..Event occurred
...
/*! ETS2_OVEN - External Trigger 2 Timestamp FIFO Overflow Event
 *  0b0..No effect
 *  0b0..No event
 *  0b1..Clears event
 *  0b1..Event occurred
...
/* The count of ENETC_PF_TMR_TMR_TEVENT */
#define ENETC_PF_TMR_TMR_TEVENT_COUNT            (1U)
...
/* The count of ENETC_PF_TMR_TMR_TEMASK */
#define ENETC_PF_TMR_TMR_TEMASK_COUNT            (1U)
...
/* The count of ENETC_PF_TMR_TMR_MSIVEC */
#define ENETC_PF_TMR_TMR_MSIVEC_COUNT            (1U)
...
/*! ETS1_VLD - External Trigger 1 Valid Timestamp
 *  0b0..All valid external trigger timestamps are read
 *  0b1..External trigger has an unread valid timestamp value
 */
...
/*! ETS2_VLD - External Trigger 2 Valid Timestamp
 *  0b0..All valid external trigger timestamps are read
 *  0b1..External trigger has an unread valid timestamp value
 */
 ...
 *  0b0..Reference clock inactive
 *  0b1..Reference clock active
 */
#define ENETC_PF_TMR_TMR_STAT_RCD(x)             (((uint32_t)(((uint32_t)(x)) << ENETC_PF_TMR_TMR_STAT_RCD_SHIFT)) & ENETC_PF_TMR_TMR_STAT_RCD_MASK)
/*! @} */

/* The count of ENETC_PF_TMR_TMR_STAT */
#define ENETC_PF_TMR_TMR_STAT_COUNT              (1U)
...
/* The count of ENETC_PF_TMR_TMR_CNT_L */
#define ENETC_PF_TMR_TMR_CNT_L_COUNT             (1U)
...
/* The count of ENETC_PF_TMR_TMR_CNT_H */
#define ENETC_PF_TMR_TMR_CNT_H_COUNT             (1U)
...
/* The count of ENETC_PF_TMR_TMR_ADD */
#define ENETC_PF_TMR_TMR_ADD_COUNT               (1U)
...
/* The count of ENETC_PF_TMR_TMR_ACC */
#define ENETC_PF_TMR_TMR_ACC_COUNT               (1U)
...
/* The count of ENETC_PF_TMR_TMR_PRSC */
#define ENETC_PF_TMR_TMR_PRSC_COUNT              (1U)
 ...
 *  0b0000..1 or more entries
 *  0b0001..2 or more entries
 *  0b0010-0b1101.....
 *  0b1110..15 or more entries
 *  0b1111..16 or more entries
 */
...
/* The count of ENETC_PF_TMR_TMR_ECTRL */
#define ENETC_PF_TMR_TMR_ECTRL_COUNT             (1U)
...
/* The count of ENETC_PF_TMR_TMROFF_L */
#define ENETC_PF_TMR_TMROFF_L_COUNT              (1U)
...
#define ENETC_PF_TMR_TMROFF_H_COUNT              (1U)
...
#define ENETC_PF_TMR_TMR_ALARM_L_COUNT           (1U)

/* The count of ENETC_PF_TMR_TMR_ALARM_L */
#define ENETC_PF_TMR_TMR_ALARM_L_COUNT2          (2U)
...
#define ENETC_PF_TMR_TMR_ALARM_H_COUNT           (1U)

/* The count of ENETC_PF_TMR_TMR_ALARM_H */
#define ENETC_PF_TMR_TMR_ALARM_H_COUNT2          (2U)
...
/* The count of ENETC_PF_TMR_TMR_ALARM_CTRL */
#define ENETC_PF_TMR_TMR_ALARM_CTRL_COUNT        (1U)
...
#define ENETC_PF_TMR_TMR_FIPER_COUNT             (1U)

/* The count of ENETC_PF_TMR_TMR_FIPER */
#define ENETC_PF_TMR_TMR_FIPER_COUNT2            (3U)
...
/*! FIPER1_PW - FIPER1 Pulse Width Selection
 *  0b00000..
 *  0b00001-0b11111..Number of timer generated clocks the FIPER is active for
 */
 ...
 *  0b0..Enabled and asserts as configured
 *  0b1..Disabled
 */
...
/*! FIPER2_PW - FIPER2 Pulse Width Selection
 *  0b00000..
 *  0b00001-0b11111..Number of timer generated clocks the FIPER is active for
 */
...
/*! FIPER3_PW - FIPER3 Pulse Width Selection
 *  0b00000..
 *  0b00001-0b11111..Number of timer generated clocks the FIPER is active for
 */
...
#define ENETC_PF_TMR_TMR_FIPER_CTRL_RELAY_EN_MASK (0x1000000U)
#define ENETC_PF_TMR_TMR_FIPER_CTRL_RELAY_EN_SHIFT (24U)
/*! RELAY_EN - FIPER Relay Enable
 *  0b0..Relay disabled on TRIG1-FIPER1
 *  0b1..Relay enabled on TRIG1-FIPER1
 */
#define ENETC_PF_TMR_TMR_FIPER_CTRL_RELAY_EN(x)  (((uint32_t)(((uint32_t)(x)) << ENETC_PF_TMR_TMR_FIPER_CTRL_RELAY_EN_SHIFT)) & ENETC_PF_TMR_TMR_FIPER_CTRL_RELAY_EN_MASK)
/*! @} */

/* The count of ENETC_PF_TMR_TMR_FIPER_CTRL */
#define ENETC_PF_TMR_TMR_FIPER_CTRL_COUNT        (1U)
...
/*! ETTS_L - External Trigger Timestamp Low */
...
#define ENETC_PF_TMR_TMR_ETTS_L_COUNT            (1U)

/* The count of ENETC_PF_TMR_TMR_ETTS_L */
#define ENETC_PF_TMR_TMR_ETTS_L_COUNT2           (2U)
...
/*! ETTS_H - External Trigger Timestamp High */
...
#define ENETC_PF_TMR_TMR_ETTS_H_COUNT            (1U)

/* The count of ENETC_PF_TMR_TMR_ETTS_H */
#define ENETC_PF_TMR_TMR_ETTS_H_COUNT2           (2U)
...
/*! TMR_CUR_TIME_L - Current Time Low */
...
/* The count of ENETC_PF_TMR_TMR_CUR_TIME_L */
#define ENETC_PF_TMR_TMR_CUR_TIME_L_COUNT        (1U)
...
/*! TMR_CUR_TIME_H - Current Time High */
...
/* The count of ENETC_PF_TMR_TMR_CUR_TIME_H */
#define ENETC_PF_TMR_TMR_CUR_TIME_H_COUNT        (1U)
 ...
 *  0b0..Not synchronized with grandmaster
 *  0b1..Synchronized with grandmaster
 */
...
/* The count of ENETC_PF_TMR_TMR_PARAM */
#define ENETC_PF_TMR_TMR_PARAM_COUNT             (1U)
