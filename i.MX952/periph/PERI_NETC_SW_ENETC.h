...
#define NETC_SW_ENETC_PCSMSIVR_VECTOR_MASK       (0x3FU)
...
#define NETC_SW_ENETC_IMDIOMSIVR_VECTOR_MASK     (0x3FU)
#define NETC_SW_ENETC_IMDIOMSIVR_VECTOR_SHIFT    (0U)
#define NETC_SW_ENETC_IMDIOMSIVR_VECTOR(x)       (((uint32_t)(((uint32_t)(x)) << NETC_SW_ENETC_IMDIOMSIVR_VECTOR_SHIFT)) & NETC_SW_ENETC_IMDIOMSIVR_VECTOR_MASK)
/*! @} */
