...
#define NETC_IERB_CFG_VSI_INST_COUNT              2u
...
typedef struct {
  ...
  struct {                                         /* offset: 0x3000, array step: 0x100 */
    ...
    __IO uint32_t EVFRIDAR;                          /**< ENETC 0 VF RID assignment register..ENETC 1 VF RID assignment register, array offset: 0x3010, array step: 0x100 */
    ...
    __IO uint32_t EFAUXR;                            /**< ENETC 0 function auxiliary register..ENETC 1 function auxiliary register, array offset: 0x3044, array step: 0x100 */
    ...
    __IO uint32_t ERIDAR;                            /**< ENETC 0 RID assignment register..ENETC 1 RID assignment register, array offset: 0x3060, array step: 0x100 */
    ...
    __I  uint32_t ERTMAR;                            /**< ENETC 0 RFS ternary memory allocation register..ENETC 1 RFS ternary memory allocation register, array offset: 0x3090, array step: 0x100 */
    ...
    __IO uint32_t ETGSLR;                            /**< ENETC 0 time gate scheduling lookahead register..ENETC 1 time gate scheduling lookahead register, array offset: 0x30F4, array step: 0x100 */
       ...
       uint8_t RESERVED_23[3584];
  struct {                                         /* offset: 0x4000, array step: 0x40 */
    __IO uint32_t VAMQR;                             /**< VSI 0 access management qualifier register..VSI 1 access management qualifier register, array offset: 0x4000, array step: 0x40 */
    __IO uint32_t VFAUXR;                            /**< VSI 0 function auxiliary register..VSI 1 function auxiliary register, array offset: 0x4004, array step: 0x40 */
    __IO uint32_t VBLPR[NETC_IERB_CFG_VSI_INST_VSI_PF_BOOT_LOAD_COUNT];   /**< VSI 0 boot loader parameter register 0..VSI 1 boot loader parameter register 1, array offset: 0x4008, array step: index*0x40, index2*0x4 */
    __IO uint32_t VPMAR0;                            /**< VSI 0 primary MAC address register 0..VSI 1 primary MAC address register 0, array offset: 0x4010, array step: 0x40 */
    __IO uint32_t VPMAR1;                            /**< VSI 0 primary MAC address register 1..VSI 1 primary MAC address register 1, array offset: 0x4014, array step: 0x40 */
...
#define NETC_IERB_EMDIOFAUXR_FAUX_MASK           (0x7U)
...
#define NETC_IERB_TFAUXR_FAUX_MASK               (0x7U)
...
/*! @name EVFRIDAR - ENETC 0 VF RID assignment register..ENETC 1 VF RID assignment register */
/*! @{ */
...
#define NETC_IERB_EVFRIDAR_COUNT                 (2U)
...
#define NETC_IERB_EAMQR_RXPAD_DIS_MASK           (0x40000000U)
#define NETC_IERB_EAMQR_RXPAD_DIS_SHIFT          (30U)
#define NETC_IERB_EAMQR_RXPAD_DIS(x)             (((uint32_t)(((uint32_t)(x)) << NETC_IERB_EAMQR_RXPAD_DIS_SHIFT)) & NETC_IERB_EAMQR_RXPAD_DIS_MASK)
/*! @} */

/* The count of NETC_IERB_EAMQR */
#define NETC_IERB_EAMQR_COUNT                    (2U)

/*! @name EFAUXR - ENETC 0 function auxiliary register..ENETC 1 function auxiliary register */
/*! @{ */

#define NETC_IERB_EFAUXR_FAUX_MASK               (0x7U)
...
#define NETC_IERB_EFAUXR_COUNT                   (2U)
...
/*! @name ERIDAR - ENETC 0 RID assignment register..ENETC 1 RID assignment register */
/*! @{ */
...
#define NETC_IERB_ERIDAR_COUNT                   (2U)
...
/*! @name ERTMAR - ENETC 0 RFS ternary memory allocation register..ENETC 1 RFS ternary memory allocation register */
/*! @{ */
...
#define NETC_IERB_ERTMAR_COUNT                   (2U)
...
/*! @name VAMQR - VSI 0 access management qualifier register..VSI 1 access management qualifier register */
/*! @{ */
...
#define NETC_IERB_VAMQR_RXPAD_DIS_MASK           (0x40000000U)
#define NETC_IERB_VAMQR_RXPAD_DIS_SHIFT          (30U)
#define NETC_IERB_VAMQR_RXPAD_DIS(x)             (((uint32_t)(((uint32_t)(x)) << NETC_IERB_VAMQR_RXPAD_DIS_SHIFT)) & NETC_IERB_VAMQR_RXPAD_DIS_MASK)
/*! @} */

/* The count of NETC_IERB_VAMQR */
#define NETC_IERB_VAMQR_COUNT                    (2U)

/*! @name VFAUXR - VSI 0 function auxiliary register..VSI 1 function auxiliary register */
/*! @{ */

#define NETC_IERB_VFAUXR_FAUX_MASK               (0x7U)
...
#define NETC_IERB_VFAUXR_COUNT                   (2U)

/*! @name VBLPR - VSI 0 boot loader parameter register 0..VSI 1 boot loader parameter register 1 */
/*! @{ */
...
#define NETC_IERB_VBLPR_COUNT                    (2U)

/* The count of NETC_IERB_VBLPR */
#define NETC_IERB_VBLPR_COUNT2                   (2U)

/*! @name VPMAR0 - VSI 0 primary MAC address register 0..VSI 1 primary MAC address register 0 */
/*! @{ */
...
#define NETC_IERB_VPMAR0_COUNT                   (2U)

/*! @name VPMAR1 - VSI 0 primary MAC address register 1..VSI 1 primary MAC address register 1 */
/*! @{ */
...
#define NETC_IERB_VPMAR1_COUNT                   (2U)
