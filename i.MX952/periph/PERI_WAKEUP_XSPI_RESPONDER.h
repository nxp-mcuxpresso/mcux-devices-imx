...
typedef struct {
  ...
  __I  uint32_t SPIMAIL[WAKEUP_XSPI_RESPONDER_SPI_MAILBOXN_COUNT]; /**< SPI Mail Interrupt, array offset: 0x44, array step: 0x4 */
...
/*! DUMMYCYCLES - Read Command 1 Sample Cycles */
...
#define WAKEUP_XSPI_RESPONDER_SPIMAIL_MAIL_MASK  (0xFFFFFFFFU)
#define WAKEUP_XSPI_RESPONDER_SPIMAIL_MAIL_SHIFT (0U)
#define WAKEUP_XSPI_RESPONDER_SPIMAIL_MAIL(x)    (((uint32_t)(((uint32_t)(x)) << WAKEUP_XSPI_RESPONDER_SPIMAIL_MAIL_SHIFT)) & WAKEUP_XSPI_RESPONDER_SPIMAIL_MAIL_MASK)
/*! @} */
