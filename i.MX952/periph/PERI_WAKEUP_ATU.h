...
#define WAKEUP_ATU_ACORE_OWAR0_EN_MASK           (0x80000000U)
#define WAKEUP_ATU_ACORE_OWAR0_EN_SHIFT          (31U)
/*! EN - Enable
 *  0b0..Disable outbound translation window
 *  0b1..Enable outbound translation window
 */
#define WAKEUP_ATU_ACORE_OWAR0_EN(x)             (((uint32_t)(((uint32_t)(x)) << WAKEUP_ATU_ACORE_OWAR0_EN_SHIFT)) & WAKEUP_ATU_ACORE_OWAR0_EN_MASK)
/*! @} */
