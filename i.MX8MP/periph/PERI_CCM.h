...
typedef struct {
  ...
  struct {                                         /* offset: 0x8000, array step: 0x80 */
    __IO uint32_t TARGET_ROOT;                       /**< Target Register, array offset: 0x8000, array step: 0x80, valid indices: [0-8, 16-29, 32-39, 48-49, 64-141] */
    __IO uint32_t TARGET_ROOT_SET;                   /**< Target Register, array offset: 0x8004, array step: 0x80, valid indices: [0-8, 16-29, 32-39, 48-49, 64-141] */
    __IO uint32_t TARGET_ROOT_CLR;                   /**< Target Register, array offset: 0x8008, array step: 0x80, valid indices: [0-8, 16-29, 32-39, 48-49, 64-141] */
    __IO uint32_t TARGET_ROOT_TOG;                   /**< Target Register, array offset: 0x800C, array step: 0x80, valid indices: [0-8, 16-29, 32-39, 48-49, 64-141] */
    __IO uint32_t MISC;                              /**< Miscellaneous Register, array offset: 0x8010, array step: 0x80, valid indices: [0-8, 16-29, 32-39, 48-49, 64-141] */
    __IO uint32_t MISC_ROOT_SET;                     /**< Miscellaneous Register, array offset: 0x8014, array step: 0x80, valid indices: [0-8, 16-29, 32-39, 48-49, 64-141] */
    __IO uint32_t MISC_ROOT_CLR;                     /**< Miscellaneous Register, array offset: 0x8018, array step: 0x80, valid indices: [0-8, 16-29, 32-39, 48-49, 64-141] */
    __IO uint32_t MISC_ROOT_TOG;                     /**< Miscellaneous Register, array offset: 0x801C, array step: 0x80, valid indices: [0-8, 16-29, 32-39, 48-49, 64-141] */
    __IO uint32_t POST;                              /**< Post Divider Register, array offset: 0x8020, array step: 0x80, valid indices: [0-8, 16-29, 32-39, 48-49, 64-141] */
    __IO uint32_t POST_ROOT_SET;                     /**< Post Divider Register, array offset: 0x8024, array step: 0x80, valid indices: [0-8, 16-29, 32-39, 48-49, 64-141] */
    __IO uint32_t POST_ROOT_CLR;                     /**< Post Divider Register, array offset: 0x8028, array step: 0x80, valid indices: [0-8, 16-29, 32-39, 48-49, 64-141] */
    __IO uint32_t POST_ROOT_TOG;                     /**< Post Divider Register, array offset: 0x802C, array step: 0x80, valid indices: [0-8, 16-29, 32-39, 48-49, 64-141] */
    __IO uint32_t PRE;                               /**< Pre Divider Register, array offset: 0x8030, array step: 0x80, valid indices: [0-8, 16-29, 32-39, 48-49, 64-141] */
    __IO uint32_t PRE_ROOT_SET;                      /**< Pre Divider Register, array offset: 0x8034, array step: 0x80, valid indices: [0-8, 16-29, 32-39, 48-49, 64-141] */
    __IO uint32_t PRE_ROOT_CLR;                      /**< Pre Divider Register, array offset: 0x8038, array step: 0x80, valid indices: [0-8, 16-29, 32-39, 48-49, 64-141] */
    __IO uint32_t PRE_ROOT_TOG;                      /**< Pre Divider Register, array offset: 0x803C, array step: 0x80, valid indices: [0-8, 16-29, 32-39, 48-49, 64-141] */
         uint8_t RESERVED_0[48];
    __IO uint32_t ACCESS_CTRL;                       /**< Access Control Register, array offset: 0x8070, array step: 0x80, valid indices: [0-8, 16-29, 32-39, 48-49, 64-141] */
    __IO uint32_t ACCESS_CTRL_ROOT_SET;              /**< Access Control Register, array offset: 0x8074, array step: 0x80, valid indices: [0-8, 16-29, 32-39, 48-49, 64-141] */
    __IO uint32_t ACCESS_CTRL_ROOT_CLR;              /**< Access Control Register, array offset: 0x8078, array step: 0x80, valid indices: [0-8, 16-29, 32-39, 48-49, 64-141] */
    __IO uint32_t ACCESS_CTRL_ROOT_TOG;              /**< Access Control Register, array offset: 0x807C, array step: 0x80, valid indices: [0-8, 16-29, 32-39, 48-49, 64-141] */
  } ROOT[CCM_ROOT_COUNT];
} CCM_Type;
