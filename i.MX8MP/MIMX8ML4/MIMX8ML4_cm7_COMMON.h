...
#if !defined(MIMX8ML4_CM7_COMMON_H_)
#define MIMX8ML4_CM7_COMMON_H_                   /**< Symbol preventing repeated inclusion */
...
#include "system_MIMX8ML4_cm7.h"       /* Device specific configuration file */
