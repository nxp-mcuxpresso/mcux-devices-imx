...
#if !defined(MIMX8UD5_DSP0_COMMON_H_)
#define MIMX8UD5_DSP0_COMMON_H_                  /**< Symbol preventing repeated inclusion */
...
#include "system_MIMX8UD5_dsp0.h"     /* Device specific configuration file */
