...
#if !defined(MIMX8UD7_dsp0_H_)  /* Check if memory map has not been already included */
#define MIMX8UD7_dsp0_H_
...
#endif  /* #if !defined(MIMX8UD7_dsp0_H_) */
