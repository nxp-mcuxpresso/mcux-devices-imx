...
#if !defined(MIMX8UD7_CM33_COMMON_H_)
#define MIMX8UD7_CM33_COMMON_H_                  /**< Symbol preventing repeated inclusion */
...
#include "system_MIMX8UD7_cm33.h"      /* Device specific configuration file */
