...
/*!
 * @file MIMX8UD7_dsp0_COMMON.h
 * @version 6.0
 * @date 2024-10-29
 * @brief Peripheral Access Layer for MIMX8UD7_dsp0
 *
 * Peripheral Access Layer for MIMX8UD7_dsp0
 */

#if !defined(MIMX8UD7_DSP0_COMMON_H_)
#define MIMX8UD7_DSP0_COMMON_H_                  /**< Symbol preventing repeated inclusion */
...
#include "system_MIMX8UD7_dsp0.h"     /* Device specific configuration file */
