 ...
 *    interval. If the INTEN bit in the CONTROL n is also set to 1, then the interrupt for timer channel n
 *    and the global interrupt are generated. Writing a 1 to INTFLAG bit clears the interrupt
 *    request.
