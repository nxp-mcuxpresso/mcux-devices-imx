...
typedef struct {
  ...
  __I  uint32_t DCPRODUCTID;                       /**< Product ID, offset: 0x17B0 */
       uint8_t RESERVED_35[76];
  __IO uint32_t DCSTATUS0;                         /**< DC Status 0, offset: 0x1800 */
...
#define LCDIF_DBICONFIG0_DBI_TYPEC_OPT_MASK      (0x3000U)
#define LCDIF_DBICONFIG0_DBI_TYPEC_OPT_SHIFT     (12U)
/*! DBI_TYPEC_OPT - Options for DBI Type C Interface Read/Write Sequence
 *  0b00..Option 1
 *  0b01..Option 2
 *  0b10..Option 3
 *  0b11..
 */
#define LCDIF_DBICONFIG0_DBI_TYPEC_OPT(x)        (((uint32_t)(((uint32_t)(x)) << LCDIF_DBICONFIG0_DBI_TYPEC_OPT_SHIFT)) & LCDIF_DBICONFIG0_DBI_TYPEC_OPT_MASK)
/*! @} */
...
/*! @name DCSTATUS0 - DC Status 0 */
/*! @{ */

#define LCDIF_DCSTATUS0_DBI_TYPEC_FIFO_FULL_MASK (0x1U)
#define LCDIF_DCSTATUS0_DBI_TYPEC_FIFO_FULL_SHIFT (0U)
/*! DBI_TYPEC_FIFO_FULL - DBI Type C afifo full. */
#define LCDIF_DCSTATUS0_DBI_TYPEC_FIFO_FULL(x)   (((uint32_t)(((uint32_t)(x)) << LCDIF_DCSTATUS0_DBI_TYPEC_FIFO_FULL_SHIFT)) & LCDIF_DCSTATUS0_DBI_TYPEC_FIFO_FULL_MASK)
/*! @} */
