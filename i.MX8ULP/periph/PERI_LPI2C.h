 ...
 *  0b0..MSR[PLTF] is set when SCL is low for longer than the configured timeout
 *  0b1..MSR[PLTF] is set when either SCL or SDA is low for longer than the configured timeout
 */
