...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for MIMX8UD3_cm33
**
...
/*!
 * @file MIMX8UD3_cm33_COMMON.h
 * @version 6.0
 * @date 2024-10-29
 * @brief CMSIS Peripheral Access Layer for MIMX8UD3_cm33
 *
 * CMSIS Peripheral Access Layer for MIMX8UD3_cm33
 */

#if !defined(MIMX8UD3_CM33_COMMON_H_)
#define MIMX8UD3_CM33_COMMON_H_                  /**< Symbol preventing repeated inclusion */
...
#include "system_MIMX8UD3_cm33.h"      /* Device specific configuration file */
...
/* EPDC - Peripheral instance base addresses */
  ...
  #define EPDC_BASE                                (0x3DB30000u)
  /** Peripheral EPDC base address */
  #define EPDC_BASE_NS                             (0x2DB30000u)
  /** Peripheral EPDC base pointer */
  #define EPDC                                     ((EPDC_Type *)EPDC_BASE)
  /** Peripheral EPDC base pointer */
  #define EPDC_NS                                  ((EPDC_Type *)EPDC_BASE_NS)
  ...
  /** Array initializer of EPDC peripheral base addresses */
  #define EPDC_BASE_ADDRS_NS                       { EPDC_BASE_NS }
  /** Array initializer of EPDC peripheral base pointers */
  #define EPDC_BASE_PTRS_NS                        { EPDC_NS }
#else
  /** Peripheral EPDC base address */
