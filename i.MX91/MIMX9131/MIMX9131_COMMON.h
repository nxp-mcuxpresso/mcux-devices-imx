...
#if !defined(MIMX9131_COMMON_H_)
#define MIMX9131_COMMON_H_                       /**< Symbol preventing repeated inclusion */
...
#include "system_MIMX9131.h"           /* Device specific configuration file */
