...
#define SRC_GENERAL_REG_SRTMR_JTAG_RST_B_MASK    (0x200U)
#define SRC_GENERAL_REG_SRTMR_JTAG_RST_B_SHIFT   (9U)
/*! JTAG_RST_B - JTAG_RST_B trigger mode configuration, locked by LOCK_CFG field
 *  0b0..Level-sensitive: System stays in reset until the reset source deasserts.
 *  0b1..Edge-sensitive: System resets once, even if the reset source remains asserted.
 */
#define SRC_GENERAL_REG_SRTMR_JTAG_RST_B(x)      (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_SRTMR_JTAG_RST_B_SHIFT)) & SRC_GENERAL_REG_SRTMR_JTAG_RST_B_MASK)
/*! @} */
...
#define SRC_GENERAL_REG_SRMASK_JTAG_RST_B_MASK_MASK (0x200U)
#define SRC_GENERAL_REG_SRMASK_JTAG_RST_B_MASK_SHIFT (9U)
/*! JTAG_RST_B_MASK - JTAG_RST_B mask, locked by LOCK_CFG field.
 *  0b0..The cold reset source can work.
 *  0b1..The cold reset source is masked and cannot work.
 */
#define SRC_GENERAL_REG_SRMASK_JTAG_RST_B_MASK(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_SRMASK_JTAG_RST_B_MASK_SHIFT)) & SRC_GENERAL_REG_SRMASK_JTAG_RST_B_MASK_MASK)
/*! @} */
...
#define SRC_GENERAL_REG_SRSR_JTAG_RST_B_MASK     (0x1000U)
#define SRC_GENERAL_REG_SRSR_JTAG_RST_B_SHIFT    (12U)
/*! JTAG_RST_B - Indicates a reset has been caused by JTAG_RST_B
...
#define SRC_GENERAL_REG_GPR20_ANAMIX_ATX_SENSE_BUS_ENABLE_LV_MASK (0x1U)
#define SRC_GENERAL_REG_GPR20_ANAMIX_ATX_SENSE_BUS_ENABLE_LV_SHIFT (0U)
/*! ANAMIX_ATX_SENSE_BUS_ENABLE_LV - ANAMIX ATX sense bus enable */
#define SRC_GENERAL_REG_GPR20_ANAMIX_ATX_SENSE_BUS_ENABLE_LV(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_GPR20_ANAMIX_ATX_SENSE_BUS_ENABLE_LV_SHIFT)) & SRC_GENERAL_REG_GPR20_ANAMIX_ATX_SENSE_BUS_ENABLE_LV_MASK)

#define SRC_GENERAL_REG_GPR20_ANAMIX_PLL_CLK_MUX_MASK (0x1EU)
#define SRC_GENERAL_REG_GPR20_ANAMIX_PLL_CLK_MUX_SHIFT (1U)
/*! ANAMIX_PLL_CLK_MUX - ANAMIX PLL clock mux */
#define SRC_GENERAL_REG_GPR20_ANAMIX_PLL_CLK_MUX(x) (((uint32_t)(((uint32_t)(x)) << SRC_GENERAL_REG_GPR20_ANAMIX_PLL_CLK_MUX_SHIFT)) & SRC_GENERAL_REG_GPR20_ANAMIX_PLL_CLK_MUX_MASK)
