...
#define I3C_SDMACTRL_BULKFB_MASK                 (0x40U)
#define I3C_SDMACTRL_BULKFB_SHIFT                (6U)
/*! BULKFB - Bulk Transfer from Bus
 *  0b0..Disable
 *  0b1..Enable
 */
#define I3C_SDMACTRL_BULKFB(x)                   (((uint32_t)(((uint32_t)(x)) << I3C_SDMACTRL_BULKFB_SHIFT)) & I3C_SDMACTRL_BULKFB_MASK)

#define I3C_SDMACTRL_BULKTB_MASK                 (0x80U)
#define I3C_SDMACTRL_BULKTB_SHIFT                (7U)
/*! BULKTB - Bulk Transfer to Bus
 *  0b0..Disable
 *  0b1..Enable
 */
#define I3C_SDMACTRL_BULKTB(x)                   (((uint32_t)(((uint32_t)(x)) << I3C_SDMACTRL_BULKTB_SHIFT)) & I3C_SDMACTRL_BULKTB_MASK)
/*! @} */
...
#define I3C_MDMACTRL_BULKFB_MASK                 (0x40U)
#define I3C_MDMACTRL_BULKFB_SHIFT                (6U)
/*! BULKFB - Bulk Transfer from Bus
 *  0b0..Disable
 *  0b1..Enable
 */
#define I3C_MDMACTRL_BULKFB(x)                   (((uint32_t)(((uint32_t)(x)) << I3C_MDMACTRL_BULKFB_SHIFT)) & I3C_MDMACTRL_BULKFB_MASK)

#define I3C_MDMACTRL_BULKTB_MASK                 (0x80U)
#define I3C_MDMACTRL_BULKTB_SHIFT                (7U)
/*! BULKTB - Bulk Transfer to Bus
 *  0b0..Disable
 *  0b1..Enable
 */
#define I3C_MDMACTRL_BULKTB(x)                   (((uint32_t)(((uint32_t)(x)) << I3C_MDMACTRL_BULKTB_SHIFT)) & I3C_MDMACTRL_BULKTB_MASK)
/*! @} */
