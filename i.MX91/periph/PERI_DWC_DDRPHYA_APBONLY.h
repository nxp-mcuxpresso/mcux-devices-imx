...
typedef struct {
  ...
  __IO uint16_t NEVERGATECSRCLOCK;                 /**< CSR clock gating control, offset: 0x6A */
  ...
  __IO uint16_t MICRORESET;                        /**< Controls reset and clock shutdown on the local microcontroller, offset: 0x132 */
       uint8_t RESERVED_5[154];
  __IO uint16_t SEQUENCEROVERRIDE;                 /**< PHY Initialization Engine (PIE) override controls, offset: 0x1CE */
...
/*! @name NEVERGATECSRCLOCK - CSR clock gating control */
/*! @{ */

#define DWC_DDRPHYA_APBONLY_NEVERGATECSRCLOCK_NeverGateCsrClock_MASK (0x1U)
#define DWC_DDRPHYA_APBONLY_NEVERGATECSRCLOCK_NeverGateCsrClock_SHIFT (0U)
/*! NeverGateCsrClock - Reserved for PHY training firmware use. */
#define DWC_DDRPHYA_APBONLY_NEVERGATECSRCLOCK_NeverGateCsrClock(x) (((uint16_t)(((uint16_t)(x)) << DWC_DDRPHYA_APBONLY_NEVERGATECSRCLOCK_NeverGateCsrClock_SHIFT)) & DWC_DDRPHYA_APBONLY_NEVERGATECSRCLOCK_NeverGateCsrClock_MASK)
/*! @} */
...
/*! StallToMicro - This field is programmable as follows: - Set this bit to stall the microcontroller by hardware. */
...
/*! ResetToMicro - This field is programmable as follows: - Set this bit to apply synchronous reset to the microcontroller. */
...
/*! @name SEQUENCEROVERRIDE - PHY Initialization Engine (PIE) override controls */
/*! @{ */

#define DWC_DDRPHYA_APBONLY_SEQUENCEROVERRIDE_RFU_SequencerOverride_MASK (0x7FFU)
#define DWC_DDRPHYA_APBONLY_SEQUENCEROVERRIDE_RFU_SequencerOverride_SHIFT (0U)
/*! RFU_SequencerOverride - RFU_SequencerOverride */
#define DWC_DDRPHYA_APBONLY_SEQUENCEROVERRIDE_RFU_SequencerOverride(x) (((uint16_t)(((uint16_t)(x)) << DWC_DDRPHYA_APBONLY_SEQUENCEROVERRIDE_RFU_SequencerOverride_SHIFT)) & DWC_DDRPHYA_APBONLY_SEQUENCEROVERRIDE_RFU_SequencerOverride_MASK)
/*! @} */
...
/*! DfiInitCompleteShadow - DfiInitCompleteShadow */
