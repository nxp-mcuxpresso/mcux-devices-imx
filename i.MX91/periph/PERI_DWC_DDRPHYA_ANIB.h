...
/*! AForceDrvCont - Force continuous drive, per-lane, of the ACX4 instance controlled by this register. */
...
/*! AForceTriCont - Force tristate control, per-lane, of the ACX4 instance controlled by this register. */
...
/*! ADrvStrenN - This 5-bit bus is used to select the target pull down output impedance. */
...
/*! ATxPreP - This is the 4-bit binary trim for the driver pull up slew rate. */
...
/*! ATxDly_p0 - Trained for LPDDR4/4X to generate timed address and command signals to the DRAMs, per ACX4. */
...
/*! ATxDly_p1 - Trained for LPDDR4/4X to generate timed address and command signals to the DRAMs, per ACX4. */
...
/*! ATxDly_p2 - Trained for LPDDR4/4X to generate timed address and command signals to the DRAMs, per ACX4. */
...
/*! ATxDly_p3 - Trained for LPDDR4/4X to generate timed address and command signals to the DRAMs, per ACX4. */
