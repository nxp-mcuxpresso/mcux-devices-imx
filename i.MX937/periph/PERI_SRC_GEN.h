...
#if !defined(PERI_SRC_GEN_H_)
#define PERI_SRC_GEN_H_                          /**< Symbol preventing repeated inclusion */
...
#define SRC_GEN_SRMR_ARRAY_COUNT                  14u
...
typedef struct {
  ...
  __IO uint32_t RST_CLK_DUR_CFG;                   /**< Reset Clock Duration Configuration Register, offset: 0x1C4 */
  __IO uint32_t CDC_RDC_CLKOFF_DUR_CFG;            /**< CDC RDC Clock Off Duration Configuration Register, offset: 0x1C8 */
  __IO uint32_t DEST_RST_MIN_DUR_CNT_CFG;          /**< Reset FSM Destructive Reset Minimum Duration Counter Configuration Register, offset: 0x1CC */
  __IO uint32_t FUNC_RST_MIN_DUR_CNT_CFG;          /**< Reset FSM Functional Reset Minimum Duration Counter Configuration Register, offset: 0x1D0 */
  __IO uint32_t RST_EVT_DUR_CNT_CFG;               /**< Reset FSM Reset Event Duration Counter Configuration Register, offset: 0x1D4 */
...
#define SRC_GEN_SMRSR_RESET_DOMAIN_FLAG_MASK     (0x7FFFFFFU)
...
#define SRC_GEN_RESET_EVENT_SSAR_ACK_CTRL_SSAR_CNT_CFG_MASK (0x3FFFU)
#define SRC_GEN_RESET_EVENT_SSAR_ACK_CTRL_SSAR_CNT_CFG_SHIFT (0U)
/*! SSAR_CNT_CFG - ssar count configure. Usage depends on CNT_MODE */
#define SRC_GEN_RESET_EVENT_SSAR_ACK_CTRL_SSAR_CNT_CFG(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_RESET_EVENT_SSAR_ACK_CTRL_SSAR_CNT_CFG_SHIFT)) & SRC_GEN_RESET_EVENT_SSAR_ACK_CTRL_SSAR_CNT_CFG_MASK)

#define SRC_GEN_RESET_EVENT_SSAR_ACK_CTRL_CNT_MODE_MASK (0xC0000000U)
#define SRC_GEN_RESET_EVENT_SSAR_ACK_CTRL_CNT_MODE_SHIFT (30U)
 ...
 */
#define SRC_GEN_RESET_EVENT_SSAR_ACK_CTRL_CNT_MODE(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_RESET_EVENT_SSAR_ACK_CTRL_CNT_MODE_SHIFT)) & SRC_GEN_RESET_EVENT_SSAR_ACK_CTRL_CNT_MODE_MASK)
/*! @} */
...
/*! @name RST_CLK_DUR_CFG - Reset Clock Duration Configuration Register */
/*! @{ */

#define SRC_GEN_RST_CLK_DUR_CFG_RST_CLK_DUR_CFG_MASK (0xFFU)
#define SRC_GEN_RST_CLK_DUR_CFG_RST_CLK_DUR_CFG_SHIFT (0U)
/*! RST_CLK_DUR_CFG - Reset Clock Duration Configuration Register */
#define SRC_GEN_RST_CLK_DUR_CFG_RST_CLK_DUR_CFG(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_RST_CLK_DUR_CFG_RST_CLK_DUR_CFG_SHIFT)) & SRC_GEN_RST_CLK_DUR_CFG_RST_CLK_DUR_CFG_MASK)
/*! @} */

/*! @name CDC_RDC_CLKOFF_DUR_CFG - CDC RDC Clock Off Duration Configuration Register */
/*! @{ */

#define SRC_GEN_CDC_RDC_CLKOFF_DUR_CFG_CDC_RDC_CLKOFF_DUR_CFG_MASK (0xFFU)
#define SRC_GEN_CDC_RDC_CLKOFF_DUR_CFG_CDC_RDC_CLKOFF_DUR_CFG_SHIFT (0U)
/*! CDC_RDC_CLKOFF_DUR_CFG - CDC RDC Clock Off Duration Configuration Register */
#define SRC_GEN_CDC_RDC_CLKOFF_DUR_CFG_CDC_RDC_CLKOFF_DUR_CFG(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_CDC_RDC_CLKOFF_DUR_CFG_CDC_RDC_CLKOFF_DUR_CFG_SHIFT)) & SRC_GEN_CDC_RDC_CLKOFF_DUR_CFG_CDC_RDC_CLKOFF_DUR_CFG_MASK)
/*! @} */

/*! @name DEST_RST_MIN_DUR_CNT_CFG - Reset FSM Destructive Reset Minimum Duration Counter Configuration Register */
/*! @{ */

#define SRC_GEN_DEST_RST_MIN_DUR_CNT_CFG_DEST_RST_MIN_DUR_CNT_CFG_MASK (0xFFU)
#define SRC_GEN_DEST_RST_MIN_DUR_CNT_CFG_DEST_RST_MIN_DUR_CNT_CFG_SHIFT (0U)
/*! DEST_RST_MIN_DUR_CNT_CFG - Reset FSM Destructive Reset Minimum Duration Counter Configuration Register */
#define SRC_GEN_DEST_RST_MIN_DUR_CNT_CFG_DEST_RST_MIN_DUR_CNT_CFG(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_DEST_RST_MIN_DUR_CNT_CFG_DEST_RST_MIN_DUR_CNT_CFG_SHIFT)) & SRC_GEN_DEST_RST_MIN_DUR_CNT_CFG_DEST_RST_MIN_DUR_CNT_CFG_MASK)
/*! @} */

/*! @name FUNC_RST_MIN_DUR_CNT_CFG - Reset FSM Functional Reset Minimum Duration Counter Configuration Register */
/*! @{ */

#define SRC_GEN_FUNC_RST_MIN_DUR_CNT_CFG_FUNC_RST_MIN_DUR_CNT_CFG_MASK (0xFFU)
#define SRC_GEN_FUNC_RST_MIN_DUR_CNT_CFG_FUNC_RST_MIN_DUR_CNT_CFG_SHIFT (0U)
/*! FUNC_RST_MIN_DUR_CNT_CFG - Reset FSM Functional Reset Minimum Duration Counter Configuration Register */
#define SRC_GEN_FUNC_RST_MIN_DUR_CNT_CFG_FUNC_RST_MIN_DUR_CNT_CFG(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_FUNC_RST_MIN_DUR_CNT_CFG_FUNC_RST_MIN_DUR_CNT_CFG_SHIFT)) & SRC_GEN_FUNC_RST_MIN_DUR_CNT_CFG_FUNC_RST_MIN_DUR_CNT_CFG_MASK)
/*! @} */

/*! @name RST_EVT_DUR_CNT_CFG - Reset FSM Reset Event Duration Counter Configuration Register */
/*! @{ */

#define SRC_GEN_RST_EVT_DUR_CNT_CFG_RST_EVT_DUR_CNT_CFG_MASK (0xFFU)
#define SRC_GEN_RST_EVT_DUR_CNT_CFG_RST_EVT_DUR_CNT_CFG_SHIFT (0U)
/*! RST_EVT_DUR_CNT_CFG - Reset FSM Reset Event Duration Counter Configuration Register */
#define SRC_GEN_RST_EVT_DUR_CNT_CFG_RST_EVT_DUR_CNT_CFG(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_RST_EVT_DUR_CNT_CFG_RST_EVT_DUR_CNT_CFG_SHIFT)) & SRC_GEN_RST_EVT_DUR_CNT_CFG_RST_EVT_DUR_CNT_CFG_MASK)
/*! @} */

/*! @name MISC_CTRL - Miscellaneous control register */
/*! @{ */

#define SRC_GEN_MISC_CTRL_IMX952_CDC_RDC_CLKOFF_MODE_EN_MASK (0x1U)
#define SRC_GEN_MISC_CTRL_IMX952_CDC_RDC_CLKOFF_MODE_EN_SHIFT (0U)
/*! IMX952_CDC_RDC_CLKOFF_MODE_EN - Enable CDC RDC Clock Off strategy
 *  0b0..CDC RDC Clock Off strategy disabled
 *  0b1..CDC RDC Clock Off strategy enabled
 */
#define SRC_GEN_MISC_CTRL_IMX952_CDC_RDC_CLKOFF_MODE_EN(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_MISC_CTRL_IMX952_CDC_RDC_CLKOFF_MODE_EN_SHIFT)) & SRC_GEN_MISC_CTRL_IMX952_CDC_RDC_CLKOFF_MODE_EN_MASK)

#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_ANAMIX_MASK (0x2U)
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_ANAMIX_SHIFT (1U)
/*! MIX_MODE_CTRL_ANAMIX - ANAMIX mode control */
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_ANAMIX(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_ANAMIX_SHIFT)) & SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_ANAMIX_MASK)

#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_AONMIX_MASK (0x4U)
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_AONMIX_SHIFT (2U)
/*! MIX_MODE_CTRL_AONMIX - AONMIX mode control */
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_AONMIX(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_AONMIX_SHIFT)) & SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_AONMIX_MASK)

#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_BBSMMIX_MASK (0x8U)
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_BBSMMIX_SHIFT (3U)
/*! MIX_MODE_CTRL_BBSMMIX - BBSMMIX mode control */
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_BBSMMIX(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_BBSMMIX_SHIFT)) & SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_BBSMMIX_MASK)

#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CAMERAMIX_MASK (0x10U)
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CAMERAMIX_SHIFT (4U)
/*! MIX_MODE_CTRL_CAMERAMIX - CAMERAMIX mode control */
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CAMERAMIX(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CAMERAMIX_SHIFT)) & SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CAMERAMIX_MASK)

#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CCMSRCGPCMIX_MASK (0x20U)
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CCMSRCGPCMIX_SHIFT (5U)
/*! MIX_MODE_CTRL_CCMSRCGPCMIX - CCMSRCGPCMIX mode control */
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CCMSRCGPCMIX(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CCMSRCGPCMIX_SHIFT)) & SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CCMSRCGPCMIX_MASK)

#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE0_MASK (0x40U)
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE0_SHIFT (6U)
/*! MIX_MODE_CTRL_CORTEXAMIX_CORE0 - CORTEXAMIX_CORE0 mode control */
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE0(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE0_SHIFT)) & SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE0_MASK)

#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE1_MASK (0x80U)
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE1_SHIFT (7U)
/*! MIX_MODE_CTRL_CORTEXAMIX_CORE1 - CORTEXAMIX_CORE1 mode control */
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE1(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE1_SHIFT)) & SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE1_MASK)

#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE2_MASK (0x100U)
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE2_SHIFT (8U)
/*! MIX_MODE_CTRL_CORTEXAMIX_CORE2 - CORTEXAMIX_CORE2 mode control */
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE2(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE2_SHIFT)) & SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE2_MASK)

#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE3_MASK (0x200U)
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE3_SHIFT (9U)
/*! MIX_MODE_CTRL_CORTEXAMIX_CORE3 - CORTEXAMIX_CORE3 mode control */
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE3(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE3_SHIFT)) & SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_CORE3_MASK)

#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_PLATFORM_MASK (0x400U)
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_PLATFORM_SHIFT (10U)
/*! MIX_MODE_CTRL_CORTEXAMIX_PLATFORM - CORTEXAMIX_PLATFORM mode control */
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_PLATFORM(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_PLATFORM_SHIFT)) & SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_CORTEXAMIX_PLATFORM_MASK)

#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_DDRMIX_MASK (0x800U)
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_DDRMIX_SHIFT (11U)
/*! MIX_MODE_CTRL_DDRMIX - DDRMIX mode control */
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_DDRMIX(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_DDRMIX_SHIFT)) & SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_DDRMIX_MASK)

#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_DISPLAYMIX_MASK (0x1000U)
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_DISPLAYMIX_SHIFT (12U)
/*! MIX_MODE_CTRL_DISPLAYMIX - DISPLAYMIX mode control */
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_DISPLAYMIX(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_DISPLAYMIX_SHIFT)) & SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_DISPLAYMIX_MASK)

#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_GPUMIX_MASK (0x2000U)
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_GPUMIX_SHIFT (13U)
/*! MIX_MODE_CTRL_GPUMIX - GPUMIX mode control */
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_GPUMIX(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_GPUMIX_SHIFT)) & SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_GPUMIX_MASK)

#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_HSIOMIX_TOP_MASK (0x4000U)
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_HSIOMIX_TOP_SHIFT (14U)
/*! MIX_MODE_CTRL_HSIOMIX_TOP - HSIOMIX_TOP mode control */
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_HSIOMIX_TOP(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_HSIOMIX_TOP_SHIFT)) & SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_HSIOMIX_TOP_MASK)

#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_HSIOMIX_WAON_MASK (0x8000U)
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_HSIOMIX_WAON_SHIFT (15U)
/*! MIX_MODE_CTRL_HSIOMIX_WAON - HSIOMIX_WAON mode control */
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_HSIOMIX_WAON(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_HSIOMIX_WAON_SHIFT)) & SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_HSIOMIX_WAON_MASK)

#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_M7MIX_MASK (0x10000U)
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_M7MIX_SHIFT (16U)
/*! MIX_MODE_CTRL_M7MIX - M7MIX mode control */
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_M7MIX(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_M7MIX_SHIFT)) & SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_M7MIX_MASK)

#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_NETCMIX_MASK (0x20000U)
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_NETCMIX_SHIFT (17U)
/*! MIX_MODE_CTRL_NETCMIX - NETCMIX mode control */
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_NETCMIX(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_NETCMIX_SHIFT)) & SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_NETCMIX_MASK)

#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_NOCMIX_MASK (0x40000U)
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_NOCMIX_SHIFT (18U)
/*! MIX_MODE_CTRL_NOCMIX - NOCMIX mode control */
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_NOCMIX(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_NOCMIX_SHIFT)) & SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_NOCMIX_MASK)

#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_NPUMIX_MASK (0x80000U)
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_NPUMIX_SHIFT (19U)
/*! MIX_MODE_CTRL_NPUMIX - NPUMIX mode control */
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_NPUMIX(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_NPUMIX_SHIFT)) & SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_NPUMIX_MASK)

#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_VPUMIX_MASK (0x100000U)
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_VPUMIX_SHIFT (20U)
/*! MIX_MODE_CTRL_VPUMIX - VPUMIX mode control */
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_VPUMIX(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_VPUMIX_SHIFT)) & SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_VPUMIX_MASK)

#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_WAKEUPMIX_MASK (0x200000U)
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_WAKEUPMIX_SHIFT (21U)
/*! MIX_MODE_CTRL_WAKEUPMIX - WAKEUPMIX mode control */
#define SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_WAKEUPMIX(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_WAKEUPMIX_SHIFT)) & SRC_GEN_MISC_CTRL_MIX_MODE_CTRL_WAKEUPMIX_MASK)

#define SRC_GEN_MISC_CTRL_DISABLE_SAFE_STATE_HSIOMIX_TOP_MASK (0x400000U)
#define SRC_GEN_MISC_CTRL_DISABLE_SAFE_STATE_HSIOMIX_TOP_SHIFT (22U)
 ...
 */
#define SRC_GEN_MISC_CTRL_DISABLE_SAFE_STATE_HSIOMIX_TOP(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_MISC_CTRL_DISABLE_SAFE_STATE_HSIOMIX_TOP_SHIFT)) & SRC_GEN_MISC_CTRL_DISABLE_SAFE_STATE_HSIOMIX_TOP_MASK)

#define SRC_GEN_MISC_CTRL_DISABLE_SAFE_STATE_NETCMIX_MASK (0x800000U)
#define SRC_GEN_MISC_CTRL_DISABLE_SAFE_STATE_NETCMIX_SHIFT (23U)
 ...
 */
#define SRC_GEN_MISC_CTRL_DISABLE_SAFE_STATE_NETCMIX(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_MISC_CTRL_DISABLE_SAFE_STATE_NETCMIX_SHIFT)) & SRC_GEN_MISC_CTRL_DISABLE_SAFE_STATE_NETCMIX_MASK)

#define SRC_GEN_MISC_CTRL_DISABLE_SAFE_STATE_WAKEUPMIX_WDOG_3_4_MASK (0x1000000U)
#define SRC_GEN_MISC_CTRL_DISABLE_SAFE_STATE_WAKEUPMIX_WDOG_3_4_SHIFT (24U)
 ...
 */
#define SRC_GEN_MISC_CTRL_DISABLE_SAFE_STATE_WAKEUPMIX_WDOG_3_4(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_MISC_CTRL_DISABLE_SAFE_STATE_WAKEUPMIX_WDOG_3_4_SHIFT)) & SRC_GEN_MISC_CTRL_DISABLE_SAFE_STATE_WAKEUPMIX_WDOG_3_4_MASK)

#define SRC_GEN_MISC_CTRL_DISABLE_SAFE_STATE_WAKEUPMIX_WDOG_5_MASK (0x2000000U)
#define SRC_GEN_MISC_CTRL_DISABLE_SAFE_STATE_WAKEUPMIX_WDOG_5_SHIFT (25U)
 ...
 */
#define SRC_GEN_MISC_CTRL_DISABLE_SAFE_STATE_WAKEUPMIX_WDOG_5(x) (((uint32_t)(((uint32_t)(x)) << SRC_GEN_MISC_CTRL_DISABLE_SAFE_STATE_WAKEUPMIX_WDOG_5_SHIFT)) & SRC_GEN_MISC_CTRL_DISABLE_SAFE_STATE_WAKEUPMIX_WDOG_5_MASK)
/*! @} */
