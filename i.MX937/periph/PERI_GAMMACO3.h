...
/*!
 * @file PERI_gammaco3.h
 * @version 1.0
 * @date 2026-04-09
 * @brief CMSIS Peripheral Access Layer for gammaco3
 *
 * CMSIS Peripheral Access Layer for gammaco3
 */

#if !defined(PERI_GAMMACO3_H_)
#define PERI_GAMMACO3_H_                         /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- gammaco3 Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup gammaco3_Peripheral_Access_Layer gammaco3 Peripheral Access Layer
 * @{
 */

/** gammaco3 - Size of Registers Arrays */
#define gammaco3_LUT_COUNT                        257u

/** gammaco3 - Register Layout Typedef */
typedef struct {
  __IO uint32_t LUT[gammaco3_LUT_COUNT];           /**< LUT, array offset: 0x0, array step: 0x4 */
} gammaco3_Type;

/* ----------------------------------------------------------------------------
   -- gammaco3 Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup gammaco3_Register_Masks gammaco3 Register Masks
 * @{
 */
...
#define gammaco3_LUT_Data2_MASK                  (0x1FFFU)
#define gammaco3_LUT_Data2_SHIFT                 (0U)
/*! Data2 - Data */
#define gammaco3_LUT_Data2(x)                    (((uint32_t)(((uint32_t)(x)) << gammaco3_LUT_Data2_SHIFT)) & gammaco3_LUT_Data2_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group gammaco3_Register_Masks */


/*!
 * @}
 */ /* end of group gammaco3_Peripheral_Access_Layer */
