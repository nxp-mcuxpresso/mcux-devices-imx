...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for lut3d1
**
 ...
 * @version 1.0
 * @date 2026-04-09
 * @brief CMSIS Peripheral Access Layer for lut3d1
 *
 * CMSIS Peripheral Access Layer for lut3d1
 */

#if !defined(PERI_LUT3D1_H_)
#define PERI_LUT3D1_H_                           /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- lut3d1 Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup lut3d1_Peripheral_Access_Layer lut3d1 Peripheral Access Layer
 * @{
 */

/** lut3d1 - Size of Registers Arrays */
#define lut3d1_LUT_COUNT                          2048u

/** lut3d1 - Register Layout Typedef */
typedef struct {
  __IO uint32_t LUT[lut3d1_LUT_COUNT];             /**< LUT, array offset: 0x0, array step: 0x4 */
} lut3d1_Type;

/* ----------------------------------------------------------------------------
   -- lut3d1 Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup lut3d1_Register_Masks lut3d1 Register Masks
 * @{
 */
...
#define lut3d1_LUT_DATA3_MASK                    (0xFFFFFU)
#define lut3d1_LUT_DATA3_SHIFT                   (0U)
/*! DATA3 - DATA */
#define lut3d1_LUT_DATA3(x)                      (((uint32_t)(((uint32_t)(x)) << lut3d1_LUT_DATA3_SHIFT)) & lut3d1_LUT_DATA3_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group lut3d1_Register_Masks */


/*!
 * @}
 */ /* end of group lut3d1_Peripheral_Access_Layer */
