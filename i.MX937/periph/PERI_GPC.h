...
#define GPC_CMC_IRQ_WAKEUP_MASK_ARRAY_COUNT       13u
#define GPC_CMC_IRQ_WAKEUP_STAT_ARRAY_COUNT       13u
...
#define GPC_CMC_IRQ_WAKEUP_MASK_COUNT            (13U)
...
#define GPC_CMC_IRQ_WAKEUP_STAT_COUNT            (13U)
...
#define GPC_CMC_SLEEP_LPCG_CTRL_DISABLE_MASK     (0x80000000U)
#define GPC_CMC_SLEEP_LPCG_CTRL_DISABLE_SHIFT    (31U)
/*! DISABLE - Disable this step
 *  0b0..This step is enabled.
 *  0b1..This step is disabled. GPC will skip this step and not send any request.
 */
#define GPC_CMC_SLEEP_LPCG_CTRL_DISABLE(x)       (((uint32_t)(((uint32_t)(x)) << GPC_CMC_SLEEP_LPCG_CTRL_DISABLE_SHIFT)) & GPC_CMC_SLEEP_LPCG_CTRL_DISABLE_MASK)
/*! @} */

/*! @name CMC_SLEEP_LPCG_STAT - CMC sleep LPCG status */
/*! @{ */

#define GPC_CMC_SLEEP_LPCG_STAT_RSP_CNT_MASK     (0xFFFFFFU)
#define GPC_CMC_SLEEP_LPCG_STAT_RSP_CNT_SHIFT    (0U)
/*! RSP_CNT - Response count, record the delay from step start to step_done received */
#define GPC_CMC_SLEEP_LPCG_STAT_RSP_CNT(x)       (((uint32_t)(((uint32_t)(x)) << GPC_CMC_SLEEP_LPCG_STAT_RSP_CNT_SHIFT)) & GPC_CMC_SLEEP_LPCG_STAT_RSP_CNT_MASK)
/*! @} */

/*! @name CMC_SLEEP_PLL_CTRL - CMC sleep PLL control */
/*! @{ */

#define GPC_CMC_SLEEP_PLL_CTRL_STEP_CNT_MASK     (0xFFFFFFU)
#define GPC_CMC_SLEEP_PLL_CTRL_STEP_CNT_SHIFT    (0U)
/*! STEP_CNT - Step count, usage depends on CNT_MODE */
#define GPC_CMC_SLEEP_PLL_CTRL_STEP_CNT(x)       (((uint32_t)(((uint32_t)(x)) << GPC_CMC_SLEEP_PLL_CTRL_STEP_CNT_SHIFT)) & GPC_CMC_SLEEP_PLL_CTRL_STEP_CNT_MASK)

#define GPC_CMC_SLEEP_PLL_CTRL_CNT_MODE_MASK     (0x30000000U)
#define GPC_CMC_SLEEP_PLL_CTRL_CNT_MODE_SHIFT    (28U)
/*! CNT_MODE - Count mode
 ...
 */
#define GPC_CMC_SLEEP_PLL_CTRL_CNT_MODE(x)       (((uint32_t)(((uint32_t)(x)) << GPC_CMC_SLEEP_PLL_CTRL_CNT_MODE_SHIFT)) & GPC_CMC_SLEEP_PLL_CTRL_CNT_MODE_MASK)

#define GPC_CMC_SLEEP_PLL_CTRL_DISABLE_MASK      (0x80000000U)
#define GPC_CMC_SLEEP_PLL_CTRL_DISABLE_SHIFT     (31U)
/*! DISABLE - Disable this step
 *  0b0..This step is enabled.
 *  0b1..This step is disabled. GPC will skip this step and not send any request.
 */
#define GPC_CMC_SLEEP_PLL_CTRL_DISABLE(x)        (((uint32_t)(((uint32_t)(x)) << GPC_CMC_SLEEP_PLL_CTRL_DISABLE_SHIFT)) & GPC_CMC_SLEEP_PLL_CTRL_DISABLE_MASK)
/*! @} */

/*! @name CMC_SLEEP_PLL_STAT - CMC sleep PLL status */
/*! @{ */

#define GPC_CMC_SLEEP_PLL_STAT_RSP_CNT_MASK      (0xFFFFFFU)
#define GPC_CMC_SLEEP_PLL_STAT_RSP_CNT_SHIFT     (0U)
/*! RSP_CNT - Response count, record the delay from step start to step_done received */
#define GPC_CMC_SLEEP_PLL_STAT_RSP_CNT(x)        (((uint32_t)(((uint32_t)(x)) << GPC_CMC_SLEEP_PLL_STAT_RSP_CNT_SHIFT)) & GPC_CMC_SLEEP_PLL_STAT_RSP_CNT_MASK)
/*! @} */
...
#define GPC_CMC_WAKEUP_PLL_CTRL_STEP_CNT_MASK    (0xFFFFFFU)
#define GPC_CMC_WAKEUP_PLL_CTRL_STEP_CNT_SHIFT   (0U)
/*! STEP_CNT - Step count, usage depends on CNT_MODE */
#define GPC_CMC_WAKEUP_PLL_CTRL_STEP_CNT(x)      (((uint32_t)(((uint32_t)(x)) << GPC_CMC_WAKEUP_PLL_CTRL_STEP_CNT_SHIFT)) & GPC_CMC_WAKEUP_PLL_CTRL_STEP_CNT_MASK)
...
#define GPC_CMC_WAKEUP_PLL_CTRL_DISABLE_MASK     (0x80000000U)
#define GPC_CMC_WAKEUP_PLL_CTRL_DISABLE_SHIFT    (31U)
/*! DISABLE - Disable this step
 *  0b0..This step is enabled.
 *  0b1..This step is disabled. GPC will skip this step and not send any request.
 */
#define GPC_CMC_WAKEUP_PLL_CTRL_DISABLE(x)       (((uint32_t)(((uint32_t)(x)) << GPC_CMC_WAKEUP_PLL_CTRL_DISABLE_SHIFT)) & GPC_CMC_WAKEUP_PLL_CTRL_DISABLE_MASK)
/*! @} */

/*! @name CMC_WAKEUP_PLL_STAT - CMC wakeup PLL status */
/*! @{ */

#define GPC_CMC_WAKEUP_PLL_STAT_RSP_CNT_MASK     (0xFFFFFFU)
#define GPC_CMC_WAKEUP_PLL_STAT_RSP_CNT_SHIFT    (0U)
/*! RSP_CNT - Response count, record the delay from step start to step_done received */
#define GPC_CMC_WAKEUP_PLL_STAT_RSP_CNT(x)       (((uint32_t)(((uint32_t)(x)) << GPC_CMC_WAKEUP_PLL_STAT_RSP_CNT_SHIFT)) & GPC_CMC_WAKEUP_PLL_STAT_RSP_CNT_MASK)
/*! @} */

/*! @name CMC_WAKEUP_LPCG_CTRL - CMC wakeup LPCG control */
/*! @{ */

#define GPC_CMC_WAKEUP_LPCG_CTRL_DISABLE_MASK    (0x80000000U)
#define GPC_CMC_WAKEUP_LPCG_CTRL_DISABLE_SHIFT   (31U)
/*! DISABLE - Disable this step
 *  0b0..This step is enabled.
 *  0b1..This step is disabled. GPC will skip this step and not send any request.
 */
#define GPC_CMC_WAKEUP_LPCG_CTRL_DISABLE(x)      (((uint32_t)(((uint32_t)(x)) << GPC_CMC_WAKEUP_LPCG_CTRL_DISABLE_SHIFT)) & GPC_CMC_WAKEUP_LPCG_CTRL_DISABLE_MASK)
/*! @} */

/*! @name CMC_WAKEUP_LPCG_STAT - CMC wakeup LPCG status */
/*! @{ */

#define GPC_CMC_WAKEUP_LPCG_STAT_RSP_CNT_MASK    (0xFFFFFFU)
#define GPC_CMC_WAKEUP_LPCG_STAT_RSP_CNT_SHIFT   (0U)
/*! RSP_CNT - Response count, record the delay from step start to step_done received */
#define GPC_CMC_WAKEUP_LPCG_STAT_RSP_CNT(x)      (((uint32_t)(((uint32_t)(x)) << GPC_CMC_WAKEUP_LPCG_STAT_RSP_CNT_SHIFT)) & GPC_CMC_WAKEUP_LPCG_STAT_RSP_CNT_MASK)
/*! @} */
