...
#define NETC_PORT_PTGSTCOCR_TX_OVERRUN_MASK      (0xFU)
#define NETC_PORT_PTGSTCOCR_TX_OVERRUN_SHIFT     (0U)
#define NETC_PORT_PTGSTCOCR_TX_OVERRUN(x)        (((uint32_t)(((uint32_t)(x)) << NETC_PORT_PTGSTCOCR_TX_OVERRUN_SHIFT)) & NETC_PORT_PTGSTCOCR_TX_OVERRUN_MASK)
/*! @} */

/* The count of NETC_PORT_PTGSTCOCR */
#define NETC_PORT_PTGSTCOCR_COUNT                (8U)
