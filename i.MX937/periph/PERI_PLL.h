...
typedef struct {
  ...
  struct {                                         /* offset: 0x30 */
    __IO uint32_t RW;                                /**< Spread Spectrum, offset: 0x30, not available in all instances (available on 30 out of 35) */
    __IO uint32_t SET;                               /**< Spread Spectrum, offset: 0x34, not available in all instances (available on 30 out of 35) */
    __IO uint32_t CLR;                               /**< Spread Spectrum, offset: 0x38, not available in all instances (available on 30 out of 35) */
    __IO uint32_t TOG;                               /**< Spread Spectrum, offset: 0x3C, not available in all instances (available on 30 out of 35) */
  } SPREAD_SPECTRUM;
  struct {                                         /* offset: 0x40 */
    __IO uint32_t RW;                                /**< Numerator, offset: 0x40, not available in all instances (available on 30 out of 35) */
    __IO uint32_t SET;                               /**< Numerator, offset: 0x44, not available in all instances (available on 30 out of 35) */
    __IO uint32_t CLR;                               /**< Numerator, offset: 0x48, not available in all instances (available on 30 out of 35) */
    __IO uint32_t TOG;                               /**< Numerator, offset: 0x4C, not available in all instances (available on 30 out of 35) */
  } NUMERATOR;
  struct {                                         /* offset: 0x50 */
    __IO uint32_t RW;                                /**< Denominator, offset: 0x50, not available in all instances (available on 30 out of 35) */
    __IO uint32_t SET;                               /**< Denominator, offset: 0x54, not available in all instances (available on 30 out of 35) */
    __IO uint32_t CLR;                               /**< Denominator, offset: 0x58, not available in all instances (available on 30 out of 35) */
    __IO uint32_t TOG;                               /**< Denominator, offset: 0x5C, not available in all instances (available on 30 out of 35) */
  } DENOMINATOR;
  struct {                                         /* offset: 0x60 */
  ...
  struct {                                         /* offset: 0x70, array step: 0x20 */
    struct {                                         /* offset: 0x70 */
      __IO uint32_t RW;                                /**< DFS Control, offset: 0x70, not available in all instances (available on 10 out of 35) */
      __IO uint32_t SET;                               /**< DFS Control, offset: 0x74, not available in all instances (available on 10 out of 35) */
      __IO uint32_t CLR;                               /**< DFS Control, offset: 0x78, not available in all instances (available on 10 out of 35) */
      __IO uint32_t TOG;                               /**< DFS Control, offset: 0x7C, not available in all instances (available on 10 out of 35) */
    } DFS_CTRL;
    struct {                                         /* offset: 0x80 */
      __IO uint32_t RW;                                /**< DFS Division_N, offset: 0x80, not available in all instances (available on 10 out of 35) */
      __IO uint32_t SET;                               /**< DFS Division_N, offset: 0x84, not available in all instances (available on 10 out of 35) */
      __IO uint32_t CLR;                               /**< DFS Division_N, offset: 0x88, not available in all instances (available on 10 out of 35) */
      __IO uint32_t TOG;                               /**< DFS Division_N, offset: 0x8C, not available in all instances (available on 10 out of 35) */
    } DFS_DIV;
  } DFS[PLL_DFS_COUNT];
  __I  uint32_t PLL_STATUS;                        /**< PLL Status, offset: 0xF0 */
  __I  uint32_t DFS_STATUS;                        /**< DFS Status, offset: 0xF4, not available in all instances (available on 10 out of 35) */
} PLL_Type;
