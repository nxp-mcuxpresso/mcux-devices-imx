...
#define BLK_CTRL_WAKEUPMIX_IPG_DEBUG_CM33_EDMA4_2_MASK (0x2U)
#define BLK_CTRL_WAKEUPMIX_IPG_DEBUG_CM33_EDMA4_2_SHIFT (1U)
/*! EDMA4_2
 *  0b0..Module does not enter debug halted mode with CM33
 *  0b1..Module enters debug halted mode when CM33 is debug halted
 */
#define BLK_CTRL_WAKEUPMIX_IPG_DEBUG_CM33_EDMA4_2(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_WAKEUPMIX_IPG_DEBUG_CM33_EDMA4_2_SHIFT)) & BLK_CTRL_WAKEUPMIX_IPG_DEBUG_CM33_EDMA4_2_MASK)
...
#define BLK_CTRL_WAKEUPMIX_IPG_DEBUG_CA55C0_EDMA4_2_MASK (0x2U)
#define BLK_CTRL_WAKEUPMIX_IPG_DEBUG_CA55C0_EDMA4_2_SHIFT (1U)
/*! EDMA4_2
 *  0b0..Module does not enter debug halted mode with A55
 *  0b1..Module enters debug halted mode when A55 is debug halted
 */
#define BLK_CTRL_WAKEUPMIX_IPG_DEBUG_CA55C0_EDMA4_2(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_WAKEUPMIX_IPG_DEBUG_CA55C0_EDMA4_2_SHIFT)) & BLK_CTRL_WAKEUPMIX_IPG_DEBUG_CA55C0_EDMA4_2_MASK)
...
#define BLK_CTRL_WAKEUPMIX_IPG_DEBUG_CA55C1_EDMA4_2_MASK (0x2U)
#define BLK_CTRL_WAKEUPMIX_IPG_DEBUG_CA55C1_EDMA4_2_SHIFT (1U)
/*! EDMA4_2
 *  0b0..Module does not enter debug halted mode with A55
 *  0b1..Module enters debug halted mode when A55 is debug halted
 */
#define BLK_CTRL_WAKEUPMIX_IPG_DEBUG_CA55C1_EDMA4_2(x) (((uint32_t)(((uint32_t)(x)) << BLK_CTRL_WAKEUPMIX_IPG_DEBUG_CA55C1_EDMA4_2_SHIFT)) & BLK_CTRL_WAKEUPMIX_IPG_DEBUG_CA55C1_EDMA4_2_MASK)
