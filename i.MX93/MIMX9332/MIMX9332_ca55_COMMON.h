...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for MIMX9332_ca55
**
...
/*!
 * @file MIMX9332_ca55_COMMON.h
 * @version 2.0
 * @date 2024-10-29
 * @brief CMSIS Peripheral Access Layer for MIMX9332_ca55
 *
 * CMSIS Peripheral Access Layer for MIMX9332_ca55
 */

#if !defined(MIMX9332_CA55_COMMON_H_)
#define MIMX9332_CA55_COMMON_H_                  /**< Symbol preventing repeated inclusion */
...
typedef enum IRQn {
  ...
  CTI_CM33_IRQn                = 35,               /**< CTI trigger outputs from CM33 platform */
  ...
  MU1_A_IRQn                   = 53,               /**< Messaging Unit 1 - Side A (to communicate with M7 core) */
  MU1_B_IRQn                   = 54,               /**< Messaging Unit 1 - Side B (to communicate with M33 core) */
  MU2_A_IRQn                   = 55,               /**< Messaging Unit 2 - Side A (to communicate with M7 core) */
  MU2_B_IRQn                   = 56,               /**< Messaging Unit 2 - Side B (to communicate with A55 core) */
  ...
  PS_PARITY_ERR_IRQn           = 78,               /**< M33 PS Tag/Data Parity Error */
  TCM_ECC_IRQn                 = 79,               /**< M33 TCM ECC interrupt */
  TCM_ERR_IRQn                 = 80,               /**< M33 TCM Error interrupt */
  ...
  FLEXIO1_IRQn                 = 85,               /**< Flexible IO 1 interrupt */
  FLEXIO2_IRQn                 = 86,               /**< Flexible IO 2 interrupt */
  ...
  CM33_SYSREQRST_RST_SRC_IRQn  = 198,              /**< CM33 SYSREQRST SRC reset source */
  CM33_LOCKUP_RST_SRC_IRQn     = 199,              /**< CM33 LOCKUP SRC reset source */
  ...
  PXP_0_IRQn                   = 205,              /**< PXP interrupt 0 */
  PXP_1_IRQn                   = 206,              /**< PXP interrupt 1 */
  CSI_IRQn                     = 207,              /**< CSI interrupt */
  LCDIFv3_IRQn                 = 208,              /**< LCDIF Sync Interrupt */
  DSI_IRQn                     = 209,              /**< MIPI DSI Interrupt Request */
  ML_IRQn                      = 210,              /**< Machine learning processor interrupt */
  ...
  CM33_MCM_IRQn                = 244,              /**< CM33 MCM interrupt */
...
#include "system_MIMX9332_ca55.h"      /* Device specific configuration file */
...
#ifndef MIMX9332_ca55_SERIES
#define MIMX9332_ca55_SERIES
#endif
/* CPU specific feature definitions */
#include "MIMX9332_ca55_features.h"
...
/* MU - Peripheral instance base addresses */
  ...
  #define MU1__MUB_BASE                            (0x54230000u)
  /** Peripheral MU1__MUB base address */
  #define MU1__MUB_BASE_NS                         (0x44230000u)
  /** Peripheral MU1__MUB base pointer */
  #define MU1__MUB                                 ((MU_Type *)MU1__MUB_BASE)
  /** Peripheral MU1__MUB base pointer */
  #define MU1__MUB_NS                              ((MU_Type *)MU1__MUB_BASE_NS)
  /** Peripheral MU2__MUB base address */
  #define MU2__MUB_BASE                            (0x52440000u)
  /** Peripheral MU2__MUB base address */
  #define MU2__MUB_BASE_NS                         (0x42440000u)
  /** Peripheral MU2__MUB base pointer */
  #define MU2__MUB                                 ((MU_Type *)MU2__MUB_BASE)
  /** Peripheral MU2__MUB base pointer */
  #define MU2__MUB_NS                              ((MU_Type *)MU2__MUB_BASE_NS)
  /** Array initializer of MU peripheral base addresses */
  #define MU_BASE_ADDRS                            { MU1__MUB_BASE, MU2__MUB_BASE }
  /** Array initializer of MU peripheral base pointers */
  #define MU_BASE_PTRS                             { MU1__MUB, MU2__MUB }
  /** Array initializer of MU peripheral base addresses */
  #define MU_BASE_ADDRS_NS                         { MU1__MUB_BASE_NS, MU2__MUB_BASE_NS }
  /** Array initializer of MU peripheral base pointers */
  #define MU_BASE_PTRS_NS                          { MU1__MUB_NS, MU2__MUB_NS }
#else
  /** Peripheral MU1__MUB base address */
