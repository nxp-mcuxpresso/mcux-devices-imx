...
#if !defined(MIMX9332_CM33_COMMON_H_)
#define MIMX9332_CM33_COMMON_H_                  /**< Symbol preventing repeated inclusion */
...
#include "system_MIMX9332_cm33.h"      /* Device specific configuration file */
