...
#if !defined(MIMX9301_CM33_COMMON_H_)
#define MIMX9301_CM33_COMMON_H_                  /**< Symbol preventing repeated inclusion */
...
#include "system_MIMX9301_cm33.h"      /* Device specific configuration file */
