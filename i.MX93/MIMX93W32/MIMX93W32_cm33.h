...
#if !defined(MIMX93W32_cm33_H_)  /* Check if memory map has not been already included */
#define MIMX93W32_cm33_H_
...
#endif  /* #if !defined(MIMX93W32_cm33_H_) */
