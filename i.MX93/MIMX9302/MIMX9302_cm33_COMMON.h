...
#if !defined(MIMX9302_CM33_COMMON_H_)
#define MIMX9302_CM33_COMMON_H_                  /**< Symbol preventing repeated inclusion */
...
#include "system_MIMX9302_cm33.h"      /* Device specific configuration file */
