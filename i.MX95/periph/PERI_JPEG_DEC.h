...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for JPEG_DEC
**
...
/*!
 * @file PERI_JPEG_DEC.h
 * @version 1.0
 * @date 2023-01-10
 * @brief CMSIS Peripheral Access Layer for JPEG_DEC
 *
 * CMSIS Peripheral Access Layer for JPEG_DEC
 */

#if !defined(PERI_JPEG_DEC_H_)
#define PERI_JPEG_DEC_H_                         /**< Symbol preventing repeated inclusion */
