...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for VPU_TCU
**
 ...
 * @version 1.0
 * @date 2023-01-10
 * @brief CMSIS Peripheral Access Layer for VPU_TCU
 *
 * CMSIS Peripheral Access Layer for VPU_TCU
 */

#if !defined(PERI_VPU_TCU_H_)
#define PERI_VPU_TCU_H_                          /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- VPU_TCU Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup VPU_TCU_Peripheral_Access_Layer VPU_TCU Peripheral Access Layer
 * @{
 */

/** VPU_TCU - Register Layout Typedef */
typedef struct {
  ...
  __IO uint32_t TCU_DFT_FUSE;                      /**< TCU fuse observe and override, offset: 0xC40 */
} VPU_TCU_Type;

/* ----------------------------------------------------------------------------
   -- VPU_TCU Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup VPU_TCU_Register_Masks VPU_TCU Register Masks
 * @{
 */
...
#define VPU_TCU_TCU_MAGIC_KW__MAGIC_KW0_out_MASK (0xFFFFFFFFU)
#define VPU_TCU_TCU_MAGIC_KW__MAGIC_KW0_out_SHIFT (0U)
/*! out - 32-Bit Magic KW0 used in conjuction with Magic KW1 to unlock the writes to test mode registers (Value is 0x12345678) */
#define VPU_TCU_TCU_MAGIC_KW__MAGIC_KW0_out(x)   (((uint32_t)(((uint32_t)(x)) << VPU_TCU_TCU_MAGIC_KW__MAGIC_KW0_out_SHIFT)) & VPU_TCU_TCU_MAGIC_KW__MAGIC_KW0_out_MASK)
/*! @} */

/*! @name TCU_MAGIC_KW__MAGIC_KW1 - Magic KW1 */
/*! @{ */

#define VPU_TCU_TCU_MAGIC_KW__MAGIC_KW1_out_MASK (0xFFFFFFFFU)
#define VPU_TCU_TCU_MAGIC_KW__MAGIC_KW1_out_SHIFT (0U)
/*! out - 32-Bit Magic KW1 used in conjuction with Magic KW0 to unlock the writes to test mode registers (Value - 0x87654321) */
#define VPU_TCU_TCU_MAGIC_KW__MAGIC_KW1_out(x)   (((uint32_t)(((uint32_t)(x)) << VPU_TCU_TCU_MAGIC_KW__MAGIC_KW1_out_SHIFT)) & VPU_TCU_TCU_MAGIC_KW__MAGIC_KW1_out_MASK)
/*! @} */

/*! @name TCU_PLL_COUNTER - tcu pll counter reg */
/*! @{ */

#define VPU_TCU_TCU_PLL_COUNTER_pll_count_rst_n_MASK (0x1U)
#define VPU_TCU_TCU_PLL_COUNTER_pll_count_rst_n_SHIFT (0U)
/*! pll_count_rst_n - pll count reset */
#define VPU_TCU_TCU_PLL_COUNTER_pll_count_rst_n(x) (((uint32_t)(((uint32_t)(x)) << VPU_TCU_TCU_PLL_COUNTER_pll_count_rst_n_SHIFT)) & VPU_TCU_TCU_PLL_COUNTER_pll_count_rst_n_MASK)

#define VPU_TCU_TCU_PLL_COUNTER_pll_count_start_MASK (0x2U)
#define VPU_TCU_TCU_PLL_COUNTER_pll_count_start_SHIFT (1U)
/*! pll_count_start - pll count start */
#define VPU_TCU_TCU_PLL_COUNTER_pll_count_start(x) (((uint32_t)(((uint32_t)(x)) << VPU_TCU_TCU_PLL_COUNTER_pll_count_start_SHIFT)) & VPU_TCU_TCU_PLL_COUNTER_pll_count_start_MASK)

#define VPU_TCU_TCU_PLL_COUNTER_pll_count_div_en_MASK (0x4U)
#define VPU_TCU_TCU_PLL_COUNTER_pll_count_div_en_SHIFT (2U)
/*! pll_count_div_en - pll count div en */
#define VPU_TCU_TCU_PLL_COUNTER_pll_count_div_en(x) (((uint32_t)(((uint32_t)(x)) << VPU_TCU_TCU_PLL_COUNTER_pll_count_div_en_SHIFT)) & VPU_TCU_TCU_PLL_COUNTER_pll_count_div_en_MASK)

#define VPU_TCU_TCU_PLL_COUNTER_pll_count_clk_sel_MASK (0x38U)
#define VPU_TCU_TCU_PLL_COUNTER_pll_count_clk_sel_SHIFT (3U)
/*! pll_count_clk_sel - pll count clk sel */
#define VPU_TCU_TCU_PLL_COUNTER_pll_count_clk_sel(x) (((uint32_t)(((uint32_t)(x)) << VPU_TCU_TCU_PLL_COUNTER_pll_count_clk_sel_SHIFT)) & VPU_TCU_TCU_PLL_COUNTER_pll_count_clk_sel_MASK)

#define VPU_TCU_TCU_PLL_COUNTER_pll_count_ref_val_MASK (0xFF00U)
#define VPU_TCU_TCU_PLL_COUNTER_pll_count_ref_val_SHIFT (8U)
/*! pll_count_ref_val - pll count ref val */
#define VPU_TCU_TCU_PLL_COUNTER_pll_count_ref_val(x) (((uint32_t)(((uint32_t)(x)) << VPU_TCU_TCU_PLL_COUNTER_pll_count_ref_val_SHIFT)) & VPU_TCU_TCU_PLL_COUNTER_pll_count_ref_val_MASK)

#define VPU_TCU_TCU_PLL_COUNTER_pll_count_cnt_MASK (0xFFFF0000U)
#define VPU_TCU_TCU_PLL_COUNTER_pll_count_cnt_SHIFT (16U)
/*! pll_count_cnt - pll count cnt */
#define VPU_TCU_TCU_PLL_COUNTER_pll_count_cnt(x) (((uint32_t)(((uint32_t)(x)) << VPU_TCU_TCU_PLL_COUNTER_pll_count_cnt_SHIFT)) & VPU_TCU_TCU_PLL_COUNTER_pll_count_cnt_MASK)
/*! @} */

/*! @name TCU_DFT_FUSE - TCU fuse observe and override */
/*! @{ */

#define VPU_TCU_TCU_DFT_FUSE_tcu_dft_fuse_disable_MASK (0x1U)
#define VPU_TCU_TCU_DFT_FUSE_tcu_dft_fuse_disable_SHIFT (0U)
/*! tcu_dft_fuse_disable - dft fuse disable */
#define VPU_TCU_TCU_DFT_FUSE_tcu_dft_fuse_disable(x) (((uint32_t)(((uint32_t)(x)) << VPU_TCU_TCU_DFT_FUSE_tcu_dft_fuse_disable_SHIFT)) & VPU_TCU_TCU_DFT_FUSE_tcu_dft_fuse_disable_MASK)

#define VPU_TCU_TCU_DFT_FUSE_tcu_fuse_obs_MASK   (0xEU)
#define VPU_TCU_TCU_DFT_FUSE_tcu_fuse_obs_SHIFT  (1U)
/*! tcu_fuse_obs - fuse observation */
#define VPU_TCU_TCU_DFT_FUSE_tcu_fuse_obs(x)     (((uint32_t)(((uint32_t)(x)) << VPU_TCU_TCU_DFT_FUSE_tcu_fuse_obs_SHIFT)) & VPU_TCU_TCU_DFT_FUSE_tcu_fuse_obs_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group VPU_TCU_Register_Masks */


/*!
 * @}
 */ /* end of group VPU_TCU_Peripheral_Access_Layer */
