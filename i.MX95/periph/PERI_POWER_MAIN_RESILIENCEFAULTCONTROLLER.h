...
/*!
 * @file PERI_power_main_ResilienceFaultController.h
 * @version 1.0
 * @date 2023-01-10
...
#if !defined(PERI_POWER_MAIN_RESILIENCEFAULTCONTROLLER_H_)
#define PERI_POWER_MAIN_RESILIENCEFAULTCONTROLLER_H_ /**< Symbol preventing repeated inclusion */
...
#endif  /* PERI_POWER_MAIN_RESILIENCEFAULTCONTROLLER_H_ */
