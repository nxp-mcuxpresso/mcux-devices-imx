...
**         I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator
**
...
/*!
 * @file PERI_I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator.h
 * @version 1.0
 * @date 2023-01-10
...
#if !defined(PERI_I_SEERIS_2D_BLITTER_STORE_WR_I_MAIN_QOSGENERATOR_H_)
#define PERI_I_SEERIS_2D_BLITTER_STORE_WR_I_MAIN_QOSGENERATOR_H_ /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_Peripheral_Access_Layer I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator Peripheral Access Layer
 * @{
 */

/** I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator - Register Layout Typedef */
typedef struct {
...
} I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_Type;

/* ----------------------------------------------------------------------------
   -- I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_Register_Masks I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator Register Masks
 * @{
 */
...
#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_ID_COREID_CORETYPEID_MASK (0xFFU)
#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_ID_COREID_CORETYPEID_SHIFT (0U)
#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_ID_COREID_CORETYPEID(x) (((uint32_t)(((uint32_t)(x)) << I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_ID_COREID_CORETYPEID_SHIFT)) & I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_ID_COREID_CORETYPEID_MASK)

#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_ID_COREID_CORECHECKSUM_MASK (0xFFFFFF00U)
#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_ID_COREID_CORECHECKSUM_SHIFT (8U)
#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_ID_COREID_CORECHECKSUM(x) (((uint32_t)(((uint32_t)(x)) << I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_ID_COREID_CORECHECKSUM_SHIFT)) & I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_ID_COREID_CORECHECKSUM_MASK)
/*! @} */

/*! @name ID_REVISIONID - Revision ID */
/*! @{ */

#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_ID_REVISIONID_USERID_MASK (0xFFU)
#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_ID_REVISIONID_USERID_SHIFT (0U)
#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_ID_REVISIONID_USERID(x) (((uint32_t)(((uint32_t)(x)) << I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_ID_REVISIONID_USERID_SHIFT)) & I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_ID_REVISIONID_USERID_MASK)

#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_ID_REVISIONID_NOCID_MASK (0xFFFFFF00U)
#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_ID_REVISIONID_NOCID_SHIFT (8U)
#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_ID_REVISIONID_NOCID(x) (((uint32_t)(((uint32_t)(x)) << I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_ID_REVISIONID_NOCID_SHIFT)) & I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_ID_REVISIONID_NOCID_MASK)
/*! @} */

/*! @name PRIORITY - Priority */
/*! @{ */

#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_PRIORITY_P0_MASK (0x3U)
#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_PRIORITY_P0_SHIFT (0U)
#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_PRIORITY_P0(x) (((uint32_t)(((uint32_t)(x)) << I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_PRIORITY_P0_SHIFT)) & I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_PRIORITY_P0_MASK)

#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_PRIORITY_P1_MASK (0x300U)
#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_PRIORITY_P1_SHIFT (8U)
#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_PRIORITY_P1(x) (((uint32_t)(((uint32_t)(x)) << I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_PRIORITY_P1_SHIFT)) & I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_PRIORITY_P1_MASK)
/*! @} */

/*! @name MODE - Mode */
/*! @{ */

#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_MODE_MODE_MASK (0x3U)
#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_MODE_MODE_SHIFT (0U)
#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_MODE_MODE(x) (((uint32_t)(((uint32_t)(x)) << I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_MODE_MODE_SHIFT)) & I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_MODE_MODE_MASK)
/*! @} */

/*! @name BANDWIDTH - Bandwidth */
/*! @{ */

#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_BANDWIDTH_BANDWIDTH_MASK (0xFFFU)
#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_BANDWIDTH_BANDWIDTH_SHIFT (0U)
#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_BANDWIDTH_BANDWIDTH(x) (((uint32_t)(((uint32_t)(x)) << I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_BANDWIDTH_BANDWIDTH_SHIFT)) & I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_BANDWIDTH_BANDWIDTH_MASK)
/*! @} */

/*! @name SATURATION - Saturation */
/*! @{ */

#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_SATURATION_SATURATION_MASK (0x3FFU)
#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_SATURATION_SATURATION_SHIFT (0U)
#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_SATURATION_SATURATION(x) (((uint32_t)(((uint32_t)(x)) << I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_SATURATION_SATURATION_SHIFT)) & I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_SATURATION_SATURATION_MASK)
/*! @} */

/*! @name EXTCONTROL - External Inputs Control */
/*! @{ */

#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_EXTCONTROL_SOCKETQOSEN_MASK (0x1U)
#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_EXTCONTROL_SOCKETQOSEN_SHIFT (0U)
#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_EXTCONTROL_SOCKETQOSEN(x) (((uint32_t)(((uint32_t)(x)) << I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_EXTCONTROL_SOCKETQOSEN_SHIFT)) & I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_EXTCONTROL_SOCKETQOSEN_MASK)

#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_EXTCONTROL_EXTTHREN_MASK (0x2U)
#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_EXTCONTROL_EXTTHREN_SHIFT (1U)
#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_EXTCONTROL_EXTTHREN(x) (((uint32_t)(((uint32_t)(x)) << I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_EXTCONTROL_EXTTHREN_SHIFT)) & I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_EXTCONTROL_EXTTHREN_MASK)

#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_EXTCONTROL_INTCLKEN_MASK (0x4U)
#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_EXTCONTROL_INTCLKEN_SHIFT (2U)
#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_EXTCONTROL_INTCLKEN(x) (((uint32_t)(((uint32_t)(x)) << I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_EXTCONTROL_INTCLKEN_SHIFT)) & I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_EXTCONTROL_INTCLKEN_MASK)

#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_EXTCONTROL_EXTLIMITEN_MASK (0x8U)
#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_EXTCONTROL_EXTLIMITEN_SHIFT (3U)
#define I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_EXTCONTROL_EXTLIMITEN(x) (((uint32_t)(((uint32_t)(x)) << I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_EXTCONTROL_EXTLIMITEN_SHIFT)) & I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_EXTCONTROL_EXTLIMITEN_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_Register_Masks */


/*!
 * @}
 */ /* end of group I_Seeris_2D_blitter_Store_wr_I_main_QosGenerator_Peripheral_Access_Layer */
...
#endif  /* PERI_I_SEERIS_2D_BLITTER_STORE_WR_I_MAIN_QOSGENERATOR_H_ */
