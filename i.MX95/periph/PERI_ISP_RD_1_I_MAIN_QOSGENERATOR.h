...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for ISP_RD_1_I_main_QosGenerator
**
...
/*!
 * @file PERI_ISP_RD_1_I_main_QosGenerator.h
 * @version 1.0
 * @date 2023-01-10
 * @brief CMSIS Peripheral Access Layer for ISP_RD_1_I_main_QosGenerator
 *
 * CMSIS Peripheral Access Layer for ISP_RD_1_I_main_QosGenerator
 */

#if !defined(PERI_ISP_RD_1_I_MAIN_QOSGENERATOR_H_)
#define PERI_ISP_RD_1_I_MAIN_QOSGENERATOR_H_     /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- ISP_RD_1_I_main_QosGenerator Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup ISP_RD_1_I_main_QosGenerator_Peripheral_Access_Layer ISP_RD_1_I_main_QosGenerator Peripheral Access Layer
 * @{
 */

/** ISP_RD_1_I_main_QosGenerator - Register Layout Typedef */
typedef struct {
...
} ISP_RD_1_I_main_QosGenerator_Type;

/* ----------------------------------------------------------------------------
   -- ISP_RD_1_I_main_QosGenerator Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup ISP_RD_1_I_main_QosGenerator_Register_Masks ISP_RD_1_I_main_QosGenerator Register Masks
 * @{
 */
...
#define ISP_RD_1_I_main_QosGenerator_ID_COREID_CORETYPEID_MASK (0xFFU)
#define ISP_RD_1_I_main_QosGenerator_ID_COREID_CORETYPEID_SHIFT (0U)
#define ISP_RD_1_I_main_QosGenerator_ID_COREID_CORETYPEID(x) (((uint32_t)(((uint32_t)(x)) << ISP_RD_1_I_main_QosGenerator_ID_COREID_CORETYPEID_SHIFT)) & ISP_RD_1_I_main_QosGenerator_ID_COREID_CORETYPEID_MASK)

#define ISP_RD_1_I_main_QosGenerator_ID_COREID_CORECHECKSUM_MASK (0xFFFFFF00U)
#define ISP_RD_1_I_main_QosGenerator_ID_COREID_CORECHECKSUM_SHIFT (8U)
#define ISP_RD_1_I_main_QosGenerator_ID_COREID_CORECHECKSUM(x) (((uint32_t)(((uint32_t)(x)) << ISP_RD_1_I_main_QosGenerator_ID_COREID_CORECHECKSUM_SHIFT)) & ISP_RD_1_I_main_QosGenerator_ID_COREID_CORECHECKSUM_MASK)
/*! @} */

/*! @name ID_REVISIONID - Revision ID */
/*! @{ */

#define ISP_RD_1_I_main_QosGenerator_ID_REVISIONID_USERID_MASK (0xFFU)
#define ISP_RD_1_I_main_QosGenerator_ID_REVISIONID_USERID_SHIFT (0U)
#define ISP_RD_1_I_main_QosGenerator_ID_REVISIONID_USERID(x) (((uint32_t)(((uint32_t)(x)) << ISP_RD_1_I_main_QosGenerator_ID_REVISIONID_USERID_SHIFT)) & ISP_RD_1_I_main_QosGenerator_ID_REVISIONID_USERID_MASK)

#define ISP_RD_1_I_main_QosGenerator_ID_REVISIONID_NOCID_MASK (0xFFFFFF00U)
#define ISP_RD_1_I_main_QosGenerator_ID_REVISIONID_NOCID_SHIFT (8U)
#define ISP_RD_1_I_main_QosGenerator_ID_REVISIONID_NOCID(x) (((uint32_t)(((uint32_t)(x)) << ISP_RD_1_I_main_QosGenerator_ID_REVISIONID_NOCID_SHIFT)) & ISP_RD_1_I_main_QosGenerator_ID_REVISIONID_NOCID_MASK)
/*! @} */

/*! @name PRIORITY - Priority */
/*! @{ */

#define ISP_RD_1_I_main_QosGenerator_PRIORITY_P0_MASK (0x3U)
#define ISP_RD_1_I_main_QosGenerator_PRIORITY_P0_SHIFT (0U)
#define ISP_RD_1_I_main_QosGenerator_PRIORITY_P0(x) (((uint32_t)(((uint32_t)(x)) << ISP_RD_1_I_main_QosGenerator_PRIORITY_P0_SHIFT)) & ISP_RD_1_I_main_QosGenerator_PRIORITY_P0_MASK)

#define ISP_RD_1_I_main_QosGenerator_PRIORITY_P1_MASK (0x300U)
#define ISP_RD_1_I_main_QosGenerator_PRIORITY_P1_SHIFT (8U)
#define ISP_RD_1_I_main_QosGenerator_PRIORITY_P1(x) (((uint32_t)(((uint32_t)(x)) << ISP_RD_1_I_main_QosGenerator_PRIORITY_P1_SHIFT)) & ISP_RD_1_I_main_QosGenerator_PRIORITY_P1_MASK)
/*! @} */

/*! @name MODE - Mode */
/*! @{ */

#define ISP_RD_1_I_main_QosGenerator_MODE_MODE_MASK (0x3U)
#define ISP_RD_1_I_main_QosGenerator_MODE_MODE_SHIFT (0U)
#define ISP_RD_1_I_main_QosGenerator_MODE_MODE(x) (((uint32_t)(((uint32_t)(x)) << ISP_RD_1_I_main_QosGenerator_MODE_MODE_SHIFT)) & ISP_RD_1_I_main_QosGenerator_MODE_MODE_MASK)
/*! @} */

/*! @name BANDWIDTH - Bandwidth */
/*! @{ */

#define ISP_RD_1_I_main_QosGenerator_BANDWIDTH_BANDWIDTH_MASK (0x1FFFU)
#define ISP_RD_1_I_main_QosGenerator_BANDWIDTH_BANDWIDTH_SHIFT (0U)
#define ISP_RD_1_I_main_QosGenerator_BANDWIDTH_BANDWIDTH(x) (((uint32_t)(((uint32_t)(x)) << ISP_RD_1_I_main_QosGenerator_BANDWIDTH_BANDWIDTH_SHIFT)) & ISP_RD_1_I_main_QosGenerator_BANDWIDTH_BANDWIDTH_MASK)
/*! @} */

/*! @name SATURATION - Saturation */
/*! @{ */

#define ISP_RD_1_I_main_QosGenerator_SATURATION_SATURATION_MASK (0x3FFU)
#define ISP_RD_1_I_main_QosGenerator_SATURATION_SATURATION_SHIFT (0U)
#define ISP_RD_1_I_main_QosGenerator_SATURATION_SATURATION(x) (((uint32_t)(((uint32_t)(x)) << ISP_RD_1_I_main_QosGenerator_SATURATION_SATURATION_SHIFT)) & ISP_RD_1_I_main_QosGenerator_SATURATION_SATURATION_MASK)
/*! @} */

/*! @name EXTCONTROL - External Inputs Control */
/*! @{ */

#define ISP_RD_1_I_main_QosGenerator_EXTCONTROL_SOCKETQOSEN_MASK (0x1U)
#define ISP_RD_1_I_main_QosGenerator_EXTCONTROL_SOCKETQOSEN_SHIFT (0U)
#define ISP_RD_1_I_main_QosGenerator_EXTCONTROL_SOCKETQOSEN(x) (((uint32_t)(((uint32_t)(x)) << ISP_RD_1_I_main_QosGenerator_EXTCONTROL_SOCKETQOSEN_SHIFT)) & ISP_RD_1_I_main_QosGenerator_EXTCONTROL_SOCKETQOSEN_MASK)

#define ISP_RD_1_I_main_QosGenerator_EXTCONTROL_EXTTHREN_MASK (0x2U)
#define ISP_RD_1_I_main_QosGenerator_EXTCONTROL_EXTTHREN_SHIFT (1U)
#define ISP_RD_1_I_main_QosGenerator_EXTCONTROL_EXTTHREN(x) (((uint32_t)(((uint32_t)(x)) << ISP_RD_1_I_main_QosGenerator_EXTCONTROL_EXTTHREN_SHIFT)) & ISP_RD_1_I_main_QosGenerator_EXTCONTROL_EXTTHREN_MASK)

#define ISP_RD_1_I_main_QosGenerator_EXTCONTROL_INTCLKEN_MASK (0x4U)
#define ISP_RD_1_I_main_QosGenerator_EXTCONTROL_INTCLKEN_SHIFT (2U)
#define ISP_RD_1_I_main_QosGenerator_EXTCONTROL_INTCLKEN(x) (((uint32_t)(((uint32_t)(x)) << ISP_RD_1_I_main_QosGenerator_EXTCONTROL_INTCLKEN_SHIFT)) & ISP_RD_1_I_main_QosGenerator_EXTCONTROL_INTCLKEN_MASK)

#define ISP_RD_1_I_main_QosGenerator_EXTCONTROL_EXTLIMITEN_MASK (0x8U)
#define ISP_RD_1_I_main_QosGenerator_EXTCONTROL_EXTLIMITEN_SHIFT (3U)
#define ISP_RD_1_I_main_QosGenerator_EXTCONTROL_EXTLIMITEN(x) (((uint32_t)(((uint32_t)(x)) << ISP_RD_1_I_main_QosGenerator_EXTCONTROL_EXTLIMITEN_SHIFT)) & ISP_RD_1_I_main_QosGenerator_EXTCONTROL_EXTLIMITEN_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group ISP_RD_1_I_main_QosGenerator_Register_Masks */


/*!
 * @}
 */ /* end of group ISP_RD_1_I_main_QosGenerator_Peripheral_Access_Layer */
...
#endif  /* PERI_ISP_RD_1_I_MAIN_QOSGENERATOR_H_ */
