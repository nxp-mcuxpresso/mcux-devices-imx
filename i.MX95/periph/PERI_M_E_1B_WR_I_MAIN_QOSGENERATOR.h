...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for m_e_1b_wr_I_main_QosGenerator
**
...
/*!
 * @file PERI_m_e_1b_wr_I_main_QosGenerator.h
 * @version 1.0
 * @date 2023-01-10
 * @brief CMSIS Peripheral Access Layer for m_e_1b_wr_I_main_QosGenerator
 *
 * CMSIS Peripheral Access Layer for m_e_1b_wr_I_main_QosGenerator
 */

#if !defined(PERI_M_E_1B_WR_I_MAIN_QOSGENERATOR_H_)
#define PERI_M_E_1B_WR_I_MAIN_QOSGENERATOR_H_    /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- m_e_1b_wr_I_main_QosGenerator Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup m_e_1b_wr_I_main_QosGenerator_Peripheral_Access_Layer m_e_1b_wr_I_main_QosGenerator Peripheral Access Layer
 * @{
 */

/** m_e_1b_wr_I_main_QosGenerator - Register Layout Typedef */
typedef struct {
...
} m_e_1b_wr_I_main_QosGenerator_Type;

/* ----------------------------------------------------------------------------
   -- m_e_1b_wr_I_main_QosGenerator Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup m_e_1b_wr_I_main_QosGenerator_Register_Masks m_e_1b_wr_I_main_QosGenerator Register Masks
 * @{
 */
...
#define m_e_1b_wr_I_main_QosGenerator_ID_COREID_CORETYPEID_MASK (0xFFU)
#define m_e_1b_wr_I_main_QosGenerator_ID_COREID_CORETYPEID_SHIFT (0U)
#define m_e_1b_wr_I_main_QosGenerator_ID_COREID_CORETYPEID(x) (((uint32_t)(((uint32_t)(x)) << m_e_1b_wr_I_main_QosGenerator_ID_COREID_CORETYPEID_SHIFT)) & m_e_1b_wr_I_main_QosGenerator_ID_COREID_CORETYPEID_MASK)

#define m_e_1b_wr_I_main_QosGenerator_ID_COREID_CORECHECKSUM_MASK (0xFFFFFF00U)
#define m_e_1b_wr_I_main_QosGenerator_ID_COREID_CORECHECKSUM_SHIFT (8U)
#define m_e_1b_wr_I_main_QosGenerator_ID_COREID_CORECHECKSUM(x) (((uint32_t)(((uint32_t)(x)) << m_e_1b_wr_I_main_QosGenerator_ID_COREID_CORECHECKSUM_SHIFT)) & m_e_1b_wr_I_main_QosGenerator_ID_COREID_CORECHECKSUM_MASK)
/*! @} */

/*! @name ID_REVISIONID - Revision ID */
/*! @{ */

#define m_e_1b_wr_I_main_QosGenerator_ID_REVISIONID_USERID_MASK (0xFFU)
#define m_e_1b_wr_I_main_QosGenerator_ID_REVISIONID_USERID_SHIFT (0U)
#define m_e_1b_wr_I_main_QosGenerator_ID_REVISIONID_USERID(x) (((uint32_t)(((uint32_t)(x)) << m_e_1b_wr_I_main_QosGenerator_ID_REVISIONID_USERID_SHIFT)) & m_e_1b_wr_I_main_QosGenerator_ID_REVISIONID_USERID_MASK)

#define m_e_1b_wr_I_main_QosGenerator_ID_REVISIONID_NOCID_MASK (0xFFFFFF00U)
#define m_e_1b_wr_I_main_QosGenerator_ID_REVISIONID_NOCID_SHIFT (8U)
#define m_e_1b_wr_I_main_QosGenerator_ID_REVISIONID_NOCID(x) (((uint32_t)(((uint32_t)(x)) << m_e_1b_wr_I_main_QosGenerator_ID_REVISIONID_NOCID_SHIFT)) & m_e_1b_wr_I_main_QosGenerator_ID_REVISIONID_NOCID_MASK)
/*! @} */

/*! @name PRIORITY - Priority */
/*! @{ */

#define m_e_1b_wr_I_main_QosGenerator_PRIORITY_P0_MASK (0x3U)
#define m_e_1b_wr_I_main_QosGenerator_PRIORITY_P0_SHIFT (0U)
#define m_e_1b_wr_I_main_QosGenerator_PRIORITY_P0(x) (((uint32_t)(((uint32_t)(x)) << m_e_1b_wr_I_main_QosGenerator_PRIORITY_P0_SHIFT)) & m_e_1b_wr_I_main_QosGenerator_PRIORITY_P0_MASK)

#define m_e_1b_wr_I_main_QosGenerator_PRIORITY_P1_MASK (0x300U)
#define m_e_1b_wr_I_main_QosGenerator_PRIORITY_P1_SHIFT (8U)
#define m_e_1b_wr_I_main_QosGenerator_PRIORITY_P1(x) (((uint32_t)(((uint32_t)(x)) << m_e_1b_wr_I_main_QosGenerator_PRIORITY_P1_SHIFT)) & m_e_1b_wr_I_main_QosGenerator_PRIORITY_P1_MASK)
/*! @} */

/*! @name MODE - Mode */
/*! @{ */

#define m_e_1b_wr_I_main_QosGenerator_MODE_MODE_MASK (0x3U)
#define m_e_1b_wr_I_main_QosGenerator_MODE_MODE_SHIFT (0U)
#define m_e_1b_wr_I_main_QosGenerator_MODE_MODE(x) (((uint32_t)(((uint32_t)(x)) << m_e_1b_wr_I_main_QosGenerator_MODE_MODE_SHIFT)) & m_e_1b_wr_I_main_QosGenerator_MODE_MODE_MASK)
/*! @} */

/*! @name BANDWIDTH - Bandwidth */
/*! @{ */

#define m_e_1b_wr_I_main_QosGenerator_BANDWIDTH_BANDWIDTH_MASK (0x1FFFU)
#define m_e_1b_wr_I_main_QosGenerator_BANDWIDTH_BANDWIDTH_SHIFT (0U)
#define m_e_1b_wr_I_main_QosGenerator_BANDWIDTH_BANDWIDTH(x) (((uint32_t)(((uint32_t)(x)) << m_e_1b_wr_I_main_QosGenerator_BANDWIDTH_BANDWIDTH_SHIFT)) & m_e_1b_wr_I_main_QosGenerator_BANDWIDTH_BANDWIDTH_MASK)
/*! @} */

/*! @name SATURATION - Saturation */
/*! @{ */

#define m_e_1b_wr_I_main_QosGenerator_SATURATION_SATURATION_MASK (0x3FFU)
#define m_e_1b_wr_I_main_QosGenerator_SATURATION_SATURATION_SHIFT (0U)
#define m_e_1b_wr_I_main_QosGenerator_SATURATION_SATURATION(x) (((uint32_t)(((uint32_t)(x)) << m_e_1b_wr_I_main_QosGenerator_SATURATION_SATURATION_SHIFT)) & m_e_1b_wr_I_main_QosGenerator_SATURATION_SATURATION_MASK)
/*! @} */

/*! @name EXTCONTROL - External Inputs Control */
/*! @{ */

#define m_e_1b_wr_I_main_QosGenerator_EXTCONTROL_SOCKETQOSEN_MASK (0x1U)
#define m_e_1b_wr_I_main_QosGenerator_EXTCONTROL_SOCKETQOSEN_SHIFT (0U)
#define m_e_1b_wr_I_main_QosGenerator_EXTCONTROL_SOCKETQOSEN(x) (((uint32_t)(((uint32_t)(x)) << m_e_1b_wr_I_main_QosGenerator_EXTCONTROL_SOCKETQOSEN_SHIFT)) & m_e_1b_wr_I_main_QosGenerator_EXTCONTROL_SOCKETQOSEN_MASK)

#define m_e_1b_wr_I_main_QosGenerator_EXTCONTROL_EXTTHREN_MASK (0x2U)
#define m_e_1b_wr_I_main_QosGenerator_EXTCONTROL_EXTTHREN_SHIFT (1U)
#define m_e_1b_wr_I_main_QosGenerator_EXTCONTROL_EXTTHREN(x) (((uint32_t)(((uint32_t)(x)) << m_e_1b_wr_I_main_QosGenerator_EXTCONTROL_EXTTHREN_SHIFT)) & m_e_1b_wr_I_main_QosGenerator_EXTCONTROL_EXTTHREN_MASK)

#define m_e_1b_wr_I_main_QosGenerator_EXTCONTROL_INTCLKEN_MASK (0x4U)
#define m_e_1b_wr_I_main_QosGenerator_EXTCONTROL_INTCLKEN_SHIFT (2U)
#define m_e_1b_wr_I_main_QosGenerator_EXTCONTROL_INTCLKEN(x) (((uint32_t)(((uint32_t)(x)) << m_e_1b_wr_I_main_QosGenerator_EXTCONTROL_INTCLKEN_SHIFT)) & m_e_1b_wr_I_main_QosGenerator_EXTCONTROL_INTCLKEN_MASK)

#define m_e_1b_wr_I_main_QosGenerator_EXTCONTROL_EXTLIMITEN_MASK (0x8U)
#define m_e_1b_wr_I_main_QosGenerator_EXTCONTROL_EXTLIMITEN_SHIFT (3U)
#define m_e_1b_wr_I_main_QosGenerator_EXTCONTROL_EXTLIMITEN(x) (((uint32_t)(((uint32_t)(x)) << m_e_1b_wr_I_main_QosGenerator_EXTCONTROL_EXTLIMITEN_SHIFT)) & m_e_1b_wr_I_main_QosGenerator_EXTCONTROL_EXTLIMITEN_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group m_e_1b_wr_I_main_QosGenerator_Register_Masks */


/*!
 * @}
 */ /* end of group m_e_1b_wr_I_main_QosGenerator_Peripheral_Access_Layer */
...
#endif  /* PERI_M_E_1B_WR_I_MAIN_QOSGENERATOR_H_ */
