...
**         ISP_WR_1_I_main_TransactionStatFilter
**
...
/*!
 * @file PERI_ISP_WR_1_I_main_TransactionStatFilter.h
 * @version 1.0
 * @date 2023-01-10
 * @brief CMSIS Peripheral Access Layer for ISP_WR_1_I_main_TransactionStatFilter
 *
 * CMSIS Peripheral Access Layer for ISP_WR_1_I_main_TransactionStatFilter
 */

#if !defined(PERI_ISP_WR_1_I_MAIN_TRANSACTIONSTATFILTER_H_)
#define PERI_ISP_WR_1_I_MAIN_TRANSACTIONSTATFILTER_H_ /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- ISP_WR_1_I_main_TransactionStatFilter Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup ISP_WR_1_I_main_TransactionStatFilter_Peripheral_Access_Layer ISP_WR_1_I_main_TransactionStatFilter Peripheral Access Layer
 * @{
 */

/** ISP_WR_1_I_main_TransactionStatFilter - Register Layout Typedef */
typedef struct {
...
} ISP_WR_1_I_main_TransactionStatFilter_Type;

/* ----------------------------------------------------------------------------
   -- ISP_WR_1_I_main_TransactionStatFilter Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup ISP_WR_1_I_main_TransactionStatFilter_Register_Masks ISP_WR_1_I_main_TransactionStatFilter Register Masks
 * @{
 */
...
#define ISP_WR_1_I_main_TransactionStatFilter_ID_COREID_CORETYPEID_MASK (0xFFU)
#define ISP_WR_1_I_main_TransactionStatFilter_ID_COREID_CORETYPEID_SHIFT (0U)
#define ISP_WR_1_I_main_TransactionStatFilter_ID_COREID_CORETYPEID(x) (((uint32_t)(((uint32_t)(x)) << ISP_WR_1_I_main_TransactionStatFilter_ID_COREID_CORETYPEID_SHIFT)) & ISP_WR_1_I_main_TransactionStatFilter_ID_COREID_CORETYPEID_MASK)

#define ISP_WR_1_I_main_TransactionStatFilter_ID_COREID_CORECHECKSUM_MASK (0xFFFFFF00U)
#define ISP_WR_1_I_main_TransactionStatFilter_ID_COREID_CORECHECKSUM_SHIFT (8U)
#define ISP_WR_1_I_main_TransactionStatFilter_ID_COREID_CORECHECKSUM(x) (((uint32_t)(((uint32_t)(x)) << ISP_WR_1_I_main_TransactionStatFilter_ID_COREID_CORECHECKSUM_SHIFT)) & ISP_WR_1_I_main_TransactionStatFilter_ID_COREID_CORECHECKSUM_MASK)
/*! @} */

/*! @name ID_REVISIONID - Revision ID */
/*! @{ */

#define ISP_WR_1_I_main_TransactionStatFilter_ID_REVISIONID_USERID_MASK (0xFFU)
#define ISP_WR_1_I_main_TransactionStatFilter_ID_REVISIONID_USERID_SHIFT (0U)
#define ISP_WR_1_I_main_TransactionStatFilter_ID_REVISIONID_USERID(x) (((uint32_t)(((uint32_t)(x)) << ISP_WR_1_I_main_TransactionStatFilter_ID_REVISIONID_USERID_SHIFT)) & ISP_WR_1_I_main_TransactionStatFilter_ID_REVISIONID_USERID_MASK)

#define ISP_WR_1_I_main_TransactionStatFilter_ID_REVISIONID_NOCID_MASK (0xFFFFFF00U)
#define ISP_WR_1_I_main_TransactionStatFilter_ID_REVISIONID_NOCID_SHIFT (8U)
#define ISP_WR_1_I_main_TransactionStatFilter_ID_REVISIONID_NOCID(x) (((uint32_t)(((uint32_t)(x)) << ISP_WR_1_I_main_TransactionStatFilter_ID_REVISIONID_NOCID_SHIFT)) & ISP_WR_1_I_main_TransactionStatFilter_ID_REVISIONID_NOCID_MASK)
/*! @} */

/*! @name MODE - Mode */
/*! @{ */

#define ISP_WR_1_I_main_TransactionStatFilter_MODE_MODE_MASK (0x1U)
#define ISP_WR_1_I_main_TransactionStatFilter_MODE_MODE_SHIFT (0U)
#define ISP_WR_1_I_main_TransactionStatFilter_MODE_MODE(x) (((uint32_t)(((uint32_t)(x)) << ISP_WR_1_I_main_TransactionStatFilter_MODE_MODE_SHIFT)) & ISP_WR_1_I_main_TransactionStatFilter_MODE_MODE_MASK)
/*! @} */

/*! @name ADDRBASE_LOW - Address Base LSB */
/*! @{ */

#define ISP_WR_1_I_main_TransactionStatFilter_ADDRBASE_LOW_ADDRBASE_LOW_MASK (0xFFFFFFFFU)
#define ISP_WR_1_I_main_TransactionStatFilter_ADDRBASE_LOW_ADDRBASE_LOW_SHIFT (0U)
#define ISP_WR_1_I_main_TransactionStatFilter_ADDRBASE_LOW_ADDRBASE_LOW(x) (((uint32_t)(((uint32_t)(x)) << ISP_WR_1_I_main_TransactionStatFilter_ADDRBASE_LOW_ADDRBASE_LOW_SHIFT)) & ISP_WR_1_I_main_TransactionStatFilter_ADDRBASE_LOW_ADDRBASE_LOW_MASK)
/*! @} */

/*! @name ADDRBASE_HIGH - Address Base MSB */
/*! @{ */

#define ISP_WR_1_I_main_TransactionStatFilter_ADDRBASE_HIGH_ADDRBASE_HIGH_MASK (0xFU)
#define ISP_WR_1_I_main_TransactionStatFilter_ADDRBASE_HIGH_ADDRBASE_HIGH_SHIFT (0U)
#define ISP_WR_1_I_main_TransactionStatFilter_ADDRBASE_HIGH_ADDRBASE_HIGH(x) (((uint32_t)(((uint32_t)(x)) << ISP_WR_1_I_main_TransactionStatFilter_ADDRBASE_HIGH_ADDRBASE_HIGH_SHIFT)) & ISP_WR_1_I_main_TransactionStatFilter_ADDRBASE_HIGH_ADDRBASE_HIGH_MASK)
/*! @} */

/*! @name ADDRWINDOWSIZE - Address Window Size */
/*! @{ */

#define ISP_WR_1_I_main_TransactionStatFilter_ADDRWINDOWSIZE_ADDRWINDOWSIZE_MASK (0x3FU)
#define ISP_WR_1_I_main_TransactionStatFilter_ADDRWINDOWSIZE_ADDRWINDOWSIZE_SHIFT (0U)
#define ISP_WR_1_I_main_TransactionStatFilter_ADDRWINDOWSIZE_ADDRWINDOWSIZE(x) (((uint32_t)(((uint32_t)(x)) << ISP_WR_1_I_main_TransactionStatFilter_ADDRWINDOWSIZE_ADDRWINDOWSIZE_SHIFT)) & ISP_WR_1_I_main_TransactionStatFilter_ADDRWINDOWSIZE_ADDRWINDOWSIZE_MASK)
/*! @} */

/*! @name OPCODE - Packet Opcode */
/*! @{ */

#define ISP_WR_1_I_main_TransactionStatFilter_OPCODE_RDEN_MASK (0x1U)
#define ISP_WR_1_I_main_TransactionStatFilter_OPCODE_RDEN_SHIFT (0U)
#define ISP_WR_1_I_main_TransactionStatFilter_OPCODE_RDEN(x) (((uint32_t)(((uint32_t)(x)) << ISP_WR_1_I_main_TransactionStatFilter_OPCODE_RDEN_SHIFT)) & ISP_WR_1_I_main_TransactionStatFilter_OPCODE_RDEN_MASK)

#define ISP_WR_1_I_main_TransactionStatFilter_OPCODE_WREN_MASK (0x2U)
#define ISP_WR_1_I_main_TransactionStatFilter_OPCODE_WREN_SHIFT (1U)
#define ISP_WR_1_I_main_TransactionStatFilter_OPCODE_WREN(x) (((uint32_t)(((uint32_t)(x)) << ISP_WR_1_I_main_TransactionStatFilter_OPCODE_WREN_SHIFT)) & ISP_WR_1_I_main_TransactionStatFilter_OPCODE_WREN_MASK)
/*! @} */

/*! @name USERBASE - User Base */
/*! @{ */

#define ISP_WR_1_I_main_TransactionStatFilter_USERBASE_USERBASE_MASK (0x7FFFFFFFU)
#define ISP_WR_1_I_main_TransactionStatFilter_USERBASE_USERBASE_SHIFT (0U)
#define ISP_WR_1_I_main_TransactionStatFilter_USERBASE_USERBASE(x) (((uint32_t)(((uint32_t)(x)) << ISP_WR_1_I_main_TransactionStatFilter_USERBASE_USERBASE_SHIFT)) & ISP_WR_1_I_main_TransactionStatFilter_USERBASE_USERBASE_MASK)
/*! @} */

/*! @name USERMASK - User Mask */
/*! @{ */

#define ISP_WR_1_I_main_TransactionStatFilter_USERMASK_USERMASK_MASK (0x7FFFFFFFU)
#define ISP_WR_1_I_main_TransactionStatFilter_USERMASK_USERMASK_SHIFT (0U)
#define ISP_WR_1_I_main_TransactionStatFilter_USERMASK_USERMASK(x) (((uint32_t)(((uint32_t)(x)) << ISP_WR_1_I_main_TransactionStatFilter_USERMASK_USERMASK_SHIFT)) & ISP_WR_1_I_main_TransactionStatFilter_USERMASK_USERMASK_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group ISP_WR_1_I_main_TransactionStatFilter_Register_Masks */


/*!
 * @}
 */ /* end of group ISP_WR_1_I_main_TransactionStatFilter_Peripheral_Access_Layer */
...
#endif  /* PERI_ISP_WR_1_I_MAIN_TRANSACTIONSTATFILTER_H_ */
