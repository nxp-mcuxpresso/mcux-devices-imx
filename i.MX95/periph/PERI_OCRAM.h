 ...
 * @version 1.0
 * @date 2023-01-10
 * @brief CMSIS Peripheral Access Layer for OCRAM
 *
 * CMSIS Peripheral Access Layer for OCRAM
 */

#if !defined(PERI_OCRAM_H_)
#define PERI_OCRAM_H_                            /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- OCRAM Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup OCRAM_Peripheral_Access_Layer OCRAM Peripheral Access Layer
 * @{
 */

/** OCRAM - Register Layout Typedef */
typedef struct {
...
/* ----------------------------------------------------------------------------
   -- OCRAM Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup OCRAM_Register_Masks OCRAM Register Masks
 * @{
 */
...
#define OCRAM_RAMCR_INIT_MASK                    (0x1U)
#define OCRAM_RAMCR_INIT_SHIFT                   (0U)
/*! INIT - Initialization Request
 *  0b0..Not requested
 *  0b1..Requested
 */
#define OCRAM_RAMCR_INIT(x)                      (((uint32_t)(((uint32_t)(x)) << OCRAM_RAMCR_INIT_SHIFT)) & OCRAM_RAMCR_INIT_MASK)

#define OCRAM_RAMCR_IWS_MASK                     (0x6U)
#define OCRAM_RAMCR_IWS_SHIFT                    (1U)
 ...
 *  0b11..Three
 */
#define OCRAM_RAMCR_IWS(x)                       (((uint32_t)(((uint32_t)(x)) << OCRAM_RAMCR_IWS_SHIFT)) & OCRAM_RAMCR_IWS_MASK)

#define OCRAM_RAMCR_INIT_SYSA_MASK               (0x100U)
#define OCRAM_RAMCR_INIT_SYSA_SHIFT              (8U)
/*! INIT_SYSA - Initialize With System Address
 *  0b0..Local
 *  0b1..System
 */
#define OCRAM_RAMCR_INIT_SYSA(x)                 (((uint32_t)(((uint32_t)(x)) << OCRAM_RAMCR_INIT_SYSA_SHIFT)) & OCRAM_RAMCR_INIT_SYSA_MASK)
/*! @} */

/*! @name RAMIAS - RAM Initialization Address Start */
/*! @{ */

#define OCRAM_RAMIAS_IAS_MASK                    (0xFFFFFFFFU)
#define OCRAM_RAMIAS_IAS_SHIFT                   (0U)
/*! IAS - Initialization Address Start */
#define OCRAM_RAMIAS_IAS(x)                      (((uint32_t)(((uint32_t)(x)) << OCRAM_RAMIAS_IAS_SHIFT)) & OCRAM_RAMIAS_IAS_MASK)
/*! @} */

/*! @name RAMIAE - RAM Initialization Address End */
/*! @{ */

#define OCRAM_RAMIAE_IAE_MASK                    (0xFFFFFFFFU)
#define OCRAM_RAMIAE_IAE_SHIFT                   (0U)
/*! IAE - Initialization Address End */
#define OCRAM_RAMIAE_IAE(x)                      (((uint32_t)(((uint32_t)(x)) << OCRAM_RAMIAE_IAE_SHIFT)) & OCRAM_RAMIAE_IAE_MASK)
/*! @} */

/*! @name RAMSR - RAM Status */
/*! @{ */

#define OCRAM_RAMSR_IDONE_MASK                   (0x1U)
#define OCRAM_RAMSR_IDONE_SHIFT                  (0U)
 ...
 */
#define OCRAM_RAMSR_IDONE(x)                     (((uint32_t)(((uint32_t)(x)) << OCRAM_RAMSR_IDONE_SHIFT)) & OCRAM_RAMSR_IDONE_MASK)

#define OCRAM_RAMSR_BUSERR_MASK                  (0x2U)
#define OCRAM_RAMSR_BUSERR_SHIFT                 (1U)
/*! BUSERR - Bus Error
 *  0b0..No error occurred since the last time this field was cleared
 *  0b1..An error occurred
 */
#define OCRAM_RAMSR_BUSERR(x)                    (((uint32_t)(((uint32_t)(x)) << OCRAM_RAMSR_BUSERR_SHIFT)) & OCRAM_RAMSR_BUSERR_MASK)

#define OCRAM_RAMSR_IPEND_MASK                   (0x4U)
#define OCRAM_RAMSR_IPEND_SHIFT                  (2U)
/*! IPEND - Initialization Pending
 *  0b0..Not in progress
 *  0b1..In progress
 */
#define OCRAM_RAMSR_IPEND(x)                     (((uint32_t)(((uint32_t)(x)) << OCRAM_RAMSR_IPEND_SHIFT)) & OCRAM_RAMSR_IPEND_MASK)

#define OCRAM_RAMSR_AVALID_MASK                  (0x8U)
#define OCRAM_RAMSR_AVALID_SHIFT                 (3U)
/*! AVALID - Addresses Valid
 *  0b0..Addresses do not correspond to an event
 *  0b1..Addresses correspond to an event
 */
#define OCRAM_RAMSR_AVALID(x)                    (((uint32_t)(((uint32_t)(x)) << OCRAM_RAMSR_AVALID_SHIFT)) & OCRAM_RAMSR_AVALID_MASK)

#define OCRAM_RAMSR_AERR_MASK                    (0x20U)
#define OCRAM_RAMSR_AERR_SHIFT                   (5U)
/*! AERR - ECC Address Error
 *  0b0..No error occurred
 *  0b1..An error occurred
 */
#define OCRAM_RAMSR_AERR(x)                      (((uint32_t)(((uint32_t)(x)) << OCRAM_RAMSR_AERR_SHIFT)) & OCRAM_RAMSR_AERR_MASK)

#define OCRAM_RAMSR_MLTERR_MASK                  (0x40U)
#define OCRAM_RAMSR_MLTERR_SHIFT                 (6U)
/*! MLTERR - ECC Multi-Bit Error
 *  0b0..No error occurred
 *  0b1..An error occurred
 */
#define OCRAM_RAMSR_MLTERR(x)                    (((uint32_t)(((uint32_t)(x)) << OCRAM_RAMSR_MLTERR_SHIFT)) & OCRAM_RAMSR_MLTERR_MASK)

#define OCRAM_RAMSR_SGLERR_MASK                  (0x80U)
#define OCRAM_RAMSR_SGLERR_SHIFT                 (7U)
/*! SGLERR - ECC Single-Bit Error
 *  0b0..No error occurred
 *  0b1..An error occurred
 */
#define OCRAM_RAMSR_SGLERR(x)                    (((uint32_t)(((uint32_t)(x)) << OCRAM_RAMSR_SGLERR_SHIFT)) & OCRAM_RAMSR_SGLERR_MASK)

#define OCRAM_RAMSR_SYND_MASK                    (0xFF00U)
#define OCRAM_RAMSR_SYND_SHIFT                   (8U)
/*! SYND - ECC Syndrome Value */
#define OCRAM_RAMSR_SYND(x)                      (((uint32_t)(((uint32_t)(x)) << OCRAM_RAMSR_SYND_SHIFT)) & OCRAM_RAMSR_SYND_MASK)

#define OCRAM_RAMSR_EINFO_MASK                   (0xFF0000U)
#define OCRAM_RAMSR_EINFO_SHIFT                  (16U)
/*! EINFO - Event Information */
#define OCRAM_RAMSR_EINFO(x)                     (((uint32_t)(((uint32_t)(x)) << OCRAM_RAMSR_EINFO_SHIFT)) & OCRAM_RAMSR_EINFO_MASK)
/*! @} */

/*! @name RAMMEMA - RAM ECC Address */
/*! @{ */

#define OCRAM_RAMMEMA_MEMA_MASK                  (0x1FFFFU)
#define OCRAM_RAMMEMA_MEMA_SHIFT                 (0U)
/*! MEMA - RAM Bank Address */
#define OCRAM_RAMMEMA_MEMA(x)                    (((uint32_t)(((uint32_t)(x)) << OCRAM_RAMMEMA_MEMA_SHIFT)) & OCRAM_RAMMEMA_MEMA_MASK)

#define OCRAM_RAMMEMA_BANK_MASK                  (0x1F00000U)
#define OCRAM_RAMMEMA_BANK_SHIFT                 (20U)
/*! BANK - RAM Bank ID */
#define OCRAM_RAMMEMA_BANK(x)                    (((uint32_t)(((uint32_t)(x)) << OCRAM_RAMMEMA_BANK_SHIFT)) & OCRAM_RAMMEMA_BANK_MASK)
/*! @} */

/*! @name RAMSYSA - RAM System Address */
/*! @{ */

#define OCRAM_RAMSYSA_SYSA_MASK                  (0xFFFFFFFFU)
#define OCRAM_RAMSYSA_SYSA_SHIFT                 (0U)
/*! SYSA - System Address */
#define OCRAM_RAMSYSA_SYSA(x)                    (((uint32_t)(((uint32_t)(x)) << OCRAM_RAMSYSA_SYSA_SHIFT)) & OCRAM_RAMSYSA_SYSA_MASK)
/*! @} */

/*! @name RAMECCNT - RAM Correctable Error Count */
/*! @{ */

#define OCRAM_RAMECCNT_ECCNT_MASK                (0xFFU)
#define OCRAM_RAMECCNT_ECCNT_SHIFT               (0U)
/*! ECCNT - ECC Correctable Error Count */
#define OCRAM_RAMECCNT_ECCNT(x)                  (((uint32_t)(((uint32_t)(x)) << OCRAM_RAMECCNT_ECCNT_SHIFT)) & OCRAM_RAMECCNT_ECCNT_MASK)
/*! @} */

/*! @name RAMEID0 - RAM Error Injection Data 0 */
/*! @{ */

#define OCRAM_RAMEID0_EID_W0_MASK                (0xFFFFFFFFU)
#define OCRAM_RAMEID0_EID_W0_SHIFT               (0U)
/*! EID_W0 - Error Injection Data Word 0 */
#define OCRAM_RAMEID0_EID_W0(x)                  (((uint32_t)(((uint32_t)(x)) << OCRAM_RAMEID0_EID_W0_SHIFT)) & OCRAM_RAMEID0_EID_W0_MASK)
/*! @} */

/*! @name RAMEID1 - RAM Error Injection Data 1 */
/*! @{ */

#define OCRAM_RAMEID1_EID_W1_MASK                (0xFFFFFFFFU)
#define OCRAM_RAMEID1_EID_W1_SHIFT               (0U)
/*! EID_W1 - Error Injection Data Word 1 */
#define OCRAM_RAMEID1_EID_W1(x)                  (((uint32_t)(((uint32_t)(x)) << OCRAM_RAMEID1_EID_W1_SHIFT)) & OCRAM_RAMEID1_EID_W1_MASK)
/*! @} */

/*! @name RAMEIDC - RAM Error Injection Data Control */
/*! @{ */

#define OCRAM_RAMEIDC_EID_CKB_MASK               (0xFFU)
#define OCRAM_RAMEIDC_EID_CKB_SHIFT              (0U)
/*! EID_CKB - Error Injection Data Checkbits */
#define OCRAM_RAMEIDC_EID_CKB(x)                 (((uint32_t)(((uint32_t)(x)) << OCRAM_RAMEIDC_EID_CKB_SHIFT)) & OCRAM_RAMEIDC_EID_CKB_MASK)

#define OCRAM_RAMEIDC_EIP_EN_MASK                (0x1000000U)
#define OCRAM_RAMEIDC_EIP_EN_SHIFT               (24U)
/*! EIP_EN - Error Injection Into Pipeline Enable
 *  0b0..No error injected
 *  0b1..Error injected
 */
#define OCRAM_RAMEIDC_EIP_EN(x)                  (((uint32_t)(((uint32_t)(x)) << OCRAM_RAMEIDC_EIP_EN_SHIFT)) & OCRAM_RAMEIDC_EIP_EN_MASK)

#define OCRAM_RAMEIDC_EIA_EN_MASK                (0x40000000U)
#define OCRAM_RAMEIDC_EIA_EN_SHIFT               (30U)
/*! EIA_EN - Error Injection Address Enable
 *  0b0..Ignore RAMEIA and RAMEIAM
 *  0b1..Enable RAMEIA and RAMEIAM
 */
#define OCRAM_RAMEIDC_EIA_EN(x)                  (((uint32_t)(((uint32_t)(x)) << OCRAM_RAMEIDC_EIA_EN_SHIFT)) & OCRAM_RAMEIDC_EIA_EN_MASK)

#define OCRAM_RAMEIDC_EID_EN_MASK                (0x80000000U)
#define OCRAM_RAMEIDC_EID_EN_SHIFT               (31U)
/*! EID_EN - Error Injection Data Enable
 *  0b0..No injection
 *  0b1..Local injection
 */
#define OCRAM_RAMEIDC_EID_EN(x)                  (((uint32_t)(((uint32_t)(x)) << OCRAM_RAMEIDC_EID_EN_SHIFT)) & OCRAM_RAMEIDC_EID_EN_MASK)
/*! @} */

/*! @name RAMEIA - RAM Error Injection Base Address */
/*! @{ */

#define OCRAM_RAMEIA_EIA_MASK                    (0xFFFFFFFFU)
#define OCRAM_RAMEIA_EIA_SHIFT                   (0U)
/*! EIA - Error Injection Base Address */
#define OCRAM_RAMEIA_EIA(x)                      (((uint32_t)(((uint32_t)(x)) << OCRAM_RAMEIA_EIA_SHIFT)) & OCRAM_RAMEIA_EIA_MASK)
/*! @} */

/*! @name RAMEIAM - RAM Error Injection Address Mask */
/*! @{ */

#define OCRAM_RAMEIAM_EIAM_MASK                  (0xFFFFFFFFU)
#define OCRAM_RAMEIAM_EIAM_SHIFT                 (0U)
/*! EIAM - Error Injection Address Mask */
#define OCRAM_RAMEIAM_EIAM(x)                    (((uint32_t)(((uint32_t)(x)) << OCRAM_RAMEIAM_EIAM_SHIFT)) & OCRAM_RAMEIAM_EIAM_MASK)
/*! @} */

/*! @name RAMMAXA - RAM Maximum-Value Address */
/*! @{ */

#define OCRAM_RAMMAXA_MAXA_MASK                  (0xFFFFFFFFU)
...
/*!
 * @}
 */ /* end of group OCRAM_Register_Masks */


/*!
 * @}
 */ /* end of group OCRAM_Peripheral_Access_Layer */
