...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for OB_WB0
**
 ...
 * @version 1.0
 * @date 2023-01-10
 * @brief CMSIS Peripheral Access Layer for OB_WB0
 *
 * CMSIS Peripheral Access Layer for OB_WB0
 */

#if !defined(PERI_OB_WB0_H_)
#define PERI_OB_WB0_H_                           /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- OB_WB0 Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup OB_WB0_Peripheral_Access_Layer OB_WB0 Peripheral Access Layer
 * @{
 */

/** OB_WB0 - Size of Registers Arrays */
#define OB_WB0_NEO_PIPE1_OB_WB_CONF_COUNT         1u

/** OB_WB0 - Register Layout Typedef */
typedef struct {
  ...
  } NEO_PIPE1_OB_WB_CONF[OB_WB0_NEO_PIPE1_OB_WB_CONF_COUNT];
} OB_WB0_Type;

/* ----------------------------------------------------------------------------
   -- OB_WB0 Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup OB_WB0_Register_Masks OB_WB0 Register Masks
 * @{
 */
...
#define OB_WB0_CTRL_CAM_OBPP_MASK                (0xCU)
#define OB_WB0_CTRL_CAM_OBPP_SHIFT               (2U)
/*! OBPP
 *  0b00..12bpp
 *  0b01..14bpp
 *  0b10..16bpp
 *  0b11..20bpp
 */
#define OB_WB0_CTRL_CAM_OBPP(x)                  (((uint32_t)(((uint32_t)(x)) << OB_WB0_CTRL_CAM_OBPP_SHIFT)) & OB_WB0_CTRL_CAM_OBPP_MASK)
/*! @} */

/* The count of OB_WB0_CTRL_CAM */
#define OB_WB0_CTRL_CAM_COUNT                    (1U)

/*! @name R_CTRL_CAM - Camera 0 OB_WB Red Channel Control Register */
/*! @{ */

#define OB_WB0_R_CTRL_CAM_OFFSET_MASK            (0xFFFFU)
#define OB_WB0_R_CTRL_CAM_OFFSET_SHIFT           (0U)
#define OB_WB0_R_CTRL_CAM_OFFSET(x)              (((uint32_t)(((uint32_t)(x)) << OB_WB0_R_CTRL_CAM_OFFSET_SHIFT)) & OB_WB0_R_CTRL_CAM_OFFSET_MASK)

#define OB_WB0_R_CTRL_CAM_GAIN_MASK              (0xFFFF0000U)
#define OB_WB0_R_CTRL_CAM_GAIN_SHIFT             (16U)
#define OB_WB0_R_CTRL_CAM_GAIN(x)                (((uint32_t)(((uint32_t)(x)) << OB_WB0_R_CTRL_CAM_GAIN_SHIFT)) & OB_WB0_R_CTRL_CAM_GAIN_MASK)
/*! @} */

/* The count of OB_WB0_R_CTRL_CAM */
#define OB_WB0_R_CTRL_CAM_COUNT                  (1U)

/*! @name GR_CTRL_CAM - Camera 0 OB_WB GreenR Channel Control Register */
/*! @{ */

#define OB_WB0_GR_CTRL_CAM_OFFSET_MASK           (0xFFFFU)
#define OB_WB0_GR_CTRL_CAM_OFFSET_SHIFT          (0U)
#define OB_WB0_GR_CTRL_CAM_OFFSET(x)             (((uint32_t)(((uint32_t)(x)) << OB_WB0_GR_CTRL_CAM_OFFSET_SHIFT)) & OB_WB0_GR_CTRL_CAM_OFFSET_MASK)

#define OB_WB0_GR_CTRL_CAM_GAIN_MASK             (0xFFFF0000U)
#define OB_WB0_GR_CTRL_CAM_GAIN_SHIFT            (16U)
#define OB_WB0_GR_CTRL_CAM_GAIN(x)               (((uint32_t)(((uint32_t)(x)) << OB_WB0_GR_CTRL_CAM_GAIN_SHIFT)) & OB_WB0_GR_CTRL_CAM_GAIN_MASK)
/*! @} */

/* The count of OB_WB0_GR_CTRL_CAM */
#define OB_WB0_GR_CTRL_CAM_COUNT                 (1U)

/*! @name GB_CTRL_CAM - Camera 0 OB_WB GreenB Channel Control Register */
/*! @{ */

#define OB_WB0_GB_CTRL_CAM_OFFSET_MASK           (0xFFFFU)
#define OB_WB0_GB_CTRL_CAM_OFFSET_SHIFT          (0U)
#define OB_WB0_GB_CTRL_CAM_OFFSET(x)             (((uint32_t)(((uint32_t)(x)) << OB_WB0_GB_CTRL_CAM_OFFSET_SHIFT)) & OB_WB0_GB_CTRL_CAM_OFFSET_MASK)

#define OB_WB0_GB_CTRL_CAM_GAIN_MASK             (0xFFFF0000U)
#define OB_WB0_GB_CTRL_CAM_GAIN_SHIFT            (16U)
#define OB_WB0_GB_CTRL_CAM_GAIN(x)               (((uint32_t)(((uint32_t)(x)) << OB_WB0_GB_CTRL_CAM_GAIN_SHIFT)) & OB_WB0_GB_CTRL_CAM_GAIN_MASK)
/*! @} */

/* The count of OB_WB0_GB_CTRL_CAM */
#define OB_WB0_GB_CTRL_CAM_COUNT                 (1U)

/*! @name B_CTRL_CAM - Camera 0 OB_WB Blue Channel Control Register */
/*! @{ */

#define OB_WB0_B_CTRL_CAM_OFFSET_MASK            (0xFFFFU)
#define OB_WB0_B_CTRL_CAM_OFFSET_SHIFT           (0U)
#define OB_WB0_B_CTRL_CAM_OFFSET(x)              (((uint32_t)(((uint32_t)(x)) << OB_WB0_B_CTRL_CAM_OFFSET_SHIFT)) & OB_WB0_B_CTRL_CAM_OFFSET_MASK)

#define OB_WB0_B_CTRL_CAM_GAIN_MASK              (0xFFFF0000U)
#define OB_WB0_B_CTRL_CAM_GAIN_SHIFT             (16U)
#define OB_WB0_B_CTRL_CAM_GAIN(x)                (((uint32_t)(((uint32_t)(x)) << OB_WB0_B_CTRL_CAM_GAIN_SHIFT)) & OB_WB0_B_CTRL_CAM_GAIN_MASK)
/*! @} */

/* The count of OB_WB0_B_CTRL_CAM */
#define OB_WB0_B_CTRL_CAM_COUNT                  (1U)


/*!
 * @}
 */ /* end of group OB_WB0_Register_Masks */


/*!
 * @}
 */ /* end of group OB_WB0_Peripheral_Access_Layer */
