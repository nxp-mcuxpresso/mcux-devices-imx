...
#if !defined(PERI_IDBG2_H_)
#define PERI_IDBG2_H_                            /**< Symbol preventing repeated inclusion */
...
#define IDBG2_DONE_STAT_RUN(x)                   (((uint32_t)(((uint32_t)(x)) << IDBG2_DONE_STAT_RUN_SHIFT)) & IDBG2_DONE_STAT_RUN_MASK)
/*! @} */
