...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for ISI_WR_U_I_main_QosGenerator
**
...
/*!
 * @file PERI_ISI_WR_U_I_main_QosGenerator.h
 * @version 1.0
 * @date 2023-01-10
 * @brief CMSIS Peripheral Access Layer for ISI_WR_U_I_main_QosGenerator
 *
 * CMSIS Peripheral Access Layer for ISI_WR_U_I_main_QosGenerator
 */

#if !defined(PERI_ISI_WR_U_I_MAIN_QOSGENERATOR_H_)
#define PERI_ISI_WR_U_I_MAIN_QOSGENERATOR_H_     /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- ISI_WR_U_I_main_QosGenerator Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup ISI_WR_U_I_main_QosGenerator_Peripheral_Access_Layer ISI_WR_U_I_main_QosGenerator Peripheral Access Layer
 * @{
 */

/** ISI_WR_U_I_main_QosGenerator - Register Layout Typedef */
typedef struct {
...
} ISI_WR_U_I_main_QosGenerator_Type;

/* ----------------------------------------------------------------------------
   -- ISI_WR_U_I_main_QosGenerator Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup ISI_WR_U_I_main_QosGenerator_Register_Masks ISI_WR_U_I_main_QosGenerator Register Masks
 * @{
 */
...
#define ISI_WR_U_I_main_QosGenerator_ID_COREID_CORETYPEID_MASK (0xFFU)
#define ISI_WR_U_I_main_QosGenerator_ID_COREID_CORETYPEID_SHIFT (0U)
#define ISI_WR_U_I_main_QosGenerator_ID_COREID_CORETYPEID(x) (((uint32_t)(((uint32_t)(x)) << ISI_WR_U_I_main_QosGenerator_ID_COREID_CORETYPEID_SHIFT)) & ISI_WR_U_I_main_QosGenerator_ID_COREID_CORETYPEID_MASK)

#define ISI_WR_U_I_main_QosGenerator_ID_COREID_CORECHECKSUM_MASK (0xFFFFFF00U)
#define ISI_WR_U_I_main_QosGenerator_ID_COREID_CORECHECKSUM_SHIFT (8U)
#define ISI_WR_U_I_main_QosGenerator_ID_COREID_CORECHECKSUM(x) (((uint32_t)(((uint32_t)(x)) << ISI_WR_U_I_main_QosGenerator_ID_COREID_CORECHECKSUM_SHIFT)) & ISI_WR_U_I_main_QosGenerator_ID_COREID_CORECHECKSUM_MASK)
/*! @} */

/*! @name ID_REVISIONID - Revision ID */
/*! @{ */

#define ISI_WR_U_I_main_QosGenerator_ID_REVISIONID_USERID_MASK (0xFFU)
#define ISI_WR_U_I_main_QosGenerator_ID_REVISIONID_USERID_SHIFT (0U)
#define ISI_WR_U_I_main_QosGenerator_ID_REVISIONID_USERID(x) (((uint32_t)(((uint32_t)(x)) << ISI_WR_U_I_main_QosGenerator_ID_REVISIONID_USERID_SHIFT)) & ISI_WR_U_I_main_QosGenerator_ID_REVISIONID_USERID_MASK)

#define ISI_WR_U_I_main_QosGenerator_ID_REVISIONID_NOCID_MASK (0xFFFFFF00U)
#define ISI_WR_U_I_main_QosGenerator_ID_REVISIONID_NOCID_SHIFT (8U)
#define ISI_WR_U_I_main_QosGenerator_ID_REVISIONID_NOCID(x) (((uint32_t)(((uint32_t)(x)) << ISI_WR_U_I_main_QosGenerator_ID_REVISIONID_NOCID_SHIFT)) & ISI_WR_U_I_main_QosGenerator_ID_REVISIONID_NOCID_MASK)
/*! @} */

/*! @name PRIORITY - Priority */
/*! @{ */

#define ISI_WR_U_I_main_QosGenerator_PRIORITY_P0_MASK (0x3U)
#define ISI_WR_U_I_main_QosGenerator_PRIORITY_P0_SHIFT (0U)
#define ISI_WR_U_I_main_QosGenerator_PRIORITY_P0(x) (((uint32_t)(((uint32_t)(x)) << ISI_WR_U_I_main_QosGenerator_PRIORITY_P0_SHIFT)) & ISI_WR_U_I_main_QosGenerator_PRIORITY_P0_MASK)

#define ISI_WR_U_I_main_QosGenerator_PRIORITY_P1_MASK (0x300U)
#define ISI_WR_U_I_main_QosGenerator_PRIORITY_P1_SHIFT (8U)
#define ISI_WR_U_I_main_QosGenerator_PRIORITY_P1(x) (((uint32_t)(((uint32_t)(x)) << ISI_WR_U_I_main_QosGenerator_PRIORITY_P1_SHIFT)) & ISI_WR_U_I_main_QosGenerator_PRIORITY_P1_MASK)
/*! @} */

/*! @name MODE - Mode */
/*! @{ */

#define ISI_WR_U_I_main_QosGenerator_MODE_MODE_MASK (0x3U)
#define ISI_WR_U_I_main_QosGenerator_MODE_MODE_SHIFT (0U)
#define ISI_WR_U_I_main_QosGenerator_MODE_MODE(x) (((uint32_t)(((uint32_t)(x)) << ISI_WR_U_I_main_QosGenerator_MODE_MODE_SHIFT)) & ISI_WR_U_I_main_QosGenerator_MODE_MODE_MASK)
/*! @} */

/*! @name BANDWIDTH - Bandwidth */
/*! @{ */

#define ISI_WR_U_I_main_QosGenerator_BANDWIDTH_BANDWIDTH_MASK (0x1FFFU)
#define ISI_WR_U_I_main_QosGenerator_BANDWIDTH_BANDWIDTH_SHIFT (0U)
#define ISI_WR_U_I_main_QosGenerator_BANDWIDTH_BANDWIDTH(x) (((uint32_t)(((uint32_t)(x)) << ISI_WR_U_I_main_QosGenerator_BANDWIDTH_BANDWIDTH_SHIFT)) & ISI_WR_U_I_main_QosGenerator_BANDWIDTH_BANDWIDTH_MASK)
/*! @} */

/*! @name SATURATION - Saturation */
/*! @{ */

#define ISI_WR_U_I_main_QosGenerator_SATURATION_SATURATION_MASK (0x3FFU)
#define ISI_WR_U_I_main_QosGenerator_SATURATION_SATURATION_SHIFT (0U)
#define ISI_WR_U_I_main_QosGenerator_SATURATION_SATURATION(x) (((uint32_t)(((uint32_t)(x)) << ISI_WR_U_I_main_QosGenerator_SATURATION_SATURATION_SHIFT)) & ISI_WR_U_I_main_QosGenerator_SATURATION_SATURATION_MASK)
/*! @} */

/*! @name EXTCONTROL - External Inputs Control */
/*! @{ */

#define ISI_WR_U_I_main_QosGenerator_EXTCONTROL_SOCKETQOSEN_MASK (0x1U)
#define ISI_WR_U_I_main_QosGenerator_EXTCONTROL_SOCKETQOSEN_SHIFT (0U)
#define ISI_WR_U_I_main_QosGenerator_EXTCONTROL_SOCKETQOSEN(x) (((uint32_t)(((uint32_t)(x)) << ISI_WR_U_I_main_QosGenerator_EXTCONTROL_SOCKETQOSEN_SHIFT)) & ISI_WR_U_I_main_QosGenerator_EXTCONTROL_SOCKETQOSEN_MASK)

#define ISI_WR_U_I_main_QosGenerator_EXTCONTROL_EXTTHREN_MASK (0x2U)
#define ISI_WR_U_I_main_QosGenerator_EXTCONTROL_EXTTHREN_SHIFT (1U)
#define ISI_WR_U_I_main_QosGenerator_EXTCONTROL_EXTTHREN(x) (((uint32_t)(((uint32_t)(x)) << ISI_WR_U_I_main_QosGenerator_EXTCONTROL_EXTTHREN_SHIFT)) & ISI_WR_U_I_main_QosGenerator_EXTCONTROL_EXTTHREN_MASK)

#define ISI_WR_U_I_main_QosGenerator_EXTCONTROL_INTCLKEN_MASK (0x4U)
#define ISI_WR_U_I_main_QosGenerator_EXTCONTROL_INTCLKEN_SHIFT (2U)
#define ISI_WR_U_I_main_QosGenerator_EXTCONTROL_INTCLKEN(x) (((uint32_t)(((uint32_t)(x)) << ISI_WR_U_I_main_QosGenerator_EXTCONTROL_INTCLKEN_SHIFT)) & ISI_WR_U_I_main_QosGenerator_EXTCONTROL_INTCLKEN_MASK)

#define ISI_WR_U_I_main_QosGenerator_EXTCONTROL_EXTLIMITEN_MASK (0x8U)
#define ISI_WR_U_I_main_QosGenerator_EXTCONTROL_EXTLIMITEN_SHIFT (3U)
#define ISI_WR_U_I_main_QosGenerator_EXTCONTROL_EXTLIMITEN(x) (((uint32_t)(((uint32_t)(x)) << ISI_WR_U_I_main_QosGenerator_EXTCONTROL_EXTLIMITEN_SHIFT)) & ISI_WR_U_I_main_QosGenerator_EXTCONTROL_EXTLIMITEN_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group ISI_WR_U_I_main_QosGenerator_Register_Masks */


/*!
 * @}
 */ /* end of group ISI_WR_U_I_main_QosGenerator_Peripheral_Access_Layer */
...
#endif  /* PERI_ISI_WR_U_I_MAIN_QOSGENERATOR_H_ */
