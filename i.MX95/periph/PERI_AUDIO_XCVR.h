...
#if !defined(AUDIO_XCVR_H_)
#define AUDIO_XCVR_H_                            /**< Symbol preventing repeated inclusion */
...
typedef struct {
  ...
  __I  uint32_t RX_CS_DATA_BITS[AUDIO_XCVR_RX_CS_DATA_BITS_COUNT]; /**< Channel status bits, array offset: 0x990, array step: 0x4 */
  __I  uint32_t RX_USER_DATA_BITS[AUDIO_XCVR_RX_USER_DATA_BITS_COUNT]; /**< User data bits, array offset: 0x9A8, array step: 0x4 */
  struct {                                         /* offset: 0x9C0 */
  ...
  __IO uint32_t TX_CS_DATA_BITS[AUDIO_XCVR_TX_CS_DATA_BITS_COUNT]; /**< Channel status bits, array offset: 0xA30, array step: 0x4 */
  __IO uint32_t TX_USER_DATA_BITS[AUDIO_XCVR_TX_USER_DATA_BITS_COUNT]; /**< User data bits, array offset: 0xA48, array step: 0x4 */
  struct {                                         /* offset: 0xA60 */
...
#define AUDIO_XCVR_EXT_CTRL_FABRIC_RR_SEL_MASK   (0x8000U)
#define AUDIO_XCVR_EXT_CTRL_FABRIC_RR_SEL_SHIFT  (15U)
/*! FABRIC_RR_SEL - Selects Arbitration mode of crossbar switch. */
#define AUDIO_XCVR_EXT_CTRL_FABRIC_RR_SEL(x)     (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_CTRL_FABRIC_RR_SEL_SHIFT)) & AUDIO_XCVR_EXT_CTRL_FABRIC_RR_SEL_MASK)

#define AUDIO_XCVR_EXT_CTRL_PAGE_MASK            (0xF0000U)
#define AUDIO_XCVR_EXT_CTRL_PAGE_SHIFT           (16U)
/*! PAGE - Page Select. */
#define AUDIO_XCVR_EXT_CTRL_PAGE(x)              (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_CTRL_PAGE_SHIFT)) & AUDIO_XCVR_EXT_CTRL_PAGE_MASK)

#define AUDIO_XCVR_EXT_CTRL_CORE_SLEEP_HOLD_REQ_B_MASK (0x200000U)
#define AUDIO_XCVR_EXT_CTRL_CORE_SLEEP_HOLD_REQ_B_SHIFT (21U)
/*! CORE_SLEEP_HOLD_REQ_B - Hold core from going to sleep mode when 0. */
#define AUDIO_XCVR_EXT_CTRL_CORE_SLEEP_HOLD_REQ_B(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_CTRL_CORE_SLEEP_HOLD_REQ_B_SHIFT)) & AUDIO_XCVR_EXT_CTRL_CORE_SLEEP_HOLD_REQ_B_MASK)

#define AUDIO_XCVR_EXT_CTRL_CORE_WAIT_MASK       (0x400000U)
#define AUDIO_XCVR_EXT_CTRL_CORE_WAIT_SHIFT      (22U)
/*! CORE_WAIT - Stop executing code */
#define AUDIO_XCVR_EXT_CTRL_CORE_WAIT(x)         (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_CTRL_CORE_WAIT_SHIFT)) & AUDIO_XCVR_EXT_CTRL_CORE_WAIT_MASK)

#define AUDIO_XCVR_EXT_CTRL_SPDIF_MODE_MASK      (0x800000U)
#define AUDIO_XCVR_EXT_CTRL_SPDIF_MODE_SHIFT     (23U)
/*! SPDIF_MODE - Indicates SPDIF output mode. */
#define AUDIO_XCVR_EXT_CTRL_SPDIF_MODE(x)        (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_CTRL_SPDIF_MODE_SHIFT)) & AUDIO_XCVR_EXT_CTRL_SPDIF_MODE_MASK)
...
#define AUDIO_XCVR_EXT_CTRL_TX_CMDC_RESET_MASK   (0x20000000U)
#define AUDIO_XCVR_EXT_CTRL_TX_CMDC_RESET_SHIFT  (29U)
/*! TX_CMDC_RESET - Soft reset to the AUDIO_XCVR Common mode Transmitter */
#define AUDIO_XCVR_EXT_CTRL_TX_CMDC_RESET(x)     (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_CTRL_TX_CMDC_RESET_SHIFT)) & AUDIO_XCVR_EXT_CTRL_TX_CMDC_RESET_MASK)

#define AUDIO_XCVR_EXT_CTRL_RX_CMDC_RESET_MASK   (0x40000000U)
#define AUDIO_XCVR_EXT_CTRL_RX_CMDC_RESET_SHIFT  (30U)
/*! RX_CMDC_RESET - Soft reset to the AUDIO_XCVR Common mode Receiver */
#define AUDIO_XCVR_EXT_CTRL_RX_CMDC_RESET(x)     (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_CTRL_RX_CMDC_RESET_SHIFT)) & AUDIO_XCVR_EXT_CTRL_RX_CMDC_RESET_MASK)

#define AUDIO_XCVR_EXT_CTRL_CORE_RESET_MASK      (0x80000000U)
#define AUDIO_XCVR_EXT_CTRL_CORE_RESET_SHIFT     (31U)
/*! CORE_RESET - M0+ Reset */
#define AUDIO_XCVR_EXT_CTRL_CORE_RESET(x)        (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_CTRL_CORE_RESET_SHIFT)) & AUDIO_XCVR_EXT_CTRL_CORE_RESET_MASK)
/*! @} */
...
#define AUDIO_XCVR_EXT_STATUS_CM0_SLEEPING_MASK  (0x10000U)
#define AUDIO_XCVR_EXT_STATUS_CM0_SLEEPING_SHIFT (16U)
/*! CM0_SLEEPING - CM0 is in Sleep mode. */
#define AUDIO_XCVR_EXT_STATUS_CM0_SLEEPING(x)    (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_STATUS_CM0_SLEEPING_SHIFT)) & AUDIO_XCVR_EXT_STATUS_CM0_SLEEPING_MASK)

#define AUDIO_XCVR_EXT_STATUS_CM0_DEEP_SLEEP_MASK (0x20000U)
#define AUDIO_XCVR_EXT_STATUS_CM0_DEEP_SLEEP_SHIFT (17U)
/*! CM0_DEEP_SLEEP - CM0 is in deep sleep mode. */
#define AUDIO_XCVR_EXT_STATUS_CM0_DEEP_SLEEP(x)  (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_STATUS_CM0_DEEP_SLEEP_SHIFT)) & AUDIO_XCVR_EXT_STATUS_CM0_DEEP_SLEEP_MASK)

#define AUDIO_XCVR_EXT_STATUS_CM0_SLEEP_HOLD_ACK_B_MASK (0x40000U)
#define AUDIO_XCVR_EXT_STATUS_CM0_SLEEP_HOLD_ACK_B_SHIFT (18U)
/*! CM0_SLEEP_HOLD_ACK_B - Sleep extension acknowledge. */
#define AUDIO_XCVR_EXT_STATUS_CM0_SLEEP_HOLD_ACK_B(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_STATUS_CM0_SLEEP_HOLD_ACK_B_SHIFT)) & AUDIO_XCVR_EXT_STATUS_CM0_SLEEP_HOLD_ACK_B_MASK)
...
#define AUDIO_XCVR_EXT_STATUS_RX_CMDC_RESP_TO_MASK (0x800000U)
#define AUDIO_XCVR_EXT_STATUS_RX_CMDC_RESP_TO_SHIFT (23U)
/*! RX_CMDC_RESP_TO - CMDC Response not sent in programmed time */
#define AUDIO_XCVR_EXT_STATUS_RX_CMDC_RESP_TO(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_STATUS_RX_CMDC_RESP_TO_SHIFT)) & AUDIO_XCVR_EXT_STATUS_RX_CMDC_RESP_TO_MASK)

#define AUDIO_XCVR_EXT_STATUS_RX_CMDC_COMMA_TO_MASK (0x2000000U)
#define AUDIO_XCVR_EXT_STATUS_RX_CMDC_COMMA_TO_SHIFT (25U)
/*! RX_CMDC_COMMA_TO - Receiver CMDC comma timeout Interrupt */
#define AUDIO_XCVR_EXT_STATUS_RX_CMDC_COMMA_TO(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_STATUS_RX_CMDC_COMMA_TO_SHIFT)) & AUDIO_XCVR_EXT_STATUS_RX_CMDC_COMMA_TO_MASK)

#define AUDIO_XCVR_EXT_STATUS_HEARTBEAT_STATUS_MASK (0x8000000U)
#define AUDIO_XCVR_EXT_STATUS_HEARTBEAT_STATUS_SHIFT (27U)
/*! HEARTBEAT_STATUS - AUDIO_XCVR Connection Status */
#define AUDIO_XCVR_EXT_STATUS_HEARTBEAT_STATUS(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_STATUS_HEARTBEAT_STATUS_SHIFT)) & AUDIO_XCVR_EXT_STATUS_HEARTBEAT_STATUS_MASK)

#define AUDIO_XCVR_EXT_STATUS_NEW_UD4_REC_MASK   (0x10000000U)
#define AUDIO_XCVR_EXT_STATUS_NEW_UD4_REC_SHIFT  (28U)
/*! NEW_UD4_REC - New user data */
#define AUDIO_XCVR_EXT_STATUS_NEW_UD4_REC(x)     (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_STATUS_NEW_UD4_REC_SHIFT)) & AUDIO_XCVR_EXT_STATUS_NEW_UD4_REC_MASK)

#define AUDIO_XCVR_EXT_STATUS_NEW_UD5_REC_MASK   (0x20000000U)
#define AUDIO_XCVR_EXT_STATUS_NEW_UD5_REC_SHIFT  (29U)
/*! NEW_UD5_REC - New user data */
#define AUDIO_XCVR_EXT_STATUS_NEW_UD5_REC(x)     (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_STATUS_NEW_UD5_REC_SHIFT)) & AUDIO_XCVR_EXT_STATUS_NEW_UD5_REC_MASK)

#define AUDIO_XCVR_EXT_STATUS_NEW_UD6_REC_MASK   (0x40000000U)
#define AUDIO_XCVR_EXT_STATUS_NEW_UD6_REC_SHIFT  (30U)
/*! NEW_UD6_REC - New user data */
#define AUDIO_XCVR_EXT_STATUS_NEW_UD6_REC(x)     (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_STATUS_NEW_UD6_REC_SHIFT)) & AUDIO_XCVR_EXT_STATUS_NEW_UD6_REC_MASK)

#define AUDIO_XCVR_EXT_STATUS_HPD_I_MASK         (0x80000000U)
#define AUDIO_XCVR_EXT_STATUS_HPD_I_SHIFT        (31U)
/*! HPD_I - HPD Input status */
#define AUDIO_XCVR_EXT_STATUS_HPD_I(x)           (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_STATUS_HPD_I_SHIFT)) & AUDIO_XCVR_EXT_STATUS_HPD_I_MASK)
/*! @} */
...
#define AUDIO_XCVR_EXT_IER0_NEW_UD_IE_0_MASK     (0x2U)
#define AUDIO_XCVR_EXT_IER0_NEW_UD_IE_0_SHIFT    (1U)
/*! NEW_UD_IE_0 - Enable for new user data received interrupt */
#define AUDIO_XCVR_EXT_IER0_NEW_UD_IE_0(x)       (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_IER0_NEW_UD_IE_0_SHIFT)) & AUDIO_XCVR_EXT_IER0_NEW_UD_IE_0_MASK)
...
#define AUDIO_XCVR_EXT_IER0_CMDC_RESP_TO_IE_0_MASK (0x8U)
#define AUDIO_XCVR_EXT_IER0_CMDC_RESP_TO_IE_0_SHIFT (3U)
/*! CMDC_RESP_TO_IE_0 - Receiver CMDC data response timeout interrupt enable */
#define AUDIO_XCVR_EXT_IER0_CMDC_RESP_TO_IE_0(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_IER0_CMDC_RESP_TO_IE_0_SHIFT)) & AUDIO_XCVR_EXT_IER0_CMDC_RESP_TO_IE_0_MASK)

#define AUDIO_XCVR_EXT_IER0_ECC_ERR_IE_0_MASK    (0x10U)
#define AUDIO_XCVR_EXT_IER0_ECC_ERR_IE_0_SHIFT   (4U)
/*! ECC_ERR_IE_0 - 60958 Compressed data uncorrectable error interrupt enable */
#define AUDIO_XCVR_EXT_IER0_ECC_ERR_IE_0(x)      (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_IER0_ECC_ERR_IE_0_SHIFT)) & AUDIO_XCVR_EXT_IER0_ECC_ERR_IE_0_MASK)
...
#define AUDIO_XCVR_EXT_IER0_OHPD_IE_0_MASK       (0x100U)
#define AUDIO_XCVR_EXT_IER0_OHPD_IE_0_SHIFT      (8U)
/*! OHPD_IE_0 - Output HPD interrupt enable. */
#define AUDIO_XCVR_EXT_IER0_OHPD_IE_0(x)         (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_IER0_OHPD_IE_0_SHIFT)) & AUDIO_XCVR_EXT_IER0_OHPD_IE_0_MASK)

#define AUDIO_XCVR_EXT_IER0_DMAC_NO_DATA_REC_IE_0_MASK (0x200U)
#define AUDIO_XCVR_EXT_IER0_DMAC_NO_DATA_REC_IE_0_SHIFT (9U)
/*! DMAC_NO_DATA_REC_IE_0 - Indicates no DMAC data is received. */
#define AUDIO_XCVR_EXT_IER0_DMAC_NO_DATA_REC_IE_0(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_IER0_DMAC_NO_DATA_REC_IE_0_SHIFT)) & AUDIO_XCVR_EXT_IER0_DMAC_NO_DATA_REC_IE_0_MASK)

#define AUDIO_XCVR_EXT_IER0_DMAC_FMT_CHG_DET_IE_0_MASK (0x400U)
#define AUDIO_XCVR_EXT_IER0_DMAC_FMT_CHG_DET_IE_0_SHIFT (10U)
/*! DMAC_FMT_CHG_DET_IE_0 - Indicates DMAC format change was detected */
#define AUDIO_XCVR_EXT_IER0_DMAC_FMT_CHG_DET_IE_0(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_IER0_DMAC_FMT_CHG_DET_IE_0_SHIFT)) & AUDIO_XCVR_EXT_IER0_DMAC_FMT_CHG_DET_IE_0_MASK)

#define AUDIO_XCVR_EXT_IER0_HB_STATE_CHG_IE_0_MASK (0x800U)
#define AUDIO_XCVR_EXT_IER0_HB_STATE_CHG_IE_0_SHIFT (11U)
/*! HB_STATE_CHG_IE_0 - Interrupt enable for Heartbeat status change */
#define AUDIO_XCVR_EXT_IER0_HB_STATE_CHG_IE_0(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_IER0_HB_STATE_CHG_IE_0_SHIFT)) & AUDIO_XCVR_EXT_IER0_HB_STATE_CHG_IE_0_MASK)

#define AUDIO_XCVR_EXT_IER0_CMDC_STATUS_UPDATE_IE_0_MASK (0x1000U)
#define AUDIO_XCVR_EXT_IER0_CMDC_STATUS_UPDATE_IE_0_SHIFT (12U)
/*! CMDC_STATUS_UPDATE_IE_0 - Interrupt enable for CMDC status register update. */
#define AUDIO_XCVR_EXT_IER0_CMDC_STATUS_UPDATE_IE_0(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_IER0_CMDC_STATUS_UPDATE_IE_0_SHIFT)) & AUDIO_XCVR_EXT_IER0_CMDC_STATUS_UPDATE_IE_0_MASK)

#define AUDIO_XCVR_EXT_IER0_TEMP_UPDATE_IE_0_MASK (0x2000U)
#define AUDIO_XCVR_EXT_IER0_TEMP_UPDATE_IE_0_SHIFT (13U)
/*! TEMP_UPDATE_IE_0 - Update request for chip temperature value. */
#define AUDIO_XCVR_EXT_IER0_TEMP_UPDATE_IE_0(x)  (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_IER0_TEMP_UPDATE_IE_0_SHIFT)) & AUDIO_XCVR_EXT_IER0_TEMP_UPDATE_IE_0_MASK)
...
#define AUDIO_XCVR_EXT_IER0_DMAC_RX_BME_ERR_IE_0_MASK (0x10000U)
#define AUDIO_XCVR_EXT_IER0_DMAC_RX_BME_ERR_IE_0_SHIFT (16U)
/*! DMAC_RX_BME_ERR_IE_0 - Bi-phase mark encoding error */
#define AUDIO_XCVR_EXT_IER0_DMAC_RX_BME_ERR_IE_0(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_IER0_DMAC_RX_BME_ERR_IE_0_SHIFT)) & AUDIO_XCVR_EXT_IER0_DMAC_RX_BME_ERR_IE_0_MASK)
...
#define AUDIO_XCVR_EXT_IER0_CH_UD_OFLOW_IE_0_MASK (0x400000U)
#define AUDIO_XCVR_EXT_IER0_CH_UD_OFLOW_IE_0_SHIFT (22U)
/*! CH_UD_OFLOW_IE_0 - Channel status or used data could not be stored. */
#define AUDIO_XCVR_EXT_IER0_CH_UD_OFLOW_IE_0(x)  (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_IER0_CH_UD_OFLOW_IE_0_SHIFT)) & AUDIO_XCVR_EXT_IER0_CH_UD_OFLOW_IE_0_MASK)
...
#define AUDIO_XCVR_EXT_IER0_SPARE_IE_0_MASK      (0xFF000000U)
#define AUDIO_XCVR_EXT_IER0_SPARE_IE_0_SHIFT     (24U)
/*! SPARE_IE_0 - Spare interrupts */
#define AUDIO_XCVR_EXT_IER0_SPARE_IE_0(x)        (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_IER0_SPARE_IE_0_SHIFT)) & AUDIO_XCVR_EXT_IER0_SPARE_IE_0_MASK)
/*! @} */
...
#define AUDIO_XCVR_EXT_IER1_NEW_UD_IE_1_MASK     (0x2U)
#define AUDIO_XCVR_EXT_IER1_NEW_UD_IE_1_SHIFT    (1U)
/*! NEW_UD_IE_1 - Enable for new user data received interrupt */
#define AUDIO_XCVR_EXT_IER1_NEW_UD_IE_1(x)       (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_IER1_NEW_UD_IE_1_SHIFT)) & AUDIO_XCVR_EXT_IER1_NEW_UD_IE_1_MASK)
...
#define AUDIO_XCVR_EXT_IER1_CMDC_RESP_TO_IE_1_MASK (0x8U)
#define AUDIO_XCVR_EXT_IER1_CMDC_RESP_TO_IE_1_SHIFT (3U)
/*! CMDC_RESP_TO_IE_1 - Receiver CMDC data response timeout interrupt enable */
#define AUDIO_XCVR_EXT_IER1_CMDC_RESP_TO_IE_1(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_IER1_CMDC_RESP_TO_IE_1_SHIFT)) & AUDIO_XCVR_EXT_IER1_CMDC_RESP_TO_IE_1_MASK)

#define AUDIO_XCVR_EXT_IER1_ECC_ERR_IE_1_MASK    (0x10U)
#define AUDIO_XCVR_EXT_IER1_ECC_ERR_IE_1_SHIFT   (4U)
/*! ECC_ERR_IE_1 - 60958 Compressed data uncorrectable error interrupt enable */
#define AUDIO_XCVR_EXT_IER1_ECC_ERR_IE_1(x)      (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_IER1_ECC_ERR_IE_1_SHIFT)) & AUDIO_XCVR_EXT_IER1_ECC_ERR_IE_1_MASK)
...
#define AUDIO_XCVR_EXT_IER1_OHPD_IE_1_MASK       (0x100U)
#define AUDIO_XCVR_EXT_IER1_OHPD_IE_1_SHIFT      (8U)
/*! OHPD_IE_1 - Output HPD interrupt enable. */
#define AUDIO_XCVR_EXT_IER1_OHPD_IE_1(x)         (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_IER1_OHPD_IE_1_SHIFT)) & AUDIO_XCVR_EXT_IER1_OHPD_IE_1_MASK)

#define AUDIO_XCVR_EXT_IER1_DMAC_NO_DATA_REC_IE_1_MASK (0x200U)
#define AUDIO_XCVR_EXT_IER1_DMAC_NO_DATA_REC_IE_1_SHIFT (9U)
/*! DMAC_NO_DATA_REC_IE_1 - Indicates no DMAC data is received. */
#define AUDIO_XCVR_EXT_IER1_DMAC_NO_DATA_REC_IE_1(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_IER1_DMAC_NO_DATA_REC_IE_1_SHIFT)) & AUDIO_XCVR_EXT_IER1_DMAC_NO_DATA_REC_IE_1_MASK)

#define AUDIO_XCVR_EXT_IER1_DMAC_FMT_CHG_DET_IE_1_MASK (0x400U)
#define AUDIO_XCVR_EXT_IER1_DMAC_FMT_CHG_DET_IE_1_SHIFT (10U)
/*! DMAC_FMT_CHG_DET_IE_1 - Indicates DMAC format change was detected */
#define AUDIO_XCVR_EXT_IER1_DMAC_FMT_CHG_DET_IE_1(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_IER1_DMAC_FMT_CHG_DET_IE_1_SHIFT)) & AUDIO_XCVR_EXT_IER1_DMAC_FMT_CHG_DET_IE_1_MASK)

#define AUDIO_XCVR_EXT_IER1_HB_STATE_CHG_IE_1_MASK (0x800U)
#define AUDIO_XCVR_EXT_IER1_HB_STATE_CHG_IE_1_SHIFT (11U)
/*! HB_STATE_CHG_IE_1 - Interrupt enable for Heartbeat status change */
#define AUDIO_XCVR_EXT_IER1_HB_STATE_CHG_IE_1(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_IER1_HB_STATE_CHG_IE_1_SHIFT)) & AUDIO_XCVR_EXT_IER1_HB_STATE_CHG_IE_1_MASK)

#define AUDIO_XCVR_EXT_IER1_CMDC_STATUS_UPDATE_IE_1_MASK (0x1000U)
#define AUDIO_XCVR_EXT_IER1_CMDC_STATUS_UPDATE_IE_1_SHIFT (12U)
/*! CMDC_STATUS_UPDATE_IE_1 - Interrupt enable for CMDC status register update. */
#define AUDIO_XCVR_EXT_IER1_CMDC_STATUS_UPDATE_IE_1(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_IER1_CMDC_STATUS_UPDATE_IE_1_SHIFT)) & AUDIO_XCVR_EXT_IER1_CMDC_STATUS_UPDATE_IE_1_MASK)

#define AUDIO_XCVR_EXT_IER1_TEMP_UPDATE_IE_1_MASK (0x2000U)
#define AUDIO_XCVR_EXT_IER1_TEMP_UPDATE_IE_1_SHIFT (13U)
/*! TEMP_UPDATE_IE_1 - Update request for chip temperature value. */
#define AUDIO_XCVR_EXT_IER1_TEMP_UPDATE_IE_1(x)  (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_IER1_TEMP_UPDATE_IE_1_SHIFT)) & AUDIO_XCVR_EXT_IER1_TEMP_UPDATE_IE_1_MASK)
...
#define AUDIO_XCVR_EXT_IER1_DMAC_RX_BME_ERR_IE_1_MASK (0x10000U)
#define AUDIO_XCVR_EXT_IER1_DMAC_RX_BME_ERR_IE_1_SHIFT (16U)
/*! DMAC_RX_BME_ERR_IE_1 - Bi-phase mark encoding error */
#define AUDIO_XCVR_EXT_IER1_DMAC_RX_BME_ERR_IE_1(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_IER1_DMAC_RX_BME_ERR_IE_1_SHIFT)) & AUDIO_XCVR_EXT_IER1_DMAC_RX_BME_ERR_IE_1_MASK)
...
#define AUDIO_XCVR_EXT_IER1_CH_UD_OFLOW_IE_1_MASK (0x400000U)
#define AUDIO_XCVR_EXT_IER1_CH_UD_OFLOW_IE_1_SHIFT (22U)
/*! CH_UD_OFLOW_IE_1 - Channel status or used data could not be stored. */
#define AUDIO_XCVR_EXT_IER1_CH_UD_OFLOW_IE_1(x)  (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_IER1_CH_UD_OFLOW_IE_1_SHIFT)) & AUDIO_XCVR_EXT_IER1_CH_UD_OFLOW_IE_1_MASK)
...
#define AUDIO_XCVR_EXT_IER1_SPARE_IE_1_MASK      (0xFF000000U)
#define AUDIO_XCVR_EXT_IER1_SPARE_IE_1_SHIFT     (24U)
/*! SPARE_IE_1 - Spare interrupt enables. */
#define AUDIO_XCVR_EXT_IER1_SPARE_IE_1(x)        (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_IER1_SPARE_IE_1_SHIFT)) & AUDIO_XCVR_EXT_IER1_SPARE_IE_1_MASK)
/*! @} */
...
#define AUDIO_XCVR_EXT_ISR_RX_NEW_USR_DATA_MASK  (0x2U)
#define AUDIO_XCVR_EXT_ISR_RX_NEW_USR_DATA_SHIFT (1U)
/*! RX_NEW_USR_DATA - Received new User data Information */
#define AUDIO_XCVR_EXT_ISR_RX_NEW_USR_DATA(x)    (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_ISR_RX_NEW_USR_DATA_SHIFT)) & AUDIO_XCVR_EXT_ISR_RX_NEW_USR_DATA_MASK)
...
#define AUDIO_XCVR_EXT_ISR_CMDC_RESP_TO_ERR_MASK (0x8U)
#define AUDIO_XCVR_EXT_ISR_CMDC_RESP_TO_ERR_SHIFT (3U)
/*! CMDC_RESP_TO_ERR - CMDC response timeout interrupt */
#define AUDIO_XCVR_EXT_ISR_CMDC_RESP_TO_ERR(x)   (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_ISR_CMDC_RESP_TO_ERR_SHIFT)) & AUDIO_XCVR_EXT_ISR_CMDC_RESP_TO_ERR_MASK)

#define AUDIO_XCVR_EXT_ISR_ECC_ERR_MASK          (0x10U)
#define AUDIO_XCVR_EXT_ISR_ECC_ERR_SHIFT         (4U)
/*! ECC_ERR - 60958 Compressed data uncorrectable error interrupt */
#define AUDIO_XCVR_EXT_ISR_ECC_ERR(x)            (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_ISR_ECC_ERR_SHIFT)) & AUDIO_XCVR_EXT_ISR_ECC_ERR_MASK)
...
#define AUDIO_XCVR_EXT_ISR_OHPD_MASK             (0x100U)
#define AUDIO_XCVR_EXT_ISR_OHPD_SHIFT            (8U)
/*! OHPD - HPD output driver */
#define AUDIO_XCVR_EXT_ISR_OHPD(x)               (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_ISR_OHPD_SHIFT)) & AUDIO_XCVR_EXT_ISR_OHPD_MASK)

#define AUDIO_XCVR_EXT_ISR_DMAC_NO_DATA_REC_MASK (0x200U)
#define AUDIO_XCVR_EXT_ISR_DMAC_NO_DATA_REC_SHIFT (9U)
/*! DMAC_NO_DATA_REC - No DMAC data is received for 1us. */
#define AUDIO_XCVR_EXT_ISR_DMAC_NO_DATA_REC(x)   (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_ISR_DMAC_NO_DATA_REC_SHIFT)) & AUDIO_XCVR_EXT_ISR_DMAC_NO_DATA_REC_MASK)

#define AUDIO_XCVR_EXT_ISR_FMT_CHG_DET_MASK      (0x400U)
#define AUDIO_XCVR_EXT_ISR_FMT_CHG_DET_SHIFT     (10U)
/*! FMT_CHG_DET - Format change detect interrupt */
#define AUDIO_XCVR_EXT_ISR_FMT_CHG_DET(x)        (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_ISR_FMT_CHG_DET_SHIFT)) & AUDIO_XCVR_EXT_ISR_FMT_CHG_DET_MASK)

#define AUDIO_XCVR_EXT_ISR_HB_STATE_CHG_MASK     (0x800U)
#define AUDIO_XCVR_EXT_ISR_HB_STATE_CHG_SHIFT    (11U)
/*! HB_STATE_CHG - Interrupt enable for Heartbeat status change */
#define AUDIO_XCVR_EXT_ISR_HB_STATE_CHG(x)       (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_ISR_HB_STATE_CHG_SHIFT)) & AUDIO_XCVR_EXT_ISR_HB_STATE_CHG_MASK)

#define AUDIO_XCVR_EXT_ISR_CMDC_STATUS_UPDATE_MASK (0x1000U)
#define AUDIO_XCVR_EXT_ISR_CMDC_STATUS_UPDATE_SHIFT (12U)
/*! CMDC_STATUS_UPDATE - Interrupt enable for CMDC status register update. */
#define AUDIO_XCVR_EXT_ISR_CMDC_STATUS_UPDATE(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_ISR_CMDC_STATUS_UPDATE_SHIFT)) & AUDIO_XCVR_EXT_ISR_CMDC_STATUS_UPDATE_MASK)

#define AUDIO_XCVR_EXT_ISR_TEMP_UPDATE_INT_MASK  (0x2000U)
#define AUDIO_XCVR_EXT_ISR_TEMP_UPDATE_INT_SHIFT (13U)
/*! TEMP_UPDATE_INT - Interrupt to get the new temperature value. */
#define AUDIO_XCVR_EXT_ISR_TEMP_UPDATE_INT(x)    (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_ISR_TEMP_UPDATE_INT_SHIFT)) & AUDIO_XCVR_EXT_ISR_TEMP_UPDATE_INT_MASK)
...
#define AUDIO_XCVR_EXT_ISR_SPARE_INT_MASK        (0xFF000000U)
#define AUDIO_XCVR_EXT_ISR_SPARE_INT_SHIFT       (24U)
/*! SPARE_INT - Extra interrupt. Currently not driven. Can be set by M0+ */
#define AUDIO_XCVR_EXT_ISR_SPARE_INT(x)          (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_EXT_ISR_SPARE_INT_SHIFT)) & AUDIO_XCVR_EXT_ISR_SPARE_INT_MASK)
/*! @} */

/*! @name IER - Interrupt enable register for M0++ */
/*! @{ */

#define AUDIO_XCVR_IER_HPD_TGL_IE_MASK           (0x8000U)
#define AUDIO_XCVR_IER_HPD_TGL_IE_SHIFT          (15U)
/*! HPD_TGL_IE - HPD pin level change interrupt enable */
#define AUDIO_XCVR_IER_HPD_TGL_IE(x)             (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_IER_HPD_TGL_IE_SHIFT)) & AUDIO_XCVR_IER_HPD_TGL_IE_MASK)

#define AUDIO_XCVR_IER_FMT_CHG_IE_MASK           (0x40000U)
#define AUDIO_XCVR_IER_FMT_CHG_IE_SHIFT          (18U)
/*! FMT_CHG_IE - Format Change interrupt. */
#define AUDIO_XCVR_IER_FMT_CHG_IE(x)             (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_IER_FMT_CHG_IE_SHIFT)) & AUDIO_XCVR_IER_FMT_CHG_IE_MASK)

#define AUDIO_XCVR_IER_SET_SPDIF_RX_IE_MASK      (0x100000U)
#define AUDIO_XCVR_IER_SET_SPDIF_RX_IE_SHIFT     (20U)
/*! SET_SPDIF_RX_IE - Interrupt enable to set up SPDIF RX mode */
#define AUDIO_XCVR_IER_SET_SPDIF_RX_IE(x)        (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_IER_SET_SPDIF_RX_IE_SHIFT)) & AUDIO_XCVR_IER_SET_SPDIF_RX_IE_MASK)

#define AUDIO_XCVR_IER_SET_SPDIF_TX_IE_MASK      (0x200000U)
#define AUDIO_XCVR_IER_SET_SPDIF_TX_IE_SHIFT     (21U)
/*! SET_SPDIF_TX_IE - Interrupt enable to set up SPDIF TX mode */
#define AUDIO_XCVR_IER_SET_SPDIF_TX_IE(x)        (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_IER_SET_SPDIF_TX_IE_SHIFT)) & AUDIO_XCVR_IER_SET_SPDIF_TX_IE_MASK)

#define AUDIO_XCVR_IER_SW_HPD_TGL_IE_MASK        (0x1000000U)
#define AUDIO_XCVR_IER_SW_HPD_TGL_IE_SHIFT       (24U)
/*! SW_HPD_TGL_IE - Interrupt enable to allow SW to assert HPD. */
#define AUDIO_XCVR_IER_SW_HPD_TGL_IE(x)          (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_IER_SW_HPD_TGL_IE_SHIFT)) & AUDIO_XCVR_IER_SW_HPD_TGL_IE_MASK)
/*! @} */

/*! @name ISR - Interrupt status register */
/*! @{ */

#define AUDIO_XCVR_ISR_HPD_TGL_MASK              (0x8000U)
#define AUDIO_XCVR_ISR_HPD_TGL_SHIFT             (15U)
/*! HPD_TGL - HPD pin level change interrupt */
#define AUDIO_XCVR_ISR_HPD_TGL(x)                (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_ISR_HPD_TGL_SHIFT)) & AUDIO_XCVR_ISR_HPD_TGL_MASK)

#define AUDIO_XCVR_ISR_FMT_CHG_INT_MASK          (0x40000U)
#define AUDIO_XCVR_ISR_FMT_CHG_INT_SHIFT         (18U)
/*! FMT_CHG_INT - Format Change interrupt. */
#define AUDIO_XCVR_ISR_FMT_CHG_INT(x)            (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_ISR_FMT_CHG_INT_SHIFT)) & AUDIO_XCVR_ISR_FMT_CHG_INT_MASK)

#define AUDIO_XCVR_ISR_SET_SPDIF_RX_MODE_MASK    (0x100000U)
#define AUDIO_XCVR_ISR_SET_SPDIF_RX_MODE_SHIFT   (20U)
/*! SET_SPDIF_RX_MODE - Interrupt to set up PHY and controller in SPDIF RX mode. */
#define AUDIO_XCVR_ISR_SET_SPDIF_RX_MODE(x)      (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_ISR_SET_SPDIF_RX_MODE_SHIFT)) & AUDIO_XCVR_ISR_SET_SPDIF_RX_MODE_MASK)
/*! @} */

/*! @name PHY_AI_CTRL - AI interface control register */
/*! @{ */

#define AUDIO_XCVR_PHY_AI_CTRL_AI_ADDR_MASK      (0xFFU)
#define AUDIO_XCVR_PHY_AI_CTRL_AI_ADDR_SHIFT     (0U)
/*! AI_ADDR - AI ADDR value */
#define AUDIO_XCVR_PHY_AI_CTRL_AI_ADDR(x)        (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_PHY_AI_CTRL_AI_ADDR_SHIFT)) & AUDIO_XCVR_PHY_AI_CTRL_AI_ADDR_MASK)

#define AUDIO_XCVR_PHY_AI_CTRL_AI_RESETN_MASK    (0x8000U)
#define AUDIO_XCVR_PHY_AI_CTRL_AI_RESETN_SHIFT   (15U)
/*! AI_RESETN - AI reset bit */
#define AUDIO_XCVR_PHY_AI_CTRL_AI_RESETN(x)      (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_PHY_AI_CTRL_AI_RESETN_SHIFT)) & AUDIO_XCVR_PHY_AI_CTRL_AI_RESETN_MASK)

#define AUDIO_XCVR_PHY_AI_CTRL_TOG_0_MASK        (0x1000000U)
#define AUDIO_XCVR_PHY_AI_CTRL_TOG_0_SHIFT       (24U)
/*! TOG_0 - AI toggle bit */
#define AUDIO_XCVR_PHY_AI_CTRL_TOG_0(x)          (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_PHY_AI_CTRL_TOG_0_SHIFT)) & AUDIO_XCVR_PHY_AI_CTRL_TOG_0_MASK)

#define AUDIO_XCVR_PHY_AI_CTRL_TOG_DONE_0_MASK   (0x2000000U)
#define AUDIO_XCVR_PHY_AI_CTRL_TOG_DONE_0_SHIFT  (25U)
/*! TOG_DONE_0 - AI toggle done bit */
#define AUDIO_XCVR_PHY_AI_CTRL_TOG_DONE_0(x)     (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_PHY_AI_CTRL_TOG_DONE_0_SHIFT)) & AUDIO_XCVR_PHY_AI_CTRL_TOG_DONE_0_MASK)

#define AUDIO_XCVR_PHY_AI_CTRL_TOG_1_MASK        (0x4000000U)
#define AUDIO_XCVR_PHY_AI_CTRL_TOG_1_SHIFT       (26U)
/*! TOG_1 - AI toggle bit */
#define AUDIO_XCVR_PHY_AI_CTRL_TOG_1(x)          (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_PHY_AI_CTRL_TOG_1_SHIFT)) & AUDIO_XCVR_PHY_AI_CTRL_TOG_1_MASK)

#define AUDIO_XCVR_PHY_AI_CTRL_TOG_DONE_1_MASK   (0x8000000U)
#define AUDIO_XCVR_PHY_AI_CTRL_TOG_DONE_1_SHIFT  (27U)
/*! TOG_DONE_1 - AI toggle done bit */
#define AUDIO_XCVR_PHY_AI_CTRL_TOG_DONE_1(x)     (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_PHY_AI_CTRL_TOG_DONE_1_SHIFT)) & AUDIO_XCVR_PHY_AI_CTRL_TOG_DONE_1_MASK)

#define AUDIO_XCVR_PHY_AI_CTRL_AI_RWB_MASK       (0x80000000U)
#define AUDIO_XCVR_PHY_AI_CTRL_AI_RWB_SHIFT      (31U)
/*! AI_RWB - AI Read / write control bit */
#define AUDIO_XCVR_PHY_AI_CTRL_AI_RWB(x)         (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_PHY_AI_CTRL_AI_RWB_SHIFT)) & AUDIO_XCVR_PHY_AI_CTRL_AI_RWB_MASK)
/*! @} */

/*! @name PHY_AI_WDATA - AI interface WDATA register */
/*! @{ */

#define AUDIO_XCVR_PHY_AI_WDATA_WDATA_MASK       (0xFFFFFFFFU)
#define AUDIO_XCVR_PHY_AI_WDATA_WDATA_SHIFT      (0U)
/*! WDATA - Write data */
#define AUDIO_XCVR_PHY_AI_WDATA_WDATA(x)         (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_PHY_AI_WDATA_WDATA_SHIFT)) & AUDIO_XCVR_PHY_AI_WDATA_WDATA_MASK)
/*! @} */

/*! @name PHY_AI_RDATA - AI interface RDATA register */
/*! @{ */

#define AUDIO_XCVR_PHY_AI_RDATA_RDATA_MASK       (0xFFFFFFFFU)
#define AUDIO_XCVR_PHY_AI_RDATA_RDATA_SHIFT      (0U)
/*! RDATA - Read data */
#define AUDIO_XCVR_PHY_AI_RDATA_RDATA(x)         (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_PHY_AI_RDATA_RDATA_SHIFT)) & AUDIO_XCVR_PHY_AI_RDATA_RDATA_MASK)
/*! @} */
...
#define AUDIO_XCVR_RX_CMDC_CTRL_COMMA_BITS_MASK  (0x1FU)
#define AUDIO_XCVR_RX_CMDC_CTRL_COMMA_BITS_SHIFT (0U)
/*! COMMA_BITS - Number of repeating bits in COMMA pattern */
#define AUDIO_XCVR_RX_CMDC_CTRL_COMMA_BITS(x)    (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_RX_CMDC_CTRL_COMMA_BITS_SHIFT)) & AUDIO_XCVR_RX_CMDC_CTRL_COMMA_BITS_MASK)

#define AUDIO_XCVR_RX_CMDC_CTRL_COMMA_EN_MASK    (0x80U)
#define AUDIO_XCVR_RX_CMDC_CTRL_COMMA_EN_SHIFT   (7U)
/*! COMMA_EN - Enables COMMA pattern generation */
#define AUDIO_XCVR_RX_CMDC_CTRL_COMMA_EN(x)      (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_RX_CMDC_CTRL_COMMA_EN_SHIFT)) & AUDIO_XCVR_RX_CMDC_CTRL_COMMA_EN_MASK)

#define AUDIO_XCVR_RX_CMDC_CTRL_RESPONSE_TIME_MASK (0x1F00U)
#define AUDIO_XCVR_RX_CMDC_CTRL_RESPONSE_TIME_SHIFT (8U)
/*! RESPONSE_TIME - Transmitter response timeout to a received message */
#define AUDIO_XCVR_RX_CMDC_CTRL_RESPONSE_TIME(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_RX_CMDC_CTRL_RESPONSE_TIME_SHIFT)) & AUDIO_XCVR_RX_CMDC_CTRL_RESPONSE_TIME_MASK)

#define AUDIO_XCVR_RX_CMDC_CTRL_TURNOVER_TIME_MASK (0xF0000U)
#define AUDIO_XCVR_RX_CMDC_CTRL_TURNOVER_TIME_SHIFT (16U)
/*! TURNOVER_TIME - Minimum time before a response is generated */
#define AUDIO_XCVR_RX_CMDC_CTRL_TURNOVER_TIME(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_RX_CMDC_CTRL_TURNOVER_TIME_SHIFT)) & AUDIO_XCVR_RX_CMDC_CTRL_TURNOVER_TIME_MASK)

#define AUDIO_XCVR_RX_CMDC_CTRL_TX_DRIVE_STOP_MASK (0x700000U)
#define AUDIO_XCVR_RX_CMDC_CTRL_TX_DRIVE_STOP_SHIFT (20U)
/*! TX_DRIVE_STOP - Transmitter bus release time */
#define AUDIO_XCVR_RX_CMDC_CTRL_TX_DRIVE_STOP(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_RX_CMDC_CTRL_TX_DRIVE_STOP_SHIFT)) & AUDIO_XCVR_RX_CMDC_CTRL_TX_DRIVE_STOP_MASK)

#define AUDIO_XCVR_RX_CMDC_CTRL_LBACK_EN_MASK    (0x80000000U)
#define AUDIO_XCVR_RX_CMDC_CTRL_LBACK_EN_SHIFT   (31U)
/*! LBACK_EN - Loopback enable */
#define AUDIO_XCVR_RX_CMDC_CTRL_LBACK_EN(x)      (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_RX_CMDC_CTRL_LBACK_EN_SHIFT)) & AUDIO_XCVR_RX_CMDC_CTRL_LBACK_EN_MASK)
/*! @} */

/*! @name RX_CMDC_STATUS - AUDIO_XCVR CMDC status */
/*! @{ */

#define AUDIO_XCVR_RX_CMDC_STATUS_CMDC_STATE_MASK (0xF0000U)
#define AUDIO_XCVR_RX_CMDC_STATUS_CMDC_STATE_SHIFT (16U)
/*! CMDC_STATE - Current state of the RX CDMC control state machine */
#define AUDIO_XCVR_RX_CMDC_STATUS_CMDC_STATE(x)  (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_RX_CMDC_STATUS_CMDC_STATE_SHIFT)) & AUDIO_XCVR_RX_CMDC_STATUS_CMDC_STATE_MASK)
/*! @} */

/*! @name RX_CMDC_TX_DATA - CMDC transmit data register */
/*! @{ */

#define AUDIO_XCVR_RX_CMDC_TX_DATA_TX_DATA_MASK  (0x3FFFFFFU)
#define AUDIO_XCVR_RX_CMDC_TX_DATA_TX_DATA_SHIFT (0U)
/*! TX_DATA - Transmit data */
#define AUDIO_XCVR_RX_CMDC_TX_DATA_TX_DATA(x)    (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_RX_CMDC_TX_DATA_TX_DATA_SHIFT)) & AUDIO_XCVR_RX_CMDC_TX_DATA_TX_DATA_MASK)

#define AUDIO_XCVR_RX_CMDC_TX_DATA_DATA_VALID_MASK (0x80000000U)
#define AUDIO_XCVR_RX_CMDC_TX_DATA_DATA_VALID_SHIFT (31U)
/*! DATA_VALID - Transmit Data Valid */
#define AUDIO_XCVR_RX_CMDC_TX_DATA_DATA_VALID(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_RX_CMDC_TX_DATA_DATA_VALID_SHIFT)) & AUDIO_XCVR_RX_CMDC_TX_DATA_DATA_VALID_MASK)
/*! @} */

/*! @name RX_CMDC_RX_DATA - CMDC receive data register */
/*! @{ */

#define AUDIO_XCVR_RX_CMDC_RX_DATA_RX_DATA_MASK  (0x3FFFFFFU)
#define AUDIO_XCVR_RX_CMDC_RX_DATA_RX_DATA_SHIFT (0U)
/*! RX_DATA - Receive data */
#define AUDIO_XCVR_RX_CMDC_RX_DATA_RX_DATA(x)    (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_RX_CMDC_RX_DATA_RX_DATA_SHIFT)) & AUDIO_XCVR_RX_CMDC_RX_DATA_RX_DATA_MASK)

#define AUDIO_XCVR_RX_CMDC_RX_DATA_CLR_RX_DATA_MASK (0x80000000U)
#define AUDIO_XCVR_RX_CMDC_RX_DATA_CLR_RX_DATA_SHIFT (31U)
/*! CLR_RX_DATA - Clear RX data field and */
#define AUDIO_XCVR_RX_CMDC_RX_DATA_CLR_RX_DATA(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_RX_CMDC_RX_DATA_CLR_RX_DATA_SHIFT)) & AUDIO_XCVR_RX_CMDC_RX_DATA_CLR_RX_DATA_MASK)
/*! @} */
...
#define AUDIO_XCVR_RX_DATAPATH_CTRL_ECC_VUC_BITS_EN_MASK (0x8U)
#define AUDIO_XCVR_RX_DATAPATH_CTRL_ECC_VUC_BITS_EN_SHIFT (3U)
/*! ECC_VUC_BITS_EN - RX_DATAPATH: Enable VUC bit replacement after ECC correction. */
#define AUDIO_XCVR_RX_DATAPATH_CTRL_ECC_VUC_BITS_EN(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_RX_DATAPATH_CTRL_ECC_VUC_BITS_EN_SHIFT)) & AUDIO_XCVR_RX_DATAPATH_CTRL_ECC_VUC_BITS_EN_MASK)

#define AUDIO_XCVR_RX_DATAPATH_CTRL_EN_COMP_PARITY_CALC_MASK (0x10U)
#define AUDIO_XCVR_RX_DATAPATH_CTRL_EN_COMP_PARITY_CALC_SHIFT (4U)
/*! EN_COMP_PARITY_CALC - RX_DATAPATH: Enable Compressed mode Parity calculation. */
#define AUDIO_XCVR_RX_DATAPATH_CTRL_EN_COMP_PARITY_CALC(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_RX_DATAPATH_CTRL_EN_COMP_PARITY_CALC_SHIFT)) & AUDIO_XCVR_RX_DATAPATH_CTRL_EN_COMP_PARITY_CALC_MASK)
...
#define AUDIO_XCVR_RX_DATAPATH_CTRL_DIS_B_PRE_ERR_CHK_MASK (0x2000U)
#define AUDIO_XCVR_RX_DATAPATH_CTRL_DIS_B_PRE_ERR_CHK_SHIFT (13U)
/*! DIS_B_PRE_ERR_CHK - RX_DATAPATH: Disable B preamble error check. */
#define AUDIO_XCVR_RX_DATAPATH_CTRL_DIS_B_PRE_ERR_CHK(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_RX_DATAPATH_CTRL_DIS_B_PRE_ERR_CHK_SHIFT)) & AUDIO_XCVR_RX_DATAPATH_CTRL_DIS_B_PRE_ERR_CHK_MASK)
...
#define AUDIO_XCVR_RX_DATAPATH_CTRL_BLKC_MASK    (0x200000U)
#define AUDIO_XCVR_RX_DATAPATH_CTRL_BLKC_SHIFT   (21U)
/*! BLKC - Block Compressed data */
#define AUDIO_XCVR_RX_DATAPATH_CTRL_BLKC(x)      (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_RX_DATAPATH_CTRL_BLKC_SHIFT)) & AUDIO_XCVR_RX_DATAPATH_CTRL_BLKC_MASK)
...
#define AUDIO_XCVR_RX_DATAPATH_CTRL_FMT_CHG_CTRL_MASK (0x1000000U)
#define AUDIO_XCVR_RX_DATAPATH_CTRL_FMT_CHG_CTRL_SHIFT (24U)
/*! FMT_CHG_CTRL - Format Change detection control. */
#define AUDIO_XCVR_RX_DATAPATH_CTRL_FMT_CHG_CTRL(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_RX_DATAPATH_CTRL_FMT_CHG_CTRL_SHIFT)) & AUDIO_XCVR_RX_DATAPATH_CTRL_FMT_CHG_CTRL_MASK)

#define AUDIO_XCVR_RX_DATAPATH_CTRL_FMT_CHG_MODE_MASK (0x2000000U)
#define AUDIO_XCVR_RX_DATAPATH_CTRL_FMT_CHG_MODE_SHIFT (25U)
/*! FMT_CHG_MODE - Format change detected. Reset HW for next frame */
#define AUDIO_XCVR_RX_DATAPATH_CTRL_FMT_CHG_MODE(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_RX_DATAPATH_CTRL_FMT_CHG_MODE_SHIFT)) & AUDIO_XCVR_RX_DATAPATH_CTRL_FMT_CHG_MODE_MASK)

#define AUDIO_XCVR_RX_DATAPATH_CTRL_LAYB_CTRL_MASK (0x4000000U)
#define AUDIO_XCVR_RX_DATAPATH_CTRL_LAYB_CTRL_SHIFT (26U)
/*! LAYB_CTRL - Layout B mode control */
#define AUDIO_XCVR_RX_DATAPATH_CTRL_LAYB_CTRL(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_RX_DATAPATH_CTRL_LAYB_CTRL_SHIFT)) & AUDIO_XCVR_RX_DATAPATH_CTRL_LAYB_CTRL_MASK)

#define AUDIO_XCVR_RX_DATAPATH_CTRL_LAYB_MODE_MASK (0x8000000U)
#define AUDIO_XCVR_RX_DATAPATH_CTRL_LAYB_MODE_SHIFT (27U)
/*! LAYB_MODE - Layout B */
#define AUDIO_XCVR_RX_DATAPATH_CTRL_LAYB_MODE(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_RX_DATAPATH_CTRL_LAYB_MODE_SHIFT)) & AUDIO_XCVR_RX_DATAPATH_CTRL_LAYB_MODE_MASK)

#define AUDIO_XCVR_RX_DATAPATH_CTRL_PRC_MASK     (0x10000000U)
#define AUDIO_XCVR_RX_DATAPATH_CTRL_PRC_SHIFT    (28U)
/*! PRC - Process Compressed */
#define AUDIO_XCVR_RX_DATAPATH_CTRL_PRC(x)       (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_RX_DATAPATH_CTRL_PRC_SHIFT)) & AUDIO_XCVR_RX_DATAPATH_CTRL_PRC_MASK)

#define AUDIO_XCVR_RX_DATAPATH_CTRL_COMP_MASK    (0x20000000U)
#define AUDIO_XCVR_RX_DATAPATH_CTRL_COMP_SHIFT   (29U)
/*! COMP - Compressed data search mode */
#define AUDIO_XCVR_RX_DATAPATH_CTRL_COMP(x)      (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_RX_DATAPATH_CTRL_COMP_SHIFT)) & AUDIO_XCVR_RX_DATAPATH_CTRL_COMP_MASK)
...
#define AUDIO_XCVR_DMAC_PRE_MATCH_VAL_PB_VAL_MASK (0xFFFFU)
#define AUDIO_XCVR_DMAC_PRE_MATCH_VAL_PB_VAL_SHIFT (0U)
/*! PB_VAL - Preamble PB value */
#define AUDIO_XCVR_DMAC_PRE_MATCH_VAL_PB_VAL(x)  (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_DMAC_PRE_MATCH_VAL_PB_VAL_SHIFT)) & AUDIO_XCVR_DMAC_PRE_MATCH_VAL_PB_VAL_MASK)

#define AUDIO_XCVR_DMAC_PRE_MATCH_VAL_PA_VAL_MASK (0xFFFF0000U)
#define AUDIO_XCVR_DMAC_PRE_MATCH_VAL_PA_VAL_SHIFT (16U)
/*! PA_VAL - Preamble PA value */
#define AUDIO_XCVR_DMAC_PRE_MATCH_VAL_PA_VAL(x)  (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_DMAC_PRE_MATCH_VAL_PA_VAL_SHIFT)) & AUDIO_XCVR_DMAC_PRE_MATCH_VAL_PA_VAL_MASK)
/*! @} */

/*! @name DMAC_DTS_PRE_MATCH_VAL - Preamble match value register */
/*! @{ */

#define AUDIO_XCVR_DMAC_DTS_PRE_MATCH_VAL_DTS_PB_VAL_MASK (0xFFFFU)
#define AUDIO_XCVR_DMAC_DTS_PRE_MATCH_VAL_DTS_PB_VAL_SHIFT (0U)
/*! DTS_PB_VAL - Preamble PB value */
#define AUDIO_XCVR_DMAC_DTS_PRE_MATCH_VAL_DTS_PB_VAL(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_DMAC_DTS_PRE_MATCH_VAL_DTS_PB_VAL_SHIFT)) & AUDIO_XCVR_DMAC_DTS_PRE_MATCH_VAL_DTS_PB_VAL_MASK)

#define AUDIO_XCVR_DMAC_DTS_PRE_MATCH_VAL_DTS_PA_VAL_MASK (0xFFFF0000U)
#define AUDIO_XCVR_DMAC_DTS_PRE_MATCH_VAL_DTS_PA_VAL_SHIFT (16U)
/*! DTS_PA_VAL - Preamble PA value */
#define AUDIO_XCVR_DMAC_DTS_PRE_MATCH_VAL_DTS_PA_VAL(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_DMAC_DTS_PRE_MATCH_VAL_DTS_PA_VAL_SHIFT)) & AUDIO_XCVR_DMAC_DTS_PRE_MATCH_VAL_DTS_PA_VAL_MASK)
/*! @} */
...
#define AUDIO_XCVR_RX_DPATH_ONE_BIT_ERR_CNT_VAL_MASK (0xFFFFU)
#define AUDIO_XCVR_RX_DPATH_ONE_BIT_ERR_CNT_VAL_SHIFT (0U)
#define AUDIO_XCVR_RX_DPATH_ONE_BIT_ERR_CNT_VAL(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_RX_DPATH_ONE_BIT_ERR_CNT_VAL_SHIFT)) & AUDIO_XCVR_RX_DPATH_ONE_BIT_ERR_CNT_VAL_MASK)
/*! @} */

/*! @name DMAC_PRE_MATCH_OFFSET - Preamble match offset value register */
/*! @{ */

#define AUDIO_XCVR_DMAC_PRE_MATCH_OFFSET_PA_OFFSET_MASK (0xFFFFFFFFU)
#define AUDIO_XCVR_DMAC_PRE_MATCH_OFFSET_PA_OFFSET_SHIFT (0U)
/*! PA_OFFSET - Sample count value for PA offset match */
#define AUDIO_XCVR_DMAC_PRE_MATCH_OFFSET_PA_OFFSET(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_DMAC_PRE_MATCH_OFFSET_PA_OFFSET_SHIFT)) & AUDIO_XCVR_DMAC_PRE_MATCH_OFFSET_PA_OFFSET_MASK)
/*! @} */
...
#define AUDIO_XCVR_TX_DATAPATH_CTRL_BYPASS_FEM_MASK (0x400U)
#define AUDIO_XCVR_TX_DATAPATH_CTRL_BYPASS_FEM_SHIFT (10U)
/*! BYPASS_FEM - Control the TX clock rate */
#define AUDIO_XCVR_TX_DATAPATH_CTRL_BYPASS_FEM(x) (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_TX_DATAPATH_CTRL_BYPASS_FEM_SHIFT)) & AUDIO_XCVR_TX_DATAPATH_CTRL_BYPASS_FEM_MASK)
...
#define AUDIO_XCVR_HPD_DBNC_CTRL_VAL_MASK        (0xFFFFFFFFU)
#define AUDIO_XCVR_HPD_DBNC_CTRL_VAL_SHIFT       (0U)
/*! VAL - HDP pin debounce interval */
#define AUDIO_XCVR_HPD_DBNC_CTRL_VAL(x)          (((uint32_t)(((uint32_t)(x)) << AUDIO_XCVR_HPD_DBNC_CTRL_VAL_SHIFT)) & AUDIO_XCVR_HPD_DBNC_CTRL_VAL_MASK)
/*! @} */
