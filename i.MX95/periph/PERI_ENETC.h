...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for ENETC
**
 ...
 * @version 1.0
 * @date 2023-01-10
 * @brief CMSIS Peripheral Access Layer for ENETC
 *
 * CMSIS Peripheral Access Layer for ENETC
 */

#if !defined(PERI_ENETC_H_)
#define PERI_ENETC_H_                            /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- ENETC Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup ENETC_Peripheral_Access_Layer ENETC Peripheral Access Layer
 * @{
 */

/** ENETC - Size of Registers Arrays */
#define ENETC_PCE_SL_COUNT                        1u
#define ENETC_HTA_LOOP_COUNT                      1u
#define ENETC_ARRAY_NUM_RC_COUNT                  1u
#define ENETC_G_BOOT_COUNT                        2u

/** ENETC - Register Layout Typedef */
typedef struct {
  ...
  } ARRAY_NUM_RC[ENETC_ARRAY_NUM_RC_COUNT];
  ...
  __I  uint32_t FBLPR[ENETC_G_BOOT_COUNT];         /**< Function boot loader parameter register 0..Function boot loader parameter register 1, array offset: 0xD00, array step: 0x4 */
} ENETC_Type;

/* ----------------------------------------------------------------------------
   -- ENETC Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup ENETC_Register_Masks ENETC Register Masks
 * @{
 */
...
#define ENETC_SMDTR_THRESH_MASK                  (0xFFFFFFU)
#define ENETC_SMDTR_THRESH_SHIFT                 (0U)
/*! THRESH - Shared memory depletion threshold in Words */
#define ENETC_SMDTR_THRESH(x)                    (((uint32_t)(((uint32_t)(x)) << ENETC_SMDTR_THRESH_SHIFT)) & ENETC_SMDTR_THRESH_MASK)
/*! @} */

/*! @name SMACR - Shared memory available count register */
/*! @{ */

#define ENETC_SMACR_COUNT_MASK                   (0xFFFFFFU)
#define ENETC_SMACR_COUNT_SHIFT                  (0U)
#define ENETC_SMACR_COUNT(x)                     (((uint32_t)(((uint32_t)(x)) << ENETC_SMACR_COUNT_SHIFT)) & ENETC_SMACR_COUNT_MASK)
/*! @} */

/*! @name SMCLWMR - Shared memory count low watermark register */
/*! @{ */

#define ENETC_SMCLWMR_WATERMARK_MASK             (0xFFFFFFU)
#define ENETC_SMCLWMR_WATERMARK_SHIFT            (0U)
/*! WATERMARK - Watermark for shared memory in words */
#define ENETC_SMCLWMR_WATERMARK(x)               (((uint32_t)(((uint32_t)(x)) << ENETC_SMCLWMR_WATERMARK_SHIFT)) & ENETC_SMCLWMR_WATERMARK_MASK)
/*! @} */

/*! @name SMBUCR - Shared memory buffer unassigned count register */
/*! @{ */

#define ENETC_SMBUCR_COUNT_MASK                  (0xFFFFFFU)
#define ENETC_SMBUCR_COUNT_SHIFT                 (0U)
/*! COUNT - Shows the current amount of unassigned shared memory buffer in words */
#define ENETC_SMBUCR_COUNT(x)                    (((uint32_t)(((uint32_t)(x)) << ENETC_SMBUCR_COUNT_SHIFT)) & ENETC_SMBUCR_COUNT_MASK)
/*! @} */

/*! @name SMBUCHWMR - Shared memory buffer unassigned count high watermark register */
/*! @{ */

#define ENETC_SMBUCHWMR_WATERMARK_MASK           (0xFFFFFFU)
#define ENETC_SMBUCHWMR_WATERMARK_SHIFT          (0U)
/*! WATERMARK - Shows the high watermark for unassigned memory */
#define ENETC_SMBUCHWMR_WATERMARK(x)             (((uint32_t)(((uint32_t)(x)) << ENETC_SMBUCHWMR_WATERMARK_SHIFT)) & ENETC_SMBUCHWMR_WATERMARK_MASK)
/*! @} */

/*! @name SMLCR - Shared memory loss count register */
/*! @{ */

#define ENETC_SMLCR_COUNT_MASK                   (0xFFFFFFU)
#define ENETC_SMLCR_COUNT_SHIFT                  (0U)
/*! COUNT - Determinate number of lost words */
#define ENETC_SMLCR_COUNT(x)                     (((uint32_t)(((uint32_t)(x)) << ENETC_SMLCR_COUNT_SHIFT)) & ENETC_SMLCR_COUNT_MASK)

#define ENETC_SMLCR_IFLC_MASK                    (0x40000000U)
#define ENETC_SMLCR_IFLC_SHIFT                   (30U)
/*! IFLC - Indeterminate free list corruption */
#define ENETC_SMLCR_IFLC(x)                      (((uint32_t)(((uint32_t)(x)) << ENETC_SMLCR_IFLC_SHIFT)) & ENETC_SMLCR_IFLC_MASK)

#define ENETC_SMLCR_IFDC_MASK                    (0x80000000U)
#define ENETC_SMLCR_IFDC_SHIFT                   (31U)
/*! IFDC - Indeterminate frame descriptor corruption */
#define ENETC_SMLCR_IFDC(x)                      (((uint32_t)(((uint32_t)(x)) << ENETC_SMLCR_IFDC_SHIFT)) & ENETC_SMLCR_IFDC_MASK)
/*! @} */

/*! @name HBTCAPR - Hash bucket table capability register */
/*! @{ */

#define ENETC_HBTCAPR_NUM_ENTRIES_MASK           (0xFFFFU)
#define ENETC_HBTCAPR_NUM_ENTRIES_SHIFT          (0U)
/*! NUM_ENTRIES - Number of allocated bucket entries */
#define ENETC_HBTCAPR_NUM_ENTRIES(x)             (((uint32_t)(((uint32_t)(x)) << ENETC_HBTCAPR_NUM_ENTRIES_SHIFT)) & ENETC_HBTCAPR_NUM_ENTRIES_MASK)

#define ENETC_HBTCAPR_MAX_COL_MASK               (0x7000000U)
#define ENETC_HBTCAPR_MAX_COL_SHIFT              (24U)
/*! MAX_COL - Maximum hash table collision chain length */
#define ENETC_HBTCAPR_MAX_COL(x)                 (((uint32_t)(((uint32_t)(x)) << ENETC_HBTCAPR_MAX_COL_SHIFT)) & ENETC_HBTCAPR_MAX_COL_MASK)

#define ENETC_HBTCAPR_MAX_VISITS_MASK            (0xF0000000U)
#define ENETC_HBTCAPR_MAX_VISITS_SHIFT           (28U)
/*! MAX_VISITS - Maximum number of table entry visits */
#define ENETC_HBTCAPR_MAX_VISITS(x)              (((uint32_t)(((uint32_t)(x)) << ENETC_HBTCAPR_MAX_VISITS_SHIFT)) & ENETC_HBTCAPR_MAX_VISITS_MASK)
/*! @} */

/*! @name HBTOR0 - Hash bucket table operational register 0 */
/*! @{ */

#define ENETC_HBTOR0_NUM_ENTRIES_MASK            (0xFFFFU)
#define ENETC_HBTOR0_NUM_ENTRIES_SHIFT           (0U)
#define ENETC_HBTOR0_NUM_ENTRIES(x)              (((uint32_t)(((uint32_t)(x)) << ENETC_HBTOR0_NUM_ENTRIES_SHIFT)) & ENETC_HBTOR0_NUM_ENTRIES_MASK)

#define ENETC_HBTOR0_HWM_ENTRIES_MASK            (0xFFFF0000U)
#define ENETC_HBTOR0_HWM_ENTRIES_SHIFT           (16U)
#define ENETC_HBTOR0_HWM_ENTRIES(x)              (((uint32_t)(((uint32_t)(x)) << ENETC_HBTOR0_HWM_ENTRIES_SHIFT)) & ENETC_HBTOR0_HWM_ENTRIES_MASK)
/*! @} */

/*! @name HBTOR2 - Hash bucket table operational register 2 */
/*! @{ */

#define ENETC_HBTOR2_RUN_AVG_FRACT_MASK          (0xFFU)
#define ENETC_HBTOR2_RUN_AVG_FRACT_SHIFT         (0U)
/*! RUN_AVG_FRACT - Fractional portion of the running average length of hash lookup */
#define ENETC_HBTOR2_RUN_AVG_FRACT(x)            (((uint32_t)(((uint32_t)(x)) << ENETC_HBTOR2_RUN_AVG_FRACT_SHIFT)) & ENETC_HBTOR2_RUN_AVG_FRACT_MASK)

#define ENETC_HBTOR2_RUN_AVG_INT_MASK            (0xFF00U)
#define ENETC_HBTOR2_RUN_AVG_INT_SHIFT           (8U)
/*! RUN_AVG_INT - Integer portion of the running average length of hash lookup */
#define ENETC_HBTOR2_RUN_AVG_INT(x)              (((uint32_t)(((uint32_t)(x)) << ENETC_HBTOR2_RUN_AVG_INT_SHIFT)) & ENETC_HBTOR2_RUN_AVG_INT_MASK)

#define ENETC_HBTOR2_HWM_COL_MASK                (0xF0000U)
#define ENETC_HBTOR2_HWM_COL_SHIFT               (16U)
#define ENETC_HBTOR2_HWM_COL(x)                  (((uint32_t)(((uint32_t)(x)) << ENETC_HBTOR2_HWM_COL_SHIFT)) & ENETC_HBTOR2_HWM_COL_MASK)
/*! @} */

/*! @name SMERBCAPR - Shared memory ENETC receive buffer capability register */
/*! @{ */

#define ENETC_SMERBCAPR_THRESH_MASK              (0xFFFFFFU)
#define ENETC_SMERBCAPR_THRESH_SHIFT             (0U)
/*! THRESH - Receive buffer memory threshold */
#define ENETC_SMERBCAPR_THRESH(x)                (((uint32_t)(((uint32_t)(x)) << ENETC_SMERBCAPR_THRESH_SHIFT)) & ENETC_SMERBCAPR_THRESH_MASK)

#define ENETC_SMERBCAPR_WORD_SIZE_MASK           (0x30000000U)
#define ENETC_SMERBCAPR_WORD_SIZE_SHIFT          (28U)
/*! WORD_SIZE - Word Size */
#define ENETC_SMERBCAPR_WORD_SIZE(x)             (((uint32_t)(((uint32_t)(x)) << ENETC_SMERBCAPR_WORD_SIZE_SHIFT)) & ENETC_SMERBCAPR_WORD_SIZE_MASK)

#define ENETC_SMERBCAPR_MLOC_MASK                (0xC0000000U)
#define ENETC_SMERBCAPR_MLOC_SHIFT               (30U)
/*! MLOC - Memory Location */
#define ENETC_SMERBCAPR_MLOC(x)                  (((uint32_t)(((uint32_t)(x)) << ENETC_SMERBCAPR_MLOC_SHIFT)) & ENETC_SMERBCAPR_MLOC_MASK)
/*! @} */

/*! @name SMERBOR0 - Shared memory ENETC receive buffer operational register 0 */
/*! @{ */

#define ENETC_SMERBOR0_AMOUNT_MASK               (0xFFFFFFU)
#define ENETC_SMERBOR0_AMOUNT_SHIFT              (0U)
#define ENETC_SMERBOR0_AMOUNT(x)                 (((uint32_t)(((uint32_t)(x)) << ENETC_SMERBOR0_AMOUNT_SHIFT)) & ENETC_SMERBOR0_AMOUNT_MASK)
/*! @} */

/*! @name SMERBOR1 - Shared memory ENETC receive buffer operational 1 */
/*! @{ */

#define ENETC_SMERBOR1_WATERMARK_MASK            (0xFFFFFFU)
#define ENETC_SMERBOR1_WATERMARK_SHIFT           (0U)
/*! WATERMARK - High Watermark */
#define ENETC_SMERBOR1_WATERMARK(x)              (((uint32_t)(((uint32_t)(x)) << ENETC_SMERBOR1_WATERMARK_SHIFT)) & ENETC_SMERBOR1_WATERMARK_MASK)
/*! @} */

/*! @name PCEOR - PCE 0 operational register */
/*! @{ */

#define ENETC_PCEOR_NUM_FRAMES_MASK              (0x7FU)
#define ENETC_PCEOR_NUM_FRAMES_SHIFT             (0U)
#define ENETC_PCEOR_NUM_FRAMES(x)                (((uint32_t)(((uint32_t)(x)) << ENETC_PCEOR_NUM_FRAMES_SHIFT)) & ENETC_PCEOR_NUM_FRAMES_MASK)

#define ENETC_PCEOR_HWM_FRAMES_MASK              (0x7F00U)
#define ENETC_PCEOR_HWM_FRAMES_SHIFT             (8U)
#define ENETC_PCEOR_HWM_FRAMES(x)                (((uint32_t)(((uint32_t)(x)) << ENETC_PCEOR_HWM_FRAMES_SHIFT)) & ENETC_PCEOR_HWM_FRAMES_MASK)

#define ENETC_PCEOR_MAX_FRAMES_MASK              (0x7F0000U)
#define ENETC_PCEOR_MAX_FRAMES_SHIFT             (16U)
/*! MAX_FRAMES - Maximum number of concurrent frames that can be processed by the PCE block */
#define ENETC_PCEOR_MAX_FRAMES(x)                (((uint32_t)(((uint32_t)(x)) << ENETC_PCEOR_MAX_FRAMES_SHIFT)) & ENETC_PCEOR_MAX_FRAMES_MASK)
/*! @} */

/* The count of ENETC_PCEOR */
#define ENETC_PCEOR_COUNT                        (1U)

/*! @name RFEOR - Replication Forwarding Engine 0 operational register */
/*! @{ */

#define ENETC_RFEOR_NUM_FRAMES_MASK              (0x3FU)
#define ENETC_RFEOR_NUM_FRAMES_SHIFT             (0U)
#define ENETC_RFEOR_NUM_FRAMES(x)                (((uint32_t)(((uint32_t)(x)) << ENETC_RFEOR_NUM_FRAMES_SHIFT)) & ENETC_RFEOR_NUM_FRAMES_MASK)

#define ENETC_RFEOR_HWM_FRAMES_MASK              (0x3F00U)
#define ENETC_RFEOR_HWM_FRAMES_SHIFT             (8U)
#define ENETC_RFEOR_HWM_FRAMES(x)                (((uint32_t)(((uint32_t)(x)) << ENETC_RFEOR_HWM_FRAMES_SHIFT)) & ENETC_RFEOR_HWM_FRAMES_MASK)

#define ENETC_RFEOR_MAX_FRAMES_MASK              (0x3F0000U)
#define ENETC_RFEOR_MAX_FRAMES_SHIFT             (16U)
/*! MAX_FRAMES - Maximum number of concurrent frames that can be processed by the RFE block. */
#define ENETC_RFEOR_MAX_FRAMES(x)                (((uint32_t)(((uint32_t)(x)) << ENETC_RFEOR_MAX_FRAMES_SHIFT)) & ENETC_RFEOR_MAX_FRAMES_MASK)
/*! @} */

/* The count of ENETC_RFEOR */
#define ENETC_RFEOR_COUNT                        (1U)

/*! @name NETCCLKR - NETC clock register */
/*! @{ */

#define ENETC_NETCCLKR_FREQ_MASK                 (0x7FFU)
#define ENETC_NETCCLKR_FREQ_SHIFT                (0U)
/*! FREQ - Frequency */
#define ENETC_NETCCLKR_FREQ(x)                   (((uint32_t)(((uint32_t)(x)) << ENETC_NETCCLKR_FREQ_SHIFT)) & ENETC_NETCCLKR_FREQ_MASK)
/*! @} */

/*! @name HTACAPR - HTA 0 capability register */
/*! @{ */

#define ENETC_HTACAPR_MAX_RX_FRAMES_MASK         (0xFFU)
#define ENETC_HTACAPR_MAX_RX_FRAMES_SHIFT        (0U)
#define ENETC_HTACAPR_MAX_RX_FRAMES(x)           (((uint32_t)(((uint32_t)(x)) << ENETC_HTACAPR_MAX_RX_FRAMES_SHIFT)) & ENETC_HTACAPR_MAX_RX_FRAMES_MASK)

#define ENETC_HTACAPR_MAX_TX_FRAMES_MASK         (0xFF00U)
#define ENETC_HTACAPR_MAX_TX_FRAMES_SHIFT        (8U)
#define ENETC_HTACAPR_MAX_TX_FRAMES(x)           (((uint32_t)(((uint32_t)(x)) << ENETC_HTACAPR_MAX_TX_FRAMES_SHIFT)) & ENETC_HTACAPR_MAX_TX_FRAMES_MASK)
/*! @} */

/* The count of ENETC_HTACAPR */
#define ENETC_HTACAPR_COUNT                      (1U)

/*! @name HTARFCOR - HTA 0 receive frame count operational register */
/*! @{ */

#define ENETC_HTARFCOR_HP_COUNT_MASK             (0xFFU)
#define ENETC_HTARFCOR_HP_COUNT_SHIFT            (0U)
#define ENETC_HTARFCOR_HP_COUNT(x)               (((uint32_t)(((uint32_t)(x)) << ENETC_HTARFCOR_HP_COUNT_SHIFT)) & ENETC_HTARFCOR_HP_COUNT_MASK)

#define ENETC_HTARFCOR_HP_HWM_MASK               (0xFF00U)
#define ENETC_HTARFCOR_HP_HWM_SHIFT              (8U)
#define ENETC_HTARFCOR_HP_HWM(x)                 (((uint32_t)(((uint32_t)(x)) << ENETC_HTARFCOR_HP_HWM_SHIFT)) & ENETC_HTARFCOR_HP_HWM_MASK)

#define ENETC_HTARFCOR_LP_COUNT_MASK             (0xFF0000U)
#define ENETC_HTARFCOR_LP_COUNT_SHIFT            (16U)
#define ENETC_HTARFCOR_LP_COUNT(x)               (((uint32_t)(((uint32_t)(x)) << ENETC_HTARFCOR_LP_COUNT_SHIFT)) & ENETC_HTARFCOR_LP_COUNT_MASK)

#define ENETC_HTARFCOR_LP_HWM_MASK               (0xFF000000U)
#define ENETC_HTARFCOR_LP_HWM_SHIFT              (24U)
#define ENETC_HTARFCOR_LP_HWM(x)                 (((uint32_t)(((uint32_t)(x)) << ENETC_HTARFCOR_LP_HWM_SHIFT)) & ENETC_HTARFCOR_LP_HWM_MASK)
/*! @} */

/* The count of ENETC_HTARFCOR */
#define ENETC_HTARFCOR_COUNT                     (1U)

/*! @name HTAHPBCOR - HTA 0 high priority byte count operational register */
/*! @{ */

#define ENETC_HTAHPBCOR_HP_COUNT_MASK            (0xFFFFU)
#define ENETC_HTAHPBCOR_HP_COUNT_SHIFT           (0U)
#define ENETC_HTAHPBCOR_HP_COUNT(x)              (((uint32_t)(((uint32_t)(x)) << ENETC_HTAHPBCOR_HP_COUNT_SHIFT)) & ENETC_HTAHPBCOR_HP_COUNT_MASK)

#define ENETC_HTAHPBCOR_HWM_MASK                 (0xFFFF0000U)
#define ENETC_HTAHPBCOR_HWM_SHIFT                (16U)
#define ENETC_HTAHPBCOR_HWM(x)                   (((uint32_t)(((uint32_t)(x)) << ENETC_HTAHPBCOR_HWM_SHIFT)) & ENETC_HTAHPBCOR_HWM_MASK)
/*! @} */

/* The count of ENETC_HTAHPBCOR */
#define ENETC_HTAHPBCOR_COUNT                    (1U)

/*! @name HTALPBCOR - HTA 0 low priority byte count operational register */
/*! @{ */

#define ENETC_HTALPBCOR_LP_COUNT_MASK            (0xFFFFU)
#define ENETC_HTALPBCOR_LP_COUNT_SHIFT           (0U)
#define ENETC_HTALPBCOR_LP_COUNT(x)              (((uint32_t)(((uint32_t)(x)) << ENETC_HTALPBCOR_LP_COUNT_SHIFT)) & ENETC_HTALPBCOR_LP_COUNT_MASK)

#define ENETC_HTALPBCOR_HWM_MASK                 (0xFFFF0000U)
#define ENETC_HTALPBCOR_HWM_SHIFT                (16U)
#define ENETC_HTALPBCOR_HWM(x)                   (((uint32_t)(((uint32_t)(x)) << ENETC_HTALPBCOR_HWM_SHIFT)) & ENETC_HTALPBCOR_HWM_MASK)
/*! @} */

/* The count of ENETC_HTALPBCOR */
#define ENETC_HTALPBCOR_COUNT                    (1U)

/*! @name HTATFCOR - HTA 0 transmit frame count operational register */
/*! @{ */

#define ENETC_HTATFCOR_HP_COUNT_MASK             (0xFFU)
#define ENETC_HTATFCOR_HP_COUNT_SHIFT            (0U)
#define ENETC_HTATFCOR_HP_COUNT(x)               (((uint32_t)(((uint32_t)(x)) << ENETC_HTATFCOR_HP_COUNT_SHIFT)) & ENETC_HTATFCOR_HP_COUNT_MASK)

#define ENETC_HTATFCOR_HP_HWM_MASK               (0xFF00U)
#define ENETC_HTATFCOR_HP_HWM_SHIFT              (8U)
#define ENETC_HTATFCOR_HP_HWM(x)                 (((uint32_t)(((uint32_t)(x)) << ENETC_HTATFCOR_HP_HWM_SHIFT)) & ENETC_HTATFCOR_HP_HWM_MASK)

#define ENETC_HTATFCOR_LP_COUNT_MASK             (0xFF0000U)
#define ENETC_HTATFCOR_LP_COUNT_SHIFT            (16U)
#define ENETC_HTATFCOR_LP_COUNT(x)               (((uint32_t)(((uint32_t)(x)) << ENETC_HTATFCOR_LP_COUNT_SHIFT)) & ENETC_HTATFCOR_LP_COUNT_MASK)

#define ENETC_HTATFCOR_LP_HWM_MASK               (0xFF000000U)
#define ENETC_HTATFCOR_LP_HWM_SHIFT              (24U)
#define ENETC_HTATFCOR_LP_HWM(x)                 (((uint32_t)(((uint32_t)(x)) << ENETC_HTATFCOR_LP_HWM_SHIFT)) & ENETC_HTATFCOR_LP_HWM_MASK)
/*! @} */

/* The count of ENETC_HTATFCOR */
#define ENETC_HTATFCOR_COUNT                     (1U)

/*! @name RCSBRLAR - Root complex 0 system bus read latency average register */
/*! @{ */

#define ENETC_RCSBRLAR_FRACT_MASK                (0xFFU)
#define ENETC_RCSBRLAR_FRACT_SHIFT               (0U)
#define ENETC_RCSBRLAR_FRACT(x)                  (((uint32_t)(((uint32_t)(x)) << ENETC_RCSBRLAR_FRACT_SHIFT)) & ENETC_RCSBRLAR_FRACT_MASK)

#define ENETC_RCSBRLAR_INT_MASK                  (0xFFF00U)
#define ENETC_RCSBRLAR_INT_SHIFT                 (8U)
#define ENETC_RCSBRLAR_INT(x)                    (((uint32_t)(((uint32_t)(x)) << ENETC_RCSBRLAR_INT_SHIFT)) & ENETC_RCSBRLAR_INT_MASK)
/*! @} */

/* The count of ENETC_RCSBRLAR */
#define ENETC_RCSBRLAR_COUNT                     (1U)

/*! @name RCSBRLHWMR - Root complex 0 system bus read latency high watermark register */
/*! @{ */

#define ENETC_RCSBRLHWMR_FRACT_MASK              (0xFFU)
#define ENETC_RCSBRLHWMR_FRACT_SHIFT             (0U)
#define ENETC_RCSBRLHWMR_FRACT(x)                (((uint32_t)(((uint32_t)(x)) << ENETC_RCSBRLHWMR_FRACT_SHIFT)) & ENETC_RCSBRLHWMR_FRACT_MASK)

#define ENETC_RCSBRLHWMR_INT_MASK                (0xFFF00U)
#define ENETC_RCSBRLHWMR_INT_SHIFT               (8U)
#define ENETC_RCSBRLHWMR_INT(x)                  (((uint32_t)(((uint32_t)(x)) << ENETC_RCSBRLHWMR_INT_SHIFT)) & ENETC_RCSBRLHWMR_INT_MASK)
/*! @} */

/* The count of ENETC_RCSBRLHWMR */
#define ENETC_RCSBRLHWMR_COUNT                   (1U)

/*! @name RCSBWLAR - Root complex 0 system bus write latency average register */
/*! @{ */

#define ENETC_RCSBWLAR_FRACT_MASK                (0xFFU)
#define ENETC_RCSBWLAR_FRACT_SHIFT               (0U)
#define ENETC_RCSBWLAR_FRACT(x)                  (((uint32_t)(((uint32_t)(x)) << ENETC_RCSBWLAR_FRACT_SHIFT)) & ENETC_RCSBWLAR_FRACT_MASK)

#define ENETC_RCSBWLAR_INT_MASK                  (0xFFF00U)
#define ENETC_RCSBWLAR_INT_SHIFT                 (8U)
#define ENETC_RCSBWLAR_INT(x)                    (((uint32_t)(((uint32_t)(x)) << ENETC_RCSBWLAR_INT_SHIFT)) & ENETC_RCSBWLAR_INT_MASK)
/*! @} */

/* The count of ENETC_RCSBWLAR */
#define ENETC_RCSBWLAR_COUNT                     (1U)

/*! @name RCSBWLHWMR - Root complex 0 system bus write latency high watermark register */
/*! @{ */

#define ENETC_RCSBWLHWMR_FRACT_MASK              (0xFFU)
#define ENETC_RCSBWLHWMR_FRACT_SHIFT             (0U)
#define ENETC_RCSBWLHWMR_FRACT(x)                (((uint32_t)(((uint32_t)(x)) << ENETC_RCSBWLHWMR_FRACT_SHIFT)) & ENETC_RCSBWLHWMR_FRACT_MASK)

#define ENETC_RCSBWLHWMR_INT_MASK                (0xFFF00U)
#define ENETC_RCSBWLHWMR_INT_SHIFT               (8U)
#define ENETC_RCSBWLHWMR_INT(x)                  (((uint32_t)(((uint32_t)(x)) << ENETC_RCSBWLHWMR_INT_SHIFT)) & ENETC_RCSBWLHWMR_INT_MASK)
/*! @} */

/* The count of ENETC_RCSBWLHWMR */
#define ENETC_RCSBWLHWMR_COUNT                   (1U)

/*! @name IPBRR0 - IP block revision register 0 */
/*! @{ */

#define ENETC_IPBRR0_IP_MN_MASK                  (0xFFU)
#define ENETC_IPBRR0_IP_MN_SHIFT                 (0U)
#define ENETC_IPBRR0_IP_MN(x)                    (((uint32_t)(((uint32_t)(x)) << ENETC_IPBRR0_IP_MN_SHIFT)) & ENETC_IPBRR0_IP_MN_MASK)

#define ENETC_IPBRR0_IP_MJ_MASK                  (0xFF00U)
#define ENETC_IPBRR0_IP_MJ_SHIFT                 (8U)
#define ENETC_IPBRR0_IP_MJ(x)                    (((uint32_t)(((uint32_t)(x)) << ENETC_IPBRR0_IP_MJ_SHIFT)) & ENETC_IPBRR0_IP_MJ_MASK)
/*! @} */

/*! @name IPBRR1 - IP block revision register 1 */
/*! @{ */

#define ENETC_IPBRR1_IP_CFG_MASK                 (0xFFU)
#define ENETC_IPBRR1_IP_CFG_SHIFT                (0U)
#define ENETC_IPBRR1_IP_CFG(x)                   (((uint32_t)(((uint32_t)(x)) << ENETC_IPBRR1_IP_CFG_SHIFT)) & ENETC_IPBRR1_IP_CFG_MASK)

#define ENETC_IPBRR1_IP_MNT_MASK                 (0xFF00U)
#define ENETC_IPBRR1_IP_MNT_SHIFT                (8U)
#define ENETC_IPBRR1_IP_MNT(x)                   (((uint32_t)(((uint32_t)(x)) << ENETC_IPBRR1_IP_MNT_SHIFT)) & ENETC_IPBRR1_IP_MNT_MASK)

#define ENETC_IPBRR1_IP_INT_MASK                 (0xFF0000U)
#define ENETC_IPBRR1_IP_INT_SHIFT                (16U)
#define ENETC_IPBRR1_IP_INT(x)                   (((uint32_t)(((uint32_t)(x)) << ENETC_IPBRR1_IP_INT_SHIFT)) & ENETC_IPBRR1_IP_INT_MASK)
/*! @} */

/*! @name FBLPR - Function boot loader parameter register 0..Function boot loader parameter register 1 */
/*! @{ */

#define ENETC_FBLPR_PARAM_VAL_MASK               (0xFFFFFFFFU)
#define ENETC_FBLPR_PARAM_VAL_SHIFT              (0U)
#define ENETC_FBLPR_PARAM_VAL(x)                 (((uint32_t)(((uint32_t)(x)) << ENETC_FBLPR_PARAM_VAL_SHIFT)) & ENETC_FBLPR_PARAM_VAL_MASK)
/*! @} */

/* The count of ENETC_FBLPR */
#define ENETC_FBLPR_COUNT                        (2U)


/*!
 * @}
 */ /* end of group ENETC_Register_Masks */


/*!
 * @}
 */ /* end of group ENETC_Peripheral_Access_Layer */
