...
#define IOMUXC_GPR_GPR0_GPR_MASK                 (0xFFFFU)
...
#define IOMUXC_GPR_GPR0_GPR_LCK_MASK             (0xFFFF0000U)
#define IOMUXC_GPR_GPR0_GPR_LCK_SHIFT            (16U)
/*! GPR_LCK - GPR lock bits */
#define IOMUXC_GPR_GPR0_GPR_LCK(x)               (((uint32_t)(((uint32_t)(x)) << IOMUXC_GPR_GPR0_GPR_LCK_SHIFT)) & IOMUXC_GPR_GPR0_GPR_LCK_MASK)
/*! @} */
