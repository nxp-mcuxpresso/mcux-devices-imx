...
**         Probe_m_e_6_main_TransactionStatProfiler
**
...
/*!
 * @file PERI_Probe_m_e_6_main_TransactionStatProfiler.h
 * @version 1.0
 * @date 2023-01-10
 * @brief CMSIS Peripheral Access Layer for
 *        Probe_m_e_6_main_TransactionStatProfiler
 *
 * CMSIS Peripheral Access Layer for Probe_m_e_6_main_TransactionStatProfiler
 */

#if !defined(PERI_PROBE_M_E_6_MAIN_TRANSACTIONSTATPROFILER_H_)
#define PERI_PROBE_M_E_6_MAIN_TRANSACTIONSTATPROFILER_H_ /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- Probe_m_e_6_main_TransactionStatProfiler Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup Probe_m_e_6_main_TransactionStatProfiler_Peripheral_Access_Layer Probe_m_e_6_main_TransactionStatProfiler Peripheral Access Layer
 * @{
 */

/** Probe_m_e_6_main_TransactionStatProfiler - Register Layout Typedef */
typedef struct {
...
} Probe_m_e_6_main_TransactionStatProfiler_Type;

/* ----------------------------------------------------------------------------
   -- Probe_m_e_6_main_TransactionStatProfiler Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup Probe_m_e_6_main_TransactionStatProfiler_Register_Masks Probe_m_e_6_main_TransactionStatProfiler Register Masks
 * @{
 */
...
#define Probe_m_e_6_main_TransactionStatProfiler_ID_COREID_CORETYPEID_MASK (0xFFU)
#define Probe_m_e_6_main_TransactionStatProfiler_ID_COREID_CORETYPEID_SHIFT (0U)
#define Probe_m_e_6_main_TransactionStatProfiler_ID_COREID_CORETYPEID(x) (((uint32_t)(((uint32_t)(x)) << Probe_m_e_6_main_TransactionStatProfiler_ID_COREID_CORETYPEID_SHIFT)) & Probe_m_e_6_main_TransactionStatProfiler_ID_COREID_CORETYPEID_MASK)

#define Probe_m_e_6_main_TransactionStatProfiler_ID_COREID_CORECHECKSUM_MASK (0xFFFFFF00U)
#define Probe_m_e_6_main_TransactionStatProfiler_ID_COREID_CORECHECKSUM_SHIFT (8U)
#define Probe_m_e_6_main_TransactionStatProfiler_ID_COREID_CORECHECKSUM(x) (((uint32_t)(((uint32_t)(x)) << Probe_m_e_6_main_TransactionStatProfiler_ID_COREID_CORECHECKSUM_SHIFT)) & Probe_m_e_6_main_TransactionStatProfiler_ID_COREID_CORECHECKSUM_MASK)
/*! @} */

/*! @name ID_REVISIONID - Revision ID */
/*! @{ */

#define Probe_m_e_6_main_TransactionStatProfiler_ID_REVISIONID_USERID_MASK (0xFFU)
#define Probe_m_e_6_main_TransactionStatProfiler_ID_REVISIONID_USERID_SHIFT (0U)
#define Probe_m_e_6_main_TransactionStatProfiler_ID_REVISIONID_USERID(x) (((uint32_t)(((uint32_t)(x)) << Probe_m_e_6_main_TransactionStatProfiler_ID_REVISIONID_USERID_SHIFT)) & Probe_m_e_6_main_TransactionStatProfiler_ID_REVISIONID_USERID_MASK)

#define Probe_m_e_6_main_TransactionStatProfiler_ID_REVISIONID_NOCID_MASK (0xFFFFFF00U)
#define Probe_m_e_6_main_TransactionStatProfiler_ID_REVISIONID_NOCID_SHIFT (8U)
#define Probe_m_e_6_main_TransactionStatProfiler_ID_REVISIONID_NOCID(x) (((uint32_t)(((uint32_t)(x)) << Probe_m_e_6_main_TransactionStatProfiler_ID_REVISIONID_NOCID_SHIFT)) & Probe_m_e_6_main_TransactionStatProfiler_ID_REVISIONID_NOCID_MASK)
/*! @} */

/*! @name EN - Enable */
/*! @{ */

#define Probe_m_e_6_main_TransactionStatProfiler_EN_EN_MASK (0x1U)
#define Probe_m_e_6_main_TransactionStatProfiler_EN_EN_SHIFT (0U)
#define Probe_m_e_6_main_TransactionStatProfiler_EN_EN(x) (((uint32_t)(((uint32_t)(x)) << Probe_m_e_6_main_TransactionStatProfiler_EN_EN_SHIFT)) & Probe_m_e_6_main_TransactionStatProfiler_EN_EN_MASK)
/*! @} */

/*! @name MODE - Mode */
/*! @{ */

#define Probe_m_e_6_main_TransactionStatProfiler_MODE_MODE_MASK (0x1U)
#define Probe_m_e_6_main_TransactionStatProfiler_MODE_MODE_SHIFT (0U)
#define Probe_m_e_6_main_TransactionStatProfiler_MODE_MODE(x) (((uint32_t)(((uint32_t)(x)) << Probe_m_e_6_main_TransactionStatProfiler_MODE_MODE_SHIFT)) & Probe_m_e_6_main_TransactionStatProfiler_MODE_MODE_MASK)
/*! @} */

/*! @name PROBE_M_E_6_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_0 -  */
/*! @{ */

#define Probe_m_e_6_main_TransactionStatProfiler_PROBE_M_E_6_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_0_THRESHOLDS_0_0_MASK (0x7FFU)
#define Probe_m_e_6_main_TransactionStatProfiler_PROBE_M_E_6_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_0_THRESHOLDS_0_0_SHIFT (0U)
#define Probe_m_e_6_main_TransactionStatProfiler_PROBE_M_E_6_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_0_THRESHOLDS_0_0(x) (((uint32_t)(((uint32_t)(x)) << Probe_m_e_6_main_TransactionStatProfiler_PROBE_M_E_6_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_0_THRESHOLDS_0_0_SHIFT)) & Probe_m_e_6_main_TransactionStatProfiler_PROBE_M_E_6_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_0_THRESHOLDS_0_0_MASK)
/*! @} */

/*! @name PROBE_M_E_6_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_1 -  */
/*! @{ */

#define Probe_m_e_6_main_TransactionStatProfiler_PROBE_M_E_6_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_1_THRESHOLDS_0_1_MASK (0x7FFU)
#define Probe_m_e_6_main_TransactionStatProfiler_PROBE_M_E_6_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_1_THRESHOLDS_0_1_SHIFT (0U)
#define Probe_m_e_6_main_TransactionStatProfiler_PROBE_M_E_6_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_1_THRESHOLDS_0_1(x) (((uint32_t)(((uint32_t)(x)) << Probe_m_e_6_main_TransactionStatProfiler_PROBE_M_E_6_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_1_THRESHOLDS_0_1_SHIFT)) & Probe_m_e_6_main_TransactionStatProfiler_PROBE_M_E_6_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_1_THRESHOLDS_0_1_MASK)
/*! @} */

/*! @name PROBE_M_E_6_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_2 -  */
/*! @{ */

#define Probe_m_e_6_main_TransactionStatProfiler_PROBE_M_E_6_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_2_THRESHOLDS_0_2_MASK (0x7FFU)
#define Probe_m_e_6_main_TransactionStatProfiler_PROBE_M_E_6_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_2_THRESHOLDS_0_2_SHIFT (0U)
#define Probe_m_e_6_main_TransactionStatProfiler_PROBE_M_E_6_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_2_THRESHOLDS_0_2(x) (((uint32_t)(((uint32_t)(x)) << Probe_m_e_6_main_TransactionStatProfiler_PROBE_M_E_6_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_2_THRESHOLDS_0_2_SHIFT)) & Probe_m_e_6_main_TransactionStatProfiler_PROBE_M_E_6_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_2_THRESHOLDS_0_2_MASK)
/*! @} */

/*! @name PROBE_M_E_6_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_3 -  */
/*! @{ */

#define Probe_m_e_6_main_TransactionStatProfiler_PROBE_M_E_6_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_3_THRESHOLDS_0_3_MASK (0x7FFU)
#define Probe_m_e_6_main_TransactionStatProfiler_PROBE_M_E_6_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_3_THRESHOLDS_0_3_SHIFT (0U)
#define Probe_m_e_6_main_TransactionStatProfiler_PROBE_M_E_6_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_3_THRESHOLDS_0_3(x) (((uint32_t)(((uint32_t)(x)) << Probe_m_e_6_main_TransactionStatProfiler_PROBE_M_E_6_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_3_THRESHOLDS_0_3_SHIFT)) & Probe_m_e_6_main_TransactionStatProfiler_PROBE_M_E_6_MAIN_TRANSACTIONSTATPROFILER_THRESHOLDS_0_3_THRESHOLDS_0_3_MASK)
/*! @} */

/*! @name OVERFLOWSTATUS - Overflow Status */
/*! @{ */

#define Probe_m_e_6_main_TransactionStatProfiler_OVERFLOWSTATUS_OVERFLOWSTATUS_MASK (0x1U)
#define Probe_m_e_6_main_TransactionStatProfiler_OVERFLOWSTATUS_OVERFLOWSTATUS_SHIFT (0U)
#define Probe_m_e_6_main_TransactionStatProfiler_OVERFLOWSTATUS_OVERFLOWSTATUS(x) (((uint32_t)(((uint32_t)(x)) << Probe_m_e_6_main_TransactionStatProfiler_OVERFLOWSTATUS_OVERFLOWSTATUS_SHIFT)) & Probe_m_e_6_main_TransactionStatProfiler_OVERFLOWSTATUS_OVERFLOWSTATUS_MASK)
/*! @} */

/*! @name OVERFLOWRESET - Overflow Reset */
/*! @{ */

#define Probe_m_e_6_main_TransactionStatProfiler_OVERFLOWRESET_OVERFLOWRESET_MASK (0x1U)
#define Probe_m_e_6_main_TransactionStatProfiler_OVERFLOWRESET_OVERFLOWRESET_SHIFT (0U)
#define Probe_m_e_6_main_TransactionStatProfiler_OVERFLOWRESET_OVERFLOWRESET(x) (((uint32_t)(((uint32_t)(x)) << Probe_m_e_6_main_TransactionStatProfiler_OVERFLOWRESET_OVERFLOWRESET_SHIFT)) & Probe_m_e_6_main_TransactionStatProfiler_OVERFLOWRESET_OVERFLOWRESET_MASK)
/*! @} */

/*! @name PENDINGEVENTMODE - Pending Event Mode */
/*! @{ */

#define Probe_m_e_6_main_TransactionStatProfiler_PENDINGEVENTMODE_PENDINGEVENTMODE_MASK (0x1U)
#define Probe_m_e_6_main_TransactionStatProfiler_PENDINGEVENTMODE_PENDINGEVENTMODE_SHIFT (0U)
#define Probe_m_e_6_main_TransactionStatProfiler_PENDINGEVENTMODE_PENDINGEVENTMODE(x) (((uint32_t)(((uint32_t)(x)) << Probe_m_e_6_main_TransactionStatProfiler_PENDINGEVENTMODE_PENDINGEVENTMODE_SHIFT)) & Probe_m_e_6_main_TransactionStatProfiler_PENDINGEVENTMODE_PENDINGEVENTMODE_MASK)
/*! @} */

/*! @name PRESCALER - Pre Scaler */
/*! @{ */

#define Probe_m_e_6_main_TransactionStatProfiler_PRESCALER_PRESCALER_MASK (0xFFU)
#define Probe_m_e_6_main_TransactionStatProfiler_PRESCALER_PRESCALER_SHIFT (0U)
#define Probe_m_e_6_main_TransactionStatProfiler_PRESCALER_PRESCALER(x) (((uint32_t)(((uint32_t)(x)) << Probe_m_e_6_main_TransactionStatProfiler_PRESCALER_PRESCALER_SHIFT)) & Probe_m_e_6_main_TransactionStatProfiler_PRESCALER_PRESCALER_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group Probe_m_e_6_main_TransactionStatProfiler_Register_Masks */


/*!
 * @}
 */ /* end of group Probe_m_e_6_main_TransactionStatProfiler_Peripheral_Access_Layer */
...
#endif  /* PERI_PROBE_M_E_6_MAIN_TRANSACTIONSTATPROFILER_H_ */
