...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for NOC_JPEG_ENC_RD_I_XSTATFILTER
**
...
/*!
 * @file PERI_NOC_JPEG_ENC_RD_I_XSTATFILTER.h
 * @version 1.0
 * @date 2023-01-10
 * @brief CMSIS Peripheral Access Layer for NOC_JPEG_ENC_RD_I_XSTATFILTER
 *
 * CMSIS Peripheral Access Layer for NOC_JPEG_ENC_RD_I_XSTATFILTER
 */

#if !defined(PERI_NOC_JPEG_ENC_RD_I_XSTATFILTER_H_)
#define PERI_NOC_JPEG_ENC_RD_I_XSTATFILTER_H_    /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- NOC_JPEG_ENC_RD_I_XSTATFILTER Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup NOC_JPEG_ENC_RD_I_XSTATFILTER_Peripheral_Access_Layer NOC_JPEG_ENC_RD_I_XSTATFILTER Peripheral Access Layer
 * @{
 */

/** NOC_JPEG_ENC_RD_I_XSTATFILTER - Register Layout Typedef */
typedef struct {
...
} NOC_JPEG_ENC_RD_I_XSTATFILTER_Type;

/* ----------------------------------------------------------------------------
   -- NOC_JPEG_ENC_RD_I_XSTATFILTER Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup NOC_JPEG_ENC_RD_I_XSTATFILTER_Register_Masks NOC_JPEG_ENC_RD_I_XSTATFILTER Register Masks
 * @{
 */
...
#define NOC_JPEG_ENC_RD_I_XSTATFILTER_ID_COREID_CORETYPEID_MASK (0xFFU)
#define NOC_JPEG_ENC_RD_I_XSTATFILTER_ID_COREID_CORETYPEID_SHIFT (0U)
#define NOC_JPEG_ENC_RD_I_XSTATFILTER_ID_COREID_CORETYPEID(x) (((uint32_t)(((uint32_t)(x)) << NOC_JPEG_ENC_RD_I_XSTATFILTER_ID_COREID_CORETYPEID_SHIFT)) & NOC_JPEG_ENC_RD_I_XSTATFILTER_ID_COREID_CORETYPEID_MASK)

#define NOC_JPEG_ENC_RD_I_XSTATFILTER_ID_COREID_CORECHECKSUM_MASK (0xFFFFFF00U)
#define NOC_JPEG_ENC_RD_I_XSTATFILTER_ID_COREID_CORECHECKSUM_SHIFT (8U)
#define NOC_JPEG_ENC_RD_I_XSTATFILTER_ID_COREID_CORECHECKSUM(x) (((uint32_t)(((uint32_t)(x)) << NOC_JPEG_ENC_RD_I_XSTATFILTER_ID_COREID_CORECHECKSUM_SHIFT)) & NOC_JPEG_ENC_RD_I_XSTATFILTER_ID_COREID_CORECHECKSUM_MASK)
/*! @} */

/*! @name ID_REVISIONID - Revision ID */
/*! @{ */

#define NOC_JPEG_ENC_RD_I_XSTATFILTER_ID_REVISIONID_USERID_MASK (0xFFU)
#define NOC_JPEG_ENC_RD_I_XSTATFILTER_ID_REVISIONID_USERID_SHIFT (0U)
#define NOC_JPEG_ENC_RD_I_XSTATFILTER_ID_REVISIONID_USERID(x) (((uint32_t)(((uint32_t)(x)) << NOC_JPEG_ENC_RD_I_XSTATFILTER_ID_REVISIONID_USERID_SHIFT)) & NOC_JPEG_ENC_RD_I_XSTATFILTER_ID_REVISIONID_USERID_MASK)

#define NOC_JPEG_ENC_RD_I_XSTATFILTER_ID_REVISIONID_NOCID_MASK (0xFFFFFF00U)
#define NOC_JPEG_ENC_RD_I_XSTATFILTER_ID_REVISIONID_NOCID_SHIFT (8U)
#define NOC_JPEG_ENC_RD_I_XSTATFILTER_ID_REVISIONID_NOCID(x) (((uint32_t)(((uint32_t)(x)) << NOC_JPEG_ENC_RD_I_XSTATFILTER_ID_REVISIONID_NOCID_SHIFT)) & NOC_JPEG_ENC_RD_I_XSTATFILTER_ID_REVISIONID_NOCID_MASK)
/*! @} */

/*! @name MODE - Mode */
/*! @{ */

#define NOC_JPEG_ENC_RD_I_XSTATFILTER_MODE_MODE_MASK (0x1U)
#define NOC_JPEG_ENC_RD_I_XSTATFILTER_MODE_MODE_SHIFT (0U)
#define NOC_JPEG_ENC_RD_I_XSTATFILTER_MODE_MODE(x) (((uint32_t)(((uint32_t)(x)) << NOC_JPEG_ENC_RD_I_XSTATFILTER_MODE_MODE_SHIFT)) & NOC_JPEG_ENC_RD_I_XSTATFILTER_MODE_MODE_MASK)
/*! @} */

/*! @name ADDRBASE_LOW - Address Base LSB */
/*! @{ */

#define NOC_JPEG_ENC_RD_I_XSTATFILTER_ADDRBASE_LOW_ADDRBASE_LOW_MASK (0xFFFFFFFFU)
#define NOC_JPEG_ENC_RD_I_XSTATFILTER_ADDRBASE_LOW_ADDRBASE_LOW_SHIFT (0U)
#define NOC_JPEG_ENC_RD_I_XSTATFILTER_ADDRBASE_LOW_ADDRBASE_LOW(x) (((uint32_t)(((uint32_t)(x)) << NOC_JPEG_ENC_RD_I_XSTATFILTER_ADDRBASE_LOW_ADDRBASE_LOW_SHIFT)) & NOC_JPEG_ENC_RD_I_XSTATFILTER_ADDRBASE_LOW_ADDRBASE_LOW_MASK)
/*! @} */

/*! @name ADDRWINDOWSIZE - Address Window Size */
/*! @{ */

#define NOC_JPEG_ENC_RD_I_XSTATFILTER_ADDRWINDOWSIZE_ADDRWINDOWSIZE_MASK (0x3FU)
#define NOC_JPEG_ENC_RD_I_XSTATFILTER_ADDRWINDOWSIZE_ADDRWINDOWSIZE_SHIFT (0U)
#define NOC_JPEG_ENC_RD_I_XSTATFILTER_ADDRWINDOWSIZE_ADDRWINDOWSIZE(x) (((uint32_t)(((uint32_t)(x)) << NOC_JPEG_ENC_RD_I_XSTATFILTER_ADDRWINDOWSIZE_ADDRWINDOWSIZE_SHIFT)) & NOC_JPEG_ENC_RD_I_XSTATFILTER_ADDRWINDOWSIZE_ADDRWINDOWSIZE_MASK)
/*! @} */

/*! @name OPCODE - Packet Opcode */
/*! @{ */

#define NOC_JPEG_ENC_RD_I_XSTATFILTER_OPCODE_RDEN_MASK (0x1U)
#define NOC_JPEG_ENC_RD_I_XSTATFILTER_OPCODE_RDEN_SHIFT (0U)
#define NOC_JPEG_ENC_RD_I_XSTATFILTER_OPCODE_RDEN(x) (((uint32_t)(((uint32_t)(x)) << NOC_JPEG_ENC_RD_I_XSTATFILTER_OPCODE_RDEN_SHIFT)) & NOC_JPEG_ENC_RD_I_XSTATFILTER_OPCODE_RDEN_MASK)

#define NOC_JPEG_ENC_RD_I_XSTATFILTER_OPCODE_WREN_MASK (0x2U)
#define NOC_JPEG_ENC_RD_I_XSTATFILTER_OPCODE_WREN_SHIFT (1U)
#define NOC_JPEG_ENC_RD_I_XSTATFILTER_OPCODE_WREN(x) (((uint32_t)(((uint32_t)(x)) << NOC_JPEG_ENC_RD_I_XSTATFILTER_OPCODE_WREN_SHIFT)) & NOC_JPEG_ENC_RD_I_XSTATFILTER_OPCODE_WREN_MASK)
/*! @} */

/*! @name USERBASE - User Base */
/*! @{ */

#define NOC_JPEG_ENC_RD_I_XSTATFILTER_USERBASE_USERBASE_MASK (0xFFFFFFFU)
#define NOC_JPEG_ENC_RD_I_XSTATFILTER_USERBASE_USERBASE_SHIFT (0U)
#define NOC_JPEG_ENC_RD_I_XSTATFILTER_USERBASE_USERBASE(x) (((uint32_t)(((uint32_t)(x)) << NOC_JPEG_ENC_RD_I_XSTATFILTER_USERBASE_USERBASE_SHIFT)) & NOC_JPEG_ENC_RD_I_XSTATFILTER_USERBASE_USERBASE_MASK)
/*! @} */

/*! @name USERMASK - User Mask */
/*! @{ */

#define NOC_JPEG_ENC_RD_I_XSTATFILTER_USERMASK_USERMASK_MASK (0xFFFFFFFU)
#define NOC_JPEG_ENC_RD_I_XSTATFILTER_USERMASK_USERMASK_SHIFT (0U)
#define NOC_JPEG_ENC_RD_I_XSTATFILTER_USERMASK_USERMASK(x) (((uint32_t)(((uint32_t)(x)) << NOC_JPEG_ENC_RD_I_XSTATFILTER_USERMASK_USERMASK_SHIFT)) & NOC_JPEG_ENC_RD_I_XSTATFILTER_USERMASK_USERMASK_MASK)
/*! @} */

/*! @name SECURITYBASE - Security Base */
/*! @{ */

#define NOC_JPEG_ENC_RD_I_XSTATFILTER_SECURITYBASE_SECURITYBASE_MASK (0x7U)
#define NOC_JPEG_ENC_RD_I_XSTATFILTER_SECURITYBASE_SECURITYBASE_SHIFT (0U)
#define NOC_JPEG_ENC_RD_I_XSTATFILTER_SECURITYBASE_SECURITYBASE(x) (((uint32_t)(((uint32_t)(x)) << NOC_JPEG_ENC_RD_I_XSTATFILTER_SECURITYBASE_SECURITYBASE_SHIFT)) & NOC_JPEG_ENC_RD_I_XSTATFILTER_SECURITYBASE_SECURITYBASE_MASK)
/*! @} */

/*! @name SECURITYMASK - Security Mask */
/*! @{ */

#define NOC_JPEG_ENC_RD_I_XSTATFILTER_SECURITYMASK_SECURITYMASK_MASK (0x7U)
#define NOC_JPEG_ENC_RD_I_XSTATFILTER_SECURITYMASK_SECURITYMASK_SHIFT (0U)
#define NOC_JPEG_ENC_RD_I_XSTATFILTER_SECURITYMASK_SECURITYMASK(x) (((uint32_t)(((uint32_t)(x)) << NOC_JPEG_ENC_RD_I_XSTATFILTER_SECURITYMASK_SECURITYMASK_SHIFT)) & NOC_JPEG_ENC_RD_I_XSTATFILTER_SECURITYMASK_SECURITYMASK_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group NOC_JPEG_ENC_RD_I_XSTATFILTER_Register_Masks */


/*!
 * @}
 */ /* end of group NOC_JPEG_ENC_RD_I_XSTATFILTER_Peripheral_Access_Layer */
...
#endif  /* PERI_NOC_JPEG_ENC_RD_I_XSTATFILTER_H_ */
