...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for NOC_JPEG_ENC_PROBE_XSTATPROFILER
**
...
/*!
 * @file PERI_NOC_JPEG_ENC_PROBE_XSTATPROFILER.h
 * @version 1.0
 * @date 2023-01-10
 * @brief CMSIS Peripheral Access Layer for NOC_JPEG_ENC_PROBE_XSTATPROFILER
 *
 * CMSIS Peripheral Access Layer for NOC_JPEG_ENC_PROBE_XSTATPROFILER
 */

#if !defined(PERI_NOC_JPEG_ENC_PROBE_XSTATPROFILER_H_)
#define PERI_NOC_JPEG_ENC_PROBE_XSTATPROFILER_H_ /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- NOC_JPEG_ENC_PROBE_XSTATPROFILER Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup NOC_JPEG_ENC_PROBE_XSTATPROFILER_Peripheral_Access_Layer NOC_JPEG_ENC_PROBE_XSTATPROFILER Peripheral Access Layer
 * @{
 */

/** NOC_JPEG_ENC_PROBE_XSTATPROFILER - Size of Registers Arrays */
#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_OBSERVEDSEL_COUNT 2u
#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_THRESHOLDS_COUNT 2u
#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_THRESHOLDS_TRANSACTIONSTATPROFILER_THRESHOLDS_J_COUNT 4u

/** NOC_JPEG_ENC_PROBE_XSTATPROFILER - Register Layout Typedef */
typedef struct {
  ...
  __IO uint32_t TRANSACTIONSTATPROFILER_OBSERVEDSEL[NOC_JPEG_ENC_PROBE_XSTATPROFILER_OBSERVEDSEL_COUNT]; /**< ObservedSel n, array offset: 0x10, array step: 0x4 */
       uint8_t RESERVED_0[8];
  __IO uint32_t NTENURELINES_0;                    /**< Number of Transaction Probe Lines, offset: 0x20 */
       uint8_t RESERVED_1[8];
  __IO uint32_t TRANSACTIONSTATPROFILER_THRESHOLDS_[NOC_JPEG_ENC_PROBE_XSTATPROFILER_THRESHOLDS_COUNT][NOC_JPEG_ENC_PROBE_XSTATPROFILER_THRESHOLDS_TRANSACTIONSTATPROFILER_THRESHOLDS_J_COUNT]; /**< Transaction Profiler Thresholds Register, array offset: 0x2C, array step: index*0x10, index2*0x4 */
...
} NOC_JPEG_ENC_PROBE_XSTATPROFILER_Type;

/* ----------------------------------------------------------------------------
   -- NOC_JPEG_ENC_PROBE_XSTATPROFILER Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup NOC_JPEG_ENC_PROBE_XSTATPROFILER_Register_Masks NOC_JPEG_ENC_PROBE_XSTATPROFILER Register Masks
 * @{
 */
...
#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_ID_COREID_CORETYPEID_MASK (0xFFU)
#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_ID_COREID_CORETYPEID_SHIFT (0U)
#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_ID_COREID_CORETYPEID(x) (((uint32_t)(((uint32_t)(x)) << NOC_JPEG_ENC_PROBE_XSTATPROFILER_ID_COREID_CORETYPEID_SHIFT)) & NOC_JPEG_ENC_PROBE_XSTATPROFILER_ID_COREID_CORETYPEID_MASK)

#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_ID_COREID_CORECHECKSUM_MASK (0xFFFFFF00U)
#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_ID_COREID_CORECHECKSUM_SHIFT (8U)
#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_ID_COREID_CORECHECKSUM(x) (((uint32_t)(((uint32_t)(x)) << NOC_JPEG_ENC_PROBE_XSTATPROFILER_ID_COREID_CORECHECKSUM_SHIFT)) & NOC_JPEG_ENC_PROBE_XSTATPROFILER_ID_COREID_CORECHECKSUM_MASK)
/*! @} */

/*! @name ID_REVISIONID - Revision ID */
/*! @{ */

#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_ID_REVISIONID_USERID_MASK (0xFFU)
#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_ID_REVISIONID_USERID_SHIFT (0U)
#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_ID_REVISIONID_USERID(x) (((uint32_t)(((uint32_t)(x)) << NOC_JPEG_ENC_PROBE_XSTATPROFILER_ID_REVISIONID_USERID_SHIFT)) & NOC_JPEG_ENC_PROBE_XSTATPROFILER_ID_REVISIONID_USERID_MASK)

#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_ID_REVISIONID_NOCID_MASK (0xFFFFFF00U)
#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_ID_REVISIONID_NOCID_SHIFT (8U)
#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_ID_REVISIONID_NOCID(x) (((uint32_t)(((uint32_t)(x)) << NOC_JPEG_ENC_PROBE_XSTATPROFILER_ID_REVISIONID_NOCID_SHIFT)) & NOC_JPEG_ENC_PROBE_XSTATPROFILER_ID_REVISIONID_NOCID_MASK)
/*! @} */

/*! @name EN - Enable */
/*! @{ */

#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_EN_EN_MASK (0x1U)
#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_EN_EN_SHIFT (0U)
#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_EN_EN(x) (((uint32_t)(((uint32_t)(x)) << NOC_JPEG_ENC_PROBE_XSTATPROFILER_EN_EN_SHIFT)) & NOC_JPEG_ENC_PROBE_XSTATPROFILER_EN_EN_MASK)
/*! @} */

/*! @name MODE - Mode */
/*! @{ */

#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_MODE_MODE_MASK (0x3U)
#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_MODE_MODE_SHIFT (0U)
#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_MODE_MODE(x) (((uint32_t)(((uint32_t)(x)) << NOC_JPEG_ENC_PROBE_XSTATPROFILER_MODE_MODE_SHIFT)) & NOC_JPEG_ENC_PROBE_XSTATPROFILER_MODE_MODE_MASK)
/*! @} */

/*! @name TRANSACTIONSTATPROFILER_OBSERVEDSEL - ObservedSel n */
/*! @{ */

#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_TRANSACTIONSTATPROFILER_OBSERVEDSEL_OBSERVEDSEL_MASK (0x1U)
#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_TRANSACTIONSTATPROFILER_OBSERVEDSEL_OBSERVEDSEL_SHIFT (0U)
#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_TRANSACTIONSTATPROFILER_OBSERVEDSEL_OBSERVEDSEL(x) (((uint32_t)(((uint32_t)(x)) << NOC_JPEG_ENC_PROBE_XSTATPROFILER_TRANSACTIONSTATPROFILER_OBSERVEDSEL_OBSERVEDSEL_SHIFT)) & NOC_JPEG_ENC_PROBE_XSTATPROFILER_TRANSACTIONSTATPROFILER_OBSERVEDSEL_OBSERVEDSEL_MASK)
/*! @} */

/* The count of NOC_JPEG_ENC_PROBE_XSTATPROFILER_TRANSACTIONSTATPROFILER_OBSERVEDSEL */
#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_TRANSACTIONSTATPROFILER_OBSERVEDSEL_COUNT (2U)

/*! @name NTENURELINES_0 - Number of Transaction Probe Lines */
/*! @{ */

#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_NTENURELINES_0_NTENURELINES_0_MASK (0x7U)
#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_NTENURELINES_0_NTENURELINES_0_SHIFT (0U)
#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_NTENURELINES_0_NTENURELINES_0(x) (((uint32_t)(((uint32_t)(x)) << NOC_JPEG_ENC_PROBE_XSTATPROFILER_NTENURELINES_0_NTENURELINES_0_SHIFT)) & NOC_JPEG_ENC_PROBE_XSTATPROFILER_NTENURELINES_0_NTENURELINES_0_MASK)
/*! @} */

/*! @name TRANSACTIONSTATPROFILER_THRESHOLDS_ - Transaction Profiler Thresholds Register */
/*! @{ */

#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_TRANSACTIONSTATPROFILER_THRESHOLDS__THRESHOLDS_MASK (0x7FFU)
#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_TRANSACTIONSTATPROFILER_THRESHOLDS__THRESHOLDS_SHIFT (0U)
/*! THRESHOLDS - Thresholds 1 3 */
#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_TRANSACTIONSTATPROFILER_THRESHOLDS__THRESHOLDS(x) (((uint32_t)(((uint32_t)(x)) << NOC_JPEG_ENC_PROBE_XSTATPROFILER_TRANSACTIONSTATPROFILER_THRESHOLDS__THRESHOLDS_SHIFT)) & NOC_JPEG_ENC_PROBE_XSTATPROFILER_TRANSACTIONSTATPROFILER_THRESHOLDS__THRESHOLDS_MASK)
/*! @} */

/* The count of NOC_JPEG_ENC_PROBE_XSTATPROFILER_TRANSACTIONSTATPROFILER_THRESHOLDS_ */
#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_TRANSACTIONSTATPROFILER_THRESHOLDS__COUNT (2U)

/* The count of NOC_JPEG_ENC_PROBE_XSTATPROFILER_TRANSACTIONSTATPROFILER_THRESHOLDS_ */
#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_TRANSACTIONSTATPROFILER_THRESHOLDS__COUNT2 (4U)

/*! @name OVERFLOWSTATUS - Overflow Status */
/*! @{ */

#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_OVERFLOWSTATUS_OVERFLOWSTATUS_MASK (0x3U)
#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_OVERFLOWSTATUS_OVERFLOWSTATUS_SHIFT (0U)
#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_OVERFLOWSTATUS_OVERFLOWSTATUS(x) (((uint32_t)(((uint32_t)(x)) << NOC_JPEG_ENC_PROBE_XSTATPROFILER_OVERFLOWSTATUS_OVERFLOWSTATUS_SHIFT)) & NOC_JPEG_ENC_PROBE_XSTATPROFILER_OVERFLOWSTATUS_OVERFLOWSTATUS_MASK)
/*! @} */

/*! @name OVERFLOWRESET - Overflow Reset */
/*! @{ */

#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_OVERFLOWRESET_OVERFLOWRESET_MASK (0x3U)
#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_OVERFLOWRESET_OVERFLOWRESET_SHIFT (0U)
#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_OVERFLOWRESET_OVERFLOWRESET(x) (((uint32_t)(((uint32_t)(x)) << NOC_JPEG_ENC_PROBE_XSTATPROFILER_OVERFLOWRESET_OVERFLOWRESET_SHIFT)) & NOC_JPEG_ENC_PROBE_XSTATPROFILER_OVERFLOWRESET_OVERFLOWRESET_MASK)
/*! @} */

/*! @name PENDINGEVENTMODE - Pending Event Mode */
/*! @{ */

#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_PENDINGEVENTMODE_PENDINGEVENTMODE_MASK (0x1U)
#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_PENDINGEVENTMODE_PENDINGEVENTMODE_SHIFT (0U)
#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_PENDINGEVENTMODE_PENDINGEVENTMODE(x) (((uint32_t)(((uint32_t)(x)) << NOC_JPEG_ENC_PROBE_XSTATPROFILER_PENDINGEVENTMODE_PENDINGEVENTMODE_SHIFT)) & NOC_JPEG_ENC_PROBE_XSTATPROFILER_PENDINGEVENTMODE_PENDINGEVENTMODE_MASK)
/*! @} */

/*! @name PRESCALER - Pre Scaler */
/*! @{ */

#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_PRESCALER_PRESCALER_MASK (0xFFU)
#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_PRESCALER_PRESCALER_SHIFT (0U)
#define NOC_JPEG_ENC_PROBE_XSTATPROFILER_PRESCALER_PRESCALER(x) (((uint32_t)(((uint32_t)(x)) << NOC_JPEG_ENC_PROBE_XSTATPROFILER_PRESCALER_PRESCALER_SHIFT)) & NOC_JPEG_ENC_PROBE_XSTATPROFILER_PRESCALER_PRESCALER_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group NOC_JPEG_ENC_PROBE_XSTATPROFILER_Register_Masks */


/*!
 * @}
 */ /* end of group NOC_JPEG_ENC_PROBE_XSTATPROFILER_Peripheral_Access_Layer */
...
#endif  /* PERI_NOC_JPEG_ENC_PROBE_XSTATPROFILER_H_ */
