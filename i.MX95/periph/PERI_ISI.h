...
#if !defined(ISI_H_)
#define ISI_H_                                   /**< Symbol preventing repeated inclusion */
...
typedef struct {
  ...
  __IO uint32_t CHNL_Y_BUF1_XTND_ADDR;             /**< Channel Output Y-Buffer 1 Extended Address, offset: 0xA0 */
  __IO uint32_t CHNL_U_BUF1_XTND_ADDR;             /**< Channel Output U-Buffer 1 Extended Address, offset: 0xA4 */
  __IO uint32_t CHNL_V_BUF1_XTND_ADDR;             /**< Channel Output V-Buffer 1 Extended Address, offset: 0xA8 */
  __IO uint32_t CHNL_Y_BUF2_XTND_ADDR;             /**< Channel Output Y-Buffer 2 Extended Address, offset: 0xAC */
  __IO uint32_t CHNL_U_BUF2_XTND_ADDR;             /**< Channel Output U-Buffer 2 Extended Address, offset: 0xB0 */
  __IO uint32_t CHNL_V_BUF2_XTND_ADDR;             /**< Channel Output V-Buffer 2 Extended Address, offset: 0xB4 */
  __IO uint32_t CHNL_IN_BUF_XTND_ADDR;             /**< Channel Input Buffer Extended Address, offset: 0xB8 */
       uint8_t RESERVED_0[4];
  __IO uint32_t PIXEL_DATA_ADDR_OFFSET;            /**< RAW32 Pixel Data Offset, offset: 0xC0 */
  __IO uint32_t STAT_DATA_ADDR_OFFSET;             /**< RAW32 Statistics Data Offset, offset: 0xC4 */
  __IO uint32_t CHNL_IMG_CFG2;                     /**< Channel Image Configuration 2, offset: 0xC8 */
  __IO uint32_t CHNL_IMG_CFG3;                     /**< Channel Image Configuration 3, offset: 0xCC */
  __IO uint32_t CHNL_OUT_BUF_MAX_SIZE_Y;           /**< Channel RGB or Luma (Y) Output Buffer Max Size, offset: 0xD0 */
  __IO uint32_t CHNL_OUT_BUF_MAX_SIZE_U;           /**< Channel Chroma (U/Cb/UV/CbCr) Output Buffer Max Size, offset: 0xD4 */
  __IO uint32_t CHNL_OUT_BUF_MAX_SIZE_V;           /**< Channel Chroma (V/Cr) Output Buffer Max Size, offset: 0xD8 */
} ISI_Type;
...
#define ISI_CHNL_CTRL_VC_ID_0_MASK               (0xC0U)
#define ISI_CHNL_CTRL_VC_ID_0_SHIFT              (6U)
 ...
 */
#define ISI_CHNL_CTRL_VC_ID_0(x)                 (((uint32_t)(((uint32_t)(x)) << ISI_CHNL_CTRL_VC_ID_0_SHIFT)) & ISI_CHNL_CTRL_VC_ID_0_MASK)
...
#define ISI_CHNL_CTRL_VC_ID_1_MASK               (0x10000U)
#define ISI_CHNL_CTRL_VC_ID_1_SHIFT              (16U)
/*! VC_ID_1 - Virtual Channel ID
 *  0b0..Virtual channel 0 to 3 selected
 *  0b1..Virtual channel 4 to 7 selected
 */
#define ISI_CHNL_CTRL_VC_ID_1(x)                 (((uint32_t)(((uint32_t)(x)) << ISI_CHNL_CTRL_VC_ID_1_SHIFT)) & ISI_CHNL_CTRL_VC_ID_1_MASK)
...
#define ISI_CHNL_IMG_CFG_HEIGHT_MASK             (0x3FFF0000U)
...
#define ISI_CHNL_IER_LINE_NO_PIXEL_ERR_EN_MASK   (0x1U)
#define ISI_CHNL_IER_LINE_NO_PIXEL_ERR_EN_SHIFT  (0U)
/*! LINE_NO_PIXEL_ERR_EN - No Pixel Data Detected in a Line Error Interrupt Enable
 *  0b0..Disable
 *  0b1..Enable
 */
#define ISI_CHNL_IER_LINE_NO_PIXEL_ERR_EN(x)     (((uint32_t)(((uint32_t)(x)) << ISI_CHNL_IER_LINE_NO_PIXEL_ERR_EN_SHIFT)) & ISI_CHNL_IER_LINE_NO_PIXEL_ERR_EN_MASK)

#define ISI_CHNL_IER_FRAME_NO_PIXEL_ERR_EN_MASK  (0x2U)
#define ISI_CHNL_IER_FRAME_NO_PIXEL_ERR_EN_SHIFT (1U)
/*! FRAME_NO_PIXEL_ERR_EN - No Pixel Data is Detected in a Frame Error Interrupt Enable
 *  0b0..Disable
 *  0b1..Enable
 */
#define ISI_CHNL_IER_FRAME_NO_PIXEL_ERR_EN(x)    (((uint32_t)(((uint32_t)(x)) << ISI_CHNL_IER_FRAME_NO_PIXEL_ERR_EN_SHIFT)) & ISI_CHNL_IER_FRAME_NO_PIXEL_ERR_EN_MASK)

#define ISI_CHNL_IER_LATE_HSYNC2_ERR_EN_MASK     (0x4U)
#define ISI_CHNL_IER_LATE_HSYNC2_ERR_EN_SHIFT    (2U)
/*! LATE_HSYNC2_ERR_EN - HSYNC Timing (Late) Error Interrupt Enable for RAW32 staggered pixel lines
 *  0b0..Disable
 *  0b1..Enable
 */
#define ISI_CHNL_IER_LATE_HSYNC2_ERR_EN(x)       (((uint32_t)(((uint32_t)(x)) << ISI_CHNL_IER_LATE_HSYNC2_ERR_EN_SHIFT)) & ISI_CHNL_IER_LATE_HSYNC2_ERR_EN_MASK)

#define ISI_CHNL_IER_LATE_HSYNC_ERR_EN_MASK      (0x8U)
#define ISI_CHNL_IER_LATE_HSYNC_ERR_EN_SHIFT     (3U)
/*! LATE_HSYNC_ERR_EN - HSYNC Timing (Late) Error Interrupt Flag Error Interrupt Enable
 *  0b0..Disable
 *  0b1..Enable
 */
#define ISI_CHNL_IER_LATE_HSYNC_ERR_EN(x)        (((uint32_t)(((uint32_t)(x)) << ISI_CHNL_IER_LATE_HSYNC_ERR_EN_SHIFT)) & ISI_CHNL_IER_LATE_HSYNC_ERR_EN_MASK)

#define ISI_CHNL_IER_OUT_MEM_LOC_Y_EN_MASK       (0x10U)
#define ISI_CHNL_IER_OUT_MEM_LOC_Y_EN_SHIFT      (4U)
/*! OUT_MEM_LOC_Y_EN - Tentative Write Out of Valid Channel RGB or Luma (Y) Output Buffer Error Interrupt Enable
 *  0b0..Disable
 *  0b1..Enable
 */
#define ISI_CHNL_IER_OUT_MEM_LOC_Y_EN(x)         (((uint32_t)(((uint32_t)(x)) << ISI_CHNL_IER_OUT_MEM_LOC_Y_EN_SHIFT)) & ISI_CHNL_IER_OUT_MEM_LOC_Y_EN_MASK)

#define ISI_CHNL_IER_OUT_MEM_LOC_U_EN_MASK       (0x20U)
#define ISI_CHNL_IER_OUT_MEM_LOC_U_EN_SHIFT      (5U)
/*! OUT_MEM_LOC_U_EN - Tentative Write Out of Valid Channel Chroma (U/Cb/UV/CbCr) Output Buffer Error Interrupt Enable
 *  0b0..Disable
 *  0b1..Enable
 */
#define ISI_CHNL_IER_OUT_MEM_LOC_U_EN(x)         (((uint32_t)(((uint32_t)(x)) << ISI_CHNL_IER_OUT_MEM_LOC_U_EN_SHIFT)) & ISI_CHNL_IER_OUT_MEM_LOC_U_EN_MASK)

#define ISI_CHNL_IER_OUT_MEM_LOC_V_EN_MASK       (0x40U)
#define ISI_CHNL_IER_OUT_MEM_LOC_V_EN_SHIFT      (6U)
/*! OUT_MEM_LOC_V_EN - Tentative Write Out of Valid Channel Chroma (V/Cr) Output Buffer Error Interrupt Enable
 *  0b0..Disable
 *  0b1..Enable
 */
#define ISI_CHNL_IER_OUT_MEM_LOC_V_EN(x)         (((uint32_t)(((uint32_t)(x)) << ISI_CHNL_IER_OUT_MEM_LOC_V_EN_SHIFT)) & ISI_CHNL_IER_OUT_MEM_LOC_V_EN_MASK)
...
#define ISI_CHNL_STS_LINE_NO_PIXEL_MASK          (0x1U)
#define ISI_CHNL_STS_LINE_NO_PIXEL_SHIFT         (0U)
/*! LINE_NO_PIXEL - No Pixel Data Detected in Line
 *  0b0..No error
 *  0b1..No pixel detected
 */
#define ISI_CHNL_STS_LINE_NO_PIXEL(x)            (((uint32_t)(((uint32_t)(x)) << ISI_CHNL_STS_LINE_NO_PIXEL_SHIFT)) & ISI_CHNL_STS_LINE_NO_PIXEL_MASK)

#define ISI_CHNL_STS_FRAME_NO_PIXEL_MASK         (0x2U)
#define ISI_CHNL_STS_FRAME_NO_PIXEL_SHIFT        (1U)
/*! FRAME_NO_PIXEL - No Pixel Data in Frame
 *  0b0..No error
 *  0b1..No pixel detected
 */
#define ISI_CHNL_STS_FRAME_NO_PIXEL(x)           (((uint32_t)(((uint32_t)(x)) << ISI_CHNL_STS_FRAME_NO_PIXEL_SHIFT)) & ISI_CHNL_STS_FRAME_NO_PIXEL_MASK)

#define ISI_CHNL_STS_LATE_HSYNC2_ERR_MASK        (0x4U)
#define ISI_CHNL_STS_LATE_HSYNC2_ERR_SHIFT       (2U)
/*! LATE_HSYNC2_ERR - HSYNC Timing (Late) Error Interrupt Flag for RAW32 Staggered Pixel Lines
 *  0b0..No error
 *  0b1..HSYNC detected later
 */
#define ISI_CHNL_STS_LATE_HSYNC2_ERR(x)          (((uint32_t)(((uint32_t)(x)) << ISI_CHNL_STS_LATE_HSYNC2_ERR_SHIFT)) & ISI_CHNL_STS_LATE_HSYNC2_ERR_MASK)

#define ISI_CHNL_STS_LATE_HSYNC_ERR_MASK         (0x8U)
#define ISI_CHNL_STS_LATE_HSYNC_ERR_SHIFT        (3U)
/*! LATE_HSYNC_ERR - HSYNC Timing (Late) Error Interrupt flag
 *  0b0..No error
 *  0b1..HSYNC detected later
 */
#define ISI_CHNL_STS_LATE_HSYNC_ERR(x)           (((uint32_t)(((uint32_t)(x)) << ISI_CHNL_STS_LATE_HSYNC_ERR_SHIFT)) & ISI_CHNL_STS_LATE_HSYNC_ERR_MASK)

#define ISI_CHNL_STS_OUT_MEM_LOC_Y_MASK          (0x10U)
#define ISI_CHNL_STS_OUT_MEM_LOC_Y_SHIFT         (4U)
/*! OUT_MEM_LOC_Y - Tentative Write Detected Out of valid Channel RGB or Luma (Y) Output Buffer
 *  0b0..No error
 *  0b1..Tentative write is detected
 */
#define ISI_CHNL_STS_OUT_MEM_LOC_Y(x)            (((uint32_t)(((uint32_t)(x)) << ISI_CHNL_STS_OUT_MEM_LOC_Y_SHIFT)) & ISI_CHNL_STS_OUT_MEM_LOC_Y_MASK)

#define ISI_CHNL_STS_OUT_MEM_LOC_U_MASK          (0x20U)
#define ISI_CHNL_STS_OUT_MEM_LOC_U_SHIFT         (5U)
/*! OUT_MEM_LOC_U - Tentative Write Detected Out of Valid Channel Chroma (U/Cb/UV/CbCr) Output Buffer
 *  0b0..No error
 *  0b1..Tentative write is detected
 */
#define ISI_CHNL_STS_OUT_MEM_LOC_U(x)            (((uint32_t)(((uint32_t)(x)) << ISI_CHNL_STS_OUT_MEM_LOC_U_SHIFT)) & ISI_CHNL_STS_OUT_MEM_LOC_U_MASK)

#define ISI_CHNL_STS_OUT_MEM_LOC_V_MASK          (0x40U)
#define ISI_CHNL_STS_OUT_MEM_LOC_V_SHIFT         (6U)
/*! OUT_MEM_LOC_V - Tentative Write Detected Out of Valid Channel Chroma (V/Cr) Output Buffer
 *  0b0..No error
 *  0b1..Tentative write is detected
 */
#define ISI_CHNL_STS_OUT_MEM_LOC_V(x)            (((uint32_t)(((uint32_t)(x)) << ISI_CHNL_STS_OUT_MEM_LOC_V_SHIFT)) & ISI_CHNL_STS_OUT_MEM_LOC_V_MASK)
...
#define ISI_CHNL_CROP_ULC_Y_MASK                 (0x1FFFU)
...
#define ISI_CHNL_CROP_LRC_Y_MASK                 (0x1FFFU)
...
#define ISI_CHNL_ROI_ULC_Y_MASK                  (0x1FFFU)
...
#define ISI_CHNL_ROI_LRC_Y_MASK                  (0x1FFFU)
...
#define ISI_CHNL_SCL_IMG_CFG_HEIGHT_MASK         (0x3FFF0000U)
...
/*! @name CHNL_Y_BUF1_XTND_ADDR - Channel Output Y-Buffer 1 Extended Address */
/*! @{ */

#define ISI_CHNL_Y_BUF1_XTND_ADDR_Y1ADDR_MSB_MASK (0xFFFU)
#define ISI_CHNL_Y_BUF1_XTND_ADDR_Y1ADDR_MSB_SHIFT (0U)
/*! Y1ADDR_MSB - Extended Address Most Significant Bits */
#define ISI_CHNL_Y_BUF1_XTND_ADDR_Y1ADDR_MSB(x)  (((uint32_t)(((uint32_t)(x)) << ISI_CHNL_Y_BUF1_XTND_ADDR_Y1ADDR_MSB_SHIFT)) & ISI_CHNL_Y_BUF1_XTND_ADDR_Y1ADDR_MSB_MASK)
/*! @} */

/*! @name CHNL_U_BUF1_XTND_ADDR - Channel Output U-Buffer 1 Extended Address */
/*! @{ */

#define ISI_CHNL_U_BUF1_XTND_ADDR_U1ADDR_MSB_MASK (0xFFFU)
#define ISI_CHNL_U_BUF1_XTND_ADDR_U1ADDR_MSB_SHIFT (0U)
/*! U1ADDR_MSB - Extended Address Most Significant Bits */
#define ISI_CHNL_U_BUF1_XTND_ADDR_U1ADDR_MSB(x)  (((uint32_t)(((uint32_t)(x)) << ISI_CHNL_U_BUF1_XTND_ADDR_U1ADDR_MSB_SHIFT)) & ISI_CHNL_U_BUF1_XTND_ADDR_U1ADDR_MSB_MASK)
/*! @} */

/*! @name CHNL_V_BUF1_XTND_ADDR - Channel Output V-Buffer 1 Extended Address */
/*! @{ */

#define ISI_CHNL_V_BUF1_XTND_ADDR_V1ADDR_MSB_MASK (0xFFFU)
#define ISI_CHNL_V_BUF1_XTND_ADDR_V1ADDR_MSB_SHIFT (0U)
/*! V1ADDR_MSB - Extended Address Most Significant Bits */
#define ISI_CHNL_V_BUF1_XTND_ADDR_V1ADDR_MSB(x)  (((uint32_t)(((uint32_t)(x)) << ISI_CHNL_V_BUF1_XTND_ADDR_V1ADDR_MSB_SHIFT)) & ISI_CHNL_V_BUF1_XTND_ADDR_V1ADDR_MSB_MASK)
/*! @} */

/*! @name CHNL_Y_BUF2_XTND_ADDR - Channel Output Y-Buffer 2 Extended Address */
/*! @{ */

#define ISI_CHNL_Y_BUF2_XTND_ADDR_Y2ADDR_MSB_MASK (0xFFFU)
#define ISI_CHNL_Y_BUF2_XTND_ADDR_Y2ADDR_MSB_SHIFT (0U)
/*! Y2ADDR_MSB - Extended Address Most Significant Bits */
#define ISI_CHNL_Y_BUF2_XTND_ADDR_Y2ADDR_MSB(x)  (((uint32_t)(((uint32_t)(x)) << ISI_CHNL_Y_BUF2_XTND_ADDR_Y2ADDR_MSB_SHIFT)) & ISI_CHNL_Y_BUF2_XTND_ADDR_Y2ADDR_MSB_MASK)
/*! @} */

/*! @name CHNL_U_BUF2_XTND_ADDR - Channel Output U-Buffer 2 Extended Address */
/*! @{ */

#define ISI_CHNL_U_BUF2_XTND_ADDR_U2ADDR_MSB_MASK (0xFFFU)
#define ISI_CHNL_U_BUF2_XTND_ADDR_U2ADDR_MSB_SHIFT (0U)
/*! U2ADDR_MSB - Extended Address Most Significant Bits */
#define ISI_CHNL_U_BUF2_XTND_ADDR_U2ADDR_MSB(x)  (((uint32_t)(((uint32_t)(x)) << ISI_CHNL_U_BUF2_XTND_ADDR_U2ADDR_MSB_SHIFT)) & ISI_CHNL_U_BUF2_XTND_ADDR_U2ADDR_MSB_MASK)
/*! @} */

/*! @name CHNL_V_BUF2_XTND_ADDR - Channel Output V-Buffer 2 Extended Address */
/*! @{ */

#define ISI_CHNL_V_BUF2_XTND_ADDR_V2ADDR_MSB_MASK (0xFFFU)
#define ISI_CHNL_V_BUF2_XTND_ADDR_V2ADDR_MSB_SHIFT (0U)
/*! V2ADDR_MSB - Extended Address Most Significant Bits */
#define ISI_CHNL_V_BUF2_XTND_ADDR_V2ADDR_MSB(x)  (((uint32_t)(((uint32_t)(x)) << ISI_CHNL_V_BUF2_XTND_ADDR_V2ADDR_MSB_SHIFT)) & ISI_CHNL_V_BUF2_XTND_ADDR_V2ADDR_MSB_MASK)
/*! @} */

/*! @name CHNL_IN_BUF_XTND_ADDR - Channel Input Buffer Extended Address */
/*! @{ */

#define ISI_CHNL_IN_BUF_XTND_ADDR_XADDR_MSB_MASK (0xFFFU)
#define ISI_CHNL_IN_BUF_XTND_ADDR_XADDR_MSB_SHIFT (0U)
/*! XADDR_MSB - Extended Address Most Significant Bits */
#define ISI_CHNL_IN_BUF_XTND_ADDR_XADDR_MSB(x)   (((uint32_t)(((uint32_t)(x)) << ISI_CHNL_IN_BUF_XTND_ADDR_XADDR_MSB_SHIFT)) & ISI_CHNL_IN_BUF_XTND_ADDR_XADDR_MSB_MASK)
/*! @} */
...
/*! @name CHNL_IMG_CFG2 - Channel Image Configuration 2 */
/*! @{ */

#define ISI_CHNL_IMG_CFG2_WIDTH_MASK             (0x1FFFU)
#define ISI_CHNL_IMG_CFG2_WIDTH_SHIFT            (0U)
/*! WIDTH - Input Image Width (Pixels) */
#define ISI_CHNL_IMG_CFG2_WIDTH(x)               (((uint32_t)(((uint32_t)(x)) << ISI_CHNL_IMG_CFG2_WIDTH_SHIFT)) & ISI_CHNL_IMG_CFG2_WIDTH_MASK)
/*! @} */

/*! @name CHNL_IMG_CFG3 - Channel Image Configuration 3 */
/*! @{ */

#define ISI_CHNL_IMG_CFG3_HEIGHT_MASK            (0x1FFFU)
#define ISI_CHNL_IMG_CFG3_HEIGHT_SHIFT           (0U)
/*! HEIGHT - Non-Pixel Data Height */
#define ISI_CHNL_IMG_CFG3_HEIGHT(x)              (((uint32_t)(((uint32_t)(x)) << ISI_CHNL_IMG_CFG3_HEIGHT_SHIFT)) & ISI_CHNL_IMG_CFG3_HEIGHT_MASK)
/*! @} */

/*! @name CHNL_OUT_BUF_MAX_SIZE_Y - Channel RGB or Luma (Y) Output Buffer Max Size */
/*! @{ */

#define ISI_CHNL_OUT_BUF_MAX_SIZE_Y_MS_MASK      (0xFFFFFFFFU)
#define ISI_CHNL_OUT_BUF_MAX_SIZE_Y_MS_SHIFT     (0U)
/*! MS - Max Size */
#define ISI_CHNL_OUT_BUF_MAX_SIZE_Y_MS(x)        (((uint32_t)(((uint32_t)(x)) << ISI_CHNL_OUT_BUF_MAX_SIZE_Y_MS_SHIFT)) & ISI_CHNL_OUT_BUF_MAX_SIZE_Y_MS_MASK)
/*! @} */

/*! @name CHNL_OUT_BUF_MAX_SIZE_U - Channel Chroma (U/Cb/UV/CbCr) Output Buffer Max Size */
/*! @{ */

#define ISI_CHNL_OUT_BUF_MAX_SIZE_U_MS_MASK      (0xFFFFFFFFU)
#define ISI_CHNL_OUT_BUF_MAX_SIZE_U_MS_SHIFT     (0U)
/*! MS - Max Size */
#define ISI_CHNL_OUT_BUF_MAX_SIZE_U_MS(x)        (((uint32_t)(((uint32_t)(x)) << ISI_CHNL_OUT_BUF_MAX_SIZE_U_MS_SHIFT)) & ISI_CHNL_OUT_BUF_MAX_SIZE_U_MS_MASK)
/*! @} */

/*! @name CHNL_OUT_BUF_MAX_SIZE_V - Channel Chroma (V/Cr) Output Buffer Max Size */
/*! @{ */

#define ISI_CHNL_OUT_BUF_MAX_SIZE_V_MS_MASK      (0xFFFFFFFFU)
#define ISI_CHNL_OUT_BUF_MAX_SIZE_V_MS_SHIFT     (0U)
/*! MS - Max Size */
#define ISI_CHNL_OUT_BUF_MAX_SIZE_V_MS(x)        (((uint32_t)(((uint32_t)(x)) << ISI_CHNL_OUT_BUF_MAX_SIZE_V_MS_SHIFT)) & ISI_CHNL_OUT_BUF_MAX_SIZE_V_MS_MASK)
/*! @} */
