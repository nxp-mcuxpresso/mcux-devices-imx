...
#define EIM_EICHD0_WORD0_CHKBIT_MASK_MASK        (0xFFFFF000U)  /* Merged from fields with different position or width, of widths (8, 14, 20), largest definition used */
#define EIM_EICHD0_WORD0_CHKBIT_MASK_SHIFT       (12U)
/*! CHKBIT_MASK - Checkbit Mask */
#define EIM_EICHD0_WORD0_CHKBIT_MASK(x)          (((uint32_t)(((uint32_t)(x)) << EIM_EICHD0_WORD0_CHKBIT_MASK_SHIFT)) & EIM_EICHD0_WORD0_CHKBIT_MASK_MASK)  /* Merged from fields with different position or width, of widths (8, 14, 20), largest definition used */
/*! @} */
...
#define EIM_EICHD4_WORD0_CHKBIT_MASK_MASK        (0xFFFFFFF0U)  /* Merged from fields with different position or width, of widths (7, 28), largest definition used */
#define EIM_EICHD4_WORD0_CHKBIT_MASK_SHIFT       (4U)
/*! CHKBIT_MASK - Checkbit Mask */
#define EIM_EICHD4_WORD0_CHKBIT_MASK(x)          (((uint32_t)(((uint32_t)(x)) << EIM_EICHD4_WORD0_CHKBIT_MASK_SHIFT)) & EIM_EICHD4_WORD0_CHKBIT_MASK_MASK)  /* Merged from fields with different position or width, of widths (7, 28), largest definition used */
/*! @} */
...
#define EIM_EICHD7_WORD0_CHKBIT_MASK_MASK        (0xFF000000U)  /* Merged from fields with different position or width, of widths (7, 8), largest definition used */
#define EIM_EICHD7_WORD0_CHKBIT_MASK_SHIFT       (24U)
/*! CHKBIT_MASK - Checkbit Mask */
#define EIM_EICHD7_WORD0_CHKBIT_MASK(x)          (((uint32_t)(((uint32_t)(x)) << EIM_EICHD7_WORD0_CHKBIT_MASK_SHIFT)) & EIM_EICHD7_WORD0_CHKBIT_MASK_MASK)  /* Merged from fields with different position or width, of widths (7, 8), largest definition used */
/*! @} */
