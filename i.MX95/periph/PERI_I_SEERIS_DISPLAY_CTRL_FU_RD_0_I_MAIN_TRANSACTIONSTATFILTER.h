...
**         I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter
**
...
/*!
 * @file PERI_I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter.h
 * @version 1.0
 * @date 2023-01-10
...
#if !defined(PERI_I_SEERIS_DISPLAY_CTRL_FU_RD_0_I_MAIN_TRANSACTIONSTATFILTER_H_)
#define PERI_I_SEERIS_DISPLAY_CTRL_FU_RD_0_I_MAIN_TRANSACTIONSTATFILTER_H_ /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_Peripheral_Access_Layer I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter Peripheral Access Layer
 * @{
 */

/** I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter - Register Layout
 * Typedef */
typedef struct {
...
} I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_Type;

/* ----------------------------------------------------------------------------
   -- I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_Register_Masks I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter Register Masks
 * @{
 */
...
#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ID_COREID_CORETYPEID_MASK (0xFFU)
#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ID_COREID_CORETYPEID_SHIFT (0U)
#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ID_COREID_CORETYPEID(x) (((uint32_t)(((uint32_t)(x)) << I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ID_COREID_CORETYPEID_SHIFT)) & I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ID_COREID_CORETYPEID_MASK)

#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ID_COREID_CORECHECKSUM_MASK (0xFFFFFF00U)
#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ID_COREID_CORECHECKSUM_SHIFT (8U)
#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ID_COREID_CORECHECKSUM(x) (((uint32_t)(((uint32_t)(x)) << I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ID_COREID_CORECHECKSUM_SHIFT)) & I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ID_COREID_CORECHECKSUM_MASK)
/*! @} */

/*! @name ID_REVISIONID - Revision ID */
/*! @{ */

#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ID_REVISIONID_USERID_MASK (0xFFU)
#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ID_REVISIONID_USERID_SHIFT (0U)
#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ID_REVISIONID_USERID(x) (((uint32_t)(((uint32_t)(x)) << I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ID_REVISIONID_USERID_SHIFT)) & I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ID_REVISIONID_USERID_MASK)

#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ID_REVISIONID_NOCID_MASK (0xFFFFFF00U)
#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ID_REVISIONID_NOCID_SHIFT (8U)
#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ID_REVISIONID_NOCID(x) (((uint32_t)(((uint32_t)(x)) << I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ID_REVISIONID_NOCID_SHIFT)) & I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ID_REVISIONID_NOCID_MASK)
/*! @} */

/*! @name MODE - Mode */
/*! @{ */

#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_MODE_MODE_MASK (0x1U)
#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_MODE_MODE_SHIFT (0U)
#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_MODE_MODE(x) (((uint32_t)(((uint32_t)(x)) << I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_MODE_MODE_SHIFT)) & I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_MODE_MODE_MASK)
/*! @} */

/*! @name ADDRBASE_LOW - Address Base LSB */
/*! @{ */

#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ADDRBASE_LOW_ADDRBASE_LOW_MASK (0xFFFFFFFFU)
#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ADDRBASE_LOW_ADDRBASE_LOW_SHIFT (0U)
#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ADDRBASE_LOW_ADDRBASE_LOW(x) (((uint32_t)(((uint32_t)(x)) << I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ADDRBASE_LOW_ADDRBASE_LOW_SHIFT)) & I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ADDRBASE_LOW_ADDRBASE_LOW_MASK)
/*! @} */

/*! @name ADDRBASE_HIGH - Address Base MSB */
/*! @{ */

#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ADDRBASE_HIGH_ADDRBASE_HIGH_MASK (0xFFU)
#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ADDRBASE_HIGH_ADDRBASE_HIGH_SHIFT (0U)
#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ADDRBASE_HIGH_ADDRBASE_HIGH(x) (((uint32_t)(((uint32_t)(x)) << I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ADDRBASE_HIGH_ADDRBASE_HIGH_SHIFT)) & I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ADDRBASE_HIGH_ADDRBASE_HIGH_MASK)
/*! @} */

/*! @name ADDRWINDOWSIZE - Address Window Size */
/*! @{ */

#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ADDRWINDOWSIZE_ADDRWINDOWSIZE_MASK (0x3FU)
#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ADDRWINDOWSIZE_ADDRWINDOWSIZE_SHIFT (0U)
#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ADDRWINDOWSIZE_ADDRWINDOWSIZE(x) (((uint32_t)(((uint32_t)(x)) << I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ADDRWINDOWSIZE_ADDRWINDOWSIZE_SHIFT)) & I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_ADDRWINDOWSIZE_ADDRWINDOWSIZE_MASK)
/*! @} */

/*! @name OPCODE - Packet Opcode */
/*! @{ */

#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_OPCODE_RDEN_MASK (0x1U)
#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_OPCODE_RDEN_SHIFT (0U)
#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_OPCODE_RDEN(x) (((uint32_t)(((uint32_t)(x)) << I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_OPCODE_RDEN_SHIFT)) & I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_OPCODE_RDEN_MASK)

#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_OPCODE_WREN_MASK (0x2U)
#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_OPCODE_WREN_SHIFT (1U)
#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_OPCODE_WREN(x) (((uint32_t)(((uint32_t)(x)) << I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_OPCODE_WREN_SHIFT)) & I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_OPCODE_WREN_MASK)
/*! @} */

/*! @name USERBASE - User Base */
/*! @{ */

#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_USERBASE_USERBASE_MASK (0xFFFFFFFU)
#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_USERBASE_USERBASE_SHIFT (0U)
#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_USERBASE_USERBASE(x) (((uint32_t)(((uint32_t)(x)) << I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_USERBASE_USERBASE_SHIFT)) & I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_USERBASE_USERBASE_MASK)
/*! @} */

/*! @name USERMASK - User Mask */
/*! @{ */

#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_USERMASK_USERMASK_MASK (0xFFFFFFFU)
#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_USERMASK_USERMASK_SHIFT (0U)
#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_USERMASK_USERMASK(x) (((uint32_t)(((uint32_t)(x)) << I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_USERMASK_USERMASK_SHIFT)) & I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_USERMASK_USERMASK_MASK)
/*! @} */

/*! @name SECURITYBASE - Security Base */
/*! @{ */

#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_SECURITYBASE_SECURITYBASE_MASK (0x7U)
#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_SECURITYBASE_SECURITYBASE_SHIFT (0U)
#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_SECURITYBASE_SECURITYBASE(x) (((uint32_t)(((uint32_t)(x)) << I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_SECURITYBASE_SECURITYBASE_SHIFT)) & I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_SECURITYBASE_SECURITYBASE_MASK)
/*! @} */

/*! @name SECURITYMASK - Security Mask */
/*! @{ */

#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_SECURITYMASK_SECURITYMASK_MASK (0x7U)
#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_SECURITYMASK_SECURITYMASK_SHIFT (0U)
#define I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_SECURITYMASK_SECURITYMASK(x) (((uint32_t)(((uint32_t)(x)) << I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_SECURITYMASK_SECURITYMASK_SHIFT)) & I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_SECURITYMASK_SECURITYMASK_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_Register_Masks */


/*!
 * @}
 */ /* end of group I_Seeris_Display_Ctrl_FU_rd_0_I_main_TransactionStatFilter_Peripheral_Access_Layer */
...
#endif  /* PERI_I_SEERIS_DISPLAY_CTRL_FU_RD_0_I_MAIN_TRANSACTIONSTATFILTER_H_ */
