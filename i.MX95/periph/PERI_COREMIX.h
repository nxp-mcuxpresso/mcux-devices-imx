 ...
 * @version 1.0
 * @date 2023-01-10
 * @brief CMSIS Peripheral Access Layer for COREMIX
 *
 * CMSIS Peripheral Access Layer for COREMIX
 */

#if !defined(PERI_COREMIX_H_)
#define PERI_COREMIX_H_                          /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- COREMIX Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup COREMIX_Peripheral_Access_Layer COREMIX Peripheral Access Layer
 * @{
 */

/** COREMIX - Register Layout Typedef */
typedef struct {
...
/* ----------------------------------------------------------------------------
   -- COREMIX Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup COREMIX_Register_Masks COREMIX Register Masks
 * @{
 */
...
#define COREMIX_AUTHEN_CTRL_LPM_MODE_MASK        (0x4U)
#define COREMIX_AUTHEN_CTRL_LPM_MODE_SHIFT       (2U)
/*! LPM_MODE - Low power control mode
 *  0b0..Low power mode controlled by software
 *  0b1..Low power mode controlled by GPC hardware
 */
#define COREMIX_AUTHEN_CTRL_LPM_MODE(x)          (((uint32_t)(((uint32_t)(x)) << COREMIX_AUTHEN_CTRL_LPM_MODE_SHIFT)) & COREMIX_AUTHEN_CTRL_LPM_MODE_MASK)

#define COREMIX_AUTHEN_CTRL_LOCK_CFG_MASK        (0x80U)
#define COREMIX_AUTHEN_CTRL_LOCK_CFG_SHIFT       (7U)
 ...
 */
#define COREMIX_AUTHEN_CTRL_LOCK_CFG(x)          (((uint32_t)(((uint32_t)(x)) << COREMIX_AUTHEN_CTRL_LOCK_CFG_SHIFT)) & COREMIX_AUTHEN_CTRL_LOCK_CFG_MASK)

#define COREMIX_AUTHEN_CTRL_TZ_USER_MASK         (0x100U)
#define COREMIX_AUTHEN_CTRL_TZ_USER_SHIFT        (8U)
 ...
 */
#define COREMIX_AUTHEN_CTRL_TZ_USER(x)           (((uint32_t)(((uint32_t)(x)) << COREMIX_AUTHEN_CTRL_TZ_USER_SHIFT)) & COREMIX_AUTHEN_CTRL_TZ_USER_MASK)

#define COREMIX_AUTHEN_CTRL_TZ_NS_MASK           (0x200U)
#define COREMIX_AUTHEN_CTRL_TZ_NS_SHIFT          (9U)
 ...
 */
#define COREMIX_AUTHEN_CTRL_TZ_NS(x)             (((uint32_t)(((uint32_t)(x)) << COREMIX_AUTHEN_CTRL_TZ_NS_SHIFT)) & COREMIX_AUTHEN_CTRL_TZ_NS_MASK)

#define COREMIX_AUTHEN_CTRL_LOCK_TZ_MASK         (0x800U)
#define COREMIX_AUTHEN_CTRL_LOCK_TZ_SHIFT        (11U)
/*! LOCK_TZ - Lock NONSECURE and USER
 *  0b0..TZ_NS and TZ_USER value can be changed.
 *  0b1..TZ_NS and TZ_USER value cannot be changed.
 */
#define COREMIX_AUTHEN_CTRL_LOCK_TZ(x)           (((uint32_t)(((uint32_t)(x)) << COREMIX_AUTHEN_CTRL_LOCK_TZ_SHIFT)) & COREMIX_AUTHEN_CTRL_LOCK_TZ_MASK)

#define COREMIX_AUTHEN_CTRL_LOCK_LIST_MASK       (0x8000U)
#define COREMIX_AUTHEN_CTRL_LOCK_LIST_SHIFT      (15U)
/*! LOCK_LIST - White list lock
 *  0b0..WHITE_LIST value can be changed.
 *  0b1..WHITE_LIST value cannot be changed.
 */
#define COREMIX_AUTHEN_CTRL_LOCK_LIST(x)         (((uint32_t)(((uint32_t)(x)) << COREMIX_AUTHEN_CTRL_LOCK_LIST_SHIFT)) & COREMIX_AUTHEN_CTRL_LOCK_LIST_MASK)

#define COREMIX_AUTHEN_CTRL_WHITE_LIST_MASK      (0xFFFF0000U)
#define COREMIX_AUTHEN_CTRL_WHITE_LIST_SHIFT     (16U)
 ...
 */
#define COREMIX_AUTHEN_CTRL_WHITE_LIST(x)        (((uint32_t)(((uint32_t)(x)) << COREMIX_AUTHEN_CTRL_WHITE_LIST_SHIFT)) & COREMIX_AUTHEN_CTRL_WHITE_LIST_MASK)
/*! @} */

/*! @name LPM_SETTING_0 - LPM Setting 0 */
/*! @{ */

#define COREMIX_LPM_SETTING_0_LPM_SETTING_CD_MASK (0x7U)
#define COREMIX_LPM_SETTING_0_LPM_SETTING_CD_SHIFT (0U)
/*! LPM_SETTING_CD - LPM setting of current domain */
#define COREMIX_LPM_SETTING_0_LPM_SETTING_CD(x)  (((uint32_t)(((uint32_t)(x)) << COREMIX_LPM_SETTING_0_LPM_SETTING_CD_SHIFT)) & COREMIX_LPM_SETTING_0_LPM_SETTING_CD_MASK)
/*! @} */

/*! @name LPM_SETTING_1 - LPM Setting 1 */
/*! @{ */

#define COREMIX_LPM_SETTING_1_LPM_SETTING_D0_MASK (0x7U)
...
#define COREMIX_LPM_SETTING_1_LPM_SETTING_D1_MASK (0x70U)
...
#define COREMIX_LPM_SETTING_1_LPM_SETTING_D2_MASK (0x700U)
...
#define COREMIX_LPM_SETTING_1_LPM_SETTING_D3_MASK (0x7000U)
...
#define COREMIX_LPM_SETTING_1_LPM_SETTING_D4_MASK (0x70000U)
...
#define COREMIX_LPM_SETTING_1_LPM_SETTING_D5_MASK (0x700000U)
...
#define COREMIX_LPM_SETTING_1_LPM_SETTING_D6_MASK (0x7000000U)
...
#define COREMIX_LPM_SETTING_1_LPM_SETTING_D7_MASK (0x70000000U)
...
#define COREMIX_LPM_SETTING_2_LPM_SETTING_D8_MASK (0x7U)
...
#define COREMIX_LPM_SETTING_2_LPM_SETTING_D9_MASK (0x70U)
...
#define COREMIX_LPM_SETTING_2_LPM_SETTING_D10_MASK (0x700U)
...
#define COREMIX_LPM_SETTING_2_LPM_SETTING_D11_MASK (0x7000U)
...
#define COREMIX_LPM_SETTING_2_LPM_SETTING_D12_MASK (0x70000U)
...
#define COREMIX_LPM_SETTING_2_LPM_SETTING_D13_MASK (0x700000U)
...
#define COREMIX_LPM_SETTING_2_LPM_SETTING_D14_MASK (0x7000000U)
...
#define COREMIX_LPM_SETTING_2_LPM_SETTING_D15_MASK (0x70000000U)
...
#define COREMIX_SLICE_SW_CTRL_PDN_SOFT_MASK      (0x80000000U)
#define COREMIX_SLICE_SW_CTRL_PDN_SOFT_SHIFT     (31U)
/*! PDN_SOFT - Software power trans control, including reset, iso, and power switch.
 *  0b0..Power Up Request
 *  0b1..Power Down Request
 */
#define COREMIX_SLICE_SW_CTRL_PDN_SOFT(x)        (((uint32_t)(((uint32_t)(x)) << COREMIX_SLICE_SW_CTRL_PDN_SOFT_SHIFT)) & COREMIX_SLICE_SW_CTRL_PDN_SOFT_MASK)
/*! @} */
...
#define COREMIX_A55_HDSK_ACK_CTRL_A55_HDSK_CNT_CFG_MASK (0xFFU)
#define COREMIX_A55_HDSK_ACK_CTRL_A55_HDSK_CNT_CFG_SHIFT (0U)
/*! A55_HDSK_CNT_CFG - A55 handshake count configure. Usage depends on CNT_MODE. Locked by LOCK_CFG field. */
#define COREMIX_A55_HDSK_ACK_CTRL_A55_HDSK_CNT_CFG(x) (((uint32_t)(((uint32_t)(x)) << COREMIX_A55_HDSK_ACK_CTRL_A55_HDSK_CNT_CFG_SHIFT)) & COREMIX_A55_HDSK_ACK_CTRL_A55_HDSK_CNT_CFG_MASK)

#define COREMIX_A55_HDSK_ACK_CTRL_CNT_MODE_MASK  (0xC0000000U)
#define COREMIX_A55_HDSK_ACK_CTRL_CNT_MODE_SHIFT (30U)
 ...
 */
#define COREMIX_A55_HDSK_ACK_CTRL_CNT_MODE(x)    (((uint32_t)(((uint32_t)(x)) << COREMIX_A55_HDSK_ACK_CTRL_CNT_MODE_SHIFT)) & COREMIX_A55_HDSK_ACK_CTRL_CNT_MODE_MASK)
/*! @} */

/*! @name A55_HDSK_ACK_STAT - A55 handshake acknowledge status */
/*! @{ */

#define COREMIX_A55_HDSK_ACK_STAT_PDN_ACK_CNT_MASK (0xFFU)
#define COREMIX_A55_HDSK_ACK_STAT_PDN_ACK_CNT_SHIFT (0U)
/*! PDN_ACK_CNT - A55 handshake power down acknowledge count. */
#define COREMIX_A55_HDSK_ACK_STAT_PDN_ACK_CNT(x) (((uint32_t)(((uint32_t)(x)) << COREMIX_A55_HDSK_ACK_STAT_PDN_ACK_CNT_SHIFT)) & COREMIX_A55_HDSK_ACK_STAT_PDN_ACK_CNT_MASK)

#define COREMIX_A55_HDSK_ACK_STAT_PUP_ACK_CNT_MASK (0xFF0000U)
#define COREMIX_A55_HDSK_ACK_STAT_PUP_ACK_CNT_SHIFT (16U)
/*! PUP_ACK_CNT - A55 handshake power up acknowledge count */
#define COREMIX_A55_HDSK_ACK_STAT_PUP_ACK_CNT(x) (((uint32_t)(((uint32_t)(x)) << COREMIX_A55_HDSK_ACK_STAT_PUP_ACK_CNT_SHIFT)) & COREMIX_A55_HDSK_ACK_STAT_PUP_ACK_CNT_MASK)

#define COREMIX_A55_HDSK_ACK_STAT_BUSY_A55_PDN_HDSK_MASK (0x40000000U)
#define COREMIX_A55_HDSK_ACK_STAT_BUSY_A55_PDN_HDSK_SHIFT (30U)
/*! BUSY_A55_PDN_HDSK - Busy requesting A55 power down handshake */
#define COREMIX_A55_HDSK_ACK_STAT_BUSY_A55_PDN_HDSK(x) (((uint32_t)(((uint32_t)(x)) << COREMIX_A55_HDSK_ACK_STAT_BUSY_A55_PDN_HDSK_SHIFT)) & COREMIX_A55_HDSK_ACK_STAT_BUSY_A55_PDN_HDSK_MASK)

#define COREMIX_A55_HDSK_ACK_STAT_BUSY_A55_PUP_HDSK_MASK (0x80000000U)
#define COREMIX_A55_HDSK_ACK_STAT_BUSY_A55_PUP_HDSK_SHIFT (31U)
/*! BUSY_A55_PUP_HDSK - Busy requesting A55 power up handshake */
#define COREMIX_A55_HDSK_ACK_STAT_BUSY_A55_PUP_HDSK(x) (((uint32_t)(((uint32_t)(x)) << COREMIX_A55_HDSK_ACK_STAT_BUSY_A55_PUP_HDSK_SHIFT)) & COREMIX_A55_HDSK_ACK_STAT_BUSY_A55_PUP_HDSK_MASK)
/*! @} */

/*! @name SYSMAN_ACK_CTRL - System Manager handshake acknowledge control */
/*! @{ */

#define COREMIX_SYSMAN_ACK_CTRL_SYSMAN_CNT_CFG_MASK (0xFFU)
#define COREMIX_SYSMAN_ACK_CTRL_SYSMAN_CNT_CFG_SHIFT (0U)
/*! SYSMAN_CNT_CFG - System Manager handshake count configure. Usage depends on CNT_MODE. Locked by LOCK_CFG field. */
#define COREMIX_SYSMAN_ACK_CTRL_SYSMAN_CNT_CFG(x) (((uint32_t)(((uint32_t)(x)) << COREMIX_SYSMAN_ACK_CTRL_SYSMAN_CNT_CFG_SHIFT)) & COREMIX_SYSMAN_ACK_CTRL_SYSMAN_CNT_CFG_MASK)

#define COREMIX_SYSMAN_ACK_CTRL_CNT_MODE_MASK    (0xC0000000U)
#define COREMIX_SYSMAN_ACK_CTRL_CNT_MODE_SHIFT   (30U)
/*! CNT_MODE - Configure the acknowledge counter working mode. Locked by LOCK_CFG field.
 ...
 */
#define COREMIX_SYSMAN_ACK_CTRL_CNT_MODE(x)      (((uint32_t)(((uint32_t)(x)) << COREMIX_SYSMAN_ACK_CTRL_CNT_MODE_SHIFT)) & COREMIX_SYSMAN_ACK_CTRL_CNT_MODE_MASK)
/*! @} */

/*! @name SYSMAN_ACK_STAT - System manager handshake acknowledge status */
/*! @{ */

#define COREMIX_SYSMAN_ACK_STAT_PDN_ACK_CNT_MASK (0xFFU)
#define COREMIX_SYSMAN_ACK_STAT_PDN_ACK_CNT_SHIFT (0U)
/*! PDN_ACK_CNT - System manager handshake power down acknowledge count. */
#define COREMIX_SYSMAN_ACK_STAT_PDN_ACK_CNT(x)   (((uint32_t)(((uint32_t)(x)) << COREMIX_SYSMAN_ACK_STAT_PDN_ACK_CNT_SHIFT)) & COREMIX_SYSMAN_ACK_STAT_PDN_ACK_CNT_MASK)

#define COREMIX_SYSMAN_ACK_STAT_PUP_ACK_CNT_MASK (0xFF0000U)
#define COREMIX_SYSMAN_ACK_STAT_PUP_ACK_CNT_SHIFT (16U)
/*! PUP_ACK_CNT - System manager handshake power up acknowledge count */
#define COREMIX_SYSMAN_ACK_STAT_PUP_ACK_CNT(x)   (((uint32_t)(((uint32_t)(x)) << COREMIX_SYSMAN_ACK_STAT_PUP_ACK_CNT_SHIFT)) & COREMIX_SYSMAN_ACK_STAT_PUP_ACK_CNT_MASK)

#define COREMIX_SYSMAN_ACK_STAT_BUSY_SYSMAN_PDN_MASK (0x40000000U)
#define COREMIX_SYSMAN_ACK_STAT_BUSY_SYSMAN_PDN_SHIFT (30U)
/*! BUSY_SYSMAN_PDN - Busy requesting System Manager power down handshake */
#define COREMIX_SYSMAN_ACK_STAT_BUSY_SYSMAN_PDN(x) (((uint32_t)(((uint32_t)(x)) << COREMIX_SYSMAN_ACK_STAT_BUSY_SYSMAN_PDN_SHIFT)) & COREMIX_SYSMAN_ACK_STAT_BUSY_SYSMAN_PDN_MASK)

#define COREMIX_SYSMAN_ACK_STAT_BUSY_SYSMAN_PUP_MASK (0x80000000U)
#define COREMIX_SYSMAN_ACK_STAT_BUSY_SYSMAN_PUP_SHIFT (31U)
/*! BUSY_SYSMAN_PUP - Busy requesting System manager power up handshake */
#define COREMIX_SYSMAN_ACK_STAT_BUSY_SYSMAN_PUP(x) (((uint32_t)(((uint32_t)(x)) << COREMIX_SYSMAN_ACK_STAT_BUSY_SYSMAN_PUP_SHIFT)) & COREMIX_SYSMAN_ACK_STAT_BUSY_SYSMAN_PUP_MASK)
/*! @} */

/*! @name SSAR_ACK_CTRL - SSAR acknowledge control */
/*! @{ */

#define COREMIX_SSAR_ACK_CTRL_SSAR_CNT_CFG_MASK  (0x3FFFU)
#define COREMIX_SSAR_ACK_CTRL_SSAR_CNT_CFG_SHIFT (0U)
/*! SSAR_CNT_CFG - ssar count configure. Usage depends on CNT_MODE. Locked by LOCK_CFG field. */
#define COREMIX_SSAR_ACK_CTRL_SSAR_CNT_CFG(x)    (((uint32_t)(((uint32_t)(x)) << COREMIX_SSAR_ACK_CTRL_SSAR_CNT_CFG_SHIFT)) & COREMIX_SSAR_ACK_CTRL_SSAR_CNT_CFG_MASK)

#define COREMIX_SSAR_ACK_CTRL_CNT_MODE_MASK      (0xC0000000U)
#define COREMIX_SSAR_ACK_CTRL_CNT_MODE_SHIFT     (30U)
/*! CNT_MODE - Configure the acknowledge counter working mode. Locked by LOCK_CFG field.
 ...
 */
#define COREMIX_SSAR_ACK_CTRL_CNT_MODE(x)        (((uint32_t)(((uint32_t)(x)) << COREMIX_SSAR_ACK_CTRL_CNT_MODE_SHIFT)) & COREMIX_SSAR_ACK_CTRL_CNT_MODE_MASK)
/*! @} */

/*! @name SSAR_ACK_STAT - SSAR acknowledge status */
/*! @{ */

#define COREMIX_SSAR_ACK_STAT_SAVE_ACK_CNT_MASK  (0x3FFFU)
#define COREMIX_SSAR_ACK_STAT_SAVE_ACK_CNT_SHIFT (0U)
/*! SAVE_ACK_CNT - SAVE acknowledge count, record the delay from stat change to acknowledge received */
#define COREMIX_SSAR_ACK_STAT_SAVE_ACK_CNT(x)    (((uint32_t)(((uint32_t)(x)) << COREMIX_SSAR_ACK_STAT_SAVE_ACK_CNT_SHIFT)) & COREMIX_SSAR_ACK_STAT_SAVE_ACK_CNT_MASK)

#define COREMIX_SSAR_ACK_STAT_RESTORE_ACK_CNT_MASK (0xFFFC000U)
#define COREMIX_SSAR_ACK_STAT_RESTORE_ACK_CNT_SHIFT (14U)
/*! RESTORE_ACK_CNT - RESTORE acknowledge count, record the delay from stat change to acknowledge received */
#define COREMIX_SSAR_ACK_STAT_RESTORE_ACK_CNT(x) (((uint32_t)(((uint32_t)(x)) << COREMIX_SSAR_ACK_STAT_RESTORE_ACK_CNT_SHIFT)) & COREMIX_SSAR_ACK_STAT_RESTORE_ACK_CNT_MASK)
...
#define COREMIX_SSAR_ACK_STAT_BUSY_SAVED_SHIFT   (30U)
/*! BUSY_SAVED - Busy requesting SSAR save */
#define COREMIX_SSAR_ACK_STAT_BUSY_SAVED(x)      (((uint32_t)(((uint32_t)(x)) << COREMIX_SSAR_ACK_STAT_BUSY_SAVED_SHIFT)) & COREMIX_SSAR_ACK_STAT_BUSY_SAVED_MASK)

#define COREMIX_SSAR_ACK_STAT_BUSY_RESTORE_MASK  (0x80000000U)
#define COREMIX_SSAR_ACK_STAT_BUSY_RESTORE_SHIFT (31U)
/*! BUSY_RESTORE - Busy requesting SSAR restore */
#define COREMIX_SSAR_ACK_STAT_BUSY_RESTORE(x)    (((uint32_t)(((uint32_t)(x)) << COREMIX_SSAR_ACK_STAT_BUSY_RESTORE_SHIFT)) & COREMIX_SSAR_ACK_STAT_BUSY_RESTORE_MASK)
/*! @} */

/*! @name PSW_ACK_CTRL_0 - Power switch acknowledge control */
/*! @{ */

#define COREMIX_PSW_ACK_CTRL_0_PUP_LF_CNT_CFG_MASK (0x3FFU)
#define COREMIX_PSW_ACK_CTRL_0_PUP_LF_CNT_CFG_SHIFT (0U)
/*! PUP_LF_CNT_CFG - PUP LF Count configure. Usage depends on CNT_MODE. Locked by LOCK_CFG field. */
#define COREMIX_PSW_ACK_CTRL_0_PUP_LF_CNT_CFG(x) (((uint32_t)(((uint32_t)(x)) << COREMIX_PSW_ACK_CTRL_0_PUP_LF_CNT_CFG_SHIFT)) & COREMIX_PSW_ACK_CTRL_0_PUP_LF_CNT_CFG_MASK)

#define COREMIX_PSW_ACK_CTRL_0_PUP_HF_CNT_CFG_MASK (0x3FF0000U)
#define COREMIX_PSW_ACK_CTRL_0_PUP_HF_CNT_CFG_SHIFT (16U)
/*! PUP_HF_CNT_CFG - PUP HF Count configure. Usage depends on CNT_MODE. Locked by LOCK_CFG field. */
#define COREMIX_PSW_ACK_CTRL_0_PUP_HF_CNT_CFG(x) (((uint32_t)(((uint32_t)(x)) << COREMIX_PSW_ACK_CTRL_0_PUP_HF_CNT_CFG_SHIFT)) & COREMIX_PSW_ACK_CTRL_0_PUP_HF_CNT_CFG_MASK)

#define COREMIX_PSW_ACK_CTRL_0_CNT_MODE_MASK     (0x30000000U)
#define COREMIX_PSW_ACK_CTRL_0_CNT_MODE_SHIFT    (28U)
/*! CNT_MODE - Configure the acknowledge counter working mode. Locked by LOCK_CFG field.
 ...
 */
#define COREMIX_PSW_ACK_CTRL_0_CNT_MODE(x)       (((uint32_t)(((uint32_t)(x)) << COREMIX_PSW_ACK_CTRL_0_CNT_MODE_SHIFT)) & COREMIX_PSW_ACK_CTRL_0_CNT_MODE_MASK)

#define COREMIX_PSW_ACK_CTRL_0_LF_ACK_INVERT_MASK (0x40000000U)
#define COREMIX_PSW_ACK_CTRL_0_LF_ACK_INVERT_SHIFT (30U)
/*! LF_ACK_INVERT - LF Acknowledge value is inverted from power switch control. Locked by LOCK_CFG field. */
#define COREMIX_PSW_ACK_CTRL_0_LF_ACK_INVERT(x)  (((uint32_t)(((uint32_t)(x)) << COREMIX_PSW_ACK_CTRL_0_LF_ACK_INVERT_SHIFT)) & COREMIX_PSW_ACK_CTRL_0_LF_ACK_INVERT_MASK)

#define COREMIX_PSW_ACK_CTRL_0_HF_ACK_INVERT_MASK (0x80000000U)
#define COREMIX_PSW_ACK_CTRL_0_HF_ACK_INVERT_SHIFT (31U)
/*! HF_ACK_INVERT - HF Acknowledge value is inverted from power switch control. Locked by LOCK_CFG field. */
#define COREMIX_PSW_ACK_CTRL_0_HF_ACK_INVERT(x)  (((uint32_t)(((uint32_t)(x)) << COREMIX_PSW_ACK_CTRL_0_HF_ACK_INVERT_SHIFT)) & COREMIX_PSW_ACK_CTRL_0_HF_ACK_INVERT_MASK)
/*! @} */

/*! @name PSW_ACK_CTRL_1 - Power switch acknowledge control */
/*! @{ */

#define COREMIX_PSW_ACK_CTRL_1_PDN_LF_CNT_CFG_MASK (0x3FFU)
#define COREMIX_PSW_ACK_CTRL_1_PDN_LF_CNT_CFG_SHIFT (0U)
/*! PDN_LF_CNT_CFG - PDN LF Count configure. Usage depends on CNT_MODE. Locked by LOCK_CFG field. */
#define COREMIX_PSW_ACK_CTRL_1_PDN_LF_CNT_CFG(x) (((uint32_t)(((uint32_t)(x)) << COREMIX_PSW_ACK_CTRL_1_PDN_LF_CNT_CFG_SHIFT)) & COREMIX_PSW_ACK_CTRL_1_PDN_LF_CNT_CFG_MASK)

#define COREMIX_PSW_ACK_CTRL_1_PDN_HF_CNT_CFG_MASK (0x3FF0000U)
#define COREMIX_PSW_ACK_CTRL_1_PDN_HF_CNT_CFG_SHIFT (16U)
/*! PDN_HF_CNT_CFG - PDN HF Count configure. Usage depends on CNT_MODE. Locked by LOCK_CFG field. */
#define COREMIX_PSW_ACK_CTRL_1_PDN_HF_CNT_CFG(x) (((uint32_t)(((uint32_t)(x)) << COREMIX_PSW_ACK_CTRL_1_PDN_HF_CNT_CFG_SHIFT)) & COREMIX_PSW_ACK_CTRL_1_PDN_HF_CNT_CFG_MASK)
/*! @} */

/*! @name PSW_ACK_STAT - PSW acknowledge status */
/*! @{ */

#define COREMIX_PSW_ACK_STAT_LF_ACK_CNT_MASK     (0x3FFU)
#define COREMIX_PSW_ACK_STAT_LF_ACK_CNT_SHIFT    (0U)
/*! LF_ACK_CNT - LF PSW acknowledge count */
#define COREMIX_PSW_ACK_STAT_LF_ACK_CNT(x)       (((uint32_t)(((uint32_t)(x)) << COREMIX_PSW_ACK_STAT_LF_ACK_CNT_SHIFT)) & COREMIX_PSW_ACK_STAT_LF_ACK_CNT_MASK)

#define COREMIX_PSW_ACK_STAT_HF_ACK_CNT_MASK     (0x3FF0000U)
#define COREMIX_PSW_ACK_STAT_HF_ACK_CNT_SHIFT    (16U)
/*! HF_ACK_CNT - HF PSW acknowledge count */
#define COREMIX_PSW_ACK_STAT_HF_ACK_CNT(x)       (((uint32_t)(((uint32_t)(x)) << COREMIX_PSW_ACK_STAT_HF_ACK_CNT_SHIFT)) & COREMIX_PSW_ACK_STAT_HF_ACK_CNT_MASK)

#define COREMIX_PSW_ACK_STAT_LF_ACK_STAT_MASK    (0x40000000U)
#define COREMIX_PSW_ACK_STAT_LF_ACK_STAT_SHIFT   (30U)
/*! LF_ACK_STAT - LF PSW acknowledge status */
#define COREMIX_PSW_ACK_STAT_LF_ACK_STAT(x)      (((uint32_t)(((uint32_t)(x)) << COREMIX_PSW_ACK_STAT_LF_ACK_STAT_SHIFT)) & COREMIX_PSW_ACK_STAT_LF_ACK_STAT_MASK)

#define COREMIX_PSW_ACK_STAT_HF_ACK_STAT_MASK    (0x80000000U)
#define COREMIX_PSW_ACK_STAT_HF_ACK_STAT_SHIFT   (31U)
/*! HF_ACK_STAT - HF PSW acknowledge status */
#define COREMIX_PSW_ACK_STAT_HF_ACK_STAT(x)      (((uint32_t)(((uint32_t)(x)) << COREMIX_PSW_ACK_STAT_HF_ACK_STAT_SHIFT)) & COREMIX_PSW_ACK_STAT_HF_ACK_STAT_MASK)
/*! @} */

/*! @name UPI_STAT_0 - UPI status 0 */
/*! @{ */

#define COREMIX_UPI_STAT_0_UPI_ISO_REQUEST_MASK  (0xFFFFU)
#define COREMIX_UPI_STAT_0_UPI_ISO_REQUEST_SHIFT (0U)
/*! UPI_ISO_REQUEST - CPU mode trans iso request of 16 domains */
#define COREMIX_UPI_STAT_0_UPI_ISO_REQUEST(x)    (((uint32_t)(((uint32_t)(x)) << COREMIX_UPI_STAT_0_UPI_ISO_REQUEST_SHIFT)) & COREMIX_UPI_STAT_0_UPI_ISO_REQUEST_MASK)

#define COREMIX_UPI_STAT_0_UPI_POWER_REQUEST_MASK (0xFFFF0000U)
#define COREMIX_UPI_STAT_0_UPI_POWER_REQUEST_SHIFT (16U)
/*! UPI_POWER_REQUEST - CPU mode trans power request of 16 domains */
#define COREMIX_UPI_STAT_0_UPI_POWER_REQUEST(x)  (((uint32_t)(((uint32_t)(x)) << COREMIX_UPI_STAT_0_UPI_POWER_REQUEST_SHIFT)) & COREMIX_UPI_STAT_0_UPI_POWER_REQUEST_MASK)
/*! @} */

/*! @name UPI_STAT_1 - UPI status 1 */
/*! @{ */

#define COREMIX_UPI_STAT_1_UPI_RESET_REQUEST_MASK (0xFFFFU)
#define COREMIX_UPI_STAT_1_UPI_RESET_REQUEST_SHIFT (0U)
/*! UPI_RESET_REQUEST - CPU mode trans reset request of 16 domains */
#define COREMIX_UPI_STAT_1_UPI_RESET_REQUEST(x)  (((uint32_t)(((uint32_t)(x)) << COREMIX_UPI_STAT_1_UPI_RESET_REQUEST_SHIFT)) & COREMIX_UPI_STAT_1_UPI_RESET_REQUEST_MASK)

#define COREMIX_UPI_STAT_1_UPI_SSAR_REQUEST_MASK (0xFFFF0000U)
#define COREMIX_UPI_STAT_1_UPI_SSAR_REQUEST_SHIFT (16U)
/*! UPI_SSAR_REQUEST - CPU mode trans ssar request of 16 domains */
#define COREMIX_UPI_STAT_1_UPI_SSAR_REQUEST(x)   (((uint32_t)(((uint32_t)(x)) << COREMIX_UPI_STAT_1_UPI_SSAR_REQUEST_SHIFT)) & COREMIX_UPI_STAT_1_UPI_SSAR_REQUEST_MASK)
/*! @} */

/*! @name UPI_STAT_2 - UPI status 2 */
/*! @{ */

#define COREMIX_UPI_STAT_2_UPI_A55_HDSK_REQUEST_MASK (0xFFFF0000U)
#define COREMIX_UPI_STAT_2_UPI_A55_HDSK_REQUEST_SHIFT (16U)
/*! UPI_A55_HDSK_REQUEST - CPU mode trans A55 handshake request of 16 domains */
#define COREMIX_UPI_STAT_2_UPI_A55_HDSK_REQUEST(x) (((uint32_t)(((uint32_t)(x)) << COREMIX_UPI_STAT_2_UPI_A55_HDSK_REQUEST_SHIFT)) & COREMIX_UPI_STAT_2_UPI_A55_HDSK_REQUEST_MASK)
/*! @} */

/*! @name UPI_STAT_3 - UPI status 3 */
/*! @{ */

#define COREMIX_UPI_STAT_3_UPI_MEM_REQUEST_MASK  (0xFFFFU)
#define COREMIX_UPI_STAT_3_UPI_MEM_REQUEST_SHIFT (0U)
/*! UPI_MEM_REQUEST - CPU mode trans mem request of 16 domains */
#define COREMIX_UPI_STAT_3_UPI_MEM_REQUEST(x)    (((uint32_t)(((uint32_t)(x)) << COREMIX_UPI_STAT_3_UPI_MEM_REQUEST_SHIFT)) & COREMIX_UPI_STAT_3_UPI_MEM_REQUEST_MASK)

#define COREMIX_UPI_STAT_3_UPI_SYSMAN_REQUEST_MASK (0xFFFF0000U)
#define COREMIX_UPI_STAT_3_UPI_SYSMAN_REQUEST_SHIFT (16U)
/*! UPI_SYSMAN_REQUEST - CPU mode trans system manager request of 16 domains */
#define COREMIX_UPI_STAT_3_UPI_SYSMAN_REQUEST(x) (((uint32_t)(((uint32_t)(x)) << COREMIX_UPI_STAT_3_UPI_SYSMAN_REQUEST_SHIFT)) & COREMIX_UPI_STAT_3_UPI_SYSMAN_REQUEST_MASK)
/*! @} */

/*! @name FSM_STAT - FSM status */
/*! @{ */

#define COREMIX_FSM_STAT_PSW_STAT_MASK           (0xFU)
#define COREMIX_FSM_STAT_PSW_STAT_SHIFT          (0U)
/*! PSW_STAT - Power switch FSM status */
#define COREMIX_FSM_STAT_PSW_STAT(x)             (((uint32_t)(((uint32_t)(x)) << COREMIX_FSM_STAT_PSW_STAT_SHIFT)) & COREMIX_FSM_STAT_PSW_STAT_MASK)

#define COREMIX_FSM_STAT_RST_STAT_MASK           (0xF0U)
#define COREMIX_FSM_STAT_RST_STAT_SHIFT          (4U)
/*! RST_STAT - Reset FSM status(rst_fsm_state 0-3bit) */
#define COREMIX_FSM_STAT_RST_STAT(x)             (((uint32_t)(((uint32_t)(x)) << COREMIX_FSM_STAT_RST_STAT_SHIFT)) & COREMIX_FSM_STAT_RST_STAT_MASK)

#define COREMIX_FSM_STAT_ISO_STAT_MASK           (0xF00U)
#define COREMIX_FSM_STAT_ISO_STAT_SHIFT          (8U)
/*! ISO_STAT - Isolation FSM status */
#define COREMIX_FSM_STAT_ISO_STAT(x)             (((uint32_t)(((uint32_t)(x)) << COREMIX_FSM_STAT_ISO_STAT_SHIFT)) & COREMIX_FSM_STAT_ISO_STAT_MASK)

#define COREMIX_FSM_STAT_RST_STAT_4BIT_MASK      (0x8000U)
#define COREMIX_FSM_STAT_RST_STAT_4BIT_SHIFT     (15U)
/*! RST_STAT_4BIT - Reset FSM status(rst_fsm_state 4bit) */
#define COREMIX_FSM_STAT_RST_STAT_4BIT(x)        (((uint32_t)(((uint32_t)(x)) << COREMIX_FSM_STAT_RST_STAT_4BIT_SHIFT)) & COREMIX_FSM_STAT_RST_STAT_4BIT_MASK)

#define COREMIX_FSM_STAT_SSAR_STAT_MASK          (0x70000U)
#define COREMIX_FSM_STAT_SSAR_STAT_SHIFT         (16U)
/*! SSAR_STAT - SSAR FSM status */
#define COREMIX_FSM_STAT_SSAR_STAT(x)            (((uint32_t)(((uint32_t)(x)) << COREMIX_FSM_STAT_SSAR_STAT_SHIFT)) & COREMIX_FSM_STAT_SSAR_STAT_MASK)

#define COREMIX_FSM_STAT_A55_HDSK_STAT_MASK      (0xF00000U)
#define COREMIX_FSM_STAT_A55_HDSK_STAT_SHIFT     (20U)
/*! A55_HDSK_STAT - A55 handshake FSM status */
#define COREMIX_FSM_STAT_A55_HDSK_STAT(x)        (((uint32_t)(((uint32_t)(x)) << COREMIX_FSM_STAT_A55_HDSK_STAT_SHIFT)) & COREMIX_FSM_STAT_A55_HDSK_STAT_MASK)

#define COREMIX_FSM_STAT_MEM_STAT_MASK           (0x7000000U)
#define COREMIX_FSM_STAT_MEM_STAT_SHIFT          (24U)
/*! MEM_STAT - Memory FSM status */
#define COREMIX_FSM_STAT_MEM_STAT(x)             (((uint32_t)(((uint32_t)(x)) << COREMIX_FSM_STAT_MEM_STAT_SHIFT)) & COREMIX_FSM_STAT_MEM_STAT_MASK)

#define COREMIX_FSM_STAT_SYSMAN_STAT_MASK        (0xF0000000U)
#define COREMIX_FSM_STAT_SYSMAN_STAT_SHIFT       (28U)
/*! SYSMAN_STAT - System Manager handshake FSM status */
#define COREMIX_FSM_STAT_SYSMAN_STAT(x)          (((uint32_t)(((uint32_t)(x)) << COREMIX_FSM_STAT_SYSMAN_STAT_SHIFT)) & COREMIX_FSM_STAT_SYSMAN_STAT_MASK)
/*! @} */

/*! @name FUNC_STAT - function status */
/*! @{ */

#define COREMIX_FUNC_STAT_PSW_STAT_MASK          (0x1U)
#define COREMIX_FUNC_STAT_PSW_STAT_SHIFT         (0U)
/*! PSW_STAT - Power switch status
 *  0b0..Power switch on
 *  0b1..Power switch off
 */
#define COREMIX_FUNC_STAT_PSW_STAT(x)            (((uint32_t)(((uint32_t)(x)) << COREMIX_FUNC_STAT_PSW_STAT_SHIFT)) & COREMIX_FUNC_STAT_PSW_STAT_MASK)

#define COREMIX_FUNC_STAT_RST_STAT_MASK          (0x4U)
#define COREMIX_FUNC_STAT_RST_STAT_SHIFT         (2U)
/*! RST_STAT - Reset status
 *  0b0..Reset assert
 *  0b1..Reset release
 */
#define COREMIX_FUNC_STAT_RST_STAT(x)            (((uint32_t)(((uint32_t)(x)) << COREMIX_FUNC_STAT_RST_STAT_SHIFT)) & COREMIX_FUNC_STAT_RST_STAT_MASK)

#define COREMIX_FUNC_STAT_ISO_STAT_MASK          (0x10U)
#define COREMIX_FUNC_STAT_ISO_STAT_SHIFT         (4U)
/*! ISO_STAT - Isolation status
 *  0b0..Isolation off
 *  0b1..Isolation on
 */
#define COREMIX_FUNC_STAT_ISO_STAT(x)            (((uint32_t)(((uint32_t)(x)) << COREMIX_FUNC_STAT_ISO_STAT_SHIFT)) & COREMIX_FUNC_STAT_ISO_STAT_MASK)

#define COREMIX_FUNC_STAT_SSAR_STAT_MASK         (0x100U)
#define COREMIX_FUNC_STAT_SSAR_STAT_SHIFT        (8U)
 ...
 */
#define COREMIX_FUNC_STAT_SSAR_STAT(x)           (((uint32_t)(((uint32_t)(x)) << COREMIX_FUNC_STAT_SSAR_STAT_SHIFT)) & COREMIX_FUNC_STAT_SSAR_STAT_MASK)

#define COREMIX_FUNC_STAT_A55_HDSK_STAT_MASK     (0x400U)
#define COREMIX_FUNC_STAT_A55_HDSK_STAT_SHIFT    (10U)
 ...
 */
#define COREMIX_FUNC_STAT_A55_HDSK_STAT(x)       (((uint32_t)(((uint32_t)(x)) << COREMIX_FUNC_STAT_A55_HDSK_STAT_SHIFT)) & COREMIX_FUNC_STAT_A55_HDSK_STAT_MASK)

#define COREMIX_FUNC_STAT_MEM_STAT_MASK          (0x1000U)
#define COREMIX_FUNC_STAT_MEM_STAT_SHIFT         (12U)
/*! MEM_STAT - Memory w/ status
 *  0b0..No effect or memory w/ exit LP done
 *  0b1..Memory w/ enter LP done
 */
#define COREMIX_FUNC_STAT_MEM_STAT(x)            (((uint32_t)(((uint32_t)(x)) << COREMIX_FUNC_STAT_MEM_STAT_SHIFT)) & COREMIX_FUNC_STAT_MEM_STAT_MASK)

#define COREMIX_FUNC_STAT_SYSMAN_STAT_MASK       (0x4000U)
#define COREMIX_FUNC_STAT_SYSMAN_STAT_SHIFT      (14U)
 ...
 */
#define COREMIX_FUNC_STAT_SYSMAN_STAT(x)         (((uint32_t)(((uint32_t)(x)) << COREMIX_FUNC_STAT_SYSMAN_STAT_SHIFT)) & COREMIX_FUNC_STAT_SYSMAN_STAT_MASK)
/*! @} */

/*! @name RSTR_STAT - Reset Region Status Register */
/*! @{ */

#define COREMIX_RSTR_STAT_RSTR_0_RST_STAT_MASK   (0x1U)
#define COREMIX_RSTR_STAT_RSTR_0_RST_STAT_SHIFT  (0U)
/*! RSTR_0_RST_STAT - Reset Status of Reset Region 0
 *  0b0..Reset Region 0 is out of reset
 *  0b1..Reset Region 0 is in reset
 */
#define COREMIX_RSTR_STAT_RSTR_0_RST_STAT(x)     (((uint32_t)(((uint32_t)(x)) << COREMIX_RSTR_STAT_RSTR_0_RST_STAT_SHIFT)) & COREMIX_RSTR_STAT_RSTR_0_RST_STAT_MASK)

#define COREMIX_RSTR_STAT_RSTR_1_RST_STAT_MASK   (0x2U)
#define COREMIX_RSTR_STAT_RSTR_1_RST_STAT_SHIFT  (1U)
/*! RSTR_1_RST_STAT - Reset Status of Reset Region 1
 *  0b0..Reset Region 1 is out of reset
 *  0b1..Reset Region 1 is in reset
 */
#define COREMIX_RSTR_STAT_RSTR_1_RST_STAT(x)     (((uint32_t)(((uint32_t)(x)) << COREMIX_RSTR_STAT_RSTR_1_RST_STAT_SHIFT)) & COREMIX_RSTR_STAT_RSTR_1_RST_STAT_MASK)

#define COREMIX_RSTR_STAT_RSTR_2_RST_STAT_MASK   (0x4U)
#define COREMIX_RSTR_STAT_RSTR_2_RST_STAT_SHIFT  (2U)
/*! RSTR_2_RST_STAT - Reset Status of Reset Region 2
 *  0b0..Reset Region 2 is out of reset
 *  0b1..Reset Region 2 is in reset
 */
#define COREMIX_RSTR_STAT_RSTR_2_RST_STAT(x)     (((uint32_t)(((uint32_t)(x)) << COREMIX_RSTR_STAT_RSTR_2_RST_STAT_SHIFT)) & COREMIX_RSTR_STAT_RSTR_2_RST_STAT_MASK)

#define COREMIX_RSTR_STAT_RSTR_3_RST_STAT_MASK   (0x8U)
#define COREMIX_RSTR_STAT_RSTR_3_RST_STAT_SHIFT  (3U)
/*! RSTR_3_RST_STAT - Reset Status of Reset Region 3
 *  0b0..Reset Region 3 is out of reset
 *  0b1..Reset Region 3 is in reset
 */
#define COREMIX_RSTR_STAT_RSTR_3_RST_STAT(x)     (((uint32_t)(((uint32_t)(x)) << COREMIX_RSTR_STAT_RSTR_3_RST_STAT_SHIFT)) & COREMIX_RSTR_STAT_RSTR_3_RST_STAT_MASK)

#define COREMIX_RSTR_STAT_RSTR_0_RST_BUSY_MASK   (0x10000U)
#define COREMIX_RSTR_STAT_RSTR_0_RST_BUSY_SHIFT  (16U)
 ...
 */
#define COREMIX_RSTR_STAT_RSTR_0_RST_BUSY(x)     (((uint32_t)(((uint32_t)(x)) << COREMIX_RSTR_STAT_RSTR_0_RST_BUSY_SHIFT)) & COREMIX_RSTR_STAT_RSTR_0_RST_BUSY_MASK)

#define COREMIX_RSTR_STAT_RSTR_1_RST_BUSY_MASK   (0x20000U)
#define COREMIX_RSTR_STAT_RSTR_1_RST_BUSY_SHIFT  (17U)
 ...
 */
#define COREMIX_RSTR_STAT_RSTR_1_RST_BUSY(x)     (((uint32_t)(((uint32_t)(x)) << COREMIX_RSTR_STAT_RSTR_1_RST_BUSY_SHIFT)) & COREMIX_RSTR_STAT_RSTR_1_RST_BUSY_MASK)

#define COREMIX_RSTR_STAT_RSTR_2_RST_BUSY_MASK   (0x40000U)
#define COREMIX_RSTR_STAT_RSTR_2_RST_BUSY_SHIFT  (18U)
 ...
 */
#define COREMIX_RSTR_STAT_RSTR_2_RST_BUSY(x)     (((uint32_t)(((uint32_t)(x)) << COREMIX_RSTR_STAT_RSTR_2_RST_BUSY_SHIFT)) & COREMIX_RSTR_STAT_RSTR_2_RST_BUSY_MASK)

#define COREMIX_RSTR_STAT_RSTR_3_RST_BUSY_MASK   (0x80000U)
#define COREMIX_RSTR_STAT_RSTR_3_RST_BUSY_SHIFT  (19U)
 ...
 */
#define COREMIX_RSTR_STAT_RSTR_3_RST_BUSY(x)     (((uint32_t)(((uint32_t)(x)) << COREMIX_RSTR_STAT_RSTR_3_RST_BUSY_SHIFT)) & COREMIX_RSTR_STAT_RSTR_3_RST_BUSY_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group COREMIX_Register_Masks */


/*!
 * @}
 */ /* end of group COREMIX_Peripheral_Access_Layer */
