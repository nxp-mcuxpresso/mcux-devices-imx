...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for ISP
**
 ...
 * @version 1.0
 * @date 2023-01-10
 * @brief CMSIS Peripheral Access Layer for ISP
 *
 * CMSIS Peripheral Access Layer for ISP
 */

#if !defined(PERI_ISP_H_)
#define PERI_ISP_H_                              /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- ISP Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup ISP_Peripheral_Access_Layer ISP Peripheral Access Layer
 * @{
 */

/** ISP - Size of Registers Arrays */
#define ISP_NEO_ALIAS_COUNT                       84u

/** ISP - Register Layout Typedef */
typedef struct {
  __IO uint32_t ALIAS_REG[ISP_NEO_ALIAS_COUNT];    /**< Alias Read Register, array offset: 0x0, array step: 0x4 */
} ISP_Type;
...
/*!
 * @addtogroup ISP_Register_Masks ISP Register Masks
 * @{
 */
...
#define ISP_ALIAS_REG_VAL_MASK                   (0xFFFFFFFFU)
#define ISP_ALIAS_REG_VAL_SHIFT                  (0U)
#define ISP_ALIAS_REG_VAL(x)                     (((uint32_t)(((uint32_t)(x)) << ISP_ALIAS_REG_VAL_SHIFT)) & ISP_ALIAS_REG_VAL_MASK)
/*! @} */

/* The count of ISP_ALIAS_REG */
#define ISP_ALIAS_REG_COUNT                      (84U)


/*!
 * @}
 */ /* end of group ISP_Register_Masks */


/*!
 * @}
 */ /* end of group ISP_Peripheral_Access_Layer */
