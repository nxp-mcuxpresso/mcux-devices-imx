...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for JPEG_ENC
**
...
/*!
 * @file PERI_JPEG_ENC.h
 * @version 1.0
 * @date 2023-01-10
 * @brief CMSIS Peripheral Access Layer for JPEG_ENC
 *
 * CMSIS Peripheral Access Layer for JPEG_ENC
 */

#if !defined(PERI_JPEG_ENC_H_)
#define PERI_JPEG_ENC_H_                         /**< Symbol preventing repeated inclusion */
...
#define JPEG_ENC_RC_REGS_SEL_RC_REGS_SEL_MASK    (0x3U)
#define JPEG_ENC_RC_REGS_SEL_RC_REGS_SEL_SHIFT   (0U)
 ...
 *  0b11..
 */
#define JPEG_ENC_RC_REGS_SEL_RC_REGS_SEL(x)      (((uint32_t)(((uint32_t)(x)) << JPEG_ENC_RC_REGS_SEL_RC_REGS_SEL_SHIFT)) & JPEG_ENC_RC_REGS_SEL_RC_REGS_SEL_MASK)
/*! @} */
