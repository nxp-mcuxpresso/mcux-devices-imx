...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for DISPLAY_INTERLEAVER
**
...
/*!
 * @file PERI_DISPLAY_INTERLEAVER.h
 * @version 1.0
 * @date 2023-01-10
 * @brief CMSIS Peripheral Access Layer for DISPLAY_INTERLEAVER
 *
 * CMSIS Peripheral Access Layer for DISPLAY_INTERLEAVER
 */

#if !defined(PERI_DISPLAY_INTERLEAVER_H_)
#define PERI_DISPLAY_INTERLEAVER_H_              /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- DISPLAY_INTERLEAVER Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup DISPLAY_INTERLEAVER_Peripheral_Access_Layer DISPLAY_INTERLEAVER Peripheral Access Layer
 * @{
 */

/** DISPLAY_INTERLEAVER - Size of Registers Arrays */
#define DISPLAY_INTERLEAVER_DISPLAY_COUNT         2u

/** DISPLAY_INTERLEAVER - Register Layout Typedef */
typedef struct {
  ...
  } DISPLAY[DISPLAY_INTERLEAVER_DISPLAY_COUNT];
} DISPLAY_INTERLEAVER_Type;

/* ----------------------------------------------------------------------------
   -- DISPLAY_INTERLEAVER Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup DISPLAY_INTERLEAVER_Register_Masks DISPLAY_INTERLEAVER Register Masks
 * @{
 */
...
#define DISPLAY_INTERLEAVER_CTRL_HSYNC_POLARITY_MASK (0x200U)
#define DISPLAY_INTERLEAVER_CTRL_HSYNC_POLARITY_SHIFT (9U)
/*! HSYNC_POLARITY - Hsync Polarity
 *  0b0..Active high
 *  0b1..Active low
 */
#define DISPLAY_INTERLEAVER_CTRL_HSYNC_POLARITY(x) (((uint32_t)(((uint32_t)(x)) << DISPLAY_INTERLEAVER_CTRL_HSYNC_POLARITY_SHIFT)) & DISPLAY_INTERLEAVER_CTRL_HSYNC_POLARITY_MASK)

#define DISPLAY_INTERLEAVER_CTRL_VSYNC_POLARITY_MASK (0x400U)
#define DISPLAY_INTERLEAVER_CTRL_VSYNC_POLARITY_SHIFT (10U)
/*! VSYNC_POLARITY - Vsync Polarity
 *  0b0..Active high
 *  0b1..Active low
 */
#define DISPLAY_INTERLEAVER_CTRL_VSYNC_POLARITY(x) (((uint32_t)(((uint32_t)(x)) << DISPLAY_INTERLEAVER_CTRL_VSYNC_POLARITY_SHIFT)) & DISPLAY_INTERLEAVER_CTRL_VSYNC_POLARITY_MASK)

#define DISPLAY_INTERLEAVER_CTRL_DE_POLARITY_MASK (0x800U)
#define DISPLAY_INTERLEAVER_CTRL_DE_POLARITY_SHIFT (11U)
/*! DE_POLARITY - DE Polarity
 *  0b0..Active high
 *  0b1..Active low
 */
#define DISPLAY_INTERLEAVER_CTRL_DE_POLARITY(x)  (((uint32_t)(((uint32_t)(x)) << DISPLAY_INTERLEAVER_CTRL_DE_POLARITY_SHIFT)) & DISPLAY_INTERLEAVER_CTRL_DE_POLARITY_MASK)

#define DISPLAY_INTERLEAVER_CTRL_PIXEL_FORMAT_MASK (0x1000U)
#define DISPLAY_INTERLEAVER_CTRL_PIXEL_FORMAT_SHIFT (12U)
/*! PIXEL_FORMAT - Pixel Format
 *  0b0..RGB format
 *  0b1..YUV format
 */
#define DISPLAY_INTERLEAVER_CTRL_PIXEL_FORMAT(x) (((uint32_t)(((uint32_t)(x)) << DISPLAY_INTERLEAVER_CTRL_PIXEL_FORMAT_SHIFT)) & DISPLAY_INTERLEAVER_CTRL_PIXEL_FORMAT_MASK)

#define DISPLAY_INTERLEAVER_CTRL_YUV_CONV_MASK   (0x2000U)
#define DISPLAY_INTERLEAVER_CTRL_YUV_CONV_SHIFT  (13U)
/*! YUV_CONV - YUV444 to YUV422 Conversion Enable
 *  0b0..Disable
 *  0b1..Enable
 */
#define DISPLAY_INTERLEAVER_CTRL_YUV_CONV(x)     (((uint32_t)(((uint32_t)(x)) << DISPLAY_INTERLEAVER_CTRL_YUV_CONV_SHIFT)) & DISPLAY_INTERLEAVER_CTRL_YUV_CONV_MASK)
/*! @} */

/* The count of DISPLAY_INTERLEAVER_CTRL */
#define DISPLAY_INTERLEAVER_CTRL_COUNT           (2U)

/*! @name SWRST - DISP_IN0 Software Reset Control Register..DISP_IN1 Software Reset Control Register */
/*! @{ */

#define DISPLAY_INTERLEAVER_SWRST_SW_RST_MASK    (0x2U)
#define DISPLAY_INTERLEAVER_SWRST_SW_RST_SHIFT   (1U)
/*! SW_RST - Software Reset
 *  0b0..No action
 *  0b1..Software reset is available
 */
#define DISPLAY_INTERLEAVER_SWRST_SW_RST(x)      (((uint32_t)(((uint32_t)(x)) << DISPLAY_INTERLEAVER_SWRST_SW_RST_SHIFT)) & DISPLAY_INTERLEAVER_SWRST_SW_RST_MASK)
/*! @} */

/* The count of DISPLAY_INTERLEAVER_SWRST */
#define DISPLAY_INTERLEAVER_SWRST_COUNT          (2U)

/*! @name IE - DISP_IN0 Interrupt Enable Register..DISP_IN1 Interrupt Enable Register */
/*! @{ */

#define DISPLAY_INTERLEAVER_IE_FOVF_IE0_MASK     (0x1U)
#define DISPLAY_INTERLEAVER_IE_FOVF_IE0_SHIFT    (0U)
/*! FOVF_IE0 - FIFO 0 Overflow Interrupt Enable
 *  0b0..Disable
 *  0b1..Enable
 */
#define DISPLAY_INTERLEAVER_IE_FOVF_IE0(x)       (((uint32_t)(((uint32_t)(x)) << DISPLAY_INTERLEAVER_IE_FOVF_IE0_SHIFT)) & DISPLAY_INTERLEAVER_IE_FOVF_IE0_MASK)

#define DISPLAY_INTERLEAVER_IE_FOVF_IE1_MASK     (0x2U)
#define DISPLAY_INTERLEAVER_IE_FOVF_IE1_SHIFT    (1U)
/*! FOVF_IE1 - FIFO 1 Overflow Interrupt Enable
 *  0b0..Disable
 *  0b1..Enable
 */
#define DISPLAY_INTERLEAVER_IE_FOVF_IE1(x)       (((uint32_t)(((uint32_t)(x)) << DISPLAY_INTERLEAVER_IE_FOVF_IE1_SHIFT)) & DISPLAY_INTERLEAVER_IE_FOVF_IE1_MASK)
/*! @} */

/* The count of DISPLAY_INTERLEAVER_IE */
#define DISPLAY_INTERLEAVER_IE_COUNT             (2U)

/*! @name IS - DISP_IN0 Interrupt Status Register..DISP_IN1 Interrupt Status Register */
/*! @{ */

#define DISPLAY_INTERLEAVER_IS_FOVF_IS0_MASK     (0x1U)
#define DISPLAY_INTERLEAVER_IS_FOVF_IS0_SHIFT    (0U)
/*! FOVF_IS0 - FIFO 0 Overflow Interrupt Status
 *  0b0..Did not occur
 *  0b1..Occurred
 */
#define DISPLAY_INTERLEAVER_IS_FOVF_IS0(x)       (((uint32_t)(((uint32_t)(x)) << DISPLAY_INTERLEAVER_IS_FOVF_IS0_SHIFT)) & DISPLAY_INTERLEAVER_IS_FOVF_IS0_MASK)

#define DISPLAY_INTERLEAVER_IS_FOVF_IS1_MASK     (0x2U)
#define DISPLAY_INTERLEAVER_IS_FOVF_IS1_SHIFT    (1U)
/*! FOVF_IS1 - FIFO 1 Overflow Interrupt Status
 *  0b0..Did not occur
 *  0b1..Occurred
 */
#define DISPLAY_INTERLEAVER_IS_FOVF_IS1(x)       (((uint32_t)(((uint32_t)(x)) << DISPLAY_INTERLEAVER_IS_FOVF_IS1_SHIFT)) & DISPLAY_INTERLEAVER_IS_FOVF_IS1_MASK)
/*! @} */

/* The count of DISPLAY_INTERLEAVER_IS */
#define DISPLAY_INTERLEAVER_IS_COUNT             (2U)

/*! @name ICTRL - DISP_IN0 Interleaving Control Register..DISP_IN1 Interleaving Control Register */
/*! @{ */

#define DISPLAY_INTERLEAVER_ICTRL_WIDTH_MASK     (0xFFFU)
#define DISPLAY_INTERLEAVER_ICTRL_WIDTH_SHIFT    (0U)
/*! WIDTH - Width Control for Interleaving Operation */
#define DISPLAY_INTERLEAVER_ICTRL_WIDTH(x)       (((uint32_t)(((uint32_t)(x)) << DISPLAY_INTERLEAVER_ICTRL_WIDTH_SHIFT)) & DISPLAY_INTERLEAVER_ICTRL_WIDTH_MASK)
/*! @} */

/* The count of DISPLAY_INTERLEAVER_ICTRL */
#define DISPLAY_INTERLEAVER_ICTRL_COUNT          (2U)


/*!
 * @}
 */ /* end of group DISPLAY_INTERLEAVER_Register_Masks */


/*!
 * @}
 */ /* end of group DISPLAY_INTERLEAVER_Peripheral_Access_Layer */
...
#endif  /* PERI_DISPLAY_INTERLEAVER_H_ */
