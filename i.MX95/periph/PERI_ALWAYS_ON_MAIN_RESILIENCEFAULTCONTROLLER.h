...
**         always_on_main_ResilienceFaultController
**
...
/*!
 * @file PERI_always_on_main_ResilienceFaultController.h
 * @version 1.0
 * @date 2023-01-10
 * @brief CMSIS Peripheral Access Layer for
 *        always_on_main_ResilienceFaultController
 *
 * CMSIS Peripheral Access Layer for always_on_main_ResilienceFaultController
 */

#if !defined(PERI_ALWAYS_ON_MAIN_RESILIENCEFAULTCONTROLLER_H_)
#define PERI_ALWAYS_ON_MAIN_RESILIENCEFAULTCONTROLLER_H_ /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- always_on_main_ResilienceFaultController Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup always_on_main_ResilienceFaultController_Peripheral_Access_Layer always_on_main_ResilienceFaultController Peripheral Access Layer
 * @{
 */

/** always_on_main_ResilienceFaultController - Size of Registers Arrays */
#define always_on_main_ResilienceFaultController_MISSIONFAULT_COUNT 4u
#define always_on_main_ResilienceFaultController_LATENTFAULT_COUNT 4u

/** always_on_main_ResilienceFaultController - Register Layout Typedef */
typedef struct {
  __I  uint32_t ID_COREID;                         /**< Core ID, offset: 0x0 */
  __I  uint32_t ID_REVISIONID;                     /**< Revision ID, offset: 0x4 */
  __I  uint32_t MISSIONFAULT[always_on_main_ResilienceFaultController_MISSIONFAULT_COUNT]; /**< Mission Fault n, array offset: 0x8, array step: 0x4 */
  __I  uint32_t LATENTFAULT[always_on_main_ResilienceFaultController_LATENTFAULT_COUNT]; /**< Latent Fault n, array offset: 0x18, array step: 0x4 */
...
} always_on_main_ResilienceFaultController_Type;

/* ----------------------------------------------------------------------------
   -- always_on_main_ResilienceFaultController Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup always_on_main_ResilienceFaultController_Register_Masks always_on_main_ResilienceFaultController Register Masks
 * @{
 */
...
#define always_on_main_ResilienceFaultController_ID_COREID_CORETYPEID_MASK (0xFFU)
#define always_on_main_ResilienceFaultController_ID_COREID_CORETYPEID_SHIFT (0U)
#define always_on_main_ResilienceFaultController_ID_COREID_CORETYPEID(x) (((uint32_t)(((uint32_t)(x)) << always_on_main_ResilienceFaultController_ID_COREID_CORETYPEID_SHIFT)) & always_on_main_ResilienceFaultController_ID_COREID_CORETYPEID_MASK)

#define always_on_main_ResilienceFaultController_ID_COREID_CORECHECKSUM_MASK (0xFFFFFF00U)
#define always_on_main_ResilienceFaultController_ID_COREID_CORECHECKSUM_SHIFT (8U)
#define always_on_main_ResilienceFaultController_ID_COREID_CORECHECKSUM(x) (((uint32_t)(((uint32_t)(x)) << always_on_main_ResilienceFaultController_ID_COREID_CORECHECKSUM_SHIFT)) & always_on_main_ResilienceFaultController_ID_COREID_CORECHECKSUM_MASK)
/*! @} */

/*! @name ID_REVISIONID - Revision ID */
/*! @{ */

#define always_on_main_ResilienceFaultController_ID_REVISIONID_USERID_MASK (0xFFU)
#define always_on_main_ResilienceFaultController_ID_REVISIONID_USERID_SHIFT (0U)
#define always_on_main_ResilienceFaultController_ID_REVISIONID_USERID(x) (((uint32_t)(((uint32_t)(x)) << always_on_main_ResilienceFaultController_ID_REVISIONID_USERID_SHIFT)) & always_on_main_ResilienceFaultController_ID_REVISIONID_USERID_MASK)

#define always_on_main_ResilienceFaultController_ID_REVISIONID_NOCID_MASK (0xFFFFFF00U)
#define always_on_main_ResilienceFaultController_ID_REVISIONID_NOCID_SHIFT (8U)
#define always_on_main_ResilienceFaultController_ID_REVISIONID_NOCID(x) (((uint32_t)(((uint32_t)(x)) << always_on_main_ResilienceFaultController_ID_REVISIONID_NOCID_SHIFT)) & always_on_main_ResilienceFaultController_ID_REVISIONID_NOCID_MASK)
/*! @} */

/*! @name MISSIONFAULT - Mission Fault n */
/*! @{ */

#define always_on_main_ResilienceFaultController_MISSIONFAULT_MISSIONFAULT_MASK (0xFFFFFFFFU)
#define always_on_main_ResilienceFaultController_MISSIONFAULT_MISSIONFAULT_SHIFT (0U)
#define always_on_main_ResilienceFaultController_MISSIONFAULT_MISSIONFAULT(x) (((uint32_t)(((uint32_t)(x)) << always_on_main_ResilienceFaultController_MISSIONFAULT_MISSIONFAULT_SHIFT)) & always_on_main_ResilienceFaultController_MISSIONFAULT_MISSIONFAULT_MASK)
/*! @} */

/*! @name LATENTFAULT - Latent Fault n */
/*! @{ */

#define always_on_main_ResilienceFaultController_LATENTFAULT_LATENTFAULT_MASK (0xFFFFFFFFU)
#define always_on_main_ResilienceFaultController_LATENTFAULT_LATENTFAULT_SHIFT (0U)
#define always_on_main_ResilienceFaultController_LATENTFAULT_LATENTFAULT(x) (((uint32_t)(((uint32_t)(x)) << always_on_main_ResilienceFaultController_LATENTFAULT_LATENTFAULT_SHIFT)) & always_on_main_ResilienceFaultController_LATENTFAULT_LATENTFAULT_MASK)
/*! @} */

/*! @name FAULTS - Interrupt Enable */
/*! @{ */

#define always_on_main_ResilienceFaultController_FAULTS_LATENTFAULT_MASK (0x1U)
#define always_on_main_ResilienceFaultController_FAULTS_LATENTFAULT_SHIFT (0U)
#define always_on_main_ResilienceFaultController_FAULTS_LATENTFAULT(x) (((uint32_t)(((uint32_t)(x)) << always_on_main_ResilienceFaultController_FAULTS_LATENTFAULT_SHIFT)) & always_on_main_ResilienceFaultController_FAULTS_LATENTFAULT_MASK)

#define always_on_main_ResilienceFaultController_FAULTS_MISSIONFAULT_MASK (0x2U)
#define always_on_main_ResilienceFaultController_FAULTS_MISSIONFAULT_SHIFT (1U)
#define always_on_main_ResilienceFaultController_FAULTS_MISSIONFAULT(x) (((uint32_t)(((uint32_t)(x)) << always_on_main_ResilienceFaultController_FAULTS_MISSIONFAULT_SHIFT)) & always_on_main_ResilienceFaultController_FAULTS_MISSIONFAULT_MASK)
/*! @} */

/*! @name INTEN - Interrupt Enable */
/*! @{ */

#define always_on_main_ResilienceFaultController_INTEN_BISTDONEEN_MASK (0x1U)
#define always_on_main_ResilienceFaultController_INTEN_BISTDONEEN_SHIFT (0U)
#define always_on_main_ResilienceFaultController_INTEN_BISTDONEEN(x) (((uint32_t)(((uint32_t)(x)) << always_on_main_ResilienceFaultController_INTEN_BISTDONEEN_SHIFT)) & always_on_main_ResilienceFaultController_INTEN_BISTDONEEN_MASK)

#define always_on_main_ResilienceFaultController_INTEN_MISSIONFAULTEN_MASK (0x2U)
#define always_on_main_ResilienceFaultController_INTEN_MISSIONFAULTEN_SHIFT (1U)
#define always_on_main_ResilienceFaultController_INTEN_MISSIONFAULTEN(x) (((uint32_t)(((uint32_t)(x)) << always_on_main_ResilienceFaultController_INTEN_MISSIONFAULTEN_SHIFT)) & always_on_main_ResilienceFaultController_INTEN_MISSIONFAULTEN_MASK)
/*! @} */

/*! @name INTCLR - InterruptClear */
/*! @{ */

#define always_on_main_ResilienceFaultController_INTCLR_LATENTFAULTCLR_MASK (0x1U)
#define always_on_main_ResilienceFaultController_INTCLR_LATENTFAULTCLR_SHIFT (0U)
#define always_on_main_ResilienceFaultController_INTCLR_LATENTFAULTCLR(x) (((uint32_t)(((uint32_t)(x)) << always_on_main_ResilienceFaultController_INTCLR_LATENTFAULTCLR_SHIFT)) & always_on_main_ResilienceFaultController_INTCLR_LATENTFAULTCLR_MASK)

#define always_on_main_ResilienceFaultController_INTCLR_MISSIONFAULTCLR_MASK (0x2U)
#define always_on_main_ResilienceFaultController_INTCLR_MISSIONFAULTCLR_SHIFT (1U)
#define always_on_main_ResilienceFaultController_INTCLR_MISSIONFAULTCLR(x) (((uint32_t)(((uint32_t)(x)) << always_on_main_ResilienceFaultController_INTCLR_MISSIONFAULTCLR_SHIFT)) & always_on_main_ResilienceFaultController_INTCLR_MISSIONFAULTCLR_MASK)
/*! @} */

/*! @name BISTCTL - BistControl */
/*! @{ */

#define always_on_main_ResilienceFaultController_BISTCTL_BISTSTART_MASK (0x1U)
#define always_on_main_ResilienceFaultController_BISTCTL_BISTSTART_SHIFT (0U)
#define always_on_main_ResilienceFaultController_BISTCTL_BISTSTART(x) (((uint32_t)(((uint32_t)(x)) << always_on_main_ResilienceFaultController_BISTCTL_BISTSTART_SHIFT)) & always_on_main_ResilienceFaultController_BISTCTL_BISTSTART_MASK)

#define always_on_main_ResilienceFaultController_BISTCTL_BISTDONECLR_MASK (0x2U)
#define always_on_main_ResilienceFaultController_BISTCTL_BISTDONECLR_SHIFT (1U)
#define always_on_main_ResilienceFaultController_BISTCTL_BISTDONECLR(x) (((uint32_t)(((uint32_t)(x)) << always_on_main_ResilienceFaultController_BISTCTL_BISTDONECLR_SHIFT)) & always_on_main_ResilienceFaultController_BISTCTL_BISTDONECLR_MASK)
/*! @} */

/*! @name BISTDONE - BistDone */
/*! @{ */

#define always_on_main_ResilienceFaultController_BISTDONE_BISTDONE_MASK (0x1U)
#define always_on_main_ResilienceFaultController_BISTDONE_BISTDONE_SHIFT (0U)
#define always_on_main_ResilienceFaultController_BISTDONE_BISTDONE(x) (((uint32_t)(((uint32_t)(x)) << always_on_main_ResilienceFaultController_BISTDONE_BISTDONE_SHIFT)) & always_on_main_ResilienceFaultController_BISTDONE_BISTDONE_MASK)

#define always_on_main_ResilienceFaultController_BISTDONE_MISSIONMODE_MASK (0x2U)
#define always_on_main_ResilienceFaultController_BISTDONE_MISSIONMODE_SHIFT (1U)
#define always_on_main_ResilienceFaultController_BISTDONE_MISSIONMODE(x) (((uint32_t)(((uint32_t)(x)) << always_on_main_ResilienceFaultController_BISTDONE_MISSIONMODE_SHIFT)) & always_on_main_ResilienceFaultController_BISTDONE_MISSIONMODE_MASK)
/*! @} */

/*! @name BISTTO1 - Bist T01 */
/*! @{ */

#define always_on_main_ResilienceFaultController_BISTTO1_BISTTO1_MASK (0xFFFFU)
#define always_on_main_ResilienceFaultController_BISTTO1_BISTTO1_SHIFT (0U)
#define always_on_main_ResilienceFaultController_BISTTO1_BISTTO1(x) (((uint32_t)(((uint32_t)(x)) << always_on_main_ResilienceFaultController_BISTTO1_BISTTO1_SHIFT)) & always_on_main_ResilienceFaultController_BISTTO1_BISTTO1_MASK)
/*! @} */

/*! @name BISTTO2 - Bist T02 */
/*! @{ */

#define always_on_main_ResilienceFaultController_BISTTO2_BISTTO2_MASK (0xFFU)
#define always_on_main_ResilienceFaultController_BISTTO2_BISTTO2_SHIFT (0U)
#define always_on_main_ResilienceFaultController_BISTTO2_BISTTO2(x) (((uint32_t)(((uint32_t)(x)) << always_on_main_ResilienceFaultController_BISTTO2_BISTTO2_SHIFT)) & always_on_main_ResilienceFaultController_BISTTO2_BISTTO2_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group always_on_main_ResilienceFaultController_Register_Masks */


/*!
 * @}
 */ /* end of group always_on_main_ResilienceFaultController_Peripheral_Access_Layer */
...
#endif  /* PERI_ALWAYS_ON_MAIN_RESILIENCEFAULTCONTROLLER_H_ */
