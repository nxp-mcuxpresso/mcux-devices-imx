...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for HDR_DECOMPRESS0
**
...
/*!
 * @file PERI_HDR_DECOMPRESS0.h
 * @version 1.0
 * @date 2023-01-10
 * @brief CMSIS Peripheral Access Layer for HDR_DECOMPRESS0
 *
 * CMSIS Peripheral Access Layer for HDR_DECOMPRESS0
 */

#if !defined(PERI_HDR_DECOMPRESS0_H_)
#define PERI_HDR_DECOMPRESS0_H_                  /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- HDR_DECOMPRESS0 Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup HDR_DECOMPRESS0_Peripheral_Access_Layer HDR_DECOMPRESS0 Peripheral Access Layer
 * @{
 */

/** HDR_DECOMPRESS0 - Size of Registers Arrays */
#define HDR_DECOMPRESS0_PIPE1_HDR_DECOMP_COUNT    1u

/** HDR_DECOMPRESS0 - Register Layout Typedef */
typedef struct {
  ...
  } PIPE1_HDR_DECOMP[HDR_DECOMPRESS0_PIPE1_HDR_DECOMP_COUNT];
} HDR_DECOMPRESS0_Type;

/* ----------------------------------------------------------------------------
   -- HDR_DECOMPRESS0 Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup HDR_DECOMPRESS0_Register_Masks HDR_DECOMPRESS0 Register Masks
 * @{
 */
...
#define HDR_DECOMPRESS0_CTRL_CAM_ENABLE_MASK     (0x80000000U)
#define HDR_DECOMPRESS0_CTRL_CAM_ENABLE_SHIFT    (31U)
/*! ENABLE
 ...
 */
#define HDR_DECOMPRESS0_CTRL_CAM_ENABLE(x)       (((uint32_t)(((uint32_t)(x)) << HDR_DECOMPRESS0_CTRL_CAM_ENABLE_SHIFT)) & HDR_DECOMPRESS0_CTRL_CAM_ENABLE_MASK)
/*! @} */

/* The count of HDR_DECOMPRESS0_CTRL_CAM */
#define HDR_DECOMPRESS0_CTRL_CAM_COUNT           (1U)

/*! @name KNEE_POINT1_CAM - Camera 0 HDR Decompress KneePoint 1 */
/*! @{ */

#define HDR_DECOMPRESS0_KNEE_POINT1_CAM_KNEEPOINT_MASK (0xFFFFU)
#define HDR_DECOMPRESS0_KNEE_POINT1_CAM_KNEEPOINT_SHIFT (0U)
#define HDR_DECOMPRESS0_KNEE_POINT1_CAM_KNEEPOINT(x) (((uint32_t)(((uint32_t)(x)) << HDR_DECOMPRESS0_KNEE_POINT1_CAM_KNEEPOINT_SHIFT)) & HDR_DECOMPRESS0_KNEE_POINT1_CAM_KNEEPOINT_MASK)
/*! @} */

/* The count of HDR_DECOMPRESS0_KNEE_POINT1_CAM */
#define HDR_DECOMPRESS0_KNEE_POINT1_CAM_COUNT    (1U)

/*! @name KNEE_POINT2_CAM - Camera 0 HDR Decompress KneePoint 2 */
/*! @{ */

#define HDR_DECOMPRESS0_KNEE_POINT2_CAM_KNEEPOINT_MASK (0xFFFFU)
#define HDR_DECOMPRESS0_KNEE_POINT2_CAM_KNEEPOINT_SHIFT (0U)
#define HDR_DECOMPRESS0_KNEE_POINT2_CAM_KNEEPOINT(x) (((uint32_t)(((uint32_t)(x)) << HDR_DECOMPRESS0_KNEE_POINT2_CAM_KNEEPOINT_SHIFT)) & HDR_DECOMPRESS0_KNEE_POINT2_CAM_KNEEPOINT_MASK)
/*! @} */

/* The count of HDR_DECOMPRESS0_KNEE_POINT2_CAM */
#define HDR_DECOMPRESS0_KNEE_POINT2_CAM_COUNT    (1U)

/*! @name KNEE_POINT3_CAM - Camera 0 HDR Decompress KneePoint 3 */
/*! @{ */

#define HDR_DECOMPRESS0_KNEE_POINT3_CAM_KNEEPOINT_MASK (0xFFFFU)
#define HDR_DECOMPRESS0_KNEE_POINT3_CAM_KNEEPOINT_SHIFT (0U)
#define HDR_DECOMPRESS0_KNEE_POINT3_CAM_KNEEPOINT(x) (((uint32_t)(((uint32_t)(x)) << HDR_DECOMPRESS0_KNEE_POINT3_CAM_KNEEPOINT_SHIFT)) & HDR_DECOMPRESS0_KNEE_POINT3_CAM_KNEEPOINT_MASK)
/*! @} */

/* The count of HDR_DECOMPRESS0_KNEE_POINT3_CAM */
#define HDR_DECOMPRESS0_KNEE_POINT3_CAM_COUNT    (1U)

/*! @name KNEE_POINT4_CAM - Camera 0 HDR Decompress KneePoint 4 */
/*! @{ */

#define HDR_DECOMPRESS0_KNEE_POINT4_CAM_KNEEPOINT_MASK (0xFFFFU)
#define HDR_DECOMPRESS0_KNEE_POINT4_CAM_KNEEPOINT_SHIFT (0U)
#define HDR_DECOMPRESS0_KNEE_POINT4_CAM_KNEEPOINT(x) (((uint32_t)(((uint32_t)(x)) << HDR_DECOMPRESS0_KNEE_POINT4_CAM_KNEEPOINT_SHIFT)) & HDR_DECOMPRESS0_KNEE_POINT4_CAM_KNEEPOINT_MASK)
/*! @} */

/* The count of HDR_DECOMPRESS0_KNEE_POINT4_CAM */
#define HDR_DECOMPRESS0_KNEE_POINT4_CAM_COUNT    (1U)

/*! @name KNEE_OFFSET0_CAM - Camera 0 HDR Decompress Knee Offset 0 */
/*! @{ */

#define HDR_DECOMPRESS0_KNEE_OFFSET0_CAM_OFFSET_MASK (0xFFFFU)
#define HDR_DECOMPRESS0_KNEE_OFFSET0_CAM_OFFSET_SHIFT (0U)
#define HDR_DECOMPRESS0_KNEE_OFFSET0_CAM_OFFSET(x) (((uint32_t)(((uint32_t)(x)) << HDR_DECOMPRESS0_KNEE_OFFSET0_CAM_OFFSET_SHIFT)) & HDR_DECOMPRESS0_KNEE_OFFSET0_CAM_OFFSET_MASK)
/*! @} */

/* The count of HDR_DECOMPRESS0_KNEE_OFFSET0_CAM */
#define HDR_DECOMPRESS0_KNEE_OFFSET0_CAM_COUNT   (1U)

/*! @name KNEE_OFFSET1_CAM - Camera 0 HDR Decompress Knee Offset 1 */
/*! @{ */

#define HDR_DECOMPRESS0_KNEE_OFFSET1_CAM_OFFSET_MASK (0xFFFFU)
#define HDR_DECOMPRESS0_KNEE_OFFSET1_CAM_OFFSET_SHIFT (0U)
#define HDR_DECOMPRESS0_KNEE_OFFSET1_CAM_OFFSET(x) (((uint32_t)(((uint32_t)(x)) << HDR_DECOMPRESS0_KNEE_OFFSET1_CAM_OFFSET_SHIFT)) & HDR_DECOMPRESS0_KNEE_OFFSET1_CAM_OFFSET_MASK)
/*! @} */

/* The count of HDR_DECOMPRESS0_KNEE_OFFSET1_CAM */
#define HDR_DECOMPRESS0_KNEE_OFFSET1_CAM_COUNT   (1U)

/*! @name KNEE_OFFSET2_CAM - Camera 0 HDR Decompress Knee Offset 2 */
/*! @{ */

#define HDR_DECOMPRESS0_KNEE_OFFSET2_CAM_OFFSET_MASK (0xFFFFU)
#define HDR_DECOMPRESS0_KNEE_OFFSET2_CAM_OFFSET_SHIFT (0U)
#define HDR_DECOMPRESS0_KNEE_OFFSET2_CAM_OFFSET(x) (((uint32_t)(((uint32_t)(x)) << HDR_DECOMPRESS0_KNEE_OFFSET2_CAM_OFFSET_SHIFT)) & HDR_DECOMPRESS0_KNEE_OFFSET2_CAM_OFFSET_MASK)
/*! @} */

/* The count of HDR_DECOMPRESS0_KNEE_OFFSET2_CAM */
#define HDR_DECOMPRESS0_KNEE_OFFSET2_CAM_COUNT   (1U)

/*! @name KNEE_OFFSET3_CAM - Camera 0 HDR Decompress Knee Offset 3 */
/*! @{ */

#define HDR_DECOMPRESS0_KNEE_OFFSET3_CAM_OFFSET_MASK (0xFFFFU)
#define HDR_DECOMPRESS0_KNEE_OFFSET3_CAM_OFFSET_SHIFT (0U)
#define HDR_DECOMPRESS0_KNEE_OFFSET3_CAM_OFFSET(x) (((uint32_t)(((uint32_t)(x)) << HDR_DECOMPRESS0_KNEE_OFFSET3_CAM_OFFSET_SHIFT)) & HDR_DECOMPRESS0_KNEE_OFFSET3_CAM_OFFSET_MASK)
/*! @} */

/* The count of HDR_DECOMPRESS0_KNEE_OFFSET3_CAM */
#define HDR_DECOMPRESS0_KNEE_OFFSET3_CAM_COUNT   (1U)

/*! @name KNEE_OFFSET4_CAM - Camera 0 HDR Decompress Knee Offset 4 */
/*! @{ */

#define HDR_DECOMPRESS0_KNEE_OFFSET4_CAM_OFFSET_MASK (0xFFFFU)
#define HDR_DECOMPRESS0_KNEE_OFFSET4_CAM_OFFSET_SHIFT (0U)
#define HDR_DECOMPRESS0_KNEE_OFFSET4_CAM_OFFSET(x) (((uint32_t)(((uint32_t)(x)) << HDR_DECOMPRESS0_KNEE_OFFSET4_CAM_OFFSET_SHIFT)) & HDR_DECOMPRESS0_KNEE_OFFSET4_CAM_OFFSET_MASK)
/*! @} */

/* The count of HDR_DECOMPRESS0_KNEE_OFFSET4_CAM */
#define HDR_DECOMPRESS0_KNEE_OFFSET4_CAM_COUNT   (1U)

/*! @name KNEE_RATIO01_CAM - Camera 0 HDR Decompress Knee Ratio 01 */
/*! @{ */

#define HDR_DECOMPRESS0_KNEE_RATIO01_CAM_RATIO0_MASK (0xFFFU)
#define HDR_DECOMPRESS0_KNEE_RATIO01_CAM_RATIO0_SHIFT (0U)
#define HDR_DECOMPRESS0_KNEE_RATIO01_CAM_RATIO0(x) (((uint32_t)(((uint32_t)(x)) << HDR_DECOMPRESS0_KNEE_RATIO01_CAM_RATIO0_SHIFT)) & HDR_DECOMPRESS0_KNEE_RATIO01_CAM_RATIO0_MASK)

#define HDR_DECOMPRESS0_KNEE_RATIO01_CAM_RATIO1_MASK (0xFFF0000U)
#define HDR_DECOMPRESS0_KNEE_RATIO01_CAM_RATIO1_SHIFT (16U)
#define HDR_DECOMPRESS0_KNEE_RATIO01_CAM_RATIO1(x) (((uint32_t)(((uint32_t)(x)) << HDR_DECOMPRESS0_KNEE_RATIO01_CAM_RATIO1_SHIFT)) & HDR_DECOMPRESS0_KNEE_RATIO01_CAM_RATIO1_MASK)
/*! @} */

/* The count of HDR_DECOMPRESS0_KNEE_RATIO01_CAM */
#define HDR_DECOMPRESS0_KNEE_RATIO01_CAM_COUNT   (1U)

/*! @name KNEE_RATIO23_CAM - Camera 0 HDR Decompress Knee Ratio 23 */
/*! @{ */

#define HDR_DECOMPRESS0_KNEE_RATIO23_CAM_RATIO2_MASK (0xFFFU)
#define HDR_DECOMPRESS0_KNEE_RATIO23_CAM_RATIO2_SHIFT (0U)
#define HDR_DECOMPRESS0_KNEE_RATIO23_CAM_RATIO2(x) (((uint32_t)(((uint32_t)(x)) << HDR_DECOMPRESS0_KNEE_RATIO23_CAM_RATIO2_SHIFT)) & HDR_DECOMPRESS0_KNEE_RATIO23_CAM_RATIO2_MASK)

#define HDR_DECOMPRESS0_KNEE_RATIO23_CAM_RATIO3_MASK (0xFFF0000U)
#define HDR_DECOMPRESS0_KNEE_RATIO23_CAM_RATIO3_SHIFT (16U)
#define HDR_DECOMPRESS0_KNEE_RATIO23_CAM_RATIO3(x) (((uint32_t)(((uint32_t)(x)) << HDR_DECOMPRESS0_KNEE_RATIO23_CAM_RATIO3_SHIFT)) & HDR_DECOMPRESS0_KNEE_RATIO23_CAM_RATIO3_MASK)
/*! @} */

/* The count of HDR_DECOMPRESS0_KNEE_RATIO23_CAM */
#define HDR_DECOMPRESS0_KNEE_RATIO23_CAM_COUNT   (1U)

/*! @name KNEE_RATIO4_CAM - Camera 0 HDR Decompress Knee Ratio 4 */
/*! @{ */

#define HDR_DECOMPRESS0_KNEE_RATIO4_CAM_RATIO4_MASK (0xFFFU)
#define HDR_DECOMPRESS0_KNEE_RATIO4_CAM_RATIO4_SHIFT (0U)
#define HDR_DECOMPRESS0_KNEE_RATIO4_CAM_RATIO4(x) (((uint32_t)(((uint32_t)(x)) << HDR_DECOMPRESS0_KNEE_RATIO4_CAM_RATIO4_SHIFT)) & HDR_DECOMPRESS0_KNEE_RATIO4_CAM_RATIO4_MASK)
/*! @} */

/* The count of HDR_DECOMPRESS0_KNEE_RATIO4_CAM */
#define HDR_DECOMPRESS0_KNEE_RATIO4_CAM_COUNT    (1U)

/*! @name KNEE_NPOINT0_CAM - Camera 0 HDR Decompress New KneePoint 0 */
/*! @{ */

#define HDR_DECOMPRESS0_KNEE_NPOINT0_CAM_KNEEPOINT_MASK (0xFFFFFU)
#define HDR_DECOMPRESS0_KNEE_NPOINT0_CAM_KNEEPOINT_SHIFT (0U)
#define HDR_DECOMPRESS0_KNEE_NPOINT0_CAM_KNEEPOINT(x) (((uint32_t)(((uint32_t)(x)) << HDR_DECOMPRESS0_KNEE_NPOINT0_CAM_KNEEPOINT_SHIFT)) & HDR_DECOMPRESS0_KNEE_NPOINT0_CAM_KNEEPOINT_MASK)
/*! @} */

/* The count of HDR_DECOMPRESS0_KNEE_NPOINT0_CAM */
#define HDR_DECOMPRESS0_KNEE_NPOINT0_CAM_COUNT   (1U)

/*! @name KNEE_NPOINT1_CAM - Camera 0 HDR Decompress New KneePoint 1 */
/*! @{ */

#define HDR_DECOMPRESS0_KNEE_NPOINT1_CAM_KNEEPOINT_MASK (0xFFFFFU)
#define HDR_DECOMPRESS0_KNEE_NPOINT1_CAM_KNEEPOINT_SHIFT (0U)
#define HDR_DECOMPRESS0_KNEE_NPOINT1_CAM_KNEEPOINT(x) (((uint32_t)(((uint32_t)(x)) << HDR_DECOMPRESS0_KNEE_NPOINT1_CAM_KNEEPOINT_SHIFT)) & HDR_DECOMPRESS0_KNEE_NPOINT1_CAM_KNEEPOINT_MASK)
/*! @} */

/* The count of HDR_DECOMPRESS0_KNEE_NPOINT1_CAM */
#define HDR_DECOMPRESS0_KNEE_NPOINT1_CAM_COUNT   (1U)

/*! @name KNEE_NPOINT2_CAM - Camera 0 HDR Decompress New KneePoint 2 */
/*! @{ */

#define HDR_DECOMPRESS0_KNEE_NPOINT2_CAM_KNEEPOINT_MASK (0xFFFFFU)
#define HDR_DECOMPRESS0_KNEE_NPOINT2_CAM_KNEEPOINT_SHIFT (0U)
#define HDR_DECOMPRESS0_KNEE_NPOINT2_CAM_KNEEPOINT(x) (((uint32_t)(((uint32_t)(x)) << HDR_DECOMPRESS0_KNEE_NPOINT2_CAM_KNEEPOINT_SHIFT)) & HDR_DECOMPRESS0_KNEE_NPOINT2_CAM_KNEEPOINT_MASK)
/*! @} */

/* The count of HDR_DECOMPRESS0_KNEE_NPOINT2_CAM */
#define HDR_DECOMPRESS0_KNEE_NPOINT2_CAM_COUNT   (1U)

/*! @name KNEE_NPOINT3_CAM - Camera 0 HDR Decompress New KneePoint 3 */
/*! @{ */

#define HDR_DECOMPRESS0_KNEE_NPOINT3_CAM_KNEEPOINT_MASK (0xFFFFFU)
#define HDR_DECOMPRESS0_KNEE_NPOINT3_CAM_KNEEPOINT_SHIFT (0U)
#define HDR_DECOMPRESS0_KNEE_NPOINT3_CAM_KNEEPOINT(x) (((uint32_t)(((uint32_t)(x)) << HDR_DECOMPRESS0_KNEE_NPOINT3_CAM_KNEEPOINT_SHIFT)) & HDR_DECOMPRESS0_KNEE_NPOINT3_CAM_KNEEPOINT_MASK)
/*! @} */

/* The count of HDR_DECOMPRESS0_KNEE_NPOINT3_CAM */
#define HDR_DECOMPRESS0_KNEE_NPOINT3_CAM_COUNT   (1U)

/*! @name KNEE_NPOINT4_CAM - Camera 0 HDR Decompress New KneePoint 4 */
/*! @{ */

#define HDR_DECOMPRESS0_KNEE_NPOINT4_CAM_KNEEPOINT_MASK (0xFFFFFU)
#define HDR_DECOMPRESS0_KNEE_NPOINT4_CAM_KNEEPOINT_SHIFT (0U)
#define HDR_DECOMPRESS0_KNEE_NPOINT4_CAM_KNEEPOINT(x) (((uint32_t)(((uint32_t)(x)) << HDR_DECOMPRESS0_KNEE_NPOINT4_CAM_KNEEPOINT_SHIFT)) & HDR_DECOMPRESS0_KNEE_NPOINT4_CAM_KNEEPOINT_MASK)
/*! @} */

/* The count of HDR_DECOMPRESS0_KNEE_NPOINT4_CAM */
#define HDR_DECOMPRESS0_KNEE_NPOINT4_CAM_COUNT   (1U)


/*!
 * @}
 */ /* end of group HDR_DECOMPRESS0_Register_Masks */


/*!
 * @}
 */ /* end of group HDR_DECOMPRESS0_Peripheral_Access_Layer */
