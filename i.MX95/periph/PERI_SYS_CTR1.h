...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for SYS_CTR1
**
...
/*!
 * @file PERI_SYS_CTR1.h
 * @version 1.0
 * @date 2023-01-10
 * @brief CMSIS Peripheral Access Layer for SYS_CTR1
 *
 * CMSIS Peripheral Access Layer for SYS_CTR1
 */

#if !defined(PERI_SYS_CTR1_H_)
#define PERI_SYS_CTR1_H_                         /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- SYS_CTR1 Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup SYS_CTR1_Peripheral_Access_Layer SYS_CTR1 Peripheral Access Layer
 * @{
 */

/** SYS_CTR1 - Register Layout Typedef */
typedef struct {
...
/* ----------------------------------------------------------------------------
   -- SYS_CTR1 Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup SYS_CTR1_Register_Masks SYS_CTR1 Register Masks
 * @{
 */
...
#define SYS_CTR1_CNTCR_EN_MASK                   (0x1U)
#define SYS_CTR1_CNTCR_EN_SHIFT                  (0U)
/*! EN - Enable Counting
 *  0b0..Disable
 *  0b1..Enable
 */
#define SYS_CTR1_CNTCR_EN(x)                     (((uint32_t)(((uint32_t)(x)) << SYS_CTR1_CNTCR_EN_SHIFT)) & SYS_CTR1_CNTCR_EN_MASK)

#define SYS_CTR1_CNTCR_HDBG_MASK                 (0x2U)
#define SYS_CTR1_CNTCR_HDBG_SHIFT                (1U)
/*! HDBG - Enable Debug Halt
 *  0b0..Ignored
 *  0b1..Causes SYS_CTR to halt
 */
#define SYS_CTR1_CNTCR_HDBG(x)                   (((uint32_t)(((uint32_t)(x)) << SYS_CTR1_CNTCR_HDBG_SHIFT)) & SYS_CTR1_CNTCR_HDBG_MASK)

#define SYS_CTR1_CNTCR_FCR0_MASK                 (0x100U)
#define SYS_CTR1_CNTCR_FCR0_SHIFT                (8U)
/*! FCR0 - Frequency Change Request, ID 0
 *  0b0..No change
 *  0b1..Base frequency
 */
#define SYS_CTR1_CNTCR_FCR0(x)                   (((uint32_t)(((uint32_t)(x)) << SYS_CTR1_CNTCR_FCR0_SHIFT)) & SYS_CTR1_CNTCR_FCR0_MASK)

#define SYS_CTR1_CNTCR_FCR1_MASK                 (0x200U)
#define SYS_CTR1_CNTCR_FCR1_SHIFT                (9U)
/*! FCR1 - Frequency Change Request, ID 1
 *  0b0..No change
 *  0b1..Alternate frequency
 */
#define SYS_CTR1_CNTCR_FCR1(x)                   (((uint32_t)(((uint32_t)(x)) << SYS_CTR1_CNTCR_FCR1_SHIFT)) & SYS_CTR1_CNTCR_FCR1_MASK)
/*! @} */

/*! @name CNTSR - Counter Status */
/*! @{ */

#define SYS_CTR1_CNTSR_DBGH_MASK                 (0x1U)
#define SYS_CTR1_CNTSR_DBGH_SHIFT                (0U)
/*! DBGH - Debug Halt
 *  0b0..Did not halt
 *  0b1..Halted
 */
#define SYS_CTR1_CNTSR_DBGH(x)                   (((uint32_t)(((uint32_t)(x)) << SYS_CTR1_CNTSR_DBGH_SHIFT)) & SYS_CTR1_CNTSR_DBGH_MASK)

#define SYS_CTR1_CNTSR_FCA0_MASK                 (0x100U)
#define SYS_CTR1_CNTSR_FCA0_SHIFT                (8U)
/*! FCA0 - Frequency Change Acknowledge, ID 0
 *  0b0..Not selected
 *  0b1..Selected
 */
#define SYS_CTR1_CNTSR_FCA0(x)                   (((uint32_t)(((uint32_t)(x)) << SYS_CTR1_CNTSR_FCA0_SHIFT)) & SYS_CTR1_CNTSR_FCA0_MASK)

#define SYS_CTR1_CNTSR_FCA1_MASK                 (0x200U)
#define SYS_CTR1_CNTSR_FCA1_SHIFT                (9U)
/*! FCA1 - Frequency Change Acknowledge, ID 1
 *  0b0..Not selected
 *  0b1..Selected
 */
#define SYS_CTR1_CNTSR_FCA1(x)                   (((uint32_t)(((uint32_t)(x)) << SYS_CTR1_CNTSR_FCA1_SHIFT)) & SYS_CTR1_CNTSR_FCA1_MASK)
/*! @} */

/*! @name CNTCV0 - Counter Count Value Low */
/*! @{ */

#define SYS_CTR1_CNTCV0_CNTCV0_MASK              (0xFFFFFFFFU)
#define SYS_CTR1_CNTCV0_CNTCV0_SHIFT             (0U)
/*! CNTCV0 - Counter Count Value Bits [31:0] */
#define SYS_CTR1_CNTCV0_CNTCV0(x)                (((uint32_t)(((uint32_t)(x)) << SYS_CTR1_CNTCV0_CNTCV0_SHIFT)) & SYS_CTR1_CNTCV0_CNTCV0_MASK)
/*! @} */

/*! @name CNTCV1 - Counter Count Value High */
/*! @{ */

#define SYS_CTR1_CNTCV1_CNTCV1_MASK              (0xFFFFFFU)
#define SYS_CTR1_CNTCV1_CNTCV1_SHIFT             (0U)
/*! CNTCV1 - Counter Count Value Bits [55:32] */
#define SYS_CTR1_CNTCV1_CNTCV1(x)                (((uint32_t)(((uint32_t)(x)) << SYS_CTR1_CNTCV1_CNTCV1_SHIFT)) & SYS_CTR1_CNTCV1_CNTCV1_MASK)
/*! @} */

/*! @name CNTFID0 - Frequency-Modes Table 0 */
/*! @{ */

#define SYS_CTR1_CNTFID0_CNTFID0_MASK            (0xFFFFFFFFU)
#define SYS_CTR1_CNTFID0_CNTFID0_SHIFT           (0U)
/*! CNTFID0 - Counter Frequency ID 0 */
#define SYS_CTR1_CNTFID0_CNTFID0(x)              (((uint32_t)(((uint32_t)(x)) << SYS_CTR1_CNTFID0_CNTFID0_SHIFT)) & SYS_CTR1_CNTFID0_CNTFID0_MASK)
/*! @} */

/*! @name CNTFID1 - Frequency-Modes Table 1 */
/*! @{ */

#define SYS_CTR1_CNTFID1_CNTFID1_MASK            (0xFFFFFFFFU)
#define SYS_CTR1_CNTFID1_CNTFID1_SHIFT           (0U)
/*! CNTFID1 - Counter Frequency ID 1 */
#define SYS_CTR1_CNTFID1_CNTFID1(x)              (((uint32_t)(((uint32_t)(x)) << SYS_CTR1_CNTFID1_CNTFID1_SHIFT)) & SYS_CTR1_CNTFID1_CNTFID1_MASK)
/*! @} */

/*! @name CNTFID2 - Frequency-Modes Table 2 */
/*! @{ */

#define SYS_CTR1_CNTFID2_CNTFID2_MASK            (0xFFFFFFFFU)
#define SYS_CTR1_CNTFID2_CNTFID2_SHIFT           (0U)
/*! CNTFID2 - Counter Frequency ID 2 */
#define SYS_CTR1_CNTFID2_CNTFID2(x)              (((uint32_t)(((uint32_t)(x)) << SYS_CTR1_CNTFID2_CNTFID2_SHIFT)) & SYS_CTR1_CNTFID2_CNTFID2_MASK)
/*! @} */

/*! @name CNTID0 - Counter ID */
/*! @{ */

#define SYS_CTR1_CNTID0_CNTID_MASK               (0xFFFFFFFFU)
#define SYS_CTR1_CNTID0_CNTID_SHIFT              (0U)
/*! CNTID - Counter Identification */
#define SYS_CTR1_CNTID0_CNTID(x)                 (((uint32_t)(((uint32_t)(x)) << SYS_CTR1_CNTID0_CNTID_SHIFT)) & SYS_CTR1_CNTID0_CNTID_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group SYS_CTR1_Register_Masks */


/*!
 * @}
 */ /* end of group SYS_CTR1_Peripheral_Access_Layer */
