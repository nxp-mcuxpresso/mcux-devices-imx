...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER
**
...
/*!
 * @file PERI_NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER.h
 * @version 1.0
 * @date 2023-01-10
 * @brief CMSIS Peripheral Access Layer for NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER
 *
 * CMSIS Peripheral Access Layer for NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER
 */

#if !defined(PERI_NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_H_)
#define PERI_NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_H_ /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_Peripheral_Access_Layer NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER Peripheral Access Layer
 * @{
 */

/** NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER - Register Layout Typedef */
typedef struct {
  __I  uint32_t ID_COREID;                         /**< Core ID, offset: 0x0 */
  __I  uint32_t ID_REVISIONID;                     /**< Revision ID, offset: 0x4 */
  __IO uint32_t USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_MODE; /**< offset: 0x8 */
  __IO uint32_t USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_ADDRBASE_LOW; /**< offset: 0xC */
  __IO uint32_t USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_ADDRBASE_HIGH; /**< offset: 0x10 */
  __IO uint32_t USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_ADDRWINDOWSIZE; /**< offset: 0x14 */
       uint8_t RESERVED_0[8];
  __IO uint32_t USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_OPCODE; /**< offset: 0x20 */
} NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_Type;

/* ----------------------------------------------------------------------------
   -- NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_Register_Masks NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER Register Masks
 * @{
 */
...
#define NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_ID_COREID_CORETYPEID_MASK (0xFFU)
#define NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_ID_COREID_CORETYPEID_SHIFT (0U)
#define NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_ID_COREID_CORETYPEID(x) (((uint32_t)(((uint32_t)(x)) << NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_ID_COREID_CORETYPEID_SHIFT)) & NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_ID_COREID_CORETYPEID_MASK)

#define NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_ID_COREID_CORECHECKSUM_MASK (0xFFFFFF00U)
#define NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_ID_COREID_CORECHECKSUM_SHIFT (8U)
#define NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_ID_COREID_CORECHECKSUM(x) (((uint32_t)(((uint32_t)(x)) << NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_ID_COREID_CORECHECKSUM_SHIFT)) & NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_ID_COREID_CORECHECKSUM_MASK)
/*! @} */

/*! @name ID_REVISIONID - Revision ID */
/*! @{ */

#define NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_ID_REVISIONID_USERID_MASK (0xFFU)
#define NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_ID_REVISIONID_USERID_SHIFT (0U)
#define NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_ID_REVISIONID_USERID(x) (((uint32_t)(((uint32_t)(x)) << NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_ID_REVISIONID_USERID_SHIFT)) & NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_ID_REVISIONID_USERID_MASK)

#define NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_ID_REVISIONID_NOCID_MASK (0xFFFFFF00U)
#define NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_ID_REVISIONID_NOCID_SHIFT (8U)
#define NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_ID_REVISIONID_NOCID(x) (((uint32_t)(((uint32_t)(x)) << NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_ID_REVISIONID_NOCID_SHIFT)) & NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_ID_REVISIONID_NOCID_MASK)
/*! @} */

/*! @name USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_MODE -  */
/*! @{ */

#define NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_MODE_MODE_MASK (0x1U)
#define NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_MODE_MODE_SHIFT (0U)
#define NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_MODE_MODE(x) (((uint32_t)(((uint32_t)(x)) << NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_MODE_MODE_SHIFT)) & NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_MODE_MODE_MASK)
/*! @} */

/*! @name USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_ADDRBASE_LOW -  */
/*! @{ */

#define NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_ADDRBASE_LOW_ADDRBASE_LOW_MASK (0xFFFFFFFFU)
#define NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_ADDRBASE_LOW_ADDRBASE_LOW_SHIFT (0U)
#define NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_ADDRBASE_LOW_ADDRBASE_LOW(x) (((uint32_t)(((uint32_t)(x)) << NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_ADDRBASE_LOW_ADDRBASE_LOW_SHIFT)) & NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_ADDRBASE_LOW_ADDRBASE_LOW_MASK)
/*! @} */

/*! @name USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_ADDRBASE_HIGH -  */
/*! @{ */

#define NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_ADDRBASE_HIGH_ADDRBASE_HIGH_MASK (0x1FFFFU)
#define NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_ADDRBASE_HIGH_ADDRBASE_HIGH_SHIFT (0U)
#define NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_ADDRBASE_HIGH_ADDRBASE_HIGH(x) (((uint32_t)(((uint32_t)(x)) << NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_ADDRBASE_HIGH_ADDRBASE_HIGH_SHIFT)) & NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_ADDRBASE_HIGH_ADDRBASE_HIGH_MASK)
/*! @} */

/*! @name USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_ADDRWINDOWSIZE -  */
/*! @{ */

#define NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_ADDRWINDOWSIZE_ADDRWINDOWSIZE_MASK (0x3FU)
#define NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_ADDRWINDOWSIZE_ADDRWINDOWSIZE_SHIFT (0U)
#define NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_ADDRWINDOWSIZE_ADDRWINDOWSIZE(x) (((uint32_t)(((uint32_t)(x)) << NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_ADDRWINDOWSIZE_ADDRWINDOWSIZE_SHIFT)) & NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_ADDRWINDOWSIZE_ADDRWINDOWSIZE_MASK)
/*! @} */

/*! @name USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_OPCODE -  */
/*! @{ */

#define NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_OPCODE_RDEN_MASK (0x1U)
#define NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_OPCODE_RDEN_SHIFT (0U)
#define NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_OPCODE_RDEN(x) (((uint32_t)(((uint32_t)(x)) << NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_OPCODE_RDEN_SHIFT)) & NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_OPCODE_RDEN_MASK)

#define NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_OPCODE_WREN_MASK (0x2U)
#define NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_OPCODE_WREN_SHIFT (1U)
#define NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_OPCODE_WREN(x) (((uint32_t)(((uint32_t)(x)) << NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_OPCODE_WREN_SHIFT)) & NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_USB2_AXI_SLAVE_RD_I_MAIN_TRANSACTIONSTATFILTER_OPCODE_WREN_MASK)
/*! @} */
...
/*!
 * @}
 */ /* end of group NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_Peripheral_Access_Layer */
...
#endif  /* PERI_NOC_USB2_AXI_SLAVE_RD_I_XSTATFILTER_H_ */
