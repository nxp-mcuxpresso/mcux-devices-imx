...
**         Probe_ISI_main_TransactionStatProfiler
**
...
/*!
 * @file PERI_Probe_ISI_main_TransactionStatProfiler.h
 * @version 1.0
 * @date 2023-01-10
 * @brief CMSIS Peripheral Access Layer for
 *        Probe_ISI_main_TransactionStatProfiler
 *
 * CMSIS Peripheral Access Layer for Probe_ISI_main_TransactionStatProfiler
 */

#if !defined(PERI_PROBE_ISI_MAIN_TRANSACTIONSTATPROFILER_H_)
#define PERI_PROBE_ISI_MAIN_TRANSACTIONSTATPROFILER_H_ /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- Probe_ISI_main_TransactionStatProfiler Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup Probe_ISI_main_TransactionStatProfiler_Peripheral_Access_Layer Probe_ISI_main_TransactionStatProfiler Peripheral Access Layer
 * @{
 */

/** Probe_ISI_main_TransactionStatProfiler - Size of Registers Arrays */
#define Probe_ISI_main_TransactionStatProfiler_OBSERVEDSEL_COUNT 4u
#define Probe_ISI_main_TransactionStatProfiler_NTENURELINES_COUNT 3u
#define Probe_ISI_main_TransactionStatProfiler_THRESHOLDS_COUNT 4u
#define Probe_ISI_main_TransactionStatProfiler_THRESHOLDS_TRANSACTIONSTATPROFILER_THRESHOLDS_J_COUNT 4u

/** Probe_ISI_main_TransactionStatProfiler - Register Layout Typedef */
typedef struct {
  ...
  __IO uint32_t TRANSACTIONSTATPROFILER_OBSERVEDSEL[Probe_ISI_main_TransactionStatProfiler_OBSERVEDSEL_COUNT]; /**< ObservedSel n, array offset: 0x10, array step: 0x4 */
  __IO uint32_t NTENURELINES[Probe_ISI_main_TransactionStatProfiler_NTENURELINES_COUNT]; /**< NTENURELINES n, array offset: 0x20, array step: 0x4 */
  __IO uint32_t TRANSACTIONSTATPROFILER_THRESHOLDS_[Probe_ISI_main_TransactionStatProfiler_THRESHOLDS_COUNT][Probe_ISI_main_TransactionStatProfiler_THRESHOLDS_TRANSACTIONSTATPROFILER_THRESHOLDS_J_COUNT]; /**< Transaction Profiler Thresholds, array offset: 0x2C, array step: index*0x10, index2*0x4 */
...
} Probe_ISI_main_TransactionStatProfiler_Type;

/* ----------------------------------------------------------------------------
   -- Probe_ISI_main_TransactionStatProfiler Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup Probe_ISI_main_TransactionStatProfiler_Register_Masks Probe_ISI_main_TransactionStatProfiler Register Masks
 * @{
 */
...
#define Probe_ISI_main_TransactionStatProfiler_ID_COREID_CORETYPEID_MASK (0xFFU)
#define Probe_ISI_main_TransactionStatProfiler_ID_COREID_CORETYPEID_SHIFT (0U)
#define Probe_ISI_main_TransactionStatProfiler_ID_COREID_CORETYPEID(x) (((uint32_t)(((uint32_t)(x)) << Probe_ISI_main_TransactionStatProfiler_ID_COREID_CORETYPEID_SHIFT)) & Probe_ISI_main_TransactionStatProfiler_ID_COREID_CORETYPEID_MASK)

#define Probe_ISI_main_TransactionStatProfiler_ID_COREID_CORECHECKSUM_MASK (0xFFFFFF00U)
#define Probe_ISI_main_TransactionStatProfiler_ID_COREID_CORECHECKSUM_SHIFT (8U)
#define Probe_ISI_main_TransactionStatProfiler_ID_COREID_CORECHECKSUM(x) (((uint32_t)(((uint32_t)(x)) << Probe_ISI_main_TransactionStatProfiler_ID_COREID_CORECHECKSUM_SHIFT)) & Probe_ISI_main_TransactionStatProfiler_ID_COREID_CORECHECKSUM_MASK)
/*! @} */

/*! @name ID_REVISIONID - Revision ID */
/*! @{ */

#define Probe_ISI_main_TransactionStatProfiler_ID_REVISIONID_USERID_MASK (0xFFU)
#define Probe_ISI_main_TransactionStatProfiler_ID_REVISIONID_USERID_SHIFT (0U)
#define Probe_ISI_main_TransactionStatProfiler_ID_REVISIONID_USERID(x) (((uint32_t)(((uint32_t)(x)) << Probe_ISI_main_TransactionStatProfiler_ID_REVISIONID_USERID_SHIFT)) & Probe_ISI_main_TransactionStatProfiler_ID_REVISIONID_USERID_MASK)

#define Probe_ISI_main_TransactionStatProfiler_ID_REVISIONID_NOCID_MASK (0xFFFFFF00U)
#define Probe_ISI_main_TransactionStatProfiler_ID_REVISIONID_NOCID_SHIFT (8U)
#define Probe_ISI_main_TransactionStatProfiler_ID_REVISIONID_NOCID(x) (((uint32_t)(((uint32_t)(x)) << Probe_ISI_main_TransactionStatProfiler_ID_REVISIONID_NOCID_SHIFT)) & Probe_ISI_main_TransactionStatProfiler_ID_REVISIONID_NOCID_MASK)
/*! @} */

/*! @name EN - Enable */
/*! @{ */

#define Probe_ISI_main_TransactionStatProfiler_EN_EN_MASK (0x1U)
#define Probe_ISI_main_TransactionStatProfiler_EN_EN_SHIFT (0U)
#define Probe_ISI_main_TransactionStatProfiler_EN_EN(x) (((uint32_t)(((uint32_t)(x)) << Probe_ISI_main_TransactionStatProfiler_EN_EN_SHIFT)) & Probe_ISI_main_TransactionStatProfiler_EN_EN_MASK)
/*! @} */

/*! @name MODE - Mode */
/*! @{ */

#define Probe_ISI_main_TransactionStatProfiler_MODE_MODE_MASK (0xFU)
#define Probe_ISI_main_TransactionStatProfiler_MODE_MODE_SHIFT (0U)
#define Probe_ISI_main_TransactionStatProfiler_MODE_MODE(x) (((uint32_t)(((uint32_t)(x)) << Probe_ISI_main_TransactionStatProfiler_MODE_MODE_SHIFT)) & Probe_ISI_main_TransactionStatProfiler_MODE_MODE_MASK)
/*! @} */

/*! @name TRANSACTIONSTATPROFILER_OBSERVEDSEL - ObservedSel n */
/*! @{ */

#define Probe_ISI_main_TransactionStatProfiler_TRANSACTIONSTATPROFILER_OBSERVEDSEL_OBSERVEDSEL_MASK (0x3U)
#define Probe_ISI_main_TransactionStatProfiler_TRANSACTIONSTATPROFILER_OBSERVEDSEL_OBSERVEDSEL_SHIFT (0U)
/*! OBSERVEDSEL - ObservedSel n */
#define Probe_ISI_main_TransactionStatProfiler_TRANSACTIONSTATPROFILER_OBSERVEDSEL_OBSERVEDSEL(x) (((uint32_t)(((uint32_t)(x)) << Probe_ISI_main_TransactionStatProfiler_TRANSACTIONSTATPROFILER_OBSERVEDSEL_OBSERVEDSEL_SHIFT)) & Probe_ISI_main_TransactionStatProfiler_TRANSACTIONSTATPROFILER_OBSERVEDSEL_OBSERVEDSEL_MASK)
/*! @} */

/* The count of Probe_ISI_main_TransactionStatProfiler_TRANSACTIONSTATPROFILER_OBSERVEDSEL */
#define Probe_ISI_main_TransactionStatProfiler_TRANSACTIONSTATPROFILER_OBSERVEDSEL_COUNT (4U)

/*! @name NTENURELINES - NTENURELINES n */
/*! @{ */

#define Probe_ISI_main_TransactionStatProfiler_NTENURELINES_NTenurelines_0_MASK (0xFU)
#define Probe_ISI_main_TransactionStatProfiler_NTENURELINES_NTenurelines_0_SHIFT (0U)
/*! NTenurelines_0 - Ntenurelines n */
#define Probe_ISI_main_TransactionStatProfiler_NTENURELINES_NTenurelines_0(x) (((uint32_t)(((uint32_t)(x)) << Probe_ISI_main_TransactionStatProfiler_NTENURELINES_NTenurelines_0_SHIFT)) & Probe_ISI_main_TransactionStatProfiler_NTENURELINES_NTenurelines_0_MASK)

#define Probe_ISI_main_TransactionStatProfiler_NTENURELINES_NTenurelines_1_MASK (0xFU)
#define Probe_ISI_main_TransactionStatProfiler_NTENURELINES_NTenurelines_1_SHIFT (0U)
/*! NTenurelines_1 - Ntenurelines n */
#define Probe_ISI_main_TransactionStatProfiler_NTENURELINES_NTenurelines_1(x) (((uint32_t)(((uint32_t)(x)) << Probe_ISI_main_TransactionStatProfiler_NTENURELINES_NTenurelines_1_SHIFT)) & Probe_ISI_main_TransactionStatProfiler_NTENURELINES_NTenurelines_1_MASK)

#define Probe_ISI_main_TransactionStatProfiler_NTENURELINES_NTenurelines_2_MASK (0xFU)
#define Probe_ISI_main_TransactionStatProfiler_NTENURELINES_NTenurelines_2_SHIFT (0U)
/*! NTenurelines_2 - Ntenurelines n */
#define Probe_ISI_main_TransactionStatProfiler_NTENURELINES_NTenurelines_2(x) (((uint32_t)(((uint32_t)(x)) << Probe_ISI_main_TransactionStatProfiler_NTENURELINES_NTenurelines_2_SHIFT)) & Probe_ISI_main_TransactionStatProfiler_NTENURELINES_NTenurelines_2_MASK)
/*! @} */

/*! @name TRANSACTIONSTATPROFILER_THRESHOLDS_ - Transaction Profiler Thresholds */
/*! @{ */

#define Probe_ISI_main_TransactionStatProfiler_TRANSACTIONSTATPROFILER_THRESHOLDS__THRESHOLDS_MASK (0x7FFU)
#define Probe_ISI_main_TransactionStatProfiler_TRANSACTIONSTATPROFILER_THRESHOLDS__THRESHOLDS_SHIFT (0U)
#define Probe_ISI_main_TransactionStatProfiler_TRANSACTIONSTATPROFILER_THRESHOLDS__THRESHOLDS(x) (((uint32_t)(((uint32_t)(x)) << Probe_ISI_main_TransactionStatProfiler_TRANSACTIONSTATPROFILER_THRESHOLDS__THRESHOLDS_SHIFT)) & Probe_ISI_main_TransactionStatProfiler_TRANSACTIONSTATPROFILER_THRESHOLDS__THRESHOLDS_MASK)
/*! @} */

/* The count of Probe_ISI_main_TransactionStatProfiler_TRANSACTIONSTATPROFILER_THRESHOLDS_ */
#define Probe_ISI_main_TransactionStatProfiler_TRANSACTIONSTATPROFILER_THRESHOLDS__COUNT (4U)

/* The count of Probe_ISI_main_TransactionStatProfiler_TRANSACTIONSTATPROFILER_THRESHOLDS_ */
#define Probe_ISI_main_TransactionStatProfiler_TRANSACTIONSTATPROFILER_THRESHOLDS__COUNT2 (4U)

/*! @name OVERFLOWSTATUS - Overflow Status */
/*! @{ */

#define Probe_ISI_main_TransactionStatProfiler_OVERFLOWSTATUS_OVERFLOWSTATUS_MASK (0xFU)
#define Probe_ISI_main_TransactionStatProfiler_OVERFLOWSTATUS_OVERFLOWSTATUS_SHIFT (0U)
#define Probe_ISI_main_TransactionStatProfiler_OVERFLOWSTATUS_OVERFLOWSTATUS(x) (((uint32_t)(((uint32_t)(x)) << Probe_ISI_main_TransactionStatProfiler_OVERFLOWSTATUS_OVERFLOWSTATUS_SHIFT)) & Probe_ISI_main_TransactionStatProfiler_OVERFLOWSTATUS_OVERFLOWSTATUS_MASK)
/*! @} */

/*! @name OVERFLOWRESET - Overflow Reset */
/*! @{ */

#define Probe_ISI_main_TransactionStatProfiler_OVERFLOWRESET_OVERFLOWRESET_MASK (0xFU)
#define Probe_ISI_main_TransactionStatProfiler_OVERFLOWRESET_OVERFLOWRESET_SHIFT (0U)
#define Probe_ISI_main_TransactionStatProfiler_OVERFLOWRESET_OVERFLOWRESET(x) (((uint32_t)(((uint32_t)(x)) << Probe_ISI_main_TransactionStatProfiler_OVERFLOWRESET_OVERFLOWRESET_SHIFT)) & Probe_ISI_main_TransactionStatProfiler_OVERFLOWRESET_OVERFLOWRESET_MASK)
/*! @} */

/*! @name PENDINGEVENTMODE - Pending Event Mode */
/*! @{ */

#define Probe_ISI_main_TransactionStatProfiler_PENDINGEVENTMODE_PENDINGEVENTMODE_MASK (0x1U)
#define Probe_ISI_main_TransactionStatProfiler_PENDINGEVENTMODE_PENDINGEVENTMODE_SHIFT (0U)
#define Probe_ISI_main_TransactionStatProfiler_PENDINGEVENTMODE_PENDINGEVENTMODE(x) (((uint32_t)(((uint32_t)(x)) << Probe_ISI_main_TransactionStatProfiler_PENDINGEVENTMODE_PENDINGEVENTMODE_SHIFT)) & Probe_ISI_main_TransactionStatProfiler_PENDINGEVENTMODE_PENDINGEVENTMODE_MASK)
/*! @} */

/*! @name PRESCALER - Pre Scaler */
/*! @{ */

#define Probe_ISI_main_TransactionStatProfiler_PRESCALER_PRESCALER_MASK (0xFFU)
#define Probe_ISI_main_TransactionStatProfiler_PRESCALER_PRESCALER_SHIFT (0U)
#define Probe_ISI_main_TransactionStatProfiler_PRESCALER_PRESCALER(x) (((uint32_t)(((uint32_t)(x)) << Probe_ISI_main_TransactionStatProfiler_PRESCALER_PRESCALER_SHIFT)) & Probe_ISI_main_TransactionStatProfiler_PRESCALER_PRESCALER_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group Probe_ISI_main_TransactionStatProfiler_Register_Masks */


/*!
 * @}
 */ /* end of group Probe_ISI_main_TransactionStatProfiler_Peripheral_Access_Layer */
...
#endif  /* PERI_PROBE_ISI_MAIN_TRANSACTIONSTATPROFILER_H_ */
