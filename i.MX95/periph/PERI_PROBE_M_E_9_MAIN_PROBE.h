...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for Probe_m_e_9_main_Probe
**
...
/*!
 * @file PERI_Probe_m_e_9_main_Probe.h
 * @version 1.0
 * @date 2023-01-10
 * @brief CMSIS Peripheral Access Layer for Probe_m_e_9_main_Probe
 *
 * CMSIS Peripheral Access Layer for Probe_m_e_9_main_Probe
 */

#if !defined(PERI_PROBE_M_E_9_MAIN_PROBE_H_)
#define PERI_PROBE_M_E_9_MAIN_PROBE_H_           /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- Probe_m_e_9_main_Probe Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup Probe_m_e_9_main_Probe_Peripheral_Access_Layer Probe_m_e_9_main_Probe Peripheral Access Layer
 * @{
 */

/** Probe_m_e_9_main_Probe - Size of Registers Arrays */
#define Probe_m_e_9_main_Probe_COUNTERS_COUNT     10u

/** Probe_m_e_9_main_Probe - Register Layout Typedef */
typedef struct {
  ...
  } COUNTERS[Probe_m_e_9_main_Probe_COUNTERS_COUNT];
} Probe_m_e_9_main_Probe_Type;

/* ----------------------------------------------------------------------------
   -- Probe_m_e_9_main_Probe Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup Probe_m_e_9_main_Probe_Register_Masks Probe_m_e_9_main_Probe Register Masks
 * @{
 */
...
#define Probe_m_e_9_main_Probe_ID_COREID_CORETYPEID_MASK (0xFFU)
#define Probe_m_e_9_main_Probe_ID_COREID_CORETYPEID_SHIFT (0U)
#define Probe_m_e_9_main_Probe_ID_COREID_CORETYPEID(x) (((uint32_t)(((uint32_t)(x)) << Probe_m_e_9_main_Probe_ID_COREID_CORETYPEID_SHIFT)) & Probe_m_e_9_main_Probe_ID_COREID_CORETYPEID_MASK)

#define Probe_m_e_9_main_Probe_ID_COREID_CORECHECKSUM_MASK (0xFFFFFF00U)
#define Probe_m_e_9_main_Probe_ID_COREID_CORECHECKSUM_SHIFT (8U)
#define Probe_m_e_9_main_Probe_ID_COREID_CORECHECKSUM(x) (((uint32_t)(((uint32_t)(x)) << Probe_m_e_9_main_Probe_ID_COREID_CORECHECKSUM_SHIFT)) & Probe_m_e_9_main_Probe_ID_COREID_CORECHECKSUM_MASK)
/*! @} */

/*! @name ID_REVISIONID - Revision ID */
/*! @{ */

#define Probe_m_e_9_main_Probe_ID_REVISIONID_USERID_MASK (0xFFU)
#define Probe_m_e_9_main_Probe_ID_REVISIONID_USERID_SHIFT (0U)
#define Probe_m_e_9_main_Probe_ID_REVISIONID_USERID(x) (((uint32_t)(((uint32_t)(x)) << Probe_m_e_9_main_Probe_ID_REVISIONID_USERID_SHIFT)) & Probe_m_e_9_main_Probe_ID_REVISIONID_USERID_MASK)

#define Probe_m_e_9_main_Probe_ID_REVISIONID_NOCID_MASK (0xFFFFFF00U)
#define Probe_m_e_9_main_Probe_ID_REVISIONID_NOCID_SHIFT (8U)
#define Probe_m_e_9_main_Probe_ID_REVISIONID_NOCID(x) (((uint32_t)(((uint32_t)(x)) << Probe_m_e_9_main_Probe_ID_REVISIONID_NOCID_SHIFT)) & Probe_m_e_9_main_Probe_ID_REVISIONID_NOCID_MASK)
/*! @} */

/*! @name MAINCTL - Main Control */
/*! @{ */

#define Probe_m_e_9_main_Probe_MAINCTL_ERREN_MASK (0x1U)
#define Probe_m_e_9_main_Probe_MAINCTL_ERREN_SHIFT (0U)
#define Probe_m_e_9_main_Probe_MAINCTL_ERREN(x)  (((uint32_t)(((uint32_t)(x)) << Probe_m_e_9_main_Probe_MAINCTL_ERREN_SHIFT)) & Probe_m_e_9_main_Probe_MAINCTL_ERREN_MASK)

#define Probe_m_e_9_main_Probe_MAINCTL_TRACEEN_MASK (0x2U)
#define Probe_m_e_9_main_Probe_MAINCTL_TRACEEN_SHIFT (1U)
#define Probe_m_e_9_main_Probe_MAINCTL_TRACEEN(x) (((uint32_t)(((uint32_t)(x)) << Probe_m_e_9_main_Probe_MAINCTL_TRACEEN_SHIFT)) & Probe_m_e_9_main_Probe_MAINCTL_TRACEEN_MASK)

#define Probe_m_e_9_main_Probe_MAINCTL_PAYLOADEN_MASK (0x4U)
#define Probe_m_e_9_main_Probe_MAINCTL_PAYLOADEN_SHIFT (2U)
#define Probe_m_e_9_main_Probe_MAINCTL_PAYLOADEN(x) (((uint32_t)(((uint32_t)(x)) << Probe_m_e_9_main_Probe_MAINCTL_PAYLOADEN_SHIFT)) & Probe_m_e_9_main_Probe_MAINCTL_PAYLOADEN_MASK)

#define Probe_m_e_9_main_Probe_MAINCTL_STATEN_MASK (0x8U)
#define Probe_m_e_9_main_Probe_MAINCTL_STATEN_SHIFT (3U)
#define Probe_m_e_9_main_Probe_MAINCTL_STATEN(x) (((uint32_t)(((uint32_t)(x)) << Probe_m_e_9_main_Probe_MAINCTL_STATEN_SHIFT)) & Probe_m_e_9_main_Probe_MAINCTL_STATEN_MASK)

#define Probe_m_e_9_main_Probe_MAINCTL_ALARMEN_MASK (0x10U)
#define Probe_m_e_9_main_Probe_MAINCTL_ALARMEN_SHIFT (4U)
#define Probe_m_e_9_main_Probe_MAINCTL_ALARMEN(x) (((uint32_t)(((uint32_t)(x)) << Probe_m_e_9_main_Probe_MAINCTL_ALARMEN_SHIFT)) & Probe_m_e_9_main_Probe_MAINCTL_ALARMEN_MASK)

#define Probe_m_e_9_main_Probe_MAINCTL_STATCONDDUMP_MASK (0x20U)
#define Probe_m_e_9_main_Probe_MAINCTL_STATCONDDUMP_SHIFT (5U)
#define Probe_m_e_9_main_Probe_MAINCTL_STATCONDDUMP(x) (((uint32_t)(((uint32_t)(x)) << Probe_m_e_9_main_Probe_MAINCTL_STATCONDDUMP_SHIFT)) & Probe_m_e_9_main_Probe_MAINCTL_STATCONDDUMP_MASK)

#define Probe_m_e_9_main_Probe_MAINCTL_INTRUSIVEMODE_MASK (0x40U)
#define Probe_m_e_9_main_Probe_MAINCTL_INTRUSIVEMODE_SHIFT (6U)
#define Probe_m_e_9_main_Probe_MAINCTL_INTRUSIVEMODE(x) (((uint32_t)(((uint32_t)(x)) << Probe_m_e_9_main_Probe_MAINCTL_INTRUSIVEMODE_SHIFT)) & Probe_m_e_9_main_Probe_MAINCTL_INTRUSIVEMODE_MASK)

#define Probe_m_e_9_main_Probe_MAINCTL_FILTBYTEALWAYSCHAINABLEEN_MASK (0x80U)
#define Probe_m_e_9_main_Probe_MAINCTL_FILTBYTEALWAYSCHAINABLEEN_SHIFT (7U)
#define Probe_m_e_9_main_Probe_MAINCTL_FILTBYTEALWAYSCHAINABLEEN(x) (((uint32_t)(((uint32_t)(x)) << Probe_m_e_9_main_Probe_MAINCTL_FILTBYTEALWAYSCHAINABLEEN_SHIFT)) & Probe_m_e_9_main_Probe_MAINCTL_FILTBYTEALWAYSCHAINABLEEN_MASK)
/*! @} */

/*! @name CFGCTL - Configuration Control */
/*! @{ */

#define Probe_m_e_9_main_Probe_CFGCTL_GLOBALEN_MASK (0x1U)
#define Probe_m_e_9_main_Probe_CFGCTL_GLOBALEN_SHIFT (0U)
#define Probe_m_e_9_main_Probe_CFGCTL_GLOBALEN(x) (((uint32_t)(((uint32_t)(x)) << Probe_m_e_9_main_Probe_CFGCTL_GLOBALEN_SHIFT)) & Probe_m_e_9_main_Probe_CFGCTL_GLOBALEN_MASK)

#define Probe_m_e_9_main_Probe_CFGCTL_ACTIVE_MASK (0x2U)
#define Probe_m_e_9_main_Probe_CFGCTL_ACTIVE_SHIFT (1U)
#define Probe_m_e_9_main_Probe_CFGCTL_ACTIVE(x)  (((uint32_t)(((uint32_t)(x)) << Probe_m_e_9_main_Probe_CFGCTL_ACTIVE_SHIFT)) & Probe_m_e_9_main_Probe_CFGCTL_ACTIVE_MASK)
/*! @} */

/*! @name STATPERIOD - Statistics Period */
/*! @{ */

#define Probe_m_e_9_main_Probe_STATPERIOD_STATPERIOD_MASK (0x1FU)
#define Probe_m_e_9_main_Probe_STATPERIOD_STATPERIOD_SHIFT (0U)
#define Probe_m_e_9_main_Probe_STATPERIOD_STATPERIOD(x) (((uint32_t)(((uint32_t)(x)) << Probe_m_e_9_main_Probe_STATPERIOD_STATPERIOD_SHIFT)) & Probe_m_e_9_main_Probe_STATPERIOD_STATPERIOD_MASK)
/*! @} */

/*! @name STATGO - StatGo */
/*! @{ */

#define Probe_m_e_9_main_Probe_STATGO_STATGO_MASK (0x1U)
#define Probe_m_e_9_main_Probe_STATGO_STATGO_SHIFT (0U)
#define Probe_m_e_9_main_Probe_STATGO_STATGO(x)  (((uint32_t)(((uint32_t)(x)) << Probe_m_e_9_main_Probe_STATGO_STATGO_SHIFT)) & Probe_m_e_9_main_Probe_STATGO_STATGO_MASK)
/*! @} */

/*! @name SRC - Counters n Source */
/*! @{ */

#define Probe_m_e_9_main_Probe_SRC_INTEVENT_MASK (0x1FU)
#define Probe_m_e_9_main_Probe_SRC_INTEVENT_SHIFT (0U)
/*! INTEVENT
 ...
 *  0b11111..reserved
 */
#define Probe_m_e_9_main_Probe_SRC_INTEVENT(x)   (((uint32_t)(((uint32_t)(x)) << Probe_m_e_9_main_Probe_SRC_INTEVENT_SHIFT)) & Probe_m_e_9_main_Probe_SRC_INTEVENT_MASK)

#define Probe_m_e_9_main_Probe_SRC_EXTEVENT_MASK (0x20U)
#define Probe_m_e_9_main_Probe_SRC_EXTEVENT_SHIFT (5U)
#define Probe_m_e_9_main_Probe_SRC_EXTEVENT(x)   (((uint32_t)(((uint32_t)(x)) << Probe_m_e_9_main_Probe_SRC_EXTEVENT_SHIFT)) & Probe_m_e_9_main_Probe_SRC_EXTEVENT_MASK)
/*! @} */

/* The count of Probe_m_e_9_main_Probe_SRC */
#define Probe_m_e_9_main_Probe_SRC_COUNT         (10U)

/*! @name VAL - Counters n Value */
/*! @{ */

#define Probe_m_e_9_main_Probe_VAL_COUNTERS_VAL_MASK (0x3FFFFFFU)
#define Probe_m_e_9_main_Probe_VAL_COUNTERS_VAL_SHIFT (0U)
/*! COUNTERS_VAL - Value */
#define Probe_m_e_9_main_Probe_VAL_COUNTERS_VAL(x) (((uint32_t)(((uint32_t)(x)) << Probe_m_e_9_main_Probe_VAL_COUNTERS_VAL_SHIFT)) & Probe_m_e_9_main_Probe_VAL_COUNTERS_VAL_MASK)
/*! @} */

/* The count of Probe_m_e_9_main_Probe_VAL */
#define Probe_m_e_9_main_Probe_VAL_COUNT         (10U)


/*!
 * @}
 */ /* end of group Probe_m_e_9_main_Probe_Register_Masks */


/*!
 * @}
 */ /* end of group Probe_m_e_9_main_Probe_Peripheral_Access_Layer */
...
#endif  /* PERI_PROBE_M_E_9_MAIN_PROBE_H_ */
