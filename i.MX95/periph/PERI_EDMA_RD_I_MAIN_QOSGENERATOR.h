...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for eDMA_RD_I_main_QosGenerator
**
...
/*!
 * @file PERI_eDMA_RD_I_main_QosGenerator.h
 * @version 1.0
 * @date 2023-01-10
 * @brief CMSIS Peripheral Access Layer for eDMA_RD_I_main_QosGenerator
 *
 * CMSIS Peripheral Access Layer for eDMA_RD_I_main_QosGenerator
 */

#if !defined(PERI_EDMA_RD_I_MAIN_QOSGENERATOR_H_)
#define PERI_EDMA_RD_I_MAIN_QOSGENERATOR_H_      /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- eDMA_RD_I_main_QosGenerator Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup eDMA_RD_I_main_QosGenerator_Peripheral_Access_Layer eDMA_RD_I_main_QosGenerator Peripheral Access Layer
 * @{
 */

/** eDMA_RD_I_main_QosGenerator - Register Layout Typedef */
typedef struct {
...
} eDMA_RD_I_main_QosGenerator_Type;

/* ----------------------------------------------------------------------------
   -- eDMA_RD_I_main_QosGenerator Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup eDMA_RD_I_main_QosGenerator_Register_Masks eDMA_RD_I_main_QosGenerator Register Masks
 * @{
 */
...
#define eDMA_RD_I_main_QosGenerator_ID_COREID_CORETYPEID_MASK (0xFFU)
#define eDMA_RD_I_main_QosGenerator_ID_COREID_CORETYPEID_SHIFT (0U)
#define eDMA_RD_I_main_QosGenerator_ID_COREID_CORETYPEID(x) (((uint32_t)(((uint32_t)(x)) << eDMA_RD_I_main_QosGenerator_ID_COREID_CORETYPEID_SHIFT)) & eDMA_RD_I_main_QosGenerator_ID_COREID_CORETYPEID_MASK)

#define eDMA_RD_I_main_QosGenerator_ID_COREID_CORECHECKSUM_MASK (0xFFFFFF00U)
#define eDMA_RD_I_main_QosGenerator_ID_COREID_CORECHECKSUM_SHIFT (8U)
#define eDMA_RD_I_main_QosGenerator_ID_COREID_CORECHECKSUM(x) (((uint32_t)(((uint32_t)(x)) << eDMA_RD_I_main_QosGenerator_ID_COREID_CORECHECKSUM_SHIFT)) & eDMA_RD_I_main_QosGenerator_ID_COREID_CORECHECKSUM_MASK)
/*! @} */

/*! @name ID_REVISIONID - Revision ID */
/*! @{ */

#define eDMA_RD_I_main_QosGenerator_ID_REVISIONID_USERID_MASK (0xFFU)
#define eDMA_RD_I_main_QosGenerator_ID_REVISIONID_USERID_SHIFT (0U)
#define eDMA_RD_I_main_QosGenerator_ID_REVISIONID_USERID(x) (((uint32_t)(((uint32_t)(x)) << eDMA_RD_I_main_QosGenerator_ID_REVISIONID_USERID_SHIFT)) & eDMA_RD_I_main_QosGenerator_ID_REVISIONID_USERID_MASK)

#define eDMA_RD_I_main_QosGenerator_ID_REVISIONID_NOCID_MASK (0xFFFFFF00U)
#define eDMA_RD_I_main_QosGenerator_ID_REVISIONID_NOCID_SHIFT (8U)
#define eDMA_RD_I_main_QosGenerator_ID_REVISIONID_NOCID(x) (((uint32_t)(((uint32_t)(x)) << eDMA_RD_I_main_QosGenerator_ID_REVISIONID_NOCID_SHIFT)) & eDMA_RD_I_main_QosGenerator_ID_REVISIONID_NOCID_MASK)
/*! @} */

/*! @name PRIORITY - Priority */
/*! @{ */

#define eDMA_RD_I_main_QosGenerator_PRIORITY_P0_MASK (0x3U)
#define eDMA_RD_I_main_QosGenerator_PRIORITY_P0_SHIFT (0U)
#define eDMA_RD_I_main_QosGenerator_PRIORITY_P0(x) (((uint32_t)(((uint32_t)(x)) << eDMA_RD_I_main_QosGenerator_PRIORITY_P0_SHIFT)) & eDMA_RD_I_main_QosGenerator_PRIORITY_P0_MASK)

#define eDMA_RD_I_main_QosGenerator_PRIORITY_P1_MASK (0x300U)
#define eDMA_RD_I_main_QosGenerator_PRIORITY_P1_SHIFT (8U)
#define eDMA_RD_I_main_QosGenerator_PRIORITY_P1(x) (((uint32_t)(((uint32_t)(x)) << eDMA_RD_I_main_QosGenerator_PRIORITY_P1_SHIFT)) & eDMA_RD_I_main_QosGenerator_PRIORITY_P1_MASK)
/*! @} */

/*! @name MODE - Mode */
/*! @{ */

#define eDMA_RD_I_main_QosGenerator_MODE_MODE_MASK (0x3U)
#define eDMA_RD_I_main_QosGenerator_MODE_MODE_SHIFT (0U)
#define eDMA_RD_I_main_QosGenerator_MODE_MODE(x) (((uint32_t)(((uint32_t)(x)) << eDMA_RD_I_main_QosGenerator_MODE_MODE_SHIFT)) & eDMA_RD_I_main_QosGenerator_MODE_MODE_MASK)
/*! @} */

/*! @name EXTCONTROL - External Inputs Control */
/*! @{ */

#define eDMA_RD_I_main_QosGenerator_EXTCONTROL_SOCKETQOSEN_MASK (0x1U)
#define eDMA_RD_I_main_QosGenerator_EXTCONTROL_SOCKETQOSEN_SHIFT (0U)
#define eDMA_RD_I_main_QosGenerator_EXTCONTROL_SOCKETQOSEN(x) (((uint32_t)(((uint32_t)(x)) << eDMA_RD_I_main_QosGenerator_EXTCONTROL_SOCKETQOSEN_SHIFT)) & eDMA_RD_I_main_QosGenerator_EXTCONTROL_SOCKETQOSEN_MASK)

#define eDMA_RD_I_main_QosGenerator_EXTCONTROL_EXTTHREN_MASK (0x2U)
#define eDMA_RD_I_main_QosGenerator_EXTCONTROL_EXTTHREN_SHIFT (1U)
#define eDMA_RD_I_main_QosGenerator_EXTCONTROL_EXTTHREN(x) (((uint32_t)(((uint32_t)(x)) << eDMA_RD_I_main_QosGenerator_EXTCONTROL_EXTTHREN_SHIFT)) & eDMA_RD_I_main_QosGenerator_EXTCONTROL_EXTTHREN_MASK)

#define eDMA_RD_I_main_QosGenerator_EXTCONTROL_INTCLKEN_MASK (0x4U)
#define eDMA_RD_I_main_QosGenerator_EXTCONTROL_INTCLKEN_SHIFT (2U)
#define eDMA_RD_I_main_QosGenerator_EXTCONTROL_INTCLKEN(x) (((uint32_t)(((uint32_t)(x)) << eDMA_RD_I_main_QosGenerator_EXTCONTROL_INTCLKEN_SHIFT)) & eDMA_RD_I_main_QosGenerator_EXTCONTROL_INTCLKEN_MASK)

#define eDMA_RD_I_main_QosGenerator_EXTCONTROL_EXTLIMITEN_MASK (0x8U)
#define eDMA_RD_I_main_QosGenerator_EXTCONTROL_EXTLIMITEN_SHIFT (3U)
#define eDMA_RD_I_main_QosGenerator_EXTCONTROL_EXTLIMITEN(x) (((uint32_t)(((uint32_t)(x)) << eDMA_RD_I_main_QosGenerator_EXTCONTROL_EXTLIMITEN_SHIFT)) & eDMA_RD_I_main_QosGenerator_EXTCONTROL_EXTLIMITEN_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group eDMA_RD_I_main_QosGenerator_Register_Masks */


/*!
 * @}
 */ /* end of group eDMA_RD_I_main_QosGenerator_Peripheral_Access_Layer */
...
#endif  /* PERI_EDMA_RD_I_MAIN_QOSGENERATOR_H_ */
