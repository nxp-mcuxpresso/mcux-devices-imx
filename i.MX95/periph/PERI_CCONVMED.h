...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for CCONVMED
**
...
/*!
 * @file PERI_CCONVMED.h
 * @version 1.0
 * @date 2023-01-10
 * @brief CMSIS Peripheral Access Layer for CCONVMED
 *
 * CMSIS Peripheral Access Layer for CCONVMED
 */

#if !defined(PERI_CCONVMED_H_)
#define PERI_CCONVMED_H_                         /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- CCONVMED Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup CCONVMED_Peripheral_Access_Layer CCONVMED Peripheral Access Layer
 * @{
 */

/** CCONVMED - Size of Registers Arrays */
#define CCONVMED_NEO_PIPE2_CCONVMED_CONF_COUNT    1u

/** CCONVMED - Register Layout Typedef */
typedef struct {
  __IO uint32_t CTRL_CAM[CCONVMED_NEO_PIPE2_CCONVMED_CONF_COUNT]; /**< Camera 0 CCONVMED Control Register, array offset: 0x0, array step: 0x4 */
} CCONVMED_Type;

/* ----------------------------------------------------------------------------
   -- CCONVMED Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup CCONVMED_Register_Masks CCONVMED Register Masks
 * @{
 */

/*! @name CTRL_CAM - Camera 0 CCONVMED Control Register */
/*! @{ */

#define CCONVMED_CTRL_CAM_FLT_MASK               (0x30U)
#define CCONVMED_CTRL_CAM_FLT_SHIFT              (4U)
/*! FLT
 *  0b00..Bypassed
 *  0b01..Filter type is convolution (5x5 binomial)
 *  0b10..Filter type is median (5x5)
 *  0b11..Reserved
 */
#define CCONVMED_CTRL_CAM_FLT(x)                 (((uint32_t)(((uint32_t)(x)) << CCONVMED_CTRL_CAM_FLT_SHIFT)) & CCONVMED_CTRL_CAM_FLT_MASK)
/*! @} */

/* The count of CCONVMED_CTRL_CAM */
#define CCONVMED_CTRL_CAM_COUNT                  (1U)


/*!
 * @}
 */ /* end of group CCONVMED_Register_Masks */


/*!
 * @}
 */ /* end of group CCONVMED_Peripheral_Access_Layer */
