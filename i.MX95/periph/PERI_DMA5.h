...
#define DMA5_CH_SBR_ATTR_MASK                    (0x7E0000U)  /* Merged from fields with different position or width, of widths (4, 6), largest definition used */
#define DMA5_CH_SBR_ATTR_SHIFT                   (17U)
/*! ATTR - Attribute Output */
#define DMA5_CH_SBR_ATTR(x)                      (((uint32_t)(((uint32_t)(x)) << DMA5_CH_SBR_ATTR_SHIFT)) & DMA5_CH_SBR_ATTR_MASK)  /* Merged from fields with different position or width, of widths (4, 6), largest definition used */
/*! @} */
