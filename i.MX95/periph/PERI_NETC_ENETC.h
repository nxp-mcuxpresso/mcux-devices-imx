...
#define NETC_ENETC_NUM_SI_COUNT                   3u
...
typedef struct {
  ...
  __IO uint32_t PLPMR;                             /**< Port low power mode register, offset: 0x340 */
  __I  uint32_t PWOSR;                             /**< Port wake-on status register, offset: 0x344 */
  ...
  struct {                                         /* offset: 0x2000, array step: 0x80 */
    __IO uint32_t PSIPMAR0;                          /**< Port station interface 0 primary MAC address register 0..Port station interface 2 primary MAC address register 0, array offset: 0x2000, array step: 0x80 */
    __IO uint32_t PSIPMAR1;                          /**< Port station interface 0 primary MAC address register 1..Port station interface 2 primary MAC address register 1, array offset: 0x2004, array step: 0x80 */
    __IO uint32_t PSIVLANR;                          /**< Port station interface 0 VLAN register..Port station interface 2 VLAN register, array offset: 0x2008, array step: 0x80 */
         uint8_t RESERVED_0[4];
    __IO uint32_t PSICFGR0;                          /**< Port station interface 0 configuration register 0..Port station interface 2 configuration register 0, array offset: 0x2010, array step: 0x80 */
    __IO uint32_t PSICFGR1;                          /**< Port station interface 1 configuration register 1..Port station interface 2 configuration register 1, array offset: 0x2014, array step: 0x80, valid indices: [1-2] */
    __IO uint32_t PSICFGR2;                          /**< Port station interface 0 configuration register 2..Port station interface 2 configuration register 2, array offset: 0x2018, array step: 0x80 */
         uint8_t RESERVED_1[20];
    __IO uint32_t PSIVMAFCFGR;                       /**< Port station interface 0 VSI MAC address filtering configuration register..Port station interface 2 VSI MAC address filtering configuration register, array offset: 0x2030, array step: 0x80 */
    __IO uint32_t PSIVLANFCFGR;                      /**< Port station interface 0 VLAN filtering configuration register..Port station interface 2 VLAN filtering configuration register, array offset: 0x2034, array step: 0x80 */
         uint8_t RESERVED_2[24];
    __IO uint32_t PSIUMHFR0;                         /**< Port station interface 0 unicast MAC hash filter register 0..Port station interface 2 unicast MAC hash filter register 0, array offset: 0x2050, array step: 0x80 */
    __IO uint32_t PSIUMHFR1;                         /**< Port station interface 0 unicast MAC hash filter register 1..Port station interface 2 unicast MAC hash filter register 1, array offset: 0x2054, array step: 0x80 */
    __IO uint32_t PSIMMHFR0;                         /**< Port station interface 0 multicast MAC hash filter register 0..Port station interface 2 multicast MAC hash filter register 0, array offset: 0x2058, array step: 0x80 */
    __IO uint32_t PSIMMHFR1;                         /**< Port station interface 0 multicast MAC hash filter register 1..Port station interface 2 multicast MAC hash filter register 1, array offset: 0x205C, array step: 0x80 */
    __IO uint32_t PSIVHFR0;                          /**< Port station interface 0 VLAN hash filter register 0..Port station interface 2 VLAN hash filter register 0, array offset: 0x2060, array step: 0x80 */
    __IO uint32_t PSIVHFR1;                          /**< Port station interface 0 VLAN hash filter register 1..Port station interface 2 VLAN hash filter register 1, array offset: 0x2064, array step: 0x80 */
...
/*! @name PSIPMAR0 - Port station interface 0 primary MAC address register 0..Port station interface 2 primary MAC address register 0 */
/*! @{ */
...
#define NETC_ENETC_PSIPMAR0_COUNT                (3U)

/*! @name PSIPMAR1 - Port station interface 0 primary MAC address register 1..Port station interface 2 primary MAC address register 1 */
/*! @{ */
...
#define NETC_ENETC_PSIPMAR1_COUNT                (3U)

/*! @name PSIVLANR - Port station interface 0 VLAN register..Port station interface 2 VLAN register */
/*! @{ */
...
#define NETC_ENETC_PSIVLANR_COUNT                (3U)

/*! @name PSICFGR0 - Port station interface 0 configuration register 0..Port station interface 2 configuration register 0 */
/*! @{ */
...
#define NETC_ENETC_PSICFGR0_COUNT                (3U)

/*! @name PSICFGR1 - Port station interface 1 configuration register 1..Port station interface 2 configuration register 1 */
/*! @{ */
...
#define NETC_ENETC_PSICFGR1_COUNT                (3U)

/*! @name PSICFGR2 - Port station interface 0 configuration register 2..Port station interface 2 configuration register 2 */
/*! @{ */
...
#define NETC_ENETC_PSICFGR2_COUNT                (3U)

/*! @name PSIVMAFCFGR - Port station interface 0 VSI MAC address filtering configuration register..Port station interface 2 VSI MAC address filtering configuration register */
/*! @{ */
...
#define NETC_ENETC_PSIVMAFCFGR_COUNT             (3U)

/*! @name PSIVLANFCFGR - Port station interface 0 VLAN filtering configuration register..Port station interface 2 VLAN filtering configuration register */
/*! @{ */
...
#define NETC_ENETC_PSIVLANFCFGR_COUNT            (3U)

/*! @name PSIUMHFR0 - Port station interface 0 unicast MAC hash filter register 0..Port station interface 2 unicast MAC hash filter register 0 */
/*! @{ */
...
#define NETC_ENETC_PSIUMHFR0_COUNT               (3U)

/*! @name PSIUMHFR1 - Port station interface 0 unicast MAC hash filter register 1..Port station interface 2 unicast MAC hash filter register 1 */
/*! @{ */
...
#define NETC_ENETC_PSIUMHFR1_COUNT               (3U)

/*! @name PSIMMHFR0 - Port station interface 0 multicast MAC hash filter register 0..Port station interface 2 multicast MAC hash filter register 0 */
/*! @{ */
...
#define NETC_ENETC_PSIMMHFR0_COUNT               (3U)

/*! @name PSIMMHFR1 - Port station interface 0 multicast MAC hash filter register 1..Port station interface 2 multicast MAC hash filter register 1 */
/*! @{ */
...
#define NETC_ENETC_PSIMMHFR1_COUNT               (3U)

/*! @name PSIVHFR0 - Port station interface 0 VLAN hash filter register 0..Port station interface 2 VLAN hash filter register 0 */
/*! @{ */
...
#define NETC_ENETC_PSIVHFR0_COUNT                (3U)

/*! @name PSIVHFR1 - Port station interface 0 VLAN hash filter register 1..Port station interface 2 VLAN hash filter register 1 */
/*! @{ */
...
#define NETC_ENETC_PSIVHFR1_COUNT                (3U)
