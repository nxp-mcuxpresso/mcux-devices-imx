...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for NOC_SSI_MASTER_ERROR_ERRLOG_0
**
...
/*!
 * @file PERI_NOC_SSI_MASTER_ERROR_ERRLOG_0.h
 * @version 1.0
 * @date 2023-01-10
 * @brief CMSIS Peripheral Access Layer for NOC_SSI_MASTER_ERROR_ERRLOG_0
 *
 * CMSIS Peripheral Access Layer for NOC_SSI_MASTER_ERROR_ERRLOG_0
 */

#if !defined(PERI_NOC_SSI_MASTER_ERROR_ERRLOG_0_H_)
#define PERI_NOC_SSI_MASTER_ERROR_ERRLOG_0_H_    /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- NOC_SSI_MASTER_ERROR_ERRLOG_0 Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup NOC_SSI_MASTER_ERROR_ERRLOG_0_Peripheral_Access_Layer NOC_SSI_MASTER_ERROR_ERRLOG_0 Peripheral Access Layer
 * @{
 */

/** NOC_SSI_MASTER_ERROR_ERRLOG_0 - Register Layout Typedef */
typedef struct {
  __I  uint32_t ID_COREID;                         /**< Core ID, offset: 0x0 */
  __I  uint32_t ID_REVISIONID;                     /**< Revision ID, offset: 0x4 */
  __IO uint32_t OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_FAULTEN; /**< offset: 0x8 */
  __I  uint32_t OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRVLD; /**< offset: 0xC */
  __O  uint32_t OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRCLR; /**< offset: 0x10 */
  __I  uint32_t OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG0; /**< offset: 0x14 */
  __I  uint32_t OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG1; /**< offset: 0x18 */
       uint8_t RESERVED_0[4];
  __I  uint32_t OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG3; /**< offset: 0x20 */
  __I  uint32_t OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG4; /**< offset: 0x24 */
       uint8_t RESERVED_1[36];
  __IO uint32_t OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_STALLEN; /**< offset: 0x4C */
} NOC_SSI_MASTER_ERROR_ERRLOG_0_Type;

/* ----------------------------------------------------------------------------
   -- NOC_SSI_MASTER_ERROR_ERRLOG_0 Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup NOC_SSI_MASTER_ERROR_ERRLOG_0_Register_Masks NOC_SSI_MASTER_ERROR_ERRLOG_0 Register Masks
 * @{
 */
...
#define NOC_SSI_MASTER_ERROR_ERRLOG_0_ID_COREID_CORETYPEID_MASK (0xFFU)
#define NOC_SSI_MASTER_ERROR_ERRLOG_0_ID_COREID_CORETYPEID_SHIFT (0U)
#define NOC_SSI_MASTER_ERROR_ERRLOG_0_ID_COREID_CORETYPEID(x) (((uint32_t)(((uint32_t)(x)) << NOC_SSI_MASTER_ERROR_ERRLOG_0_ID_COREID_CORETYPEID_SHIFT)) & NOC_SSI_MASTER_ERROR_ERRLOG_0_ID_COREID_CORETYPEID_MASK)

#define NOC_SSI_MASTER_ERROR_ERRLOG_0_ID_COREID_CORECHECKSUM_MASK (0xFFFFFF00U)
#define NOC_SSI_MASTER_ERROR_ERRLOG_0_ID_COREID_CORECHECKSUM_SHIFT (8U)
#define NOC_SSI_MASTER_ERROR_ERRLOG_0_ID_COREID_CORECHECKSUM(x) (((uint32_t)(((uint32_t)(x)) << NOC_SSI_MASTER_ERROR_ERRLOG_0_ID_COREID_CORECHECKSUM_SHIFT)) & NOC_SSI_MASTER_ERROR_ERRLOG_0_ID_COREID_CORECHECKSUM_MASK)
/*! @} */

/*! @name ID_REVISIONID - Revision ID */
/*! @{ */

#define NOC_SSI_MASTER_ERROR_ERRLOG_0_ID_REVISIONID_USERID_MASK (0xFFU)
#define NOC_SSI_MASTER_ERROR_ERRLOG_0_ID_REVISIONID_USERID_SHIFT (0U)
#define NOC_SSI_MASTER_ERROR_ERRLOG_0_ID_REVISIONID_USERID(x) (((uint32_t)(((uint32_t)(x)) << NOC_SSI_MASTER_ERROR_ERRLOG_0_ID_REVISIONID_USERID_SHIFT)) & NOC_SSI_MASTER_ERROR_ERRLOG_0_ID_REVISIONID_USERID_MASK)

#define NOC_SSI_MASTER_ERROR_ERRLOG_0_ID_REVISIONID_NOCID_MASK (0xFFFFFF00U)
#define NOC_SSI_MASTER_ERROR_ERRLOG_0_ID_REVISIONID_NOCID_SHIFT (8U)
#define NOC_SSI_MASTER_ERROR_ERRLOG_0_ID_REVISIONID_NOCID(x) (((uint32_t)(((uint32_t)(x)) << NOC_SSI_MASTER_ERROR_ERRLOG_0_ID_REVISIONID_NOCID_SHIFT)) & NOC_SSI_MASTER_ERROR_ERRLOG_0_ID_REVISIONID_NOCID_MASK)
/*! @} */

/*! @name OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_FAULTEN -  */
/*! @{ */

#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_FAULTEN_FAULTEN_MASK (0x1U)
#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_FAULTEN_FAULTEN_SHIFT (0U)
#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_FAULTEN_FAULTEN(x) (((uint32_t)(((uint32_t)(x)) << NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_FAULTEN_FAULTEN_SHIFT)) & NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_FAULTEN_FAULTEN_MASK)
/*! @} */

/*! @name OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRVLD -  */
/*! @{ */

#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRVLD_ERRVLD_MASK (0x1U)
#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRVLD_ERRVLD_SHIFT (0U)
#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRVLD_ERRVLD(x) (((uint32_t)(((uint32_t)(x)) << NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRVLD_ERRVLD_SHIFT)) & NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRVLD_ERRVLD_MASK)
/*! @} */

/*! @name OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRCLR -  */
/*! @{ */

#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRCLR_ERRCLR_MASK (0x1U)
#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRCLR_ERRCLR_SHIFT (0U)
#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRCLR_ERRCLR(x) (((uint32_t)(((uint32_t)(x)) << NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRCLR_ERRCLR_SHIFT)) & NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRCLR_ERRCLR_MASK)
/*! @} */

/*! @name OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG0 -  */
/*! @{ */

#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG0_LOCK_MASK (0x1U)
#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG0_LOCK_SHIFT (0U)
#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG0_LOCK(x) (((uint32_t)(((uint32_t)(x)) << NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG0_LOCK_SHIFT)) & NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG0_LOCK_MASK)

#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG0_OPC_MASK (0x1EU)
#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG0_OPC_SHIFT (1U)
#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG0_OPC(x) (((uint32_t)(((uint32_t)(x)) << NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG0_OPC_SHIFT)) & NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG0_OPC_MASK)

#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG0_ERRCODE_MASK (0x700U)
#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG0_ERRCODE_SHIFT (8U)
#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG0_ERRCODE(x) (((uint32_t)(((uint32_t)(x)) << NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG0_ERRCODE_SHIFT)) & NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG0_ERRCODE_MASK)

#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG0_LEN1_MASK (0xFF0000U)
#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG0_LEN1_SHIFT (16U)
#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG0_LEN1(x) (((uint32_t)(((uint32_t)(x)) << NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG0_LEN1_SHIFT)) & NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG0_LEN1_MASK)

#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG0_FORMAT_MASK (0x80000000U)
#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG0_FORMAT_SHIFT (31U)
#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG0_FORMAT(x) (((uint32_t)(((uint32_t)(x)) << NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG0_FORMAT_SHIFT)) & NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG0_FORMAT_MASK)
/*! @} */

/*! @name OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG1 -  */
/*! @{ */

#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG1_ERRLOG1_MASK (0xFFFFFU)
#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG1_ERRLOG1_SHIFT (0U)
#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG1_ERRLOG1(x) (((uint32_t)(((uint32_t)(x)) << NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG1_ERRLOG1_SHIFT)) & NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG1_ERRLOG1_MASK)
/*! @} */

/*! @name OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG3 -  */
/*! @{ */

#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG3_ERRLOG3_MASK (0xFFFFFFFFU)
#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG3_ERRLOG3_SHIFT (0U)
#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG3_ERRLOG3(x) (((uint32_t)(((uint32_t)(x)) << NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG3_ERRLOG3_SHIFT)) & NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG3_ERRLOG3_MASK)
/*! @} */

/*! @name OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG4 -  */
/*! @{ */

#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG4_ERRLOG4_MASK (0x1FFFFU)
#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG4_ERRLOG4_SHIFT (0U)
#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG4_ERRLOG4(x) (((uint32_t)(((uint32_t)(x)) << NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG4_ERRLOG4_SHIFT)) & NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_ERRLOG4_ERRLOG4_MASK)
/*! @} */

/*! @name OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_STALLEN -  */
/*! @{ */

#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_STALLEN_STALLEN_MASK (0x1U)
#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_STALLEN_STALLEN_SHIFT (0U)
#define NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_STALLEN_STALLEN(x) (((uint32_t)(((uint32_t)(x)) << NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_STALLEN_STALLEN_SHIFT)) & NOC_SSI_MASTER_ERROR_ERRLOG_0_OBSERVER_SSI_MASTER_ERROR_MAIN_ERRORLOGGER_0_STALLEN_STALLEN_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group NOC_SSI_MASTER_ERROR_ERRLOG_0_Register_Masks */


/*!
 * @}
 */ /* end of group NOC_SSI_MASTER_ERROR_ERRLOG_0_Peripheral_Access_Layer */
...
#endif  /* PERI_NOC_SSI_MASTER_ERROR_ERRLOG_0_H_ */
