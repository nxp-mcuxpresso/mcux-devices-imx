...
#if !defined(PERI_VPU_JPEG_ENC_WRAP_H_)
#define PERI_VPU_JPEG_ENC_WRAP_H_                /**< Symbol preventing repeated inclusion */
...
#endif  /* PERI_VPU_JPEG_ENC_WRAP_H_ */
