...
**
**     Abstract:
**         CMSIS Peripheral Access Layer for CM0_I_main_QosGenerator
**
...
/*!
 * @file PERI_CM0_I_main_QosGenerator.h
 * @version 1.0
 * @date 2023-01-10
 * @brief CMSIS Peripheral Access Layer for CM0_I_main_QosGenerator
 *
 * CMSIS Peripheral Access Layer for CM0_I_main_QosGenerator
 */

#if !defined(PERI_CM0_I_MAIN_QOSGENERATOR_H_)
#define PERI_CM0_I_MAIN_QOSGENERATOR_H_          /**< Symbol preventing repeated inclusion */
...
/* ----------------------------------------------------------------------------
   -- CM0_I_main_QosGenerator Peripheral Access Layer
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup CM0_I_main_QosGenerator_Peripheral_Access_Layer CM0_I_main_QosGenerator Peripheral Access Layer
 * @{
 */

/** CM0_I_main_QosGenerator - Register Layout Typedef */
typedef struct {
...
} CM0_I_main_QosGenerator_Type;

/* ----------------------------------------------------------------------------
   -- CM0_I_main_QosGenerator Register Masks
   ---------------------------------------------------------------------------- */

/*!
 * @addtogroup CM0_I_main_QosGenerator_Register_Masks CM0_I_main_QosGenerator Register Masks
 * @{
 */
...
#define CM0_I_main_QosGenerator_ID_COREID_CORETYPEID_MASK (0xFFU)
#define CM0_I_main_QosGenerator_ID_COREID_CORETYPEID_SHIFT (0U)
#define CM0_I_main_QosGenerator_ID_COREID_CORETYPEID(x) (((uint32_t)(((uint32_t)(x)) << CM0_I_main_QosGenerator_ID_COREID_CORETYPEID_SHIFT)) & CM0_I_main_QosGenerator_ID_COREID_CORETYPEID_MASK)

#define CM0_I_main_QosGenerator_ID_COREID_CORECHECKSUM_MASK (0xFFFFFF00U)
#define CM0_I_main_QosGenerator_ID_COREID_CORECHECKSUM_SHIFT (8U)
#define CM0_I_main_QosGenerator_ID_COREID_CORECHECKSUM(x) (((uint32_t)(((uint32_t)(x)) << CM0_I_main_QosGenerator_ID_COREID_CORECHECKSUM_SHIFT)) & CM0_I_main_QosGenerator_ID_COREID_CORECHECKSUM_MASK)
/*! @} */

/*! @name ID_REVISIONID - Revision ID */
/*! @{ */

#define CM0_I_main_QosGenerator_ID_REVISIONID_USERID_MASK (0xFFU)
#define CM0_I_main_QosGenerator_ID_REVISIONID_USERID_SHIFT (0U)
#define CM0_I_main_QosGenerator_ID_REVISIONID_USERID(x) (((uint32_t)(((uint32_t)(x)) << CM0_I_main_QosGenerator_ID_REVISIONID_USERID_SHIFT)) & CM0_I_main_QosGenerator_ID_REVISIONID_USERID_MASK)

#define CM0_I_main_QosGenerator_ID_REVISIONID_NOCID_MASK (0xFFFFFF00U)
#define CM0_I_main_QosGenerator_ID_REVISIONID_NOCID_SHIFT (8U)
#define CM0_I_main_QosGenerator_ID_REVISIONID_NOCID(x) (((uint32_t)(((uint32_t)(x)) << CM0_I_main_QosGenerator_ID_REVISIONID_NOCID_SHIFT)) & CM0_I_main_QosGenerator_ID_REVISIONID_NOCID_MASK)
/*! @} */

/*! @name PRIORITY - Priority */
/*! @{ */

#define CM0_I_main_QosGenerator_PRIORITY_P0_MASK (0x3U)
#define CM0_I_main_QosGenerator_PRIORITY_P0_SHIFT (0U)
#define CM0_I_main_QosGenerator_PRIORITY_P0(x)   (((uint32_t)(((uint32_t)(x)) << CM0_I_main_QosGenerator_PRIORITY_P0_SHIFT)) & CM0_I_main_QosGenerator_PRIORITY_P0_MASK)

#define CM0_I_main_QosGenerator_PRIORITY_P1_MASK (0x300U)
#define CM0_I_main_QosGenerator_PRIORITY_P1_SHIFT (8U)
#define CM0_I_main_QosGenerator_PRIORITY_P1(x)   (((uint32_t)(((uint32_t)(x)) << CM0_I_main_QosGenerator_PRIORITY_P1_SHIFT)) & CM0_I_main_QosGenerator_PRIORITY_P1_MASK)
/*! @} */

/*! @name MODE - Mode */
/*! @{ */

#define CM0_I_main_QosGenerator_MODE_MODE_MASK   (0x3U)
#define CM0_I_main_QosGenerator_MODE_MODE_SHIFT  (0U)
#define CM0_I_main_QosGenerator_MODE_MODE(x)     (((uint32_t)(((uint32_t)(x)) << CM0_I_main_QosGenerator_MODE_MODE_SHIFT)) & CM0_I_main_QosGenerator_MODE_MODE_MASK)
/*! @} */

/*! @name EXTCONTROL - External Inputs Control */
/*! @{ */

#define CM0_I_main_QosGenerator_EXTCONTROL_SOCKETQOSEN_MASK (0x1U)
#define CM0_I_main_QosGenerator_EXTCONTROL_SOCKETQOSEN_SHIFT (0U)
#define CM0_I_main_QosGenerator_EXTCONTROL_SOCKETQOSEN(x) (((uint32_t)(((uint32_t)(x)) << CM0_I_main_QosGenerator_EXTCONTROL_SOCKETQOSEN_SHIFT)) & CM0_I_main_QosGenerator_EXTCONTROL_SOCKETQOSEN_MASK)

#define CM0_I_main_QosGenerator_EXTCONTROL_EXTTHREN_MASK (0x2U)
#define CM0_I_main_QosGenerator_EXTCONTROL_EXTTHREN_SHIFT (1U)
#define CM0_I_main_QosGenerator_EXTCONTROL_EXTTHREN(x) (((uint32_t)(((uint32_t)(x)) << CM0_I_main_QosGenerator_EXTCONTROL_EXTTHREN_SHIFT)) & CM0_I_main_QosGenerator_EXTCONTROL_EXTTHREN_MASK)

#define CM0_I_main_QosGenerator_EXTCONTROL_INTCLKEN_MASK (0x4U)
#define CM0_I_main_QosGenerator_EXTCONTROL_INTCLKEN_SHIFT (2U)
#define CM0_I_main_QosGenerator_EXTCONTROL_INTCLKEN(x) (((uint32_t)(((uint32_t)(x)) << CM0_I_main_QosGenerator_EXTCONTROL_INTCLKEN_SHIFT)) & CM0_I_main_QosGenerator_EXTCONTROL_INTCLKEN_MASK)

#define CM0_I_main_QosGenerator_EXTCONTROL_EXTLIMITEN_MASK (0x8U)
#define CM0_I_main_QosGenerator_EXTCONTROL_EXTLIMITEN_SHIFT (3U)
#define CM0_I_main_QosGenerator_EXTCONTROL_EXTLIMITEN(x) (((uint32_t)(((uint32_t)(x)) << CM0_I_main_QosGenerator_EXTCONTROL_EXTLIMITEN_SHIFT)) & CM0_I_main_QosGenerator_EXTCONTROL_EXTLIMITEN_MASK)
/*! @} */


/*!
 * @}
 */ /* end of group CM0_I_main_QosGenerator_Register_Masks */


/*!
 * @}
 */ /* end of group CM0_I_main_QosGenerator_Peripheral_Access_Layer */
...
#endif  /* PERI_CM0_I_MAIN_QOSGENERATOR_H_ */
