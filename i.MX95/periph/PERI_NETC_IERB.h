...
#define NETC_IERB_CFG_ENETC_INST_COUNT            3u
#define NETC_IERB_CFG_VSI_INST_VSI_PF_BOOT_LOAD_COUNT 2u
#define NETC_IERB_CFG_VSI_INST_COUNT              6u
...
typedef struct {
  ...
  struct {                                         /* offset: 0x400, array step: 0x64 */
  ...
  __IO uint32_t L2E0MAR1;                          /**< Link 2 end 0 MAC address register 1, offset: 0x10A4 */
       uint8_t RESERVED_25[8024];
  struct {                                         /* offset: 0x3000, array step: 0x100 */
         uint8_t RESERVED_0[4];
    __I  uint32_t EBCR1;                             /**< ENETC 0 binding configuration register 1..ENETC 2 binding configuration register 1, array offset: 0x3004, array step: 0x100 */
    ...
    __IO uint32_t EVFRIDAR;                          /**< ENETC 0 VF RID assignment register..ENETC 2 VF RID assignment register, array offset: 0x3010, array step: 0x100 */
    __IO uint32_t EMCR;                              /**< ENETC 0 MSI-X configuration register..ENETC 2 MSI-X configuration register, array offset: 0x3014, array step: 0x100 */
         uint8_t RESERVED_2[8];
    __IO uint32_t E_CFH_DIDVID;                      /**< ENETC 0 config header device ID and vendor ID register..ENETC 2 config header device ID and vendor ID register, array offset: 0x3020, array step: 0x100 */
    __IO uint32_t E_CFH_SIDSVID;                     /**< ENETC 0 config header subsystem ID and subsystem vendor ID register..ENETC 2 config header subsystem ID and subsystem vendor ID register, array offset: 0x3024, array step: 0x100 */
    __IO uint32_t E_CFC_VFDID;                       /**< ENETC 0 config capability VF device ID register..ENETC 2 config capability VF device ID register, array offset: 0x3028, array step: 0x100 */
         uint8_t RESERVED_3[4];
    __IO uint32_t EBCAR;                             /**< ENETC 0 buffer cache attribute register 0..ENETC 2 buffer cache attribute register 0, array offset: 0x3030, array step: 0x100 */
    __IO uint32_t EMCAR;                             /**< ENETC 0 message cache attribute register..ENETC 2 message cache attribute register, array offset: 0x3034, array step: 0x100 */
    __IO uint32_t ECAR;                              /**< ENETC 0 command cache attribute register..ENETC 2 command cache attribute register, array offset: 0x3038, array step: 0x100 */
         uint8_t RESERVED_4[4];
    __IO uint32_t EAMQR;                             /**< ENETC 0 access management qualifier register..ENETC 2 access management qualifier register, array offset: 0x3040, array step: 0x100 */
    __IO uint32_t EFAUXR;                            /**< ENETC 0 function auxiliary register..ENETC 2 function auxiliary register, array offset: 0x3044, array step: 0x100 */
    __IO uint32_t EBLPR[NETC_IERB_CFG_ENETC_INST_ENETC_PF_BOOT_LOAD_COUNT];   /**< ENETC 0 boot loader parameter register 0..ENETC 2 boot loader parameter register 1, array offset: 0x3048, array step: index*0x100, index2*0x4 */
    __IO uint32_t ERXMBER;                           /**< ENETC 0 receive memory buffer entitlement register..ENETC 2 receive memory buffer entitlement register, array offset: 0x3050, array step: 0x100 */
    __IO uint32_t ERXMBLR;                           /**< ENETC 0 receive memory buffer limit register..ENETC 2 receive memory buffer limit register, array offset: 0x3054, array step: 0x100 */
         uint8_t RESERVED_5[8];
    __IO uint32_t ERIDAR;                            /**< ENETC 0 RID assignment register..ENETC 2 RID assignment register, array offset: 0x3060, array step: 0x100 */
         uint8_t RESERVED_6[12];
    __IO uint32_t ETXHPTBCR;                         /**< ENETC 0 transmit high priority tier byte credit register..ENETC 2 transmit high priority tier byte credit register, array offset: 0x3070, array step: 0x100 */
    __IO uint32_t ETXLPTBCR;                         /**< ENETC 0 transmit low priority tier byte credit register..ENETC 2 transmit low priority tier byte credit register, array offset: 0x3074, array step: 0x100 */
         uint8_t RESERVED_7[8];
    __IO uint32_t EHTMAR;                            /**< ENETC 0 hash table memory allotment register..ENETC 2 hash table memory allotment register, array offset: 0x3080, array step: 0x100 */
    __IO uint32_t EITMAR;                            /**< ENETC 0 index table memory allocation register..ENETC 2 index table memory allocation register, array offset: 0x3084, array step: 0x100 */
    __IO uint32_t EIPFTMAR;                          /**< ENETC 0 ingress port filter table memory allocation register..ENETC 2 ingress port filter table memory allocation register, array offset: 0x3088, array step: 0x100 */
         uint8_t RESERVED_8[20];
    __IO uint32_t ERPITMAR;                          /**< ENETC 0 rate policer index table memory allocation register..ENETC 2 rate policer index table memory allocation register, array offset: 0x30A0, array step: 0x100 */
    __IO uint32_t EISCITMAR;                         /**< ENETC 0 ingress stream counter index table memory allocation register..ENETC 2 ingress stream counter index table memory allocation register, array offset: 0x30A4, array step: 0x100 */
    __IO uint32_t EISITMAR;                          /**< ENETC 0 ingress stream index table memory allocation register..ENETC 2 ingress stream index table memory allocation register, array offset: 0x30A8, array step: 0x100 */
         uint8_t RESERVED_9[8];
    __IO uint32_t ESGIITMAR;                         /**< ENETC 0 stream gate instance index table memory allocation register..ENETC 2 stream gate instance index table memory allocation register, array offset: 0x30B4, array step: 0x100 */
    __IO uint32_t ESGCLITMAR;                        /**< ENETC 0 stream gate control list index table memory allocation register..ENETC 2 stream gate control list index table memory allocation register, array offset: 0x30B8, array step: 0x100 */
         uint8_t RESERVED_10[52];
    __IO uint32_t ETGSTAR;                           /**< ENETC 0 time gate scheduling table allocation register..ENETC 2 time gate scheduling table allocation register, array offset: 0x30F0, array step: 0x100 */
    __IO uint32_t ETGSLR;                            /**< ENETC 0 time gate scheduling lookahead register..ENETC 2 time gate scheduling lookahead register, array offset: 0x30F4, array step: 0x100 */
         uint8_t RESERVED_11[8];
  } CFG_ENETC_INST[NETC_IERB_CFG_ENETC_INST_COUNT];
       uint8_t RESERVED_26[3328];
  struct {                                         /* offset: 0x4000, array step: 0x40 */
    __IO uint32_t VAMQR;                             /**< VSI 0 access management qualifier register..VSI 5 access management qualifier register, array offset: 0x4000, array step: 0x40 */
    __IO uint32_t VFAUXR;                            /**< VSI 0 function auxiliary register..VSI 5 function auxiliary register, array offset: 0x4004, array step: 0x40 */
    __IO uint32_t VBLPR[NETC_IERB_CFG_VSI_INST_VSI_PF_BOOT_LOAD_COUNT];   /**< VSI 0 boot loader parameter register 0..VSI 5 boot loader parameter register 1, array offset: 0x4008, array step: index*0x40, index2*0x4 */
    __IO uint32_t VPMAR0;                            /**< VSI 0 primary MAC address register 0..VSI 5 primary MAC address register 0, array offset: 0x4010, array step: 0x40 */
    __IO uint32_t VPMAR1;                            /**< VSI 0 primary MAC address register 1..VSI 5 primary MAC address register 1, array offset: 0x4014, array step: 0x40 */
...
#define NETC_IERB_TFAUXR_COUNT                   (1U)
...
#define NETC_IERB_TRIDAR_COUNT                   (1U)
...
/*! @name EBCR1 - ENETC 0 binding configuration register 1..ENETC 2 binding configuration register 1 */
/*! @{ */
...
#define NETC_IERB_EBCR1_COUNT                    (3U)

/*! @name EBCR2 - ENETC 0 binding configuration register 2..ENETC 2 binding configuration register 2 */
/*! @{ */
...
#define NETC_IERB_EBCR2_COUNT                    (3U)

/*! @name EVFRIDAR - ENETC 0 VF RID assignment register..ENETC 2 VF RID assignment register */
/*! @{ */
...
#define NETC_IERB_EVFRIDAR_COUNT                 (3U)

/*! @name EMCR - ENETC 0 MSI-X configuration register..ENETC 2 MSI-X configuration register */
/*! @{ */
...
#define NETC_IERB_EMCR_COUNT                     (3U)

/*! @name E_CFH_DIDVID - ENETC 0 config header device ID and vendor ID register..ENETC 2 config header device ID and vendor ID register */
/*! @{ */
...
#define NETC_IERB_E_CFH_DIDVID_COUNT             (3U)

/*! @name E_CFH_SIDSVID - ENETC 0 config header subsystem ID and subsystem vendor ID register..ENETC 2 config header subsystem ID and subsystem vendor ID register */
/*! @{ */
...
#define NETC_IERB_E_CFH_SIDSVID_COUNT            (3U)

/*! @name E_CFC_VFDID - ENETC 0 config capability VF device ID register..ENETC 2 config capability VF device ID register */
/*! @{ */
...
#define NETC_IERB_E_CFC_VFDID_COUNT              (3U)

/*! @name EBCAR - ENETC 0 buffer cache attribute register 0..ENETC 2 buffer cache attribute register 0 */
/*! @{ */
...
#define NETC_IERB_EBCAR_COUNT                    (3U)

/*! @name EMCAR - ENETC 0 message cache attribute register..ENETC 2 message cache attribute register */
/*! @{ */
...
#define NETC_IERB_EMCAR_COUNT                    (3U)

/*! @name ECAR - ENETC 0 command cache attribute register..ENETC 2 command cache attribute register */
/*! @{ */
...
#define NETC_IERB_ECAR_COUNT                     (3U)

/*! @name EAMQR - ENETC 0 access management qualifier register..ENETC 2 access management qualifier register */
/*! @{ */
...
#define NETC_IERB_EAMQR_COUNT                    (3U)

/*! @name EFAUXR - ENETC 0 function auxiliary register..ENETC 2 function auxiliary register */
/*! @{ */
...
#define NETC_IERB_EFAUXR_COUNT                   (3U)

/*! @name EBLPR - ENETC 0 boot loader parameter register 0..ENETC 2 boot loader parameter register 1 */
/*! @{ */
...
#define NETC_IERB_EBLPR_COUNT                    (3U)

/* The count of NETC_IERB_EBLPR */
#define NETC_IERB_EBLPR_COUNT2                   (2U)

/*! @name ERXMBER - ENETC 0 receive memory buffer entitlement register..ENETC 2 receive memory buffer entitlement register */
/*! @{ */
...
#define NETC_IERB_ERXMBER_COUNT                  (3U)

/*! @name ERXMBLR - ENETC 0 receive memory buffer limit register..ENETC 2 receive memory buffer limit register */
/*! @{ */
...
#define NETC_IERB_ERXMBLR_COUNT                  (3U)

/*! @name ERIDAR - ENETC 0 RID assignment register..ENETC 2 RID assignment register */
/*! @{ */
...
#define NETC_IERB_ERIDAR_COUNT                   (3U)

/*! @name ETXHPTBCR - ENETC 0 transmit high priority tier byte credit register..ENETC 2 transmit high priority tier byte credit register */
/*! @{ */
...
#define NETC_IERB_ETXHPTBCR_COUNT                (3U)

/*! @name ETXLPTBCR - ENETC 0 transmit low priority tier byte credit register..ENETC 2 transmit low priority tier byte credit register */
/*! @{ */
...
#define NETC_IERB_ETXLPTBCR_COUNT                (3U)

/*! @name EHTMAR - ENETC 0 hash table memory allotment register..ENETC 2 hash table memory allotment register */
/*! @{ */
...
#define NETC_IERB_EHTMAR_COUNT                   (3U)

/*! @name EITMAR - ENETC 0 index table memory allocation register..ENETC 2 index table memory allocation register */
/*! @{ */
...
#define NETC_IERB_EITMAR_COUNT                   (3U)

/*! @name EIPFTMAR - ENETC 0 ingress port filter table memory allocation register..ENETC 2 ingress port filter table memory allocation register */
/*! @{ */
...
#define NETC_IERB_EIPFTMAR_COUNT                 (3U)

/*! @name ERPITMAR - ENETC 0 rate policer index table memory allocation register..ENETC 2 rate policer index table memory allocation register */
/*! @{ */
...
#define NETC_IERB_ERPITMAR_COUNT                 (3U)

/*! @name EISCITMAR - ENETC 0 ingress stream counter index table memory allocation register..ENETC 2 ingress stream counter index table memory allocation register */
/*! @{ */
...
#define NETC_IERB_EISCITMAR_COUNT                (3U)

/*! @name EISITMAR - ENETC 0 ingress stream index table memory allocation register..ENETC 2 ingress stream index table memory allocation register */
/*! @{ */
...
#define NETC_IERB_EISITMAR_COUNT                 (3U)

/*! @name ESGIITMAR - ENETC 0 stream gate instance index table memory allocation register..ENETC 2 stream gate instance index table memory allocation register */
/*! @{ */
...
#define NETC_IERB_ESGIITMAR_COUNT                (3U)

/*! @name ESGCLITMAR - ENETC 0 stream gate control list index table memory allocation register..ENETC 2 stream gate control list index table memory allocation register */
/*! @{ */
...
#define NETC_IERB_ESGCLITMAR_COUNT               (3U)

/*! @name ETGSTAR - ENETC 0 time gate scheduling table allocation register..ENETC 2 time gate scheduling table allocation register */
/*! @{ */
...
#define NETC_IERB_ETGSTAR_COUNT                  (3U)

/*! @name ETGSLR - ENETC 0 time gate scheduling lookahead register..ENETC 2 time gate scheduling lookahead register */
/*! @{ */
...
#define NETC_IERB_ETGSLR_COUNT                   (3U)

/*! @name VAMQR - VSI 0 access management qualifier register..VSI 5 access management qualifier register */
/*! @{ */
...
#define NETC_IERB_VAMQR_COUNT                    (6U)

/*! @name VFAUXR - VSI 0 function auxiliary register..VSI 5 function auxiliary register */
/*! @{ */
...
#define NETC_IERB_VFAUXR_COUNT                   (6U)

/*! @name VBLPR - VSI 0 boot loader parameter register 0..VSI 5 boot loader parameter register 1 */
/*! @{ */
...
#define NETC_IERB_VBLPR_COUNT                    (6U)

/* The count of NETC_IERB_VBLPR */
#define NETC_IERB_VBLPR_COUNT2                   (2U)

/*! @name VPMAR0 - VSI 0 primary MAC address register 0..VSI 5 primary MAC address register 0 */
/*! @{ */
...
#define NETC_IERB_VPMAR0_COUNT                   (6U)

/*! @name VPMAR1 - VSI 0 primary MAC address register 1..VSI 5 primary MAC address register 1 */
/*! @{ */
...
#define NETC_IERB_VPMAR1_COUNT                   (6U)
