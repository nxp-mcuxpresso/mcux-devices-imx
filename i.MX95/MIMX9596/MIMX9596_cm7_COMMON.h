...
#if !defined(MIMX9596_CM7_COMMON_H_)
#define MIMX9596_CM7_COMMON_H_                   /**< Symbol preventing repeated inclusion */
...
#include "system_MIMX9596_cm7.h"       /* Device specific configuration file */
