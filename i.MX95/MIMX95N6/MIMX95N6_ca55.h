...
#if !defined(MIMX95N6_ca55_H_)  /* Check if memory map has not been already included */
#define MIMX95N6_ca55_H_
...
#endif  /* #if !defined(MIMX95N6_ca55_H_) */
