...
#if !defined(MIMX95N4_cm33_H_)  /* Check if memory map has not been already included */
#define MIMX95N4_cm33_H_
...
#endif  /* #if !defined(MIMX95N4_cm33_H_) */
